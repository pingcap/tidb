...
func (s *testTableCodecSuite) TestDecodeBadDecical(c *C) {
	gofail.Enable("github.com/pingcap/tidb/v3/util/codec/errorInDecodeDecimal", `return(true)`)
	defer gofail.Disable("github.com/pingcap/tidb/v3/util/codec/errorInDecodeDecimal")
