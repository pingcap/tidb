...
var MySQLErrName = map[uint16]string{
	...
	ErrConCountError:                            "Too many connections",
	...
	ErrBadHostError:                             "Can't get hostname for your address",
	ErrHandshakeError:                           "Bad handshake",
	ErrDbaccessDeniedError:                      "Access denied for user '%-.48s'@'%-.64s' to database '%-.192s'",
	ErrAccessDeniedError:                        "Access denied for user '%-.48s'@'%-.64s' (using password: %s)",
	ErrNoDbError:                                "No database selected",
	ErrUnknownComError:                          "Unknown command",
	ErrBadNullError:                             "Column '%-.192s' cannot be null",
	ErrBadDbError:                               "Unknown database '%-.192s'",
	ErrTableExistsError:                         "Table '%-.192s' already exists",
	ErrBadTableError:                            "Unknown table '%-.100s'",
	ErrNonUniqError:                             "Column '%-.192s' in %-.192s is ambiguous",
	ErrServerShutdown:                           "Server shutdown in progress",
	ErrBadFieldError:                            "Unknown column '%-.192s' in '%-.192s'",
	...
	ErrParseError:                               "%s near '%-.80s' at line %d",
	...
	ErrIpsockError:                              "Can't create IP socket",
	...
	ErrFileExistsError:                          "File '%-.200s' already exists",
	...
	ErrKillDeniedError:                          "You are not owner of thread %lu",
	...
	ErrRegexpError:                              "Got error '%-.64s' from regexp",
	...
	ErrTableaccessDeniedError:                   "%-.128s command denied to user '%-.48s'@'%-.64s' for table '%-.64s'",
	ErrColumnaccessDeniedError:                  "%-.16s command denied to user '%-.48s'@'%-.64s' for column '%-.192s' in table '%-.192s'",
	...
	ErrSyntaxError:                              "You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use",
	...
	ErrNetFcntlError:                            "Got an error from fcntl()",
	ErrNetPacketsOutOfOrder:                     "Got packets out of order",
	ErrNetUncompressError:                       "Couldn't uncompress communication packet",
	ErrNetReadError:                             "Got an error reading communication packets",
	...
	ErrSpecificAccessDeniedError:                "Access denied; you need (at least one of) the %-.128s privilege(s) for this operation",
	...
	ErrZlibZMemError:                            "ZLIB: Not enough memory",
	ErrZlibZBufError:                            "ZLIB: Not enough room in the output buffer (probably, length of uncompressed data was corrupted)",
	ErrZlibZDataError:                           "ZLIB: Input data corrupted",
	...
	ErrProcaccessDeniedError:                    "%-.16s command denied to user '%-.48s'@'%-.64s' for routine '%-.192s'",
	...
	ErrQueryOnForeignDataSource:                 "There was a problem processing the query on the foreign data source. Data source error: %-.64s",
	ErrForeignDataSourceDoesntExist:             "The foreign data source you are trying to reference does not exist. Data source error:  %-.64s",
	...
	ErrCantCreateFederatedTable:                 "Can't create federated table. Foreign data src error:  %-.64s",
	...
	ErrForeignServerDoesntExist:                 "The foreign server name you are trying to reference does not exist. Data source error:  %-.64s",
	ErrIllegalHaCreateOption:                    "Table storage engine '%-.64s' does not support the create option '%.64s'",
	ErrPartitionRequiresValuesError:             "Syntax error: %-.64s PARTITIONING requires definition of VALUES %-.64s for each partition",
	ErrPartitionWrongValuesError:                "Only %-.64s PARTITIONING can use VALUES %-.64s in partition definition",
	ErrPartitionMaxvalueError:                   "MAXVALUE can only be used in last partition definition",
	ErrPartitionSubpartitionError:               "Subpartitions can only be hash partitions and by key",
	ErrPartitionSubpartMixError:                 "Must define subpartitions on all partitions if on one partition",
	ErrPartitionWrongNoPartError:                "Wrong number of partitions defined, mismatch with previous setting",
	ErrPartitionWrongNoSubpartError:             "Wrong number of subpartitions defined, mismatch with previous setting",
	ErrWrongExprInPartitionFuncError:            "Constant, random or timezone-dependent expressions in (sub)partitioning function are not allowed",
	ErrNoConstExprInRangeOrListError:            "Expression in RANGE/LIST VALUES must be constant",
	ErrFieldNotFoundPartError:                   "Field in list of fields for partition function not found in table",
	ErrListOfFieldsOnlyInHashError:              "List of fields is only allowed in KEY partitions",
	ErrInconsistentPartitionInfoError:           "The partition info in the frm file is not consistent with what can be written into the frm file",
	ErrPartitionFuncNotAllowedError:             "The %-.192s function returns the wrong type",
	ErrPartitionsMustBeDefinedError:             "For %-.64s partitions each partition must be defined",
	ErrRangeNotIncreasingError:                  "VALUES LESS THAN value must be strictly increasing for each partition",
	ErrInconsistentTypeOfFunctionsError:         "VALUES value must be of same type as partition function",
	ErrMultipleDefConstInListPartError:          "Multiple definition of same constant in list partitioning",
	ErrPartitionEntryError:                      "Partitioning can not be used stand-alone in query",
	ErrMixHandlerError:                          "The mix of handlers in the partitions is not allowed in this version of MySQL",
	ErrPartitionNotDefinedError:                 "For the partitioned engine it is necessary to define all %-.64s",
	ErrTooManyPartitionsError:                   "Too many partitions (including subpartitions) were defined",
	ErrSubpartitionError:                        "It is only possible to mix RANGE/LIST partitioning with HASH/KEY partitioning for subpartitioning",
	ErrCantCreateHandlerFile:                    "Failed to create specific handler file",
	ErrBlobFieldInPartFuncError:                 "A BLOB field is not allowed in partition function",
	ErrUniqueKeyNeedAllFieldsInPf:               "A %-.192s must include all columns in the table's partitioning function",
	ErrNoPartsError:                             "Number of %-.64s = 0 is not an allowed value",
	...
	ErrReorgNoParamError:                        "REORGANIZE PARTITION without parameters can only be used on auto-partitioned tables using HASH PARTITIONs",
	ErrOnlyOnRangeListPartition:                 "%-.64s PARTITION can only be used on RANGE/LIST partitions",
	ErrAddPartitionSubpartError:                 "Trying to Add partition(s) with wrong number of subpartitions",
	...
	ErrNoBinlogError:                            "It is not allowed to shut off binlog on this command",
	...
	ErrPartStateError:                           "Partition state cannot be defined from CREATE/ALTER TABLE",
	...
	ErrTablespaceAutoExtendError:                "The handler doesn't support autoextend of tablespaces",
	ErrWrongSizeNumber:                          "A size parameter was incorrectly specified, either number or on the form 10M",
	ErrSizeOverflowError:                        "The size number was correct but we don't allow the digit part to be more than 2 billion",
	...
	ErrEventCompileError:                        "Error during compilation of event's body",
	...
	ErrPartitionConstDomainError:                "Partition constant is out of partition function domain",
	ErrPartitionFunctionIsNotAllowed:            "This partition function is not allowed",
	ErrDdlLogError:                              "Error in DDL log",
	...
	ErrEventModifyQueueError:                    "Internal scheduler error %d",
	ErrEventSetVarError:                         "Error during starting/stopping of the scheduler. Error code %u",
	ErrPartitionMergeError:                      "Engine cannot be used in partitioned tables",
	ErrCantActivateLog:                          "Cannot activate '%-.64s' log",
	ErrRbrNotAvailable:                          "The server was not built with row-based replication",
	ErrBase64DecodeError:                        "Decoding of base64 string failed",
	ErrEventRecursionForbidden:                  "Recursion of EVENT DDL statements is forbidden when body is present",
	ErrEventsDbError:                            "Cannot proceed because system tables used by Event Scheduler were found damaged at server start",
	...
	ErrSlaveFatalError:                          "Fatal error: %s",
	...
	ErrNdbReplicationSchemaError:                             "Bad schema for mysql.ndbReplication table. Message: %-.64s",
	ErrConflictFnParseError:                                  "Error in parsing conflict function. Message: %-.64s",
	ErrExceptionsWriteError:                                  "Write to exceptions table failed. Message: %-.128s\"",
	...
	ErrPartitionColumnListError:                              "Inconsistency in usage of column lists for partitioning",
	ErrWrongTypeColumnValueError:                             "Partition column values of incorrect type",
	ErrTooManyPartitionFuncFieldsError:                       "Too many fields in '%-.192s'",
	ErrMaxvalueInValuesIn:                                    "Cannot use MAXVALUE as value in VALUES IN",
	ErrTooManyValuesError:                                    "Cannot have more than one value for this type of %-.64s partitioning",
	ErrRowSinglePartitionFieldError:                          "Row expressions in VALUES IN only allowed for multi-field column partitioning",
	...
	ErrValuesIsNotIntTypeError:                               "VALUES value for partition '%-.64s' must have type INT",
	ErrAccessDeniedNoPasswordError:                           "Access denied for user '%-.48s'@'%-.64s'",
	...
	ErrIoReadError:                                           "IO Read error: (%lu, %s) %s",
	ErrIoWriteError:                                          "IO Write error: (%lu, %s) %s",
	...
	ErrInternalError:                                         "Internal error: %s",
	ErrInnodbImportError:                                     "ALTER TABLE '%-.192s' IMPORT TABLESPACE failed with error %lu : '%s'",
