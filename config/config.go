...
type Config struct {
	...
	// EnableAlterPrimaryKey is used to control alter primary key feature.
	EnableAlterPrimaryKey bool `toml:"enable-alter-primary-key" json:"enable-alter-primary-key"`
