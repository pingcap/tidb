...
type TiKVClient struct {
	...
	// EnableParallelCommit enables parallel commit for all transactions.
	EnableParallelCommit bool `toml:"enable-parallel-commit" json:"enable-parallel-commit"`
