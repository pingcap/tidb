...
func (s *testPrivilegeSuite) TestIssue22946(c *C) {
	...
	mustExec(c, rootSe,"CREATE USER 'tester'@'localhost';")
	mustExec(c, rootSe,"grant all on db1.* to tester@'localhost';")
	mustExec(c, rootSe,"grant all on db2.* to tester@'localhost';")
	mustExec(c, rootSe,"grant select on test.* to tester@'localhost';")
	mustExec(c, rootSe,"flush privileges;")
