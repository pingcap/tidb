...
func (ts *testDMLSuite) TestDMLVisitorCover(c *C) {
	...
	stmts := []struct {
		...
		{&LoadDataStmt{Table: &TableName{}, Columns: []*ColumnName{&ColumnName{}}, FieldsInfo: &FieldsClause{}, LinesInfo: &LinesClause{}}, 0, 0},
		{&Assignment{Column: &ColumnName{}, Expr: ce}, 1, 1},
		{&ByItem{Expr: ce}, 1, 1},
		{&GroupByClause{Items: []*ByItem{&ByItem{Expr: ce}, &ByItem{Expr: ce}}}, 2, 2},
		{&HavingClause{Expr: ce}, 1, 1},
		{&Join{Left: &TableSource{Source: &TableName{}}}, 0, 0},
		{&Limit{Count: ce, Offset: ce}, 2, 2},
		{&OnCondition{Expr: ce}, 1, 1},
		{&OrderByClause{Items: []*ByItem{&ByItem{Expr: ce}, &ByItem{Expr: ce}}}, 2, 2},
