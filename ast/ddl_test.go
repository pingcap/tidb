...
func (ts *testDDLSuite) TestDDLVisitorCover(c *C) {
	...
	alterTableSpec := &AlterTableSpec{Constraint: constraint, Options: []*TableOption{{}}, NewTable: &TableName{},
		NewColumns: []*ColumnDef{{Name: &ColumnName{}}}, OldColumnName: &ColumnName{},
		Positions: []*ColumnPosition{{RelativeColumn: &ColumnName{}}}}
