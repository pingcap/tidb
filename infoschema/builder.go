...
func (b *Builder) ApplyDiff(m *meta.Meta, diff *model.SchemaDiff) ([]int64, error) {
	...
	if tableIDIsValid(newTableID) {
		...
		err := b.applyCreateTable(m, dbInfo, newTableID, allocs)
		if err != nil {
...
func (b *Builder) applyCreateTable(m *meta.Meta, dbInfo *model.DBInfo, tableID int64, allocs autoid.Allocators) error {
