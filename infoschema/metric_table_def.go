...
var MetricTableMap = map[string]MetricTableDef{
	...
	"tikv_snapshot_state_total_count": {
		PromQL:  `sum(delta(tikv_raftstore_snapshot_traffic_total{$LABEL_CONDITIONS}[60s])) by (type,instance)`,
		Labels:  []string{"instance", "type"},
	...
	"tikv_cop_scan_details_total": {
		PromQL: `sum(increase(tikv_coprocessor_scan_details{$LABEL_CONDITIONS}[60s])) by (tag,req,cf,instance)`,
		Labels: []string{"instance", "tag", "req", "cf"},
	},
	...
	"etcd_wal_fsync_total_count": {
		PromQL:  "sum(increase(etcd_disk_wal_fsync_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of writing WAL into the persistent storage",
	},
	"etcd_wal_fsync_total_time": {
		PromQL:  "sum(increase(etcd_disk_wal_fsync_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of writing WAL into the persistent storage",
	},
	"pd_client_cmd_total_count": {
		PromQL:  "sum(increase(pd_client_cmd_handle_cmds_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of pd client command durations",
	},
	"pd_client_cmd_total_time": {
		PromQL:  "sum(increase(pd_client_cmd_handle_cmds_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of pd client command durations",
	},
	"pd_grpc_completed_commands_total_count": {
		PromQL:  "sum(increase(grpc_server_handling_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,grpc_method)",
		Labels:  []string{"instance", "grpc_method"},
		Comment: "The total count of completing each kind of gRPC commands",
	},
	"pd_grpc_completed_commands_total_time": {
		PromQL:  "sum(increase(grpc_server_handling_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,grpc_method)",
		Labels:  []string{"instance", "grpc_method"},
		Comment: "The total time of completing each kind of gRPC commands",
	},
	"pd_handle_request_total_count": {
		PromQL:  "sum(increase(pd_client_request_handle_requests_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of pd handle request duration(second)",
	},
	"pd_handle_request_total_time": {
		PromQL:  "sum(increase(pd_client_request_handle_requests_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of pd handle request duration(second)",
	},
	"pd_handle_transactions_total_count": {
		PromQL:  "sum(increase(pd_txn_handle_txns_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,result)",
		Labels:  []string{"instance", "result"},
		Comment: "The total count of handling etcd transactions",
	},
	"pd_handle_transactions_total_time": {
		PromQL:  "sum(increase(pd_txn_handle_txns_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,result)",
		Labels:  []string{"instance", "result"},
		Comment: "The total time of handling etcd transactions",
	},
	"pd_operator_finish_total_count": {
		PromQL:  "sum(increase(pd_schedule_finish_operators_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (type)",
		Labels:  []string{"type"},
		Comment: "The total count of the operator is finished",
	},
	"pd_operator_finish_total_time": {
		PromQL:  "sum(increase(pd_schedule_finish_operators_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (type)",
		Labels:  []string{"type"},
		Comment: "The total time consumed when the operator is finished",
	},
	"pd_operator_step_finish_total_count": {
		PromQL:  "sum(increase(pd_schedule_finish_operator_steps_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (type)",
		Labels:  []string{"type"},
		Comment: "The total count of the operator step is finished",
	},
	"pd_operator_step_finish_total_time": {
		PromQL:  "sum(increase(pd_schedule_finish_operator_steps_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (type)",
		Labels:  []string{"type"},
		Comment: "The total time consumed when the operator step is finished",
	},
	"pd_peer_round_trip_total_count": {
		PromQL:  "sum(increase(etcd_network_peer_round_trip_time_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,To)",
		Labels:  []string{"instance", "To"},
		Comment: "The total count of the network in .99",
	},
	"pd_peer_round_trip_total_time": {
		PromQL:  "sum(increase(etcd_network_peer_round_trip_time_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,To)",
		Labels:  []string{"instance", "To"},
		Comment: "The total time of latency of the network in .99",
	},
	"pd_region_heartbeat_total_count": {
		PromQL:  "sum(increase(pd_scheduler_region_heartbeat_latency_seconds_count{$LABEL_CONDITIONS}[60s])) by (address,store)",
		Labels:  []string{"address", "store"},
		Comment: "The total count of heartbeat latency of each TiKV instance in",
	},
	"pd_region_heartbeat_total_time": {
		PromQL:  "sum(increase(pd_scheduler_region_heartbeat_latency_seconds_sum{$LABEL_CONDITIONS}[60s])) by (address,store)",
		Labels:  []string{"address", "store"},
		Comment: "The total time of heartbeat latency of each TiKV instance in",
	},
	"pd_start_tso_wait_total_count": {
		PromQL:  "sum(increase(tidb_pdclient_ts_future_wait_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total countof the waiting time for getting the start timestamp oracle",
	},
	"pd_start_tso_wait_total_time": {
		PromQL:  "sum(increase(tidb_pdclient_ts_future_wait_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of duration of the waiting time for getting the start timestamp oracle",
	},
	"pd_tso_rpc_total_count": {
		PromQL:  "sum(increase(pd_client_request_handle_requests_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of a client sending TSO request until received the response.",
	},
	"pd_tso_rpc_total_time": {
		PromQL:  "sum(increase(pd_client_request_handle_requests_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of a client sending TSO request until received the response.",
	},
	"pd_tso_wait_total_count": {
		PromQL:  "sum(increase(pd_client_cmd_handle_cmds_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of a client starting to wait for the TS until received the TS result.",
	},
	"pd_tso_wait_total_time": {
		PromQL:  "sum(increase(pd_client_cmd_handle_cmds_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_auto_id_request_total_count": {
		PromQL:  "sum(increase(tidb_autoid_operation_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of TiDB auto id requests durations",
	},
	"tidb_auto_id_request_total_time": {
		PromQL:  "sum(increase(tidb_autoid_operation_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of TiDB auto id requests durations",
	},
	"tidb_batch_client_unavailable_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_batch_client_unavailable_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of kv storage batch processing unvailable durations",
	},
	"tidb_batch_client_unavailable_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_batch_client_unavailable_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of kv storage batch processing unvailable durations",
	},
	"tidb_batch_client_wait_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_batch_wait_duration_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of kv storage batch processing durations",
	},
	"tidb_batch_client_wait_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_batch_wait_duration_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of kv storage batch processing durations",
	},
	"tidb_compile_total_count": {
		PromQL:  "sum(increase(tidb_session_compile_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total count of building the query plan(second)",
	},
	"tidb_compile_total_time": {
		PromQL:  "sum(increase(tidb_session_compile_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total time of cost of building the query plan(second)",
	},
	"tidb_cop_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_cop_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of kv storage coprocessor processing durations",
	},
	"tidb_cop_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_cop_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of kv storage coprocessor processing durations",
	},
	"tidb_ddl_batch_add_index_total_count": {
		PromQL:  "sum(increase(tidb_ddl_batch_add_idx_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of TiDB batch add index durations by histogram buckets",
	},
	"tidb_ddl_batch_add_index_total_time": {
		PromQL:  "sum(increase(tidb_ddl_batch_add_idx_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of TiDB batch add index durations by histogram buckets",
	},
	"tidb_ddl_deploy_syncer_total_count": {
		PromQL:  "sum(increase(tidb_ddl_deploy_syncer_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
	...
	"tidb_ddl_deploy_syncer_total_time": {
		PromQL:  "sum(increase(tidb_ddl_deploy_syncer_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
	...
	"tidb_ddl_total_count": {
		PromQL:  "sum(increase(tidb_ddl_handle_job_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of TiDB DDL duration statistics",
	},
	"tidb_ddl_total_time": {
		PromQL:  "sum(increase(tidb_ddl_handle_job_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of TiDB DDL duration statistics",
	},
	"tidb_ddl_update_self_version_total_count": {
		PromQL:  "sum(increase(tidb_ddl_update_self_ver_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,result)",
		Labels:  []string{"instance", "result"},
		Comment: "The total count of TiDB schema syncer version update time duration",
	},
	"tidb_ddl_update_self_version_total_time": {
		PromQL:  "sum(increase(tidb_ddl_update_self_ver_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,result)",
		Labels:  []string{"instance", "result"},
		Comment: "The total time of TiDB schema syncer version update time duration",
	},
	"tidb_ddl_worker_total_count": {
		PromQL:  "sum(increase(tidb_ddl_worker_operation_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type,result,action)",
		Labels:  []string{"instance", "type", "result", "action"},
		Comment: "The total count of TiDB ddl worker duration",
	},
	"tidb_ddl_worker_total_time": {
		PromQL:  "sum(increase(tidb_ddl_worker_operation_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,result,action)",
		Labels:  []string{"instance", "type", "result", "action"},
		Comment: "The total time of TiDB ddl worker duration",
	},
	"tidb_distsql_execution_total_count": {
		PromQL:  "sum(increase(tidb_distsql_handle_query_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of distsql execution(second)",
	},
	"tidb_distsql_execution_total_time": {
		PromQL:  "sum(increase(tidb_distsql_handle_query_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of distsql execution(second)",
	},
	"tidb_execute_total_count": {
		PromQL:  "sum(increase(tidb_session_execute_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total count of of executing the SQL which does not include the time to get the results of the query(second)",
	},
	"tidb_execute_total_time": {
		PromQL:  "sum(increase(tidb_session_execute_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
	...
	"tidb_gc_push_task_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_range_task_push_duration_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of kv storage range worker processing one task duration",
	},
	"tidb_gc_push_task_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_range_task_push_duration_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of kv storage range worker processing one task duration",
	},
	"tidb_gc_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_gc_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of kv storage garbage collection time durations",
	},
	"tidb_gc_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_gc_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of kv storage garbage collection time durations",
	},
	"tidb_get_token_total_count": {
		PromQL:  "sum(increase(tidb_server_get_token_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_get_token_total_time": {
		PromQL:  "sum(increase(tidb_server_get_token_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_kv_backoff_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_backoff_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of kv backoff time durations(second)",
	},
	"tidb_kv_backoff_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_backoff_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
	...
	"tidb_kv_request_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_request_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,store)",
		Labels:  []string{"instance", "type", "store"},
		Comment: "The total time of kv requests durations by store",
	},
	"tidb_load_schema_total_count": {
		PromQL:  "sum(increase(tidb_domain_load_schema_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of TiDB loading schema time durations by instance",
	},
	"tidb_load_schema_total_time": {
		PromQL:  "sum(increase(tidb_domain_load_schema_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of TiDB loading schema time durations by instance",
	},
	"tidb_meta_operation_total_count": {
		PromQL:  "sum(increase(tidb_meta_operation_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
	...
	"tidb_meta_operation_total_time": {
		PromQL:  "sum(increase(tidb_meta_operation_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
	...
	"tidb_new_etcd_session_total_count": {
		PromQL:  "sum(increase(tidb_owner_new_session_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
		Comment: "The total count of TiDB new session durations for new etcd sessions",
	},
	"tidb_new_etcd_session_total_time": {
		PromQL:  "sum(increase(tidb_owner_new_session_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
		Comment: "The total time of TiDB new session durations for new etcd sessions",
	},
	"tidb_owner_handle_syncer_total_count": {
		PromQL:  "sum(increase(tidb_ddl_owner_handle_syncer_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
		Comment: "The total count of TiDB ddl owner time operations on etcd duration statistics ",
	},
	"tidb_owner_handle_syncer_total_time": {
		PromQL:  "sum(increase(tidb_ddl_owner_handle_syncer_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,result)",
		Labels:  []string{"instance", "type", "result"},
		Comment: "The total time of TiDB ddl owner time operations on etcd duration statistics ",
	},
	"tidb_parse_total_count": {
		PromQL:  "sum(increase(tidb_session_parse_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total count of parsing SQL to AST(second)",
	},
	"tidb_parse_total_time": {
		PromQL:  "sum(increase(tidb_session_parse_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total time cost of parsing SQL to AST(second)",
	},
	"tidb_query_total_count": {
		PromQL:  "sum(increase(tidb_server_handle_query_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total count of TiDB query durations(second)",
	},
	"tidb_query_total_time": {
		PromQL:  "sum(increase(tidb_server_handle_query_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,sql_type)",
		Labels:  []string{"instance", "sql_type"},
		Comment: "The total time of TiDB query durations(second)",
	},
	"tidb_slow_query_cop_process_total_count": {
		PromQL:  "sum(increase(tidb_server_slow_query_cop_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_slow_query_cop_process_total_time": {
		PromQL:  "sum(increase(tidb_server_slow_query_cop_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_slow_query_cop_wait_total_count": {
		PromQL:  "sum(increase(tidb_server_slow_query_wait_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_slow_query_cop_wait_total_time": {
		PromQL:  "sum(increase(tidb_server_slow_query_wait_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_slow_query_total_count": {
		PromQL:  "sum(increase(tidb_server_slow_query_process_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of TiDB slow query statistics with slow query time(second)",
	},
	"tidb_slow_query_total_time": {
		PromQL:  "sum(increase(tidb_server_slow_query_process_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of TiDB slow query statistics with slow query time(second)",
	},
	"tidb_statistics_auto_analyze_total_count": {
		PromQL:  "sum(increase(tidb_statistics_auto_analyze_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_statistics_auto_analyze_total_time": {
		PromQL:  "sum(increase(tidb_statistics_auto_analyze_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_transaction_local_latch_wait_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_local_latch_wait_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_transaction_local_latch_wait_total_time": {
		PromQL:  "sum(increase(tidb_tikvclient_local_latch_wait_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of TiDB transaction latch wait time on key value storage(second)",
	},
	"tidb_transaction_total_count": {
		PromQL:  "sum(increase(tidb_session_transaction_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type,sql_type)",
		Labels:  []string{"instance", "type", "sql_type"},
		Comment: "The total count of transaction execution durations, including retry(second)",
	},
	"tidb_transaction_total_time": {
		PromQL:  "sum(increase(tidb_session_transaction_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type,sql_type)",
		Labels:  []string{"instance", "type", "sql_type"},
		Comment: "The total time of transaction execution durations, including retry(second)",
	},
	"tikv_append_log_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_append_log_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of Raft appends log",
	},
	"tikv_append_log_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_append_log_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of Raft appends log",
	},
	"tikv_apply_log_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_apply_log_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of Raft applies log",
	},
	"tikv_apply_log_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_apply_log_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of Raft applies log",
	},
	"tikv_apply_wait_total_count": {
		PromQL: "sum(increase(tikv_raftstore_apply_wait_time_duration_secs_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_apply_wait_total_time": {
		PromQL: "sum(increase(tikv_raftstore_apply_wait_time_duration_secs_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_backup_range_total_count": {
		PromQL: "sum(increase(tikv_backup_range_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels: []string{"instance", "type"},
	},
	"tikv_backup_range_total_time": {
		PromQL: "sum(increase(tikv_backup_range_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels: []string{"instance", "type"},
	},
	"tikv_backup_total_count": {
		PromQL: "sum(increase(tikv_backup_request_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_backup_total_time": {
		PromQL: "sum(increase(tikv_backup_request_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_check_split_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_check_split_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of time consumed when running split check in .9999",
	},
	"tikv_check_split_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_check_split_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of time consumed when running split check in .9999",
	},
	"tikv_commit_log_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_commit_log_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of Raft commits log",
	},
	"tikv_commit_log_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_commit_log_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of Raft commits log",
	},
	"tikv_cop_handle_total_count": {
		PromQL:  "sum(increase(tikv_coprocessor_request_handle_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels:  []string{"instance", "req"},
		Comment: "The total count of time consumed when handling coprocessor requests",
	},
	"tikv_cop_handle_total_time": {
		PromQL:  "sum(increase(tikv_coprocessor_request_handle_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels:  []string{"instance", "req"},
		Comment: "The total time of time consumed when handling coprocessor requests",
	},
	"tikv_cop_request_total_count": {
		PromQL:  "sum(increase(tikv_coprocessor_request_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels:  []string{"instance", "req"},
		Comment: "The total count of time consumed to handle coprocessor read requests",
	},
	"tikv_cop_request_total_time": {
		PromQL:  "sum(increase(tikv_coprocessor_request_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels:  []string{"instance", "req"},
		Comment: "The total time of time consumed to handle coprocessor read requests",
	},
	"tikv_cop_wait_total_count": {
		PromQL:  "sum(increase(tikv_coprocessor_request_wait_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels:  []string{"instance", "req"},
		Comment: "The total count of time consumed when coprocessor requests are wait for being handled",
	},
	"tikv_cop_wait_total_time": {
		PromQL:  "sum(increase(tikv_coprocessor_request_wait_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels:  []string{"instance", "req"},
	...
	"tikv_raft_store_events_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_event_duration_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of raftstore events (P99).99",
	},
	"tikv_raft_store_events_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_event_duration_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of raftstore events (P99).99",
	},
	"tikv_gc_tasks_total_count": {
		PromQL:  "sum(increase(tikv_gcworker_gc_task_duration_vec_count{$LABEL_CONDITIONS}[60s])) by (instance,task)",
		Labels:  []string{"instance", "task"},
		Comment: "The total count of time consumed when executing GC tasks",
	},
	"tikv_gc_tasks_total_time": {
		PromQL:  "sum(increase(tikv_gcworker_gc_task_duration_vec_sum{$LABEL_CONDITIONS}[60s])) by (instance,task)",
		Labels:  []string{"instance", "task"},
		Comment: "The total time of time consumed when executing GC tasks",
	},
	"tikv_grpc_messge_total_count": {
		PromQL:  "sum(increase(tikv_grpc_msg_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of execution time of gRPC message",
	},
	"tikv_grpc_messge_total_time": {
		PromQL:  "sum(increase(tikv_grpc_msg_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of execution time of gRPC message",
	},
	"tikv_handle_snapshot_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_snapshot_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of time consumed when handling snapshots",
	},
	"tikv_handle_snapshot_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_snapshot_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of time consumed when handling snapshots",
	},
	"tikv_ingest_sst_total_count": {
		PromQL:  "sum(increase(tikv_snapshot_ingest_sst_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,db)",
		Labels:  []string{"instance", "db"},
		Comment: "The total count of time consumed when ingesting SST files",
	},
	"tikv_ingest_sst_total_time": {
		PromQL:  "sum(increase(tikv_snapshot_ingest_sst_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,db)",
		Labels:  []string{"instance", "db"},
		Comment: "The total time of time consumed when ingesting SST files",
	},
	"tikv_lock_manager_deadlock_detect_total_count": {
		PromQL: "sum(increase(tikv_lock_manager_detect_duration_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_lock_manager_deadlock_detect_total_time": {
		PromQL: "sum(increase(tikv_lock_manager_detect_duration_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_lock_manager_waiter_lifetime_total_count": {
		PromQL: "sum(increase(tikv_lock_manager_waiter_lifetime_duration_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_lock_manager_waiter_lifetime_total_time": {
		PromQL: "sum(increase(tikv_lock_manager_waiter_lifetime_duration_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_process_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_raft_process_duration_secs_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of peer processes in Raft",
	},
	"tikv_process_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_raft_process_duration_secs_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of peer processes in Raft",
	},
	"tikv_propose_wait_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_request_wait_time_duration_secs_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of each proposal",
	},
	"tikv_propose_wait_total_time": {
		PromQL:  "sum(increase(tikv_raftstore_request_wait_time_duration_secs_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tikv_send_snapshot_total_time": {
		PromQL:  "sum(increase(tikv_server_send_snapshot_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of time consumed when sending snapshots",
	},
	"tikv_storage_async_request_total_count": {
		PromQL:  "sum(increase(tikv_storage_engine_async_request_duration_seconds_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
	...
	"tikv_storage_async_request_total_time": {
		PromQL:  "sum(increase(tikv_storage_engine_async_request_duration_seconds_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of time consumed by processing asynchronous snapshot requests",
	},

	"tidb_distsql_partial_num_total_count": {
		PromQL:  "sum(increase(tidb_distsql_partial_num_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of distsql partial numbers per query",
	},
	"tidb_distsql_partial_scan_key_num_total_count": {
		PromQL:  "sum(increase(tidb_distsql_scan_keys_partial_num_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_kv_write_size_total_count": {
		PromQL:  "sum(increase(tidb_tikvclient_txn_write_size_bytes_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tidb_statistics_fast_analyze_status_total_count": {
		PromQL:  "sum(increase(tidb_statistics_fast_analyze_status_count{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total count of TiDB fast analyze statistics ",
	},
	"tidb_statistics_fast_analyze_total_status": {
		PromQL:  "sum(increase(tidb_statistics_fast_analyze_status_sum{$LABEL_CONDITIONS}[60s])) by (instance,type)",
		Labels:  []string{"instance", "type"},
		Comment: "The total time of TiDB fast analyze statistics ",
	},
	"tidb_statistics_stats_inaccuracy_rate_total_count": {
		PromQL:  "sum(increase(tidb_statistics_stats_inaccuracy_rate_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total count of TiDB statistics inaccurate rate",
	},
	"tidb_statistics_stats_inaccuracy_total_rate": {
		PromQL:  "sum(increase(tidb_statistics_stats_inaccuracy_rate_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of TiDB statistics inaccurate rate",
	},
	"tidb_transaction_retry_num_total_count": {
		PromQL:  "sum(increase(tidb_session_retry_num_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tikv_approximate_region_total_size": {
		PromQL:  "sum(increase(tikv_raftstore_region_size_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
		Comment: "The total time of approximate Region size, the default value is P99",
	},
	"tikv_backup_range_size_total_count": {
		PromQL: "sum(increase(tikv_backup_range_size_bytes_count{$LABEL_CONDITIONS}[60s])) by (instance,cf)",
		Labels: []string{"instance", "cf"},
	},
	"tikv_backup_range_total_size": {
		PromQL: "sum(increase(tikv_backup_range_size_bytes_sum{$LABEL_CONDITIONS}[60s])) by (instance,cf)",
		Labels: []string{"instance", "cf"},
	},
	"tikv_cop_kv_cursor_operations_total_count": {
		PromQL: "sum(increase(tikv_coprocessor_scan_keys_count{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels: []string{"instance", "req"},
	},
	"tikv_cop_kv_cursor_total_operations": {
		PromQL: "sum(increase(tikv_coprocessor_scan_keys_sum{$LABEL_CONDITIONS}[60s])) by (instance,req)",
		Labels: []string{"instance", "req"},
	},
	...
	"tikv_grpc_req_batch_size_total_count": {
		PromQL: "sum(increase(tikv_server_grpc_req_batch_size_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_grpc_req_batch_total_size": {
		PromQL: "sum(increase(tikv_server_grpc_req_batch_size_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_grpc_resp_batch_size_total_count": {
		PromQL: "sum(increase(tikv_server_grpc_resp_batch_size_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_grpc_resp_batch_total_size": {
		PromQL: "sum(increase(tikv_server_grpc_resp_batch_size_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_raft_message_batch_size_total_count": {
		PromQL: "sum(increase(tikv_server_raft_message_batch_size_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_raft_message_batch_total_size": {
		PromQL: "sum(increase(tikv_server_raft_message_batch_size_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels: []string{"instance"},
	},
	"tikv_raft_proposals_per_ready_total_count": {
		PromQL:  "sum(increase(tikv_raftstore_apply_proposal_count{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
	...
	"tikv_snapshot_total_size": {
		PromQL:  "sum(increase(tikv_snapshot_size_sum{$LABEL_CONDITIONS}[60s])) by (instance)",
		Labels:  []string{"instance"},
