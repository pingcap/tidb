...
var MetricTableMap = map[string]MetricTableDef{
	...
	"tikv_engine_max_get_duration": {
		...
		Labels:  []string{"instance", "type", "db"},
		Comment: "The max time consumed when executing get operations, unit is microsecond",
	},
	"tikv_engine_avg_get_duration": {
		PromQL:  `avg(tikv_engine_get_micro_seconds{$LABEL_CONDITIONS}) by (db,type,instance)`,
		Labels:  []string{"instance", "type", "db"},
		Comment: "The average time consumed when executing get operations, unit is microsecond",
	},
	...
	"tikv_engine_max_seek_duration": {
		...
		Labels:  []string{"instance", "type", "db"},
		Comment: "The time consumed when executing seek operation, unit is microsecond",
	},
	...
	"tikv_engine_write_duration": {
		...
		Labels:  []string{"instance", "type", "db"},
		Comment: "The time consumed when executing write operation, unit is microsecond",
	},
	...
	"tikv_wal_sync_max_duration": {
		...
		Labels:  []string{"instance", "type", "db"},
		Comment: "The max time consumed when executing WAL sync operation, unit is microsecond",
	},
	"tikv_wal_sync_duration": {
		PromQL:  `avg(tikv_engine_wal_file_sync_micro_seconds{$LABEL_CONDITIONS}) by (db,type,instance)`,
		Labels:  []string{"instance", "type"},
		Comment: "The time consumed when executing WAL sync operation, unit is microsecond",
	},
