...
var MetricTableMap = map[string]MetricTableDef{
	...
	"tidb_distsql_partial_scan_key_total_count": {
	...
	"tidb_distsql_partial_total_count": {
	...
	"tidb_distsql_scan_key_total_count": {
	...
	"tidb_statistics_fast_analyze_total_count": {
	...
	"tidb_statistics_stats_inaccuracy_total_count": {
	...
	"tidb_transaction_retry_total_count": {
	...
	"tidb_transaction_statement_total_count": {
