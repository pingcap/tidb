...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: "AVG_KV_TOTAL", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of TiKV used"},
	{name: "AVG_PD_TOTAL", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of PD used"},
	{name: "AVG_BACKOFF_TOTAL", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of Backoff used"},
	{name: "AVG_WRITE_SQL_RESP_TOTAL", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of write sql resp used"},
