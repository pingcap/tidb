...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: stmtsummary.Collation, tp: mysql.TypeVarchar, size: 64, comment: "Sampled charset"},
	{name: stmtsummary.PlanHint, tp: mysql.TypeVarchar, size: 64, comment: "Sampled charset"},
}
