...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: "SUM_KV_TOTAL", tp: mysql.TypeDouble, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of TiKV used"},
	{name: "SUM_PD_TOTAL", tp: mysql.TypeDouble, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of PD used"},
	{name: "SUM_BACKOFF_TOTAL", tp: mysql.TypeDouble, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of Backoff used"},
	{name: "SUM_WRITE_SQL_RESP_TOTAL", tp: mysql.TypeDouble, size: 22, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum time of write sql resp used"},
