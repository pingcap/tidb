...
var slowQueryCols = []columnInfo{
	...
	{name: variable.SlowLogExecuteTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogBuildExecutorTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogOpenExecutorTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogRunExecutorTimeStr, tp: mysql.TypeDouble, size: 22},
