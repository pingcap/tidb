...
var slowQueryCols = []columnInfo{
	...
	{name: variable.SlowLogResultSet, tp: mysql.TypeLonglong, size: 22},
...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: "SUM_RESULT_SET", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Sum count of sql result rows"},
	{name: "MAX_RESULT_SET", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Max count of sql result rows"},
	{name: "MIN_RESULT_SET", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Min count of sql result rows"},
	{name: "AVG_RESULT_SET", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Average count of sql result rows"},
