...
var slowQueryCols = []columnInfo{
	...
	{name: variable.SlowLogDiskUsage, tp: mysql.TypeLonglong, size: 20},
...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: "DISK_USAGE", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Disk space(byte) used"},
