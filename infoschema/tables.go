...
var tablesCols = []columnInfo{
	...
	{name: "TIDB_DIRECT_PLACEMENT", tp: mysql.TypeVarchar, size: 512},
}
...
var tablePlacementRulesCols = []columnInfo{
	...
	{name: "PRIMARY_REGION", tp: mysql.TypeVarchar, size: 64, flag: mysql.NotNullFlag},
	{name: "REGIONS", tp: mysql.TypeVarchar, size: 64, flag: mysql.NotNullFlag},
	{name: "CONSTRAINTS", tp: mysql.TypeVarchar, size: 64, flag: mysql.NotNullFlag},
	{name: "LEADER_CONSTRAINTS", tp: mysql.TypeVarchar, size: 64, flag: mysql.NotNullFlag},
	{name: "FOLLOWER_CONSTRAINTS", tp: mysql.TypeVarchar, size: 64, flag: mysql.NotNullFlag},
	{name: "LEARNER_CONSTRAINTS", tp: mysql.TypeVarchar, size: 64, flag: mysql.NotNullFlag},
