...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: "MAX_RESULT_ROWS", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Max count of sql result rows"},
	{name: "MIN_RESULT_ROWS", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Min count of sql result rows"},
	{name: "AVG_RESULT_ROWS", tp: mysql.TypeLonglong, size: 22, flag: mysql.NotNullFlag, comment: "Average count of sql result rows"},
