...
var tableIDMap = map[string]int64{
	tableSchemata:                           autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 1),
	tableTables:                             autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 2),
	tableColumns:                            autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 3),
	tableColumnStatistics:                   autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 4),
	tableStatistics:                         autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 5),
	tableCharacterSets:                      autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 6),
	tableCollations:                         autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 7),
	tableFiles:                              autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 8),
	catalogVal:                              autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 9),
	tableProfiling:                          autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 10),
	tablePartitions:                         autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 11),
	tableKeyColumm:                          autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 12),
	tableReferConst:                         autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 13),
	tableSessionVar:                         autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 14),
	tablePlugins:                            autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 15),
	tableConstraints:                        autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 16),
	tableTriggers:                           autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 17),
	tableUserPrivileges:                     autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 18),
	tableSchemaPrivileges:                   autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 19),
	tableTablePrivileges:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 20),
	tableColumnPrivileges:                   autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 21),
	tableEngines:                            autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 22),
	tableViews:                              autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 23),
	tableRoutines:                           autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 24),
	tableParameters:                         autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 25),
	tableEvents:                             autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 26),
	tableGlobalStatus:                       autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 27),
	tableGlobalVariables:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 28),
	tableSessionStatus:                      autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 29),
	tableOptimizerTrace:                     autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 30),
	tableTableSpaces:                        autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 31),
	tableCollationCharacterSetApplicability: autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 32),
	tableProcesslist:                        autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 33),
	tableTiDBIndexes:                        autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 34),
	tableSlowLog:                            autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 35),
	tableTiDBHotRegions:                     autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 36),
	tableTiKVStoreStatus:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 37),
	tableAnalyzeStatus:                      autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 38),
	tableTiKVRegionStatus:                   autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 39),
	tableTiKVRegionPeers:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 40),
	tableTiDBServersInfo:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 41),
	tableTiDBClusterInfo:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 42),
	tableTiDBClusterConfig:                  autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 43),
	tableTiDBClusterLoad:                    autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 44),
	tableTiFlashReplica:                     autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 45),
	clusterTableSlowLog:                     autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 46),
	clusterTableProcesslist:                 autoid.SystemSchemaIDFlag | (autoid.InformationSchemaTableIDStart + 47),
}
