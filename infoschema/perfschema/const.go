...
const tableEventsStatementsSummaryByDigest = "CREATE TABLE if not exists events_statements_summary_by_digest (" +
	...
	"AVG_REQUEST_COUNT BIGINT(20) UNSIGNED NOT NULL," +
	"MAX_REQUEST_COUNT BIGINT(20) UNSIGNED NOT NULL," +
...
// tableEventsStatementsSummaryByDigestHistory contains the history of statement summary.
// Its fields are the same with that of tableEventsStatementsSummaryByDigest.
