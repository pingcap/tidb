...
var tableIDMap = map[string]int64{
	tableNameGlobalStatus:                    autoid.PerformanceSchemaTableIDStart + 1,
	tableNameSessionStatus:                   autoid.PerformanceSchemaTableIDStart + 2,
	tableNameSetupActors:                     autoid.PerformanceSchemaTableIDStart + 3,
	tableNameSetupObjects:                    autoid.PerformanceSchemaTableIDStart + 4,
	tableNameSetupInstruments:                autoid.PerformanceSchemaTableIDStart + 5,
	tableNameSetupConsumers:                  autoid.PerformanceSchemaTableIDStart + 6,
	tableNameEventsStatementsCurrent:         autoid.PerformanceSchemaTableIDStart + 7,
	tableNameEventsStatementsHistory:         autoid.PerformanceSchemaTableIDStart + 8,
	tableNameEventsStatementsHistoryLong:     autoid.PerformanceSchemaTableIDStart + 9,
	tableNamePreparedStatementsInstances:     autoid.PerformanceSchemaTableIDStart + 10,
	tableNameEventsTransactionsCurrent:       autoid.PerformanceSchemaTableIDStart + 11,
	tableNameEventsTransactionsHistory:       autoid.PerformanceSchemaTableIDStart + 12,
	tableNameEventsTransactionsHistoryLong:   autoid.PerformanceSchemaTableIDStart + 13,
	tableNameEventsStagesCurrent:             autoid.PerformanceSchemaTableIDStart + 14,
	tableNameEventsStagesHistory:             autoid.PerformanceSchemaTableIDStart + 15,
	tableNameEventsStagesHistoryLong:         autoid.PerformanceSchemaTableIDStart + 16,
	tableNameEventsStatementsSummaryByDigest: autoid.PerformanceSchemaTableIDStart + 17,
	tableNameTiDBProfileCPU:                  autoid.PerformanceSchemaTableIDStart + 18,
	tableNameTiDBProfileMemory:               autoid.PerformanceSchemaTableIDStart + 19,
	tableNameTiDBProfileMutex:                autoid.PerformanceSchemaTableIDStart + 20,
	tableNameTiDBProfileAllocs:               autoid.PerformanceSchemaTableIDStart + 21,
	tableNameTiDBProfileBlock:                autoid.PerformanceSchemaTableIDStart + 22,
	tableNameTiDBProfileGoroutines:           autoid.PerformanceSchemaTableIDStart + 23,
}
