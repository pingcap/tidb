...
func SubTestSelectClusterTable(s *clusterTablesSuite) func(*testing.T) {
	return func(t *testing.T) {
		...
		for i := 0; i < 2; i++ {
			...
			tk.MustQuery("select digest, count(*) from `CLUSTER_SLOW_QUERY` group by digest order by digest").Check(testkit.Rows("42a1c8aae6f133e934d4bf0147491709a8812ea05ff8819ec522780fe657b772 1"))
