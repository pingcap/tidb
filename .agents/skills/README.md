...
- `tidb-change-instruction-critic`: assess proposed fixes before implementation; investigate uncertainty and ask only for unresolved requirements, contract choices, or scope decisions.
