...
- `pkg/planner/cardinality/selectivity_test.go` - planner/cardinality: Tests selectivity estimation, virtual-column index fallback, collation columns, and out-of-range bounds.
