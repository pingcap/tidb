...
type TikvClient interface {
	...
	KvUnsafeCleanupRange(ctx context.Context, in *kvrpcpb.UnsafeCleanupRangeRequest, opts ...grpc.CallOption) (*kvrpcpb.UnsafeCleanupRangeResponse, error)
	// RawKV commands.
...
func (c *tikvClient) KvUnsafeCleanupRange(ctx context.Context, in *kvrpcpb.UnsafeCleanupRangeRequest, opts ...grpc.CallOption) (*kvrpcpb.UnsafeCleanupRangeResponse, error) {
	out := new(kvrpcpb.UnsafeCleanupRangeResponse)
	err := grpc.Invoke(ctx, "/tikvpb.Tikv/KvUnsafeCleanupRange", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	KvUnsafeCleanupRange(context.Context, *kvrpcpb.UnsafeCleanupRangeRequest) (*kvrpcpb.UnsafeCleanupRangeResponse, error)
	// RawKV commands.
...
func _Tikv_KvUnsafeCleanupRange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.UnsafeCleanupRangeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).KvUnsafeCleanupRange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/KvUnsafeCleanupRange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).KvUnsafeCleanupRange(ctx, req.(*kvrpcpb.UnsafeCleanupRangeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "KvUnsafeCleanupRange",
			Handler:    _Tikv_KvUnsafeCleanupRange_Handler,
		},
		{
			MethodName: "RawGet",
...
var fileDescriptorTikvpb = []byte{
	...
	,
}
