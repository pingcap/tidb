...
type TikvClient interface {
	...
	DestroyRange(ctx context.Context, in *kvrpcpb.DestroyRangeRequest, opts ...grpc.CallOption) (*kvrpcpb.DestroyRangeResponse, error)
...
func (c *tikvClient) DestroyRange(ctx context.Context, in *kvrpcpb.DestroyRangeRequest, opts ...grpc.CallOption) (*kvrpcpb.DestroyRangeResponse, error) {
	out := new(kvrpcpb.DestroyRangeResponse)
	err := grpc.Invoke(ctx, "/tikvpb.Tikv/DestroyRange", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	// Store commands (to the whole tikv but not a certain region)
	DestroyRange(context.Context, *kvrpcpb.DestroyRangeRequest) (*kvrpcpb.DestroyRangeResponse, error)
	// SQL push down commands.
...
func _Tikv_DestroyRange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.DestroyRangeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).DestroyRange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/DestroyRange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).DestroyRange(ctx, req.(*kvrpcpb.DestroyRangeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DestroyRange",
			Handler:    _Tikv_DestroyRange_Handler,
		},
		{
...
var fileDescriptorTikvpb = []byte{
	...
	,
}
