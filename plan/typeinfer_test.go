...
func (s *testPlanSuite) createTestCase4TimeFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		// {"unix_timestamp(c_int      )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 11, 0},
		// {"unix_timestamp(c_bigint   )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 11, 0},
		// {"unix_timestamp(c_float    )", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag, 18, 6},
		// {"unix_timestamp(c_double   )", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag, 18, 6},
		...
		{"unix_timestamp(c_time     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 11, 0},
		// {"unix_timestamp(c_timestamp)", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 11, 0},
		...
		{"unix_timestamp(c_text     )", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag, 18, 6},
		...
		{"unix_timestamp(c_blob     )", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag, 18, 6},
