...
func (s *testPlanSuite) createTestCase4Miscellaneous() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"any_value(c_datetime)", mysql.TypeDatetime, charset.CharsetUTF8, mysql.NotNullFlag, 22, 2},
		{"any_value(c_time_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 10, 0},
		{"any_value(c_timestamp_d)", mysql.TypeTimestamp, charset.CharsetUTF8, mysql.NotNullFlag, 19, types.UnspecifiedLength},
