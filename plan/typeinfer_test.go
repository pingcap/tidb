...
func (s *testPlanSuite) createTestCase4StrFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"make_set(c_int_d      , c_text_d)", mysql.TypeMediumBlob, charset.CharsetUTF8, mysql.BinaryFlag, 65546, types.UnspecifiedLength},
		{"make_set(c_bigint_d   , c_text_d, c_binary)", mysql.TypeMediumBlob, charset.CharsetBin, mysql.BinaryFlag, 65577, types.UnspecifiedLength},

		{"quote(c_int_d      )", mysql.TypeVarString, charset.CharsetUTF8, 0, 24, types.UnspecifiedLength},
		{"quote(c_bigint_d   )", mysql.TypeVarString, charset.CharsetUTF8, 0, 44, types.UnspecifiedLength},
