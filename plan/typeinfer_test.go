...
func (s *testPlanSuite) createTestCase4TimeFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"year(c_int      )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		{"year(c_bigint   )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		{"year(c_float    )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		{"year(c_double   )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		...
		{"year(c_time     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		{"year(c_timestamp)", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		...
		{"year(c_text     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		...
		{"year(c_blob     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 4, 0},
		...
		{"month(c_int      )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		{"month(c_bigint   )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		{"month(c_float    )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		{"month(c_double   )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		...
		{"month(c_time     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		{"month(c_timestamp)", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		...
		{"month(c_text     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
		...
		{"month(c_blob     )", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag, 2, 0},
