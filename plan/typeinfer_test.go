...
func (s *testPlanSuite) createTestCase4TimeFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"monthName(c_int_d      )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_bigint_d   )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_float_d    )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_double_d   )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_decimal    )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_datetime   )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_time_d     )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_timestamp_d)", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_char       )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_varchar    )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_text_d     )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_binary     )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_varbinary  )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_blob_d     )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_set        )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
		{"monthName(c_enum       )", mysql.TypeVarchar, charset.CharsetUTF8, 0, 10, types.UnspecifiedLength},
