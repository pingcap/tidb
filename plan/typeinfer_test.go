...
func (s *testPlanSuite) TestInferType(c *C) {
	...
	tests := []struct {
		...
		{"lower(c_int)", mysql.TypeVarString, charset.CharsetUTF8, 0, 0, types.UnspecifiedLength},
		{"upper(c_int)", mysql.TypeVarString, charset.CharsetUTF8, 0, 0, types.UnspecifiedLength},
	}
