...
func (s *testPrepareSuite) TestPrepareCache(c *C) {
	...
	tk.MustExec("insert into t values(1, 1, 1), (1, 1, 2), (1, 2, 2), (2, 2, 2), (3, 3, 3), (4, 4, 4), (5, 5, 5)")
	...
	tk.MustQuery("execute stmt1 using @a, @b").Check(testkit.Rows("1 1 1", "1 1 2"))
	tk.MustQuery("execute stmt1 using @a, @b").Check(testkit.Rows("1 1 1", "1 1 2"))
	tk.MustQuery("execute stmt2 using @b").Check(testkit.Rows("1 1", "1 1"))
	tk.MustQuery("execute stmt2 using @b").Check(testkit.Rows("1 1", "1 1"))
	tk.MustQuery("execute stmt3 using @a").Check(testkit.Rows("1 1 1", " 1 1 2"))
	tk.MustQuery("execute stmt3 using @a").Check(testkit.Rows("1 1 1", "1 1 2"))
	...
	tk.MustQuery("execute stmt5").Check(testkit.Rows("1", "2", "2", "2", "3", "4", "5"))
	tk.MustQuery("execute stmt5").Check(testkit.Rows("1", "2", "2", "2", "3", "4", "5"))
}
