...
const (
	...
	// TypeNLJLeft is the type of NestedLoopJoinLeft
	TypeNLJLeft = "NestedLoopJoinLeft"
	// TypeNLJRight is the type of NestedLoopJoinLeft
	TypeNLJRight = "NestedLoopJoinRight"
