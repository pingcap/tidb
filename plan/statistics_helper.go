...
func getRealRowCountByIndexRanges(sc *variable.StatementContext, statsTbl *statistics.Table, indexRanges []*IndexRange, indexInfo *model.IndexInfo, id int64) (uint64, error) {
	totalCount := int64(0)
...
func getPseudoRowCountByIndexRanges(sc *variable.StatementContext, statsTbl *statistics.Table, table *model.TableInfo, indexRanges []*IndexRange, indexInfo *model.IndexInfo, inAndEQCnt int) (uint64, error) {
