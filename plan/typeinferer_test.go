...
func (ts *testTypeInferrerSuite) TestInferType(c *C) {
	...
	cases := []struct {
		...
		{"COS(0)", mysql.TypeDouble, charset.CharsetBin},
		{"TAN(0)", mysql.TypeDouble, charset.CharsetBin},
		{"COT(1)", mysql.TypeDouble, charset.CharsetBin},
		...
		{"period_add(199206, 2)", mysql.TypeLonglong, charset.CharsetBin},
		...
		{"timestampadd(WEEK,40,'2003-01-01 01:01:01.000011')", mysql.TypeDatetime, charset.CharsetBin},
		...
		{`compress('love')`, mysql.TypeBlob, charset.CharsetBin},
		...
		{`from_base64('YWJj')`, mysql.TypeVarString, charset.CharsetUTF8},
