...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:OWuxbPLOH68b4KnTGrhKJi4MGIkfYFF0Y1j15ptGMKQ=",
        version = "v0.0.0-20260513130714-a164c29a1dce",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2w5n8tmcoxxk3kOxEMMKM5lv2A6ocaXnLt3O0x93PVs=",
        version = "v0.0.0-20260514095636-e99988475b0c",
    )
    go_repository(
