...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:UnDZ/zFfG1JhH/DqxIZYU/1CUAlTUScoXD/LcM2Ykk8=",
        version = "v0.55.0",
    )
    go_repository(
        ...
        sum = "h1:7t/qx5Ost0s0wbA/VDrByOooURhp+ikYwv20i9Y07TQ=",
        version = "v0.55.0",
    )
    go_repository(
        ...
        sum = "h1:0s6TxfCu2KHkkZPnBfsQ2y5qia0jl3MMrmBhu3nCOYk=",
        version = "v0.55.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Cz50LcApIJiLSd0GPZ3aWJWz9mJXXbpxph0JOilwQRY=",
        version = "v1.61.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ZrPRak/kS4xI3AVXy8F7pipuDXmDsrO8Lg+yQjBLjw0=",
        version = "v1.40.0",
    )
    go_repository(
