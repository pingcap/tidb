...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:WMEsVCofBWBKgoJrT+e8BDuDmC9DkM2MHWTG9H4Kd4k=",
        version = "v0.0.0-20230111073157-fe26818a554e",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JzXZSGQBN5Rfqt/qOzhz1TJlQGR/2ryBcrqKbDM1XTM=",
        version = "v2.0.0-alpha.0.20230111160718-65b8ed719757",
    )
    go_repository(
