...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:REeYeyw0P9Lvl864TLeu56DU/RAabwSoeJsAPQ56Ek4=",
        version = "v0.0.0-20260902031311-e98c296c957f",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5X7VszX0E2uZSCg1PiYcft3fbG+JjoS6EaxkKrV4edY=",
        version = "v2.0.8-0.20260904063002-98c0367bae69",
    )
    go_repository(
