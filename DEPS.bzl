...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:w1C73NPjdEnVBX9IM8CJRJk1pFTzj8OAIrkD04A3MIs=",
        version = "v0.0.0-20250908061600-97d984880071",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:u2gLNL2k3cyCDV/fqs4C01OqTafljRyW67CMuHsN7iE=",
        version = "v2.0.8-0.20260713095422-3a987fd9f0ec",
    )
    go_repository(
