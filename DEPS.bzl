...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "9112cc704a4461604f65194cee264e44714773715506686cc53163250b242e6b",
        strip_prefix = "github.com/prometheus/prometheus@v0.51.1",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/github.com/prometheus/prometheus/com_github_prometheus_prometheus-v0.51.1.zip",
            "http://ats.apps.svc/gomod/github.com/prometheus/prometheus/com_github_prometheus_prometheus-v0.51.1.zip",
            "https://cache.hawkingrei.com/gomod/github.com/prometheus/prometheus/com_github_prometheus_prometheus-v0.51.1.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/github.com/prometheus/prometheus/com_github_prometheus_prometheus-v0.51.1.zip",
        ],
    )
    go_repository(
