...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:AfIJz8UV2wTsmyX0fgZ230P3hTWdiENCu6ZgQflSXhg=",
        version = "v0.0.0-20230309134254-145f0534a0eb",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rk2oMV9qGhROMXQtdtfngPEIkxCVj6zzb6HxjGVrwZQ=",
        version = "v2.0.0-alpha.0.20230307141124-6b1baae7ef56",
    )
    go_repository(
