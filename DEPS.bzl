...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:J+XztbJwVgmwg9umpJIbnyrPf1P17QQk/WNsX6YGhMQ=",
        version = "v0.0.0-20230310162856-04bef527513d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:X51A7pgqGa54m7u1Gyi3hmLKEGEMRychCYTPBJvRLFk=",
        version = "v2.0.0-alpha.0.20230310172912-75c8d11b2365",
    )
    go_repository(
