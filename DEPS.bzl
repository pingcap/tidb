...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:cI2ljenF84QjGjdbpxPGLlvEdWKOKq2kbEpIaK+7htI=",
        version = "v2.0.0-20260819075847-5691b80961e9",
    )
    go_repository(
        ...
        sum = "h1:3hbXM0FAzOO6WoLxp3H59d3JJviy/Q0/bLFRhNMFEv0=",
        version = "v0.0.0-20260819070454-a0b720772fe5",
    )
    go_repository(
