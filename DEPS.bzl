...
=======
        sum = "h1:dHXK/ahoO3PhU9oqiYwB4BBNl2PpgJiZODmtWAfxygo=",
        version = "v2.0.8-0.20240807051551-73815ad261dc",
>>>>>>> 05ef7ace0b (update)
    )
    go_repository(
        ...
        sum = "h1:oZygf/SCdTUhjoHuZRE85EBgK0oA6LjikpWuJqqjM8U=",
        version = "v0.0.0-20240724132535-fcb34c90790c",
    )
    go_repository(
