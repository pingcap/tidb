...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:1wN4FPTxtzBrQmhrMY6j+Uscsi4BKhdCGKhC7jzjNow=",
        version = "v0.0.0-20260729184023-a29e794b680d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CFz+2mpN/ae7FwwsvsHH6a6jGoMN7FZs5LO765q5+yg=",
        version = "v2.0.8-0.20260803114328-b09e63bd485b",
    )
    go_repository(
