...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "9ddc54cbe3f6033791304f0a48cb84eb5bfe1e8f1d40359c84631afdc16462b7",
        strip_prefix = "github.com/prometheus/common@v0.50.0",
        urls = [
            "http://bazel-cache.pingcap.net:8080/gomod/github.com/prometheus/common/com_github_prometheus_common-v0.50.0.zip",
            "http://ats.apps.svc/gomod/github.com/prometheus/common/com_github_prometheus_common-v0.50.0.zip",
            "https://cache.hawkingrei.com/gomod/github.com/prometheus/common/com_github_prometheus_common-v0.50.0.zip",
            "https://storage.googleapis.com/pingcapmirror/gomod/github.com/prometheus/common/com_github_prometheus_common-v0.50.0.zip",
        ],
    )
    go_repository(
