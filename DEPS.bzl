...
def go_deps():
    ...
    go_repository(
        ...
        replace = "github.com/RidRisR/kvproto",
        sum = "h1:tCzbOI8Wmp85NMpGvrKVs3inCvTJCDRUk9EVj+JdU2k=",
        version = "v0.0.0-20260908090938-d51dc4098c86",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GPImWDAr0eb6FqS89eNcO3AdEbGq5ygQhIEaftOl0IY=",
        version = "v2.0.8-0.20260831103552-e4905600583b",
    )
    go_repository(
