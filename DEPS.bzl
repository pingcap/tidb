...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:jK97X3ssEMEH1YkRKq9rsafbjj0nOXoOp1tizTBbNYU=",
        version = "v2.0.0-20260820105841-9643ccb293f8",
    )
    go_repository(
        ...
        sum = "h1:EuFoHRiT1oEjqmJaSyBMlwHAIY7cBOXkATLZjrE2j1k=",
        version = "v0.0.0-20260820105723-5d6648e4b040",
    )
    go_repository(
