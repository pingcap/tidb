...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:puhZJ86ZXvSCZLTshL6xBEhvF963MAoL+/Jydh2tvO8=",
        version = "v0.0.0-20230822064221-711da6fede03",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:KhPSL2mIKB7KAfPCdO9N5lKZhMJAQLUGWIekCFJRG8Q=",
        version = "v2.0.8-0.20230822092520-ff39b4af09f1",
    )
    go_repository(
