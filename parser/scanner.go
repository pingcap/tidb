...
yystate1260:
	...
	goto yystate1261 // silence unused label error
yystate1261:
	c = l.next()
yystart1261:
	switch {
...
yystate1266:
	...
	goto yystate1267 // silence unused label error
yystate1267:
	c = l.next()
yystart1267:
	switch {
...
yystate1272:
	...
	goto yystate1273 // silence unused label error
yystate1273:
	c = l.next()
yystart1273:
	switch {
	default:
		goto yystate1274 // c >= '\x01' && c <= '\b' || c >= '\n' && c <= '\x1f' || c >= '!' && c <= 'ÿ'
	case c == '\t' || c == ' ':
		goto yystate1275
	case c == '\x00':
		goto yystate2
...
yystate1275:
	...
	goto yystate1276 // silence unused label error
yystate1276:
	c = l.next()
yystart1276:
	switch {
