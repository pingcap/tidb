...
(PARTITION part0 VALUES LESS THAN (1) COMMENT = '1月份' ENGINE = InnoDB,
 ...
 PARTITION part11 VALUES LESS THAN (12) COMMENT = '12月份' ENGINE = InnoDB) */ ;`, true},
		...
		{"ALTER TABLE t ADD COLUMN a SMALLINT UNSIGNED, LOCK=SHARED", true},
		{"ALTER TABLE t ADD COLUMN a SMALLINT UNSIGNED, LOCK=EXCLUSIVE", true},
		{"ALTER TABLE t ADD COLUMN a INT(24) DEFAULT 1", true},
		{"ALTER TABLE t ADD COLUMN a INT(24) DEFAULT -1", true},
		{"ALTER TABLE t ADD COLUMN a INT(24) DEFAULT +1", true},
		{"ALTER TABLE t ADD COLUMN a INT(24) NOT NULL DEFAULT -1", true},
		{"ALTER TABLE t ADD COLUMN a FLOAT DEFAULT 0.1", true},
		{"ALTER TABLE t ADD COLUMN a FLOAT DEFAULT -0.1", true},
		{"ALTER TABLE t ADD COLUMN a FLOAT DEFAULT +0.1", true},
		{"ALTER TABLE t ADD COLUMN a FLOAT NOT NULL DEFAULT -0.1", true},
		{"ALTER TABLE t ADD COLUMN a DECIMAL(2,2) DEFAULT 1.1", true},
		{"ALTER TABLE t ADD COLUMN a DECIMAL(2,2) DEFAULT -1.1", true},
		{"ALTER TABLE t ADD COLUMN a DECIMAL(2,2) DEFAULT +1.1", true},
		{"ALTER TABLE t ADD COLUMN a DECIMAL(2,2) NOT NULL DEFAULT -1.1", true},
