...
func TestPrivilege(t *testing.T) {
	table := []testCase{
		...
		{"CREATE USER `user@pingcap.com`@'localhost' IDENTIFIED WITH 'tidb_auth_token' ATTRIBUTE '{\"email\": \"user@pingcap.com\"}'", true, "CREATE USER `user@pingcap.com`@`localhost` IDENTIFIED WITH 'tidb_auth_token' ATTRIBUTE '{\"email\": \"user@pingcap.com\"}'"},
