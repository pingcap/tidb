...
func TestBinding(t *testing.T) {
	table := []testCase{
		...
		{"set global binding using for select * from t", true, "SET GLOBAL BINDING USING FOR SELECT * FROM `t`"},
		{"set session binding using for select * from t", true, "SET SESSION BINDING USING FOR SELECT * FROM `t`"},
		{"set global binding using for select * from t using select * from t use index(a)", true, "SET GLOBAL BINDING USING FOR SELECT * FROM `t` USING SELECT * FROM `t` USE INDEX (`a`)"},
		{"set session binding using for select * from t using select * from t use index(a)", true, "SET SESSION BINDING USING FOR SELECT * FROM `t` USING SELECT * FROM `t` USE INDEX (`a`)"},
		{"set global binding ignored for select * from t", true, "SET GLOBAL BINDING IGNORED FOR SELECT * FROM `t`"},
		{"set session binding ignored for select * from t", true, "SET SESSION BINDING IGNORED FOR SELECT * FROM `t`"},
		{"set global binding ignored for select * from t using select * from t use index(a)", true, "SET GLOBAL BINDING IGNORED FOR SELECT * FROM `t` USING SELECT * FROM `t` USE INDEX (`a`)"},
		{"set session binding ignored for select * from t using select * from t use index(a)", true, "SET SESSION BINDING IGNORED FOR SELECT * FROM `t` USING SELECT * FROM `t` USE INDEX (`a`)"},
