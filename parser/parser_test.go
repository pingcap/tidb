...
func TestBRIE(t *testing.T) {
	table := []testCase{
		...
		{"backup log to 'noop://'", true, "BACKUP LOG TO 'noop://'"},
		{"backup log to 'noop://' start_ts='20220304'", true, "BACKUP LOG TO 'noop://' START_TS = '20220304'"},
		{"pause backup log", true, "PAUSE BACKUP LOG"},
		{"pause backup log gc_ttl='20220304'", true, "PAUSE BACKUP LOG GC_TTL = '20220304'"},
		{"resume backup log", true, "RESUME BACKUP LOG"},
		{"show backup log status", true, "SHOW BACKUP LOG STATUS"},
		{"show backup log metadata from 'noop://'", true, "SHOW BACKUP LOG METADATA FROM 'noop://'"},
		...
		{"purge backup log from 'noop://'", true, "PURGE BACKUP LOG FROM 'noop://'"},
		{"purge backup log from 'noop://' until_ts='2012122304'", true, "PURGE BACKUP LOG FROM 'noop://' UNTIL_TS = '2012122304'"},
