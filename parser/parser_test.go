...
'`},
		...
		{"calibrate resource END_TIME now()", true, "CALIBRATE RESOURCE END_TIME CURRENT_TIMESTAMP()"},
		{"calibrate resource START_TIME now()", true, "CALIBRATE RESOURCE START_TIME CURRENT_TIMESTAMP()"},
		// Because NOW converted into CURRENT_TIMESTAMP, offset is 14. So there are so many space.
		{"calibrate resource START_TIME NOW()               END_TIME now()", true, "CALIBRATE RESOURCE START_TIME CURRENT_TIMESTAMP() END_TIME CURRENT_TIMESTAMP()"},
		{"calibrate resource START_TIME CURRENT_TIMESTAMP() - '10m' END_TIME now()", true, "CALIBRATE RESOURCE START_TIME CURRENT_TIMESTAMP() - '10m' END_TIME CURRENT_TIMESTAMP()"},
		{"calibrate resource START_TIME '2023-04-01 13:00:00' END_TIME current_timestamp()", true, "CALIBRATE RESOURCE START_TIME '2023-04-01 13:00:00' END_TIME CURRENT_TIMESTAMP()"},
		{"calibrate resource START_TIME CURRENT_TIMESTAMP() - '2023-04-01 13:00:00' END_TIME current_timestamp()", false, ""},
