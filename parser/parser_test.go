...
func TestIntervalPartition(t *testing.T) {
	table := []testCase{
		...
		//{`ALTER TABLE t add LAST PARTITION LESS THAN (1000)`, true, "ALTER TABLE `t` add LAST PARTITION LESS THAN (1000)"},
		...
		{`ALTER TABLE t split MAX PARTITION LESS THAN (1000)`, true, "ALTER TABLE `t` SPLIT MAX PARTITION LESS THAN (1000)"},
		{`ALTER TABLE t merge first PARTITION LESS THAN (1000)`, true, "ALTER TABLE `t` MERGE FIRST PARTITION LESS THAN (1000)"},
		//{`ALTER TABLE t drop first PARTITION LESS THAN (1000)`, true, "ALTER TABLE `t` DROP FIRST PARTITION LESS THAN (1000)"},
	}
