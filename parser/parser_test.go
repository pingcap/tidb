...
func TestBRIE(t *testing.T) {
	table := []testCase{
		...
		{"IMPORT DATABASE a FROM 'local:///tmp/archive01/'", true, "IMPORT DATABASE `a` FROM 'local:///tmp/archive01/'"},
		{"IMPORT SCHEMA a FROM 'local:///tmp/archive01/'", true, "IMPORT DATABASE `a` FROM 'local:///tmp/archive01/'"},
		{"IMPORT DATABASE a,b,c FROM 'noop://'", true, "IMPORT DATABASE `a`, `b`, `c` FROM 'noop://'"},
		{"IMPORT DATABASE a.b FROM 'noop://'", false, ""},
		{"IMPORT DATABASE * FROM 'noop://'", true, "IMPORT DATABASE * FROM 'noop://'"},
		{"IMPORT DATABASE *, a FROM 'noop://'", false, ""},
		{"IMPORT DATABASE a, * FROM 'noop://'", false, ""},
		{"IMPORT DATABASE FROM 'noop://'", false, ""},
		{"IMPORT TABLE a FROM 'noop://'", true, "IMPORT TABLE `a` FROM 'noop://'"},
		{"IMPORT TABLE a.b FROM 'noop://'", true, "IMPORT TABLE `a`.`b` FROM 'noop://'"},
		{"IMPORT TABLE a.b,c.d,e FROM 'noop://'", true, "IMPORT TABLE `a`.`b`, `c`.`d`, `e` FROM 'noop://'"},
		{"IMPORT TABLE a.* FROM 'noop://'", false, ""},
		{"IMPORT TABLE * FROM 'noop://'", false, ""},
		{"IMPORT TABLE FROM 'noop://'", false, ""},
