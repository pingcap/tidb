...
/*
ToHashKey removes leading zeros and trailing zeros and generates a key;
Two keys generated by different precision or fraction can be compared with memcmp directly;
