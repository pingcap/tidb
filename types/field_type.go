...
func NewFieldType(tp byte) *FieldType {
	...
	flen, decimal := MaxFlenAndDecimalForType(tp)
...
// MaxFlenAndDecimalForType returns the default flen/decimal for mysql type.
func MaxFlenAndDecimalForType(tp byte) (int, int) {
	switch tp {
