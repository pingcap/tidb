...
// Source: github.com/pingcap/tidb/disttask/framework/scheduler (interfaces: TaskTable,SubtaskExecutor,Pool,MiniTaskExecutor,Scheduler,Extension)
...
func (m *MockSubtaskExecutor) SplitSubtask(arg0 context.Context, arg1 []byte) ([]proto.MinimalTask, error) {
	m.ctrl.T.Helper()
...
func (m *MockExtension) GetMiniTaskExecutor(arg0 proto.MinimalTask, arg1 string, arg2 int64) (scheduler.MiniTaskExecutor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMiniTaskExecutor", arg0, arg1, arg2)
	ret0, _ := ret[0].(scheduler.MiniTaskExecutor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockExtension) GetSubtaskExecutor(arg0 context.Context, arg1 *proto.Task) (scheduler.SubtaskExecutor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSubtaskExecutor", arg0, arg1)
	ret0, _ := ret[0].(scheduler.SubtaskExecutor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
