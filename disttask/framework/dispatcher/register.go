...
type TaskFlowHandle interface {
	ProcessNormalFlow(ctx context.Context, d Dispatch, gTask *proto.Task) (metas [][]byte, err error)
	ProcessErrFlow(ctx context.Context, d Dispatch, gTask *proto.Task, receive string) (meta []byte, err error)
}
