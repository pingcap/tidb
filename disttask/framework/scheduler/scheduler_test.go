...
func TestSchedulerRun(t *testing.T) {
	...
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending}).Return(nil, getSubtaskErr).Once()
	...
	mockScheduler.On("InitSubtaskExecEnv", mock.Anything).Return(nil).Once()
	mockPool.On("RunWithConcurrency", mock.Anything, mock.Anything).Return(nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending}).Return(&proto.Subtask{ID: 1}, nil).Once()
	...
	mockScheduler.On("InitSubtaskExecEnv", mock.Anything).Return(nil).Once()
	mockPool.On("RunWithConcurrency", mock.Anything, mock.Anything).Return(nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending}).Return(&proto.Subtask{ID: 1, Type: tp}, nil).Once()
	...
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending}).Return(nil, nil).Once()
	mockScheduler.On("CleanupSubtaskExecEnv", mock.Anything).Return(nil).Once()
	err = scheduler.Run(runCtx, &proto.Task{Step: proto.StepOne, Type: tp, ID: taskID, Concurrency: concurrency})
	...
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending}).Return(&proto.Subtask{ID: 2, Type: tp}, nil).Once()
...
func TestSchedulerRollback(t *testing.T) {
	...
	schedulerRegisterErr := errors.Errorf("constructor of scheduler for key %s not found", getKey(tp, proto.StepOne))
	scheduler := NewInternalScheduler(ctx, "id", 1, mockSubtaskTable, mockPool)
	mockSubtaskTable.On("GetSubtaskInStates", "id", int64(1), []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(nil, nil).Once()
	...
	getSubtaskErr := errors.New("get subtask error")
	var taskID int64 = 1
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(nil, nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStateRevertPending}).Return(nil, getSubtaskErr).Once()
	err = scheduler.Rollback(runCtx, &proto.Task{Step: proto.StepOne, Type: tp, ID: taskID})
	require.EqualError(t, err, getSubtaskErr.Error())

	// 3. no subtask
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(nil, nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStateRevertPending}).Return(nil, nil).Once()
	err = scheduler.Rollback(runCtx, &proto.Task{Step: proto.StepOne, Type: tp, ID: taskID})
	require.NoError(t, err)
	...
	updateSubtaskErr := errors.New("update subtask error")
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(nil, nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStateRevertPending}).Return(&proto.Subtask{ID: 1}, nil).Once()
	...
	// rollback success
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(&proto.Subtask{ID: 1}, nil).Once()
	mockSubtaskTable.On("UpdateSubtaskStateAndError", int64(1), proto.TaskStateCanceled).Return(nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(&proto.Subtask{ID: 2}, nil).Once()
	mockSubtaskTable.On("UpdateSubtaskStateAndError", int64(2), proto.TaskStateCanceled).Return(nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(nil, nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStateRevertPending}).Return(&proto.Subtask{ID: 3}, nil).Once()
...
func TestScheduler(t *testing.T) {
	...
	// rollback success
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStatePending, proto.TaskStateRunning}).Return(nil, nil).Once()
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []any{proto.TaskStateRevertPending}).Return(&proto.Subtask{ID: 1, Type: tp}, nil).Once()
	mockSubtaskTable.On("UpdateSubtaskStateAndError", taskID, proto.TaskStateReverting).Return(nil).Once()
	mockScheduler.On("Rollback", mock.Anything).Return(nil).Once()
