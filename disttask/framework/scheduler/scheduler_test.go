...
func TestSchedulerRun(t *testing.T) {
	...
	RegisterSchedulerConstructor(tp, func(task *proto.Task, step int64) (Scheduler, error) {
	...
	mockScheduler.On("SplitSubtask", &proto.Subtask{ID: 1}).Return([]proto.MinimalTask{&proto.Subtask{ID: 1}}).Once()
	...
	mockSubtaskTable.On("GetSubtaskInStates", "id", taskID, []interface{}{proto.TaskStatePending}).Return(&proto.Subtask{ID: 1}, nil).Once()
	mockSubtaskTable.On("UpdateSubtaskState", taskID, proto.TaskStateRunning).Return(nil).Once()
	mockScheduler.On("SplitSubtask", &proto.Subtask{ID: 1}).Return([]proto.MinimalTask{&proto.Subtask{ID: 1}, &proto.Subtask{ID: 1}}).Once()
	mockSubtaskExecutor.On("Run", mock.Anything).Return(nil).Once()
