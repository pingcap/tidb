...
func (t *MockTaskTable) GetGlobalTasksInStates(states ...any) ([]*proto.Task, error) {
...
func (t *MockTaskTable) GetSubtaskInStates(instanceID string, taskID int64, states ...any) (*proto.Subtask, error) {
...
func (t *MockTaskTable) HasSubtasksInStates(instanceID string, taskID int64, states ...any) (bool, error) {
	args := t.Called(instanceID, taskID, states)
