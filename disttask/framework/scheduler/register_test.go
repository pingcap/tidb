...
func mockSchedulerConstructor(task *proto.Task, step int64) (Scheduler, error) {
	return nil, nil
}
...
func TestRegisterSubtaskExectorConstructor(t *testing.T) {
	...
	require.Equal(t, subtaskExecutorOptions["test1"].PoolSize, 0)
	...
	require.Equal(t, subtaskExecutorOptions["test2"].PoolSize, 0)
	...
	require.Equal(t, subtaskExecutorOptions["test3"].PoolSize, 1)
	...
	require.Equal(t, subtaskExecutorOptions["test4"].PoolSize, 1)
