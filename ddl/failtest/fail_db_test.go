...
func (s *testFailDBSuite) TestFailSchemaSyncer(c *C) {
	...
	c.Assert(err, NotNil)
	c.Assert(err.Error(), Equals, "[DB:domain:8027] Information schema is out of date: schema failed to update in 1 lease, please make sure TiDB can connect to TiKV")
