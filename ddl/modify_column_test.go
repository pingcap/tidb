...
func TestModifyColumnNullToNotNull(t *testing.T) {
	...
	tbl := testutil.GetTableByName(t, tk1, "test", "t1")
	...
	c2 := testutil.GetModifyColumn(t, tk1, "test", "t1", "c2", false)
...
func TestModifyColumnBetweenStringTypes(t *testing.T) {
	...
	mvc := testutil.GetModifyColumn(t, tk, "test", "tt", "a", false)
	...
	mc := testutil.GetModifyColumn(t, tk, "test", "tt", "a", false)
	...
	mb := testutil.GetModifyColumn(t, tk, "test", "tt", "a", false)
	...
	mvb := testutil.GetModifyColumn(t, tk, "test", "tt", "a", false)
	...
	c2 := testutil.GetModifyColumn(t, tk, "test", "tt", "a", false)
...
func TestModifyColumnCharset(t *testing.T) {
	...
	tbl := testutil.GetTableByName(t, tk, "test", "t_mcc")
