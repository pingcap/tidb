...
var (
	...
	// ErrUnsupportedTempTable returns for unsupported actions for temporary table.
	ErrUnsupportedTempTable = terror.ClassDDL.New(mysql.ErrUnsupportedDDLOperation, fmt.Sprintf(mysql.MySQLErrName[mysql.ErrUnsupportedDDLOperation], "temporary table"))
