...
func (d *ddl) prepareWorkers4ConcurrencyDDL() {
	workerFactory := func(tp workerType) func() (pools.Resource, error) {
		return func() (pools.Resource, error) {
			...
			wk.sess = su.NewSession(sessForJob)
...
func get2JobsFromTable(sess *su.Session) (*model.Job, *model.Job, error) {
	var generalJob, reorgJob *model.Job
...
func GetAllDDLJobs(sess sessionctx.Context, t *meta.Meta) ([]*model.Job, error) {
	return getJobsBySQL(su.NewSession(sess), JobTable, "1 order by job_id")
}
...
func AddHistoryDDLJob(sess *su.Session, t *meta.Meta, job *model.Job, updateRawArgs bool) error {
...
func addHistoryDDLJob2Table(sess *su.Session, job *model.Job, updateRawArgs bool) error {
