...
type DDL interface {
	...
	CreateView(ctx context.Context, ident ast.Ident, colNames []string, selectFields []string, selectText string) error
...
func init() {
	ddlMySQLErrCodes := map[terror.ErrCode]uint16{
		...
		codeViewInvalid:                  mysql.ErrViewInvalid,
	}
