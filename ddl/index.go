...
func buildIndexColumns(columns []*model.ColumnInfo, idxColNames []*ast.KeyPartSpecification) ([]*model.IndexColumn, error) {
	// Build offsets.
...
func checkPKOnGeneratedColumn(tblInfo *model.TableInfo, idxColNames []*ast.KeyPartSpecification) (*model.ColumnInfo, error) {
...
func checkIndexColumn(col *model.ColumnInfo, ic *ast.KeyPartSpecification) error {
...
func buildIndexInfo(tblInfo *model.TableInfo, indexName model.CIStr, idxColNames []*ast.KeyPartSpecification, state model.SchemaState) (*model.IndexInfo, error) {
