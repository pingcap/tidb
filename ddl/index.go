...
// buildIndexInfo return an IndexInfo to be added to TableInfo.
// nil session context will be treated as strict SQL mode.
// Caller may need to validateCommentLength.
func buildIndexInfo(
