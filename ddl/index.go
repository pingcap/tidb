...
func buildIndexColumns(columns []*model.ColumnInfo, idxColNames []*ast.IndexColNameWithExpr) ([]*model.IndexColumn, error) {
	// Build offsets.
...
func checkPKOnGeneratedColumn(tblInfo *model.TableInfo, idxColNames []*ast.IndexColNameWithExpr) (*model.ColumnInfo, error) {
...
func checkIndexColumn(col *model.ColumnInfo, ic *ast.IndexColNameWithExpr) error {
...
func buildIndexInfo(tblInfo *model.TableInfo, indexName model.CIStr, idxColNames []*ast.IndexColNameWithExpr, state model.SchemaState) (*model.IndexInfo, error) {
