...
const (
	...
	ReorgTableSQL = "create table " + ReorgTable + "(job_id bigint not null, ele_id bigint, ele_type blob, start_key blob, end_key blob, store_id bigint, reorg_meta longblob, unique key(job_id, ele_id, ele_type(20)))"
