...
func (s *testIntegrationSuite5) TestDropColumnWithMultiIndex(c *C) {
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec("use test_db")
	tk.MustExec("create table t_drop_column_with_idx1(a int, b int, c int)")
	tk.MustExec("create index idx_1 on t_drop_column_with_idx1(b)")
	tk.MustExec("create index idx_2 on t_drop_column_with_idx1(b)")
	tk.MustExec("alter table t_drop_column_with_idx1 drop column b")
	query := queryIndexOnTable("test_db", "t_drop_column_with_idx1")
	tk.MustQuery(query).Check(testkit.Rows())
}
...
func (s *testIntegrationSuite5) TestDropColumnsWithMultiCompositeIndex(c *C) {
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec("use test_db")
	tk.MustExec("create table t_drop_columns_with_idx1(a int, b int, c int, index idx_1(a,b), index idx_2(b,c), index idx_3(a, c), index idx_4(b))")
	tk.MustExec("alter table t_drop_columns_with_idx1 drop column b, drop column c")
	query := queryIndexOnTable("test_db", "t_drop_columns_with_idx1")
...
func (s *testIntegrationSuite5) TestDropColumnsWithMultiCompositeIndex2(c *C) {
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec("use test_db")
	tk.MustExec("create table t_drop_columns_with_idx2(a int, b int, c int, index idx_1(b,c))")
	tk.MustExec("alter table t_drop_columns_with_idx2 drop column b, drop column c")
	query := queryIndexOnTable("test_db", "t_drop_columns_with_idx2")
	tk.MustQuery(query).Check(testkit.Rows())
}
...
func (s *testIntegrationSuite5) TestDropColumnsWithMultiCompositeIndexWithData(c *C) {
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec("use test_db")
	tk.MustExec("create table t_drop_columns_with_idx3(a int, b int, c int, unique index idx_1(b,c), index idx_2(a, c))")
	tk.MustExec("insert into t_drop_columns_with_idx3(a, b, c) values (1, 2, 3), (1, 2, 4), (1, 2, 5)")
	tk.MustGetErrCode("alter table t_drop_columns_with_idx3 drop column a, drop column c", 1062)
	query := queryIndexOnTable("test_db", "t_drop_columns_with_idx3")
