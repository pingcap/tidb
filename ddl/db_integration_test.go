...
func (s *testIntegrationSuite5) TestNoZeroDateMode(c *C) {
	...
	tk.MustGetErrCode("create table test_zero_date(agent_start_time date NOT NULL DEFAULT '0000-00-00')", tmysql.ErrInvalidDefault)
	tk.MustGetErrCode("create table test_zero_date(agent_start_time datetime NOT NULL DEFAULT '0000-00-00 00:00:00')", tmysql.ErrInvalidDefault)
	tk.MustGetErrCode("create table test_zero_date(agent_start_time timestamp NOT NULL DEFAULT '0000-00-00 00:00:00')", tmysql.ErrInvalidDefault)
	tk.MustGetErrCode("create table test_zero_date(a timestamp default '0000-00-00 00');", tmysql.ErrInvalidDefault)
	tk.MustGetErrCode("create table test_zero_date(a timestamp default 0);", tmysql.ErrInvalidDefault)
}
...
func (s *testIntegrationSuite2) TestInvalidDefault(c *C) {
	...
	c.Assert(err, NotNil)
	c.Assert(pterror.ErrorEqual(err, types.ErrInvalidDefault), IsTrue, Commentf("err %v", err))
...
func (s *testIntegrationSuite3) TestInvalidNameWhenCreateTable(c *C) {
	...
	c.Assert(err, NotNil)
	c.Assert(pterror.ErrorEqual(err, ddl.ErrWrongDBName), IsTrue, Commentf("err %v", err))

	_, err = tk.Exec("create table t(test.tttt.a bigint)")
	c.Assert(err, NotNil)
	c.Assert(pterror.ErrorEqual(err, ddl.ErrWrongTableName), IsTrue, Commentf("err %v", err))
...
func (s *testIntegrationSuite3) TestCreateTableIfNotExists(c *C) {
	...
	c.Assert(pterror.ErrorEqual(infoschema.ErrTableExists, lastWarn.Err), IsTrue, Commentf("err %v", lastWarn.Err))
	...
	c.Assert(len(warnings), GreaterEqual, 1)
	lastWarn = warnings[len(warnings)-1]
	c.Assert(pterror.ErrorEqual(infoschema.ErrTableExists, lastWarn.Err), IsTrue)
}
...
func (s *testIntegrationSuite2) TestIssue6101(c *C) {
	...
	terr := errors.Cause(err).(pterror.BaseErrorConvertible)
	c.Assert(terr.ToBaseError().Code(), Equals, pterror.ErrCode(tmysql.ErrWarnDataOutOfRange))
...
func (s *testIntegrationSuite5) TestMySQLErrorCode(c *C) {
	...
	tk.MustGetErrCode(sql, tmysql.ErrTooLongIdent)
	sql = "create database test"
	tk.MustGetErrCode(sql, tmysql.ErrDBCreateExists)
	sql = "create database test1 character set uft8;"
	tk.MustGetErrCode(sql, tmysql.ErrUnknownCharacterSet)
	...
	tk.MustGetErrCode(sql, tmysql.ErrDBDropExists)
	// create table
	...
	tk.MustGetErrCode(sql, tmysql.ErrTableExists)
	sql = "create table test_error_code1 (c1 int, c2 int, c2 int)"
	tk.MustGetErrCode(sql, tmysql.ErrDupFieldName)
	...
	tk.MustGetErrCode(sql, tmysql.ErrDupKeyName)
	...
	tk.MustGetErrCode(sql, tmysql.ErrWrongFkDef)
	...
	tk.MustGetErrCode(sql, tmysql.ErrMultiplePriKey)
	...
	tk.MustGetErrCode(sql, tmysql.ErrWrongAutoKey)
	...
	tk.MustGetErrCode(sql, tmysql.ErrInvalidOnUpdate)
	...
	tk.MustGetErrCode(sql, tmysql.ErrNoSuchTable)
	sql = "alter table test_error_code_succ add column `a ` int ;"
	tk.MustGetErrCode(sql, tmysql.ErrWrongColumnName)
	...
	tk.MustGetErrCode(sql, tmysql.ErrCantRemoveAllFields)
	// add index
	...
	tk.MustGetErrCode(sql, tmysql.ErrBadNull)
}
...
func (s *testIntegrationSuite3) TestTableDDLWithFloatType(c *C) {
	...
	s.tk.MustGetErrCode("create table t (a decimal(1, 2))", tmysql.ErrMBiggerThanD)
	s.tk.MustGetErrCode("create table t (a float(1, 2))", tmysql.ErrMBiggerThanD)
	s.tk.MustGetErrCode("create table t (a double(1, 2))", tmysql.ErrMBiggerThanD)
	s.tk.MustExec("create table t (a double(1, 1))")
	s.tk.MustGetErrCode("alter table t add column b decimal(1, 2)", tmysql.ErrMBiggerThanD)
	// add multi columns now not support, so no case.
	s.tk.MustGetErrCode("alter table t modify column a float(1, 4)", tmysql.ErrMBiggerThanD)
	s.tk.MustGetErrCode("alter table t change column a aa float(1, 4)", tmysql.ErrMBiggerThanD)
...
func (s *testIntegrationSuite1) TestTableDDLWithTimeType(c *C) {
	...
	s.tk.MustExec("use test")
	s.tk.MustExec("drop table if exists t")
	s.tk.MustGetErrCode("create table t (a time(7))", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("create table t (a datetime(7))", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("create table t (a timestamp(7))", tmysql.ErrTooBigPrecision)
	_, err := s.tk.Exec("create table t (a time(-1))")
	c.Assert(err, NotNil)
	s.tk.MustExec("create table t (a datetime)")
	s.tk.MustGetErrCode("alter table t add column b time(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t add column b datetime(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t add column b timestamp(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t modify column a time(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t modify column a datetime(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t modify column a timestamp(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t change column a aa time(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t change column a aa datetime(7)", tmysql.ErrTooBigPrecision)
	s.tk.MustGetErrCode("alter table t change column a aa timestamp(7)", tmysql.ErrTooBigPrecision)
...
func (s *testIntegrationSuite3) TestChangingCharsetToUtf8(c *C) {
	...
	tk.MustGetErrCode("alter table t modify column a varchar(20) charset utf8", tmysql.ErrUnsupportedDDLOperation)
	tk.MustGetErrCode("alter table t modify column a varchar(20) charset utf8mb4", tmysql.ErrUnsupportedDDLOperation)
	tk.MustGetErrCode("alter table t modify column a varchar(20) charset utf8 collate utf8_bin", tmysql.ErrUnsupportedDDLOperation)
	tk.MustGetErrCode("alter table t modify column a varchar(20) charset utf8mb4 collate utf8mb4_general_ci", tmysql.ErrUnsupportedDDLOperation)

	tk.MustGetErrCode("alter table t modify column a varchar(20) charset utf8mb4 collate utf8bin", tmysql.ErrUnknownCollation)
	tk.MustGetErrCode("alter table t collate LATIN1_GENERAL_CI charset utf8 collate utf8_bin", tmysql.ErrConflictingDeclarations)
	tk.MustGetErrCode("alter table t collate LATIN1_GENERAL_CI collate UTF8MB4_UNICODE_ci collate utf8_bin", tmysql.ErrCollationCharsetMismatch)
}
...
func (s *testIntegrationSuite4) TestChangingTableCharset(c *C) {
	...
	tk.MustGetErrCode("alter table t charset gbk", tmysql.ErrUnknownCharacterSet)
	tk.MustGetErrCode("alter table t charset ''", tmysql.ErrUnknownCharacterSet)

	tk.MustGetErrCode("alter table t charset utf8mb4 collate '' collate utf8mb4_bin;", tmysql.ErrUnknownCollation)

	tk.MustGetErrCode("alter table t charset utf8 collate latin1_bin", tmysql.ErrCollationCharsetMismatch)
	tk.MustGetErrCode("alter table t charset utf8 collate utf8mb4_bin;", tmysql.ErrCollationCharsetMismatch)
	tk.MustGetErrCode("alter table t charset utf8 collate utf8_bin collate utf8mb4_bin collate utf8_bin;", tmysql.ErrCollationCharsetMismatch)

	tk.MustGetErrCode("alter table t charset utf8", tmysql.ErrUnsupportedDDLOperation)
	tk.MustGetErrCode("alter table t charset utf8mb4", tmysql.ErrUnsupportedDDLOperation)
	tk.MustGetErrCode("alter table t charset utf8mb4 collate utf8mb4_bin", tmysql.ErrUnsupportedDDLOperation)

	tk.MustGetErrCode("alter table t charset latin1 charset utf8 charset utf8mb4 collate utf8_bin;", tmysql.ErrConflictingDeclarations)
	...
	tk.MustGetErrCode("alter table t convert to charset utf8mb4;", tmysql.ErrUnsupportedDDLOperation)
...
func (s *testIntegrationSuite1) TestCreateTableTooLarge(c *C) {
	...
	sql += ");"
	s.tk.MustGetErrCode(sql, tmysql.ErrTooManyFields)
...
func (s *testIntegrationSuite3) TestChangeColumnPosition(c *C) {
	...
	s.tk.MustGetErrCode("alter table position1 modify column b int after b", tmysql.ErrBadField)
	...
	s.tk.MustGetErrCode("alter table position2 change column c b int after c", tmysql.ErrBadField)
...
func (s *testIntegrationSuite2) TestAddIndexAfterAddColumn(c *C) {
	...
	s.tk.MustGetErrCode(sql, tmysql.ErrDupEntry)
	...
	s.tk.MustGetErrCode(sql, tmysql.ErrTooManyKeyParts)
}
...
func (s *testIntegrationSuite3) TestAlterColumn(c *C) {
	...
	s.tk.MustGetErrCode(sql, tmysql.ErrNoSuchTable)
	...
	s.tk.MustGetErrCode("alter table t1 modify column a varchar(3000);", tmysql.ErrTooLongKey)
	// check modify column with rename column.
	s.tk.MustGetErrCode("alter table t1 change column a x varchar(3000);", tmysql.ErrTooLongKey)
	s.tk.MustGetErrCode("alter table t1 modify column c bigint;", tmysql.ErrTooLongKey)
...
func (s *testIntegrationSuite) assertWarningExec(c *C, sql string, expectedWarn *terror.TError) {
	_, err := s.tk.Exec(sql)
	c.Assert(err, IsNil)
...
func (s *testIntegrationSuite) assertAlterErrorExec(c *C, sql string) {
	s.tk.MustGetErrCode(sql, tmysql.ErrAlterOperationNotSupportedReason)
}
...
func (s *testIntegrationSuite3) TestAlterTableAddUniqueOnPartionRangeColumn(c *C) {
	...
	s.tk.MustGetErrCode("alter table t add unique index idx_a(a)", tmysql.ErrDupEntry)
	...
	s.tk.MustGetErrCode("alter table t add unique index idx_b(b)", tmysql.ErrUniqueKeyNeedAllFieldsInPf)
}
...
func (s *testIntegrationSuite1) TestTreatOldVersionUTF8AsUTF8MB4(c *C) {
	...
	s.tk.MustGetErrCode("insert into t set a= x'f09f8c80';", tmysql.ErrTruncatedWrongValueForField)
...
func (s *testIntegrationSuite4) TestDropAutoIncrementIndex(c *C) {
	...
	tk.MustGetErrCode(dropIndexSQL, tmysql.ErrWrongAutoKey)
...
func (s *testIntegrationSuite4) TestInsertIntoGeneratedColumnWithDefaultExpr(c *C) {
	...
	tk.MustGetErrCode("insert into t5 values (20, default(a))", tmysql.ErrBadGeneratedColumn)
...
func (s *testIntegrationSuite3) TestSqlFunctionsInGeneratedColumns(c *C) {
	...
	tk.MustGetErrCode("create table t (a int, b int as (sysdate()))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	// 2. Non-builtin function
	tk.MustGetErrCode("create table t (a int, b int as (non_exist_funcA()))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	// 3. values(x) function
	tk.MustGetErrCode("create table t (a int, b int as (values(a)))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	// 4. Subquery
	tk.MustGetErrCode("create table t (a int, b int as ((SELECT 1 FROM t1 UNION SELECT 1 FROM t1)))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	// 5. Variable & functions related to variable
	tk.MustExec("set @x = 1")
	tk.MustGetErrCode("create table t (a int, b int as (@x))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode("create table t (a int, b int as (@@max_connections))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode("create table t (a int, b int as (@y:=1))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode(`create table t (a int, b int as (getval("x")))`, tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode(`create table t (a int, b int as (setval("y", 1)))`, tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	// 6. Aggregate function
	tk.MustGetErrCode("create table t1 (a int, b int as (avg(a)));", tmysql.ErrInvalidGroupFuncUse)
	...
	tk.MustGetErrCode("create table t (a int, b int as (updatexml(1, 1, 1)))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode("create table t (a int, b int as (statement_digest(1)))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode("create table t (a int, b int as (statement_digest_text(1)))", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
}
...
func (s *testIntegrationSuite6) TestAddExpressionIndex(c *C) {
	...
	tk.MustGetErrCode("create table t(a int, b int, index((a+b)));", tmysql.ErrNotSupportedYet)
	...
	tk.MustExec("drop table if exists t;")
	tk.MustExec("create table t (a int, b real);")
	tk.MustGetErrCode("alter table t add primary key ((a+b));", tmysql.ErrFunctionalIndexPrimaryKey)
	tk.MustGetErrCode("alter table t add index ((rand()));", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)
	tk.MustGetErrCode("alter table t add index ((now()+1));", tmysql.ErrGeneratedColumnFunctionIsNotAllowed)

	tk.MustExec("alter table t add column (_V$_idx_0 int);")
	tk.MustGetErrCode("alter table t add index idx((a+1));", tmysql.ErrDupFieldName)
	tk.MustExec("alter table t drop column _V$_idx_0;")
	tk.MustExec("alter table t add index idx((a+1));")
	tk.MustGetErrCode("alter table t add column (_V$_idx_0 int);", tmysql.ErrDupFieldName)
	tk.MustExec("alter table t drop index idx;")
	tk.MustExec("alter table t add column (_V$_idx_0 int);")

	tk.MustExec("alter table t add column (_V$_expression_index_0 int);")
	tk.MustGetErrCode("alter table t add index ((a+1));", tmysql.ErrDupFieldName)
	tk.MustExec("alter table t drop column _V$_expression_index_0;")
	tk.MustExec("alter table t add index ((a+1));")
	tk.MustGetErrCode("alter table t drop column _V$_expression_index_0;", tmysql.ErrCantDropFieldOrKey)
	tk.MustGetErrCode("alter table t add column e int as (_V$_expression_index_0 + 1);", tmysql.ErrBadField)
}
