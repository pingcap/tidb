...
type TikvClient interface {
	...
	KvBatchLockResolve(ctx context.Context, in *kvrpcpb.BatchLockResolveRequest, opts ...grpc.CallOption) (*kvrpcpb.BatchLockResolveResponse, error)
...
func (c *tikvClient) KvBatchLockResolve(ctx context.Context, in *kvrpcpb.BatchLockResolveRequest, opts ...grpc.CallOption) (*kvrpcpb.BatchLockResolveResponse, error) {
	out := new(kvrpcpb.BatchLockResolveResponse)
	err := grpc.Invoke(ctx, "/tikvpb.Tikv/KvBatchLockResolve", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	KvBatchLockResolve(context.Context, *kvrpcpb.BatchLockResolveRequest) (*kvrpcpb.BatchLockResolveResponse, error)
...
func _Tikv_KvBatchLockResolve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.BatchLockResolveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).KvBatchLockResolve(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/KvBatchLockResolve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).KvBatchLockResolve(ctx, req.(*kvrpcpb.BatchLockResolveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "KvBatchLockResolve",
			Handler:    _Tikv_KvBatchLockResolve_Handler,
		},
		{
			MethodName: "KvGC",
...
var fileDescriptorTikvpb = []byte{
	...
	,
}
