...
type Session interface {
	...
	PrepareStmt(goCtx goctx.Context, sql string) (stmtID uint32,
		paramCount int, fields []*ast.ResultField, err error)
...
func (s *session) PrepareStmt(goCtx goctx.Context, sql string) (stmtID uint32,
	paramCount int, fields []*ast.ResultField, err error) {
