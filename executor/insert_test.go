...
func (s *testSuite10) TestAddDateColumnNotNull(c *C) {
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec(`use test`)
	tk.MustExec("drop table if exists t")
	tk.MustExec("create table t (id int)")
	tk.MustExec("insert into t values(1)")
	tk.MustGetErrCode("alter table t add column a date not null", errno.ErrTruncatedWrongValueForField)
	tk.MustGetErrCode("alter table t add column a datetime not null", errno.ErrTruncatedWrongValueForField)
	tk.MustExec("alter table t add column a date default '1989-12-03'")
	tk.MustExec("alter table t add column b datetime default '1989-12-03 00:00:00'")
	tk.MustExec("drop table if exists t")
	tk.MustExec("create table t (id int)")
	tk.MustExec("alter table t add column a date not null")
	tk.MustExec("alter table t add column b datetime not null")
	tk.MustExec("alter table t add column c date default '1989-12-03'")
	tk.MustExec("alter table t add column d datetime default '1989-12-03 00:00:00'")

	tk.MustExec("drop table if exists test.t;")
	tk.MustExec("create table test.t(a int);")
	tk.MustExec("insert into test.t values (1);")
	tk.MustExec("alter table test.t add date_0 DATE NULL DEFAULT '1000-01-01';")
	tk.MustExec("alter table test.t add date_1 DATE NULL DEFAULT '9999-12-31';")
	tk.MustGetErrCode("alter table test.t add date_a DATE NOT NULL;", errno.ErrTruncatedWrongValueForField)
	tk.MustExec("alter table test.t add time_0 TIME NULL DEFAULT '59';")
	tk.MustExec("alter table test.t add time_1 TIME(6) NULL DEFAULT '-838:59:59.000000';")
	tk.MustExec("alter table test.t add time_2 TIME(6) NULL DEFAULT '838:59:59.000000';")
	tk.MustExec("alter table test.t add time_3 TIME(6) NULL DEFAULT '0';")
	tk.MustExec("alter table test.t add time_a TIME NOT NULL;")
	tk.MustExec("alter table test.t add time_b TIME(6) NOT NULL;")
	tk.MustExec("alter table test.t add datetime_0 DATETIME(6) NULL DEFAULT '1000-01-01 00:00:00.000000';")
