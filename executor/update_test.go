...
func TestIssue38577(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
	...
	tk.MustExec(`insert into tbl_1 values ( 'Bob',null,0.04,2650749963804575036,4044 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Alice',171,1838.2,6452757231340518222,1190 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Bob',202,2.962,4304284252076747481,2112 )`)
	tk.MustExec(`insert into tbl_1 values ( 'David',155,32610.05,5899651588546531414,104 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Charlie',52,4219.7,6151233689319516187,1246 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Bob',55,3963.11,3614977408465893392,1188 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Alice',203,72.01,1553550133494908281,1658 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Bob',40,871.569,8114062926218465773,1397 )`)
	tk.MustExec(`insert into tbl_1 values ( 'Alice',165,7765,4481202107781982005,2089 )`)
	tk.MustExec(`insert into tbl_1 values ( 'David',79,7.02,993594504887208796,514 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Alice',7032411265967085555,'P7*KBZ159','Alice',7516989 )`)
	tk.MustExec(`insert into tbl_3 values ( 'David',486417871670147038,'','Charlie',-2135446 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Charlie',5784081664185069254,'7V_&YzKM~Q','Charlie',5583839 )`)
	tk.MustExec(`insert into tbl_3 values ( 'David',6346366522897598558,')Lp&$2)SC@','Bob',2522913 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Charlie',224922711063053272,'gY','David',6624398 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Alice',4678579167560495958,'fPIXY%R8WyY(=u&O','David',-3267160 )`)
	tk.MustExec(`insert into tbl_3 values ( 'David',8817108026311573677,'Cs0dZW*SPnKhV1','Alice',2359718 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Bob',3177426155683033662,'o2=@zv2qQDhKUs)4y','Bob',-8091802 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Bob',2543586640437235142,'hDa*CsOUzxmjf2m','Charlie',-8091935 )`)
	tk.MustExec(`insert into tbl_3 values ( 'Charlie',6204182067887668945,'DX-!=)dbGPQO','David',-1954600 )`)
	tk.MustExec(`insert into tbl_4 values ( 'David',167,576262750,'lX&x04W','2035-09-28' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Charlie',236,2637776757,'92OhsL!w%7','2036-02-08' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Bob',68,1077999933,'M0l','1997-09-16' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Charlie',184,1280264753,'FhjkfeXsK1Q(','2030-03-16' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Alice',10,2150711295,'Eqip)^tr*MoL','2032-07-02' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Bob',108,2421602476,'Eul~~Df_Q8s&I3Y-7','2019-06-10' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Alice',36,2811198561,'%XgRou0#iKtn*','2022-06-13' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Charlie',115,330972286,'hKeJS','2000-11-15' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Alice',6,2958326555,'c6+=1','2001-02-11' )`)
	tk.MustExec(`insert into tbl_4 values ( 'Alice',99,387404826,'figc(@9R*k3!QM_Vve','2036-02-17' )`)
	tk.MustExec(`update tbl_4 set tbl_4.col_20 = '2006-01-24' where tbl_4.col_18 in ( select col_11 from tbl_3 where IsNull( tbl_4.col_16 ) or not( tbl_4.col_19 in ( select col_3 from tbl_1 where tbl_4.col_16 between 'Alice' and 'David' and tbl_4.col_19 <= '%XgRou0#iKtn*' ) ) ) `)
}
