...
var (
	...
	ErrBRIERequireTiKV          = dbterror.ClassExecutor.NewStd(mysql.ErrBRIERequireTiKV)
	ErrBRIEInvalidExternalStore = dbterror.ClassExecutor.NewStd(mysql.ErrBRIEInvalidExternalStore)
	ErrBRIEInvalidTable         = dbterror.ClassExecutor.NewStd(mysql.ErrBRIEInvalidTable)
	ErrBRIEInvalidOption        = dbterror.ClassExecutor.NewStd(mysql.ErrBRIEInvalidOption)
)
