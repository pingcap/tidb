...
func (s *testStaleTxnSuite) TestStalenessAndHistoryRead(c *C) {
	...
	time1 := time.Now()
	time1_ts := oracle.GoTimeToTS(time1)
	...
	time2 := time.Now()
	time2_ts := oracle.GoTimeToTS(time2)
	...
	c.Assert(tk.Se.GetSessionVars().SnapshotTS, Equals, time1_ts)
	...
	c.Assert(tk.Se.GetSessionVars().SnapshotInfoschema, NotNil)
	c.Assert(tk.Se.GetSessionVars().TxnReadTS.PeakTxnReadTS(), Equals, time2_ts)
	...
	c.Assert(tk.Se.GetSessionVars().TxnReadTS.PeakTxnReadTS(), Equals, time1_ts)
	c.Assert(tk.Se.GetSessionVars().SnapshotInfoschema, NotNil)
	c.Assert(tk.Se.GetInfoSchema().SchemaMetaVersion(), Equals, schemaVer1)
	tk.MustExec(fmt.Sprintf(`set @@tidb_snapshot="%s"`, time2.Format("2006-1-2 15:04:05.000")))
	c.Assert(tk.Se.GetSessionVars().TxnReadTS.PeakTxnReadTS(), Equals, uint64(0))
	c.Assert(tk.Se.GetSessionVars().SnapshotTS, Equals, time2_ts)
	c.Assert(tk.Se.GetSessionVars().SnapshotInfoschema, NotNil)
	c.Assert(tk.Se.GetInfoSchema().SchemaMetaVersion(), Equals, schemaVer2)
	...
	c.Assert(tk.Se.GetSessionVars().SnapshotTS, Equals, uint64(0))
	c.Assert(tk.Se.GetSessionVars().TxnCtx.StartTS, Equals, time2_ts)
