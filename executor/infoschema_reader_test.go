...
func (s *testInfoschemaTableSuite) TestKeyColumnUsage(c *C) {
	...
	keyColumnTester.MustQuery("select * from information_schema.KEY_COLUMN_USAGE where TABLE_NAME != 'cluster_slow_query' and 'slow_query ';").Check([][]interface{}{})
...
func (s *testInfoschemaTableSuite) TestUserPrivileges(c *C) {
	...
	constraintsTester.MustQuery("select * from information_schema.TABLE_CONSTRAINTS WHERE TABLE_NAME != 'cluster_slow_query' AND 'show_query';").Check([][]interface{}{})
	...
	tk1.MustQuery("select * from information_schema.STATISTICS WHERE TABLE_NAME != 'cluster_slow_query' AND 'show_query';").Check([][]interface{}{})
