...
func (s *testInfoschemaTableSuite) TestTablesComment(c *C) {
	tk := testkit.NewTestKitWithInit(c, s.store)
	tk.MustExec("create table test_tables_comment (c1 VARCHAR(10) NOT NULL COMMENT 'c1 comment', c2 INTEGER,c3 INTEGER COMMENT '', c4 INTEGER, c5 INTEGER, c6 INTEGER, c7 INTEGER, INDEX i1 (c1) COMMENT 'i1 comment',INDEX i2(c2)  ) COMMENT='';")
	tk.MustQuery("SELECT char_length(table_comment) FROM information_schema.tables WHERE table_name='test_tables_comment';").Check(testkit.Rows(strconv.Itoa(infoschema.MaxTableCommentLengt)))
}
