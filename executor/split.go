...
func (e *SplitIndexRegionExec) splitIndexRegion(ctx context.Context) error {
	...
	defer cancel()
	regionIDs, err := s.SplitAndScatterRegions(ctxWithTimeout, e.splitIdxKeys, &e.tableInfo.ID)
	if err != nil {
...
func (e *SplitTableRegionExec) splitTableRegion(ctx context.Context) error {
	...
	regionIDs, err := s.SplitAndScatterRegions(ctxWithTimeout, e.splitKeys, &e.tableInfo.ID)
	if err != nil {
