...
func TestFastAnalyze4GlobalStats(t *testing.T) {
	...
	require.Regexp(t, ".*Fast analyze hasn't reached General Availability and only support analyze version 1 currently.*", err.Error())
}
...
func TestFailedAnalyzeRequest(t *testing.T) {
	...
	require.EqualError(t, err, "mock buildStatsFromResult error")
