...
func (s *testSuite5) TestShowCreateTable(c *C) {
	...
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
	tk.MustExec("create table t(a int,b int,c int) STATS_BUCKETS=1,STATS_SAMPLE_RATE=0.2,STATS_COL_CHOICE='list',STATS_COL_LIST='a,b'")
	tk.MustQuery("show create table t").Check(testutil.RowsWithSep("|",
		"t CREATE TABLE `t` (\n"+
			"  `a` int(11) DEFAULT NULL,\n"+
			"  `b` int(11) DEFAULT NULL,\n"+
			"  `c` int(11) DEFAULT NULL\n"+
			") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin /*T! STATS_BUCKETS=1,STATS_TOPN=default,STATS_SAMPLE_RATE=0.2,STATS_COL_CHOICE='list',STATS_COL_LIST='a,b' */"))
