...
func (s *testSuite) TestShowCreateTable(c *C) {
	...
	tk.MustQuery("show warnings").Check(testutil.RowsWithSep("|", "Warning|1105|The user specified charset of table 'test.t3' is utf8, currently TiDB treat all the data as utf8mb4 actually."))
