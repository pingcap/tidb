...
func (s *testSuite) TestShowCreateTable(c *C) {
	...
	tk.MustExec("create table t2 (a varchar(10)) charset=utf8;")
	tk.MustExec("create table t3 (a varchar(10)) charset=utf8mb4;")
	tk.MustExec("show create table t1;")
	...
	tk.MustQuery("show warnings").Check(testutil.RowsWithSep("|", "Warning|1105|The user specified charset of table 't2' is utf8, currently TiDB treat all the data as utf8mb4 actually."))
