...
func init() {
	...
	planner.EvalSubquery = func(p planner.PhysicalPlan, is infoschema.InfoSchema, sctx sessionctx.Context) (rows [][]types.Datum, err error) {
...
// Close implements planner.Plan Close interface.
