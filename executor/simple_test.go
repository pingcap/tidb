...
func TestSetRoleAllCorner(t *testing.T) {
	...
	func
	TestSetDefaultRoleAll(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
	...
	func
	TestFlushPrivileges(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
	...
	func
	TestFlushPrivilegesPanic(t * testing.T)
	{
	...
	func
	TestDropPartitionStats(t * testing.T)
	{
...
partition by range (a) (
	...
	func
	TestDropStatsFromKV(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
	...
	func
	TestStmtAutoNewTxn(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
	...
	func
	TestExtendedStatsPrivileges(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
	...
	func
	TestSetCurrentUserPwd(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
	...
	func
	TestShowGrantsAfterDropRole(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
	...
	func
	TestDropRoleAfterRevoke(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		// issue 29781
	...
	func
	TestUserWithSetNames(t * testing.T)
	{
		store, clean := testkit.CreateMockStore(t)
		defer clean()
		tk := testkit.NewTestKit(t, store)
