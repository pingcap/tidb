...
func (st *slowQueryTuple) convertToDatumRow() []types.Datum {
	...
	record = append(record, types.NewDefaultCollationStringDatum(st.user))
	record = append(record, types.NewDefaultCollationStringDatum(st.host))
	...
	record = append(record, types.NewDefaultCollationStringDatum(st.backoffTypes))
	...
	record = append(record, types.NewDefaultCollationStringDatum(st.db))
	record = append(record, types.NewDefaultCollationStringDatum(st.indexIDs))
	record = append(record, types.NewDatum(st.isInternal))
	record = append(record, types.NewDefaultCollationStringDatum(st.digest))
	record = append(record, types.NewDefaultCollationStringDatum(st.statsInfo))
	...
	record = append(record, types.NewDefaultCollationStringDatum(st.maxProcessAddress))
	...
	record = append(record, types.NewDefaultCollationStringDatum(st.maxWaitAddress))
	...
	record = append(record, types.NewDefaultCollationStringDatum(parsePlan(st.plan)))
	record = append(record, types.NewDefaultCollationStringDatum(st.planDigest))
	record = append(record, types.NewDefaultCollationStringDatum(st.prevStmt))
	record = append(record, types.NewDefaultCollationStringDatum(st.sql))
	return record
}
