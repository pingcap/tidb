...
func (e *hashJoinRuntimeStats) String() string {
	...
	if e.fetchAndBuildHashTable > 0 {
		...
		buf.WriteString(execdetails.FormatDurationForExplain(e.fetchAndBuildHashTable))
		buf.WriteString(", fetch:")
		buf.WriteString(execdetails.FormatDurationForExplain((e.fetchAndBuildHashTable - e.hashStat.buildTableElapse)))
		buf.WriteString(", build:")
		buf.WriteString(execdetails.FormatDurationForExplain(e.hashStat.buildTableElapse))
		buf.WriteString("}")
	}
	if e.probe > 0 {
		...
		buf.WriteString(execdetails.FormatDurationForExplain(time.Duration(e.fetchAndProbe)))
		buf.WriteString(", max:")
		buf.WriteString(execdetails.FormatDurationForExplain(time.Duration(atomic.LoadInt64(&e.maxFetchAndProbe))))
		buf.WriteString(", probe:")
		buf.WriteString(execdetails.FormatDurationForExplain(time.Duration(e.probe)))
		buf.WriteString(", fetch:")
		buf.WriteString(execdetails.FormatDurationForExplain(time.Duration(e.fetchAndProbe - e.probe)))
