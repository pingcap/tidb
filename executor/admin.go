...
func (e *CheckIndexRangeExec) Next(ctx context.Context, req *execution.ExecRequest) error {
	req.RetChunk.Reset()
...
// Next implements the Executor Next interface.
func (e *RecoverIndexExec) Next(ctx context.Context, req *execution.ExecRequest) error {
	req.RetChunk.Reset()
	if e.done {
		return nil
	}
	...
	req.RetChunk.AppendInt64(0, totalAddedCnt)
	req.RetChunk.AppendInt64(1, totalScanCnt)
	e.done = true
	return nil
}
...
// Next implements the Executor Next interface.
func (e *CleanupIndexExec) Next(ctx context.Context, req *execution.ExecRequest) error {
	req.RetChunk.Reset()
	if e.done {
		return nil
	}
	...
	e.done = true
	req.RetChunk.AppendUint64(0, e.removeCnt)
	return nil
}
