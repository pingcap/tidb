...
var (
	...
	// FairLockingSkipRetryCount counts the events that when executing a statement, lock-with-conflict has occurred,
	// and the statement retry is skipped.
	FairLockingSkipRetryCount prometheus.Counter
...
func InitMetricsVars() {
	...
	FairLockingSkipRetryCount = metrics.FairLockingUsageCount.WithLabelValues(metrics.LblFairLockingSkipRetry)
