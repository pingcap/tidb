...
func (s *testSuite3) TestColumnCharsetAndCollate(c *C) {
	...
	tests := []struct {
		...
		},
		{
			colType:     "varchar(10)",
			charset:     "CHARSET utf8mb4",
			collates:    "COLLATE UTF8MB4_GENERAL_CI",
			exptCharset: "utf8mb4",
			exptCollate: "utf8mb4_general_ci",
			errMsg:      "",
		},
		{
			colType:     "varchar(10)",
			charset:     "CHARSET utf8mb4",
			collates:    "COLLATE UTF8MB4_GENERAL_CI COLLATE utf8mb4_unicode_ci",
			exptCharset: "utf8mb4",
			exptCollate: "utf8mb4_unicode_ci",
			errMsg:      "",
		},
		{
			colType:     "varchar(10)",
			charset:     "",
			collates:    "COLLATE utf8_bin COLLATE utf8_unicode_ci",
			exptCharset: "utf8",
			exptCollate: "utf8_unicode_ci",
			errMsg:      "",
		},
		{
			colType:     "varchar(10)",
			charset:     "",
			collates:    "COLLATE utf8_bin COLLATE utf8mb4_unicode_ci",
			exptCharset: "utf8mb4",
			exptCollate: "utf8mb4_unicode_ci",
			errMsg:      "[ddl:1253]COLLATION 'utf8mb4_unicode_ci' is not valid for CHARACTER SET 'utf8'",
		},
	}
