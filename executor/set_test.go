...
func (s *testSerialSuite1) TestSetVar(c *C) {
	...
	tk.MustExec("set global tidb_tso_client_batch_max_wait_time = 1.1")
	tk.MustQuery("select @@tidb_tso_client_batch_max_wait_time").Check(testkit.Rows("1.1"))
	tk.MustExec("set global tidb_tso_client_batch_max_wait_time = 1.01")
	tk.MustQuery("select @@tidb_tso_client_batch_max_wait_time").Check(testkit.Rows("1.01"))
