...
func TestSetVar(t *testing.T) {
	...
	// test for tidb_opt_3stage_distinct_agg
	tk.MustQuery("select @@session.tidb_opt_3stage_distinct_agg").Check(testkit.Rows("1")) // default value is 1
	tk.MustExec("set session tidb_opt_3stage_distinct_agg=0")
	tk.MustQuery("select @@session.tidb_opt_3stage_distinct_agg").Check(testkit.Rows("0"))
	tk.MustQuery("select @@global.tidb_opt_3stage_distinct_agg").Check(testkit.Rows("1")) // default value is 1
	tk.MustExec("set global tidb_opt_3stage_distinct_agg=0")
	tk.MustQuery("select @@global.tidb_opt_3stage_distinct_agg").Check(testkit.Rows("0"))
