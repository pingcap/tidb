...
func (s *testSuiteJoin1) TestHashJoin(c *C) {
	...
	//   0                       1        2 3         4        5                                                                    6                                           7         8
	// 0 HashLeftJoin_9          7992.00  0 root               time:959.436µs, loops:1, Concurrency:5, probe collision:0, build:0s  semi join, equal:[eq(test.t1.a, test.t2.a)] 0 Bytes   0 Bytes
