...
func (s *testSuite2) TestIssue11390(c *C) {
	...
	tk.MustExec("insert into issue11390 values(null, 1)")
	tk.MustQuery("select /*+ TIDB_INLJ(t1, t2) */ * from issue11390 t1, issue11390 t2 where t1.k1 is null and t1.k2=t2.k2 and t2.k1 is null").Check(testkit.Rows("<nil> 1 <nil> 1"))
}
