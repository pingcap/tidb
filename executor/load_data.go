...
func (e *LoadDataWorker) mergeAndSetMessage() string {
	...
	numAffected := encodeStmtCtx.AffectedRows()
	numRecords := encodeStmtCtx.RecordRows()
	numDeletes := encodeStmtCtx.DeletedRows()
	numSkipped := numRecords - encodeStmtCtx.CopiedRows()
