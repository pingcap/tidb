...
func TestIndexMergeCarePreferTiflash(t *testing.T) {
	...
	tk.MustQuery("explain format=\"brief\" SELECT" +
		...
		testkit.Rows("TableReader 0.00 root  MppVersion: 1, data:ExchangeSender",
...
>>>>>>> b2a9059b5e1 (planner: Limit fine grained shuffle usage for mpp join operators to ensure shuffle keys are the same with actual join keys (#59884)):pkg/executor/test/tiflashtest/tiflash_test.go
