...
func (b *executorBuilder) build(p plannercore.Plan) Executor {
	...
	case *plannercore.ReloadDisabledOptimizeList:
		return b.buildReloadDisabledOptimizeList(v)
...
func (b *executorBuilder) buildReloadDisabledOptimizeList(v *plannercore.ReloadDisabledOptimizeList) Executor {
	return &ReloadDisabledOptimizeListExec{baseExecutor{ctx: b.ctx}}
}
