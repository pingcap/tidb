...
func (e *WindowExec) consumeGroupRows(chk *chunk.Chunk) error {
	...
	e.copyChk(chk)
	var err error
	e.groupRows, err = e.wf.ProcessOneChunk(e.ctx, e.groupRows, chk)
	return err
}
...
func (e *WindowExec) appendResult2Chunk(chk *chunk.Chunk) error {
	e.copyChk(chk)
	var err error
	e.groupRows, err = e.wf.ExhaustResult(e.ctx, e.groupRows, chk)
	return err
}
