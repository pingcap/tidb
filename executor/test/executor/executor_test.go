...
func TestTableScan(t *testing.T) {
	...
	rowStr1 := fmt.Sprintf("%s %s %s %s %v %v", "def", "mysql", "utf8mb4", "utf8mb4_0900_ai_ci", nil, nil)
	rowStr2 := fmt.Sprintf("%s %s %s %s %v %v", "def", "mytest", "utf8mb4", "utf8mb4_0900_ai_ci", nil, nil)
	tk.MustExec("use information_schema")
