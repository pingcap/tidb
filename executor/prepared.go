...
func (e *PrepareExec) Next(goCtx context.Context) (Row, error) {
	return nil, errors.Trace(e.DoPrepare())
}

// NextChunk implements the Executor NextChunk interface.
func (e *PrepareExec) NextChunk(goCtx context.Context, chk *chunk.Chunk) error {
...
func (e *ExecuteExec) Next(goCtx context.Context) (Row, error) {
	return nil, nil
}

// NextChunk implements the Executor NextChunk interface.
func (e *ExecuteExec) NextChunk(goCtx context.Context, chk *chunk.Chunk) error {
	return nil
}
...
// Next implements the Executor Next interface.
func (e *DeallocateExec) Next(goCtx context.Context) (Row, error) {
	return nil, errors.Trace(e.run(goCtx))
}

// NextChunk implements the Executor NextChunk interface.
func (e *DeallocateExec) NextChunk(goCtx context.Context, chk *chunk.Chunk) error {
	return errors.Trace(e.run(goCtx))
}

func (e *DeallocateExec) run(goCtx context.Context) error {
	vars := e.ctx.GetSessionVars()
