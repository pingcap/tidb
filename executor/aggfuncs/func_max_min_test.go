...
func (s *testSuite) TestMemMaxMin(c *C) {
	tests := []aggMemTest{
		...
		buildAggMemTester(ast.AggFuncMax, mysql.TypeString, 5,
			aggfuncs.DefPartialResult4MaxMinStringSize, noZeroUpdateMemDeltaGens, false),
		buildAggMemTester(ast.AggFuncMax, mysql.TypeJSON, 5,
			aggfuncs.DefPartialResult4MaxMinJSONSize, noZeroUpdateMemDeltaGens, false),
		buildAggMemTester(ast.AggFuncMax, mysql.TypeEnum, 5,
			aggfuncs.DefPartialResult4MaxMinEnumSize, noZeroUpdateMemDeltaGens, false),
		buildAggMemTester(ast.AggFuncMax, mysql.TypeSet, 5,
			aggfuncs.DefPartialResult4MaxMinSetSize, noZeroUpdateMemDeltaGens, false),
