...
func (s *testSuite) TestMemCount(c *C) {
	tests := []aggMemTest{
		...
		buildAggMemTester(ast.AggFuncCount, mysql.TypeDuration, 5,
			aggfuncs.DefPartialResult4CountSize, defaultUpdateMemDeltaGens, false),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeLonglong, 5,
			aggfuncs.DefPartialResult4CountDistinctIntSize+aggfuncs.DefInt64SetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeFloat, 5,
			aggfuncs.DefPartialResult4CountDistinctRealSize+aggfuncs.DefFloat64SetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeDouble, 5,
			aggfuncs.DefPartialResult4CountDistinctRealSize+aggfuncs.DefFloat64SetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeNewDecimal, 5,
			aggfuncs.DefPartialResult4CountDistinctDecimalSize+aggfuncs.DefStringSetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeString, 5,
			aggfuncs.DefPartialResult4CountDistinctStringSize+aggfuncs.DefStringSetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeDate, 5,
			aggfuncs.DefPartialResult4CountWithDistinctSize+aggfuncs.DefStringSetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
		buildAggMemTester(ast.AggFuncCount, mysql.TypeDuration, 5,
			aggfuncs.DefPartialResult4CountDistinctDurationSize+aggfuncs.DefInt64SetBucketMemoryUsage, distinctUpdateMemDeltaGens, true),
