			...
			if row == nil {
				...
				e.ctx.GetSessionVars().StmtCtx.MergeExecDetails(
					&execdetails.ExecDetails{
						...
						IndexResultChan:      atomic.LoadInt64(&r.IndexResultChan),
						FetcherNext:          atomic.LoadInt64(&r.FetcherNext),
						FetcherRetCh:         atomic.LoadInt64(&r.FetcherRetCh),
						CopBuildRange:        atomic.LoadInt64(&r.CopBuildRange),
						CopDispatchWaitToken: atomic.LoadInt64(&r.CopDispatchWaitToken),
						CopDispatchChan:      atomic.LoadInt64(&r.CopDispatchChan),
						CopSendIndex:         atomic.LoadInt64(&r.CopSendIndex),
						CopHandleOne:         atomic.LoadInt64(&r.CopHandleOne),
						CopRegionError:       atomic.LoadInt64(&r.CopRegionError),
						CopLockError:         atomic.LoadInt64(&r.CopLockError),
						CopRetCh:             atomic.LoadInt64(&r.CopRetCh),
					},
					nil,
				)
				break
