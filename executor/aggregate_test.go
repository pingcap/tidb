...
func (s *testSuite) TestOnlyFullGroupBy(c *C) {
	...
	c.Assert(terror.ErrorEqual(err, core.ErrFieldNotInGroupBy), IsTrue, Commentf("err %v", err))
	...
	c.Assert(terror.ErrorEqual(err, core.ErrAmbiguous), IsTrue, Commentf("err %v", err))
}
