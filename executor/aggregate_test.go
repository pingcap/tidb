...
func (s *testSuite) TestAggregation(c *C) {
	...
	tk.MustExec("insert t values (NULL, 1),(1, 1),(1, 2),(1, 3),(1, 1),(3, 2),(4, 3)")
	...
	result = tk.MustQuery("select sum(b.c), count(b.d), max(a.c) from t a left join t b on a.c = b.d group by b.d order by b.d")
...
func (s *testSuite) TestGroupConcatAggr(c *C) {
	...
	tk.MustExec("insert into test values(1, 10),(1, 20),(1, 30),(2, 20),(3, 200),(3, 500);")
