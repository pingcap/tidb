...
func (s *testSuite) TestOnlyFullGroupBy(c *C) {
	...
	c.Assert(terror.ErrorEqual(err, planner.ErrFieldNotInGroupBy), IsTrue, Commentf("err %v", err))
	...
	c.Assert(terror.ErrorEqual(err, planner.ErrMixOfGroupFuncAndFields), IsTrue, Commentf("err %v", err))
	...
	//c.Assert(terror.ErrorEqual(err, planner.ErrFieldNotInGroupBy), IsTrue)
	...
	c.Assert(terror.ErrorEqual(err, planner.ErrAmbiguous), IsTrue, Commentf("err %v", err))
}
