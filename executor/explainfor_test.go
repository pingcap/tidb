...
func TestExplainFor(t *testing.T) {
	...
	check := func() {
		...
		require.Regexp(t, "TableReader_5 10000.00 0 root  time:.*, loops:1,( RRU:0.000000, WRU:0.000000,)? cop_task: {num:.*, max:.*, proc_keys:.* rpc_num: 1, rpc_time:.*} data:TableFullScan_4 N/A N/A\n"+
