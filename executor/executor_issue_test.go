...
<<<<<<< HEAD:executor/executor_issue_test.go
=======
...
>>>>>>> bd7fb08838 (distsql: fix a bug of ranger.Range to kv.KeyRange conversion (#40204)):executor/issuetest/executor_issue_test.go
