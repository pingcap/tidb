...
// SetHandleRanges sets "KeyRanges" for "kv.Request" by converting common handle range
// "ranges" to "KeyRanges" firstly.
...
// SetHandleRangesForTables sets "KeyRanges" for "kv.Request" by converting common handle range
