...
func (e *testSuite) TestTableRangesToKVRanges(c *C) {
...
func (e *testSuite) TestIndexRangesToKVRanges(c *C) {
	ranges := []*ranger.NewRange{
		&ranger.NewRange{
			LowVal:  []types.Datum{types.NewIntDatum(1)},
			HighVal: []types.Datum{types.NewIntDatum(2)},
...
func (e *testSuite) TestRequestBuilder1(c *C) {
	ranges := []*ranger.NewRange{
		&ranger.NewRange{
			LowVal:  []types.Datum{types.NewIntDatum(1)},
			HighVal: []types.Datum{types.NewIntDatum(2)},
...
func (e *testSuite) TestRequestBuilder2(c *C) {
	ranges := []*ranger.NewRange{
		&ranger.NewRange{
			LowVal:  []types.Datum{types.NewIntDatum(1)},
			HighVal: []types.Datum{types.NewIntDatum(2)},
...
func (e *testSuite) TestRequestBuilder3(c *C) {
	handles := []int64{0, 2, 3, 4, 5, 10, 11, 100}
...
func (e *testSuite) TestRequestBuilder4(c *C) {
	keyRanges := []kv.KeyRange{
		kv.KeyRange{
			StartKey: kv.Key{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x5f, 0x72, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
			EndKey:   kv.Key{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x5f, 0x72, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1},
...
func (e *testSuite) TestRequestBuilder5(c *C) {
	keyRanges := []kv.KeyRange{
		kv.KeyRange{
			StartKey: kv.Key{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x5f, 0x72, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
			EndKey:   kv.Key{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x5f, 0x72, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1},
