...
func (s *testSuite) TestUpdateCopRuntimeStats(c *C) {
	...
	sr.updateCopRuntimeStats(&tikv.CopRuntimeStats{ExecDetails: execdetails.ExecDetails{CalleeAddress: "a"}}, 0)
	...
	sr.updateCopRuntimeStats(&tikv.CopRuntimeStats{ExecDetails: execdetails.ExecDetails{CalleeAddress: "callee"}}, 0)
