...
ifeq ("$(TRAVIS_COVERAGE)", "1")
	...
	$(OVERALLS) -project=github.com/pingcap/tidb -covermode=count -ignore='.git,vendor,cmd,docs,LICENSES,ddl/failtest,ddl/testutil/,executor/seqtest' \
			-concurrency=4 || { $(GOFAIL_DISABLE); exit 1; }
else
