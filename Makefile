...
bazel_coverage_test: failpoint-enable bazel_ci_simple_prepare
	bazel $(BAZEL_GLOBAL_CONFIG) --nohome_rc coverage $(BAZEL_CMD_CONFIG) --nocache_test_results --jobs=35 --instrumentation_filter=/pkg,/br,/dumpling --build_tests_only --test_keep_going=false \
