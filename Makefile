...
mock_import: mockgen
	...
	tools/bin/mockgen -package mock github.com/pingcap/tidb/pkg/dxf/framework/scheduler Scheduler,Cleaner,ExpiredFileCleaner,TaskManager > pkg/dxf/framework/mock/scheduler_mock.go
