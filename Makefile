...
mock_import: mockgen
	...
	tools/bin/mockgen -package mock github.com/pingcap/tidb/pkg/lightning/importinto CheckpointManager,JobSubmitter,JobMonitor,JobOrchestrator > pkg/lightning/importinto/mock/mock.go
