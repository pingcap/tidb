...
func TestNewCollationStatsWithPrefixIndex(t *testing.T) {
	...
	tk.MustQuery("show stats_buckets where db_name = 'test' and table_name = 't'").Sort().Check(testkit.Rows(
		"test t  a 0 0 3 1 A AAA 0",
		"test t  a 0 1 6 1 AAAAABBBBBBB AB 0",
		"test t  a 0 2 9 1 B BB 0",
		"test t  a 0 3 12 1 BBB BBBBBBBBBBBBBBRRRR 0",
		"test t  a 0 4 14 1 BBBBBBBBBBBBR BBBBBDDDDDDD 0",
		"test t  ia 1 0 3 1 A AAA 0",
		"test t  ia 1 1 6 1 AAAAABBBBBBB AB 0",
		"test t  ia 1 2 9 1 B BB 0",
		"test t  ia 1 3 12 1 BBB BBBBBBBBBBBBBBRRRR 0",
		"test t  ia 1 4 14 1 BBBBBBBBBBBBR BBBBBDDDDDDD 0",
		"test t  ia10 1 0 3 1 A AAA 0",
		"test t  ia10 1 1 6 1 AB BA 0",
		"test t  ia10 1 2 9 1 BB BBBB 0",
		"test t  ia10 1 3 10 1 BBBBBDDDDD BBBBBDDDDD 0",
	))
	tk.MustQuery("show stats_topn where db_name = 'test' and table_name = 't'").Sort().Check(testkit.Rows(
		"test t  a 0 AAAAAAAAAAABBC 2",
		"test t  ia 1 AAAAAAAAAAABBC 2",
		"test t  ia10 1 AAAAAAAAAA 2",
		"test t  ia10 1 AAAAABBBBB 2",
		"test t  ia10 1 BBBBBBBBBB 2",
		"test t  ia3 1 A 1",
		"test t  ia3 1 AA 1",
		"test t  ia3 1 AAA 5",
		"test t  ia3 1 AB 1",
