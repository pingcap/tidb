...
function main() { 
    ...
    #BR
    download "$br_download_url" "br-linux-amd64.tar.gz" "tmp/br-linux-amd64.tar.gz"
    tar -xzf tmp/br-linux-amd64.tar.gz -C third_bin
    mv third_bin/br-linux-amd64/bin/* third_bin/
