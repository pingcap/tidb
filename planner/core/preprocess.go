...
func (p *preprocessor) checkBindGrammar(createBindingStmt *ast.CreateBindingStmt) {
	...
	if originSQL != hintedSQL {
		p.err = errors.Errorf("hinted sql and origin sql don't match when hinted sql erase the hint info, after erase hint info, originSQL:", originSQL, ", hintedSQL:", hintedSQL)
	}
}
