...
type LogicalPlan interface {
	...
	// recursiveGetConstantPredicates recursive get constant predicate, used for the constant propagation rule
	recursiveGetConstantPredicates() []expression.Expression
