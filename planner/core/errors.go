...
var (
	...
	ErrCantUpdateTableInCreateTableSelect = terror.ClassOptimizer.New(codeCantUpdateTableInCreateTableSelect, mysql.MySQLErrName[mysql.ErrCantUpdateTableInCreateTableSelect])
)
