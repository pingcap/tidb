...
var (
	...
	ErrCantUpdateTableInCreateTableSelect = terror.ClassOptimizer.New(mysql.ErrCantUpdateTableInCreateTableSelect, mysql.MySQLErrName[mysql.ErrCantUpdateTableInCreateTableSelect])
...
func init() {
	mysqlErrCodeMap := map[terror.ErrCode]uint16{
		...
		mysql.ErrCantUpdateTableInCreateTableSelect:  mysql.ErrCantUpdateTableInCreateTableSelect,
	}
