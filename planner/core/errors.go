...
var (
	...
	ErrViewRecursive                   = terror.ClassOptimizer.NewStd(mysql.ErrViewRecursive)
	...
	ErrMultiUpdateKeyConflict          = terror.ClassOptimizer.NewStd(mysql.ErrMultiUpdateKeyConflict)
	...
	ErrWarnConflictingHint             = terror.ClassOptimizer.NewStd(mysql.ErrWarnConflictingHint)
