...
var defaultVer2Factors = costVer2Factors{
	...
	TiKVScan:      costVer2Factor{"tikv_scan_factor", 40.7},
	TiKVDescScan:  costVer2Factor{"tikv_desc_scan_factor", 61.1},
	TiFlashScan:   costVer2Factor{"tiflash_scan_factor", 11.6},
	TiDBCPU:       costVer2Factor{"tidb_cpu_factor", 49.9},
	TiKVCPU:       costVer2Factor{"tikv_cpu_factor", 49.9},
	TiFlashCPU:    costVer2Factor{"tiflash_cpu_factor", 2.4},
	TiDB2KVNet:    costVer2Factor{"tidb_kv_net_factor", 3.96},
	TiDB2FlashNet: costVer2Factor{"tidb_flash_net_factor", 2.2},
	TiFlashMPPNet: costVer2Factor{"tiflash_mpp_net_factor", 1.0},
	TiDBMem:       costVer2Factor{"tidb_mem_factor", 0.2},
	TiKVMem:       costVer2Factor{"tikv_mem_factor", 0.2},
	TiFlashMem:    costVer2Factor{"tiflash_mem_factor", 0.1},
	TiDBDisk:      costVer2Factor{"tidb_disk_factor", 200},
	TiDBRequest:   costVer2Factor{"tidb_request_factor", 6000000},
}
