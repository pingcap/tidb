...
func TestPointGetWithSelectLock(t *testing.T) {
	...
	tk.MustGetErrMsg("explain select a, b from t where (a = 1 and b = 2) or (a =2 and b = 1) for update;", "[planner:1815]Internal : Can't find a proper physical plan for this query")
	...
	tk.MustGetErrMsg("explain select a,b from t where a = 1 and (b = 1 or b = 2) for update;", "[planner:1815]Internal : Can't find a proper physical plan for this query")
	...
	tk.MustQuery("explain select a, b from t where  a = 1 and b = 2 for update;")
	tk.MustQuery("explain select a, b from t where (a = 1 and b = 2) or (a =2 and b = 1) for update;")
}
