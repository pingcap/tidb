...
func (s *testIntegrationSerialSuite) TestIssue26358(c *C) {
	...
	tk.MustQuery("select d_bit, d_smallint, if(d_bit, d_bit, d_smallint), if(d_bit, d_smallint, d_bit) from all_types;").Check(testkit.Rows("0x000C 1 0x000C 0x31"))
	tk.MustQuery("select d_bit, d_tinyint, if(d_bit, d_bit, d_tinyint), if(d_bit, d_tinyint, d_bit) from all_types;").Check(testkit.Rows("0x000C 1 0x000C 0x30"))
	tk.MustQuery("select d_bit, d_int, if(d_bit, d_bit, d_int), if(d_bit, d_int, d_bit) from all_types;").Check(testkit.Rows("0x000C 2 0x000C 0x32"))
	tk.MustQuery("select d_bit, d_bigint, if(d_bit, d_bit, d_bigint), if(d_bit, d_bigint, d_bit) from all_types;").Check(testkit.Rows("0x000C 3 0x000C 0x33"))
	tk.MustQuery("select d_bit, d_float, if(d_bit, d_bit, d_float), if(d_bit, d_float, d_bit) from all_types;").Check(testkit.Rows("0x000C 1.5 0x000C 0x312E35"))
	tk.MustQuery("select d_bit, d_double, if(d_bit, d_bit, d_double), if(d_bit, d_double, d_bit) from all_types;").Check(testkit.Rows("0x000C 2.2 0x000C 0x322E32"))
	tk.MustQuery("select d_bit, d_decimal, if(d_bit, d_bit, d_decimal), if(d_bit, d_decimal, d_bit) from all_types;").Check(testkit.Rows("0x000C 10.23 0x000C 0x31302E3233"))
