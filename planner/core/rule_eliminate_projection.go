...
<<<<<<< HEAD:planner/core/rule_eliminate_projection.go
...
>>>>>>> 724b7eda3a7 (pkg/planner, tests: set the AvoidColumnEvaluator correctly in ProjectionElimination (#55219)):pkg/planner/core/rule_eliminate_projection.go
	}
	return child
}
