...
func (s *testPointGetSuite) TestIssue23511(c *C) {
	...
	tk.MustQuery("select * from t1 where col1 = 0x39;").Check(testkit.Rows("9"))
	tk.MustQuery("select * from t2 where col1 = 0x39;").Check(testkit.Rows("9"))
	tk.MustQuery("select * from t1 where col1 = 0x00;").Check(testkit.Rows("\x00"))
	tk.MustQuery("select * from t1 where col1 = 0x0000;").Check(testkit.Rows("\x00"))
	...
	tk.MustQuery("select * from t1 where col1 = 0x0039;").Check(testkit.Rows("9"))
	tk.MustQuery("select * from t2 where col1 = 0x0039;").Check(testkit.Rows("9"))
