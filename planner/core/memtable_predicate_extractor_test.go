...
func TestPredicateQuery(t *testing.T) {
	...
	tk.MustQuery("show columns from t like 'ABC%'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,"))
	tk.MustQuery("show columns from t like '%ime'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,", "DATETIME_PRECISION int(11) YES  <nil> "))
	tk.MustQuery("show columns from t like '%IME'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,", "DATETIME_PRECISION int(11) YES  <nil> "))
	tk.MustQuery("show columns in t like '%ime'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,", "DATETIME_PRECISION int(11) YES  <nil> "))
	tk.MustQuery("show columns in t like '%IME'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,", "DATETIME_PRECISION int(11) YES  <nil> "))
	tk.MustQuery("show fields in t like '%ime'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,", "DATETIME_PRECISION int(11) YES  <nil> "))
	tk.MustQuery("show fields in t like '%IME'").Check(testkit.RowsWithSep(",", "abctime,int(11),YES,,<nil>,", "DATETIME_PRECISION int(11) YES  <nil> "))
