...
func (s *testPlanSuite) TestVisitInfo(c *C) {
	...
	tests := []struct {
		...
		},
		{
			...
			ans: []visitInfo{
				{mysql.SelectPriv, "", "", "", nil, false},
				{mysql.InsertPriv, "", "", "", nil, false},
				{mysql.UpdatePriv, "", "", "", nil, false},
				{mysql.DeletePriv, "", "", "", nil, false},
				{mysql.CreatePriv, "", "", "", nil, false},
				{mysql.DropPriv, "", "", "", nil, false},
				{mysql.ProcessPriv, "", "", "", nil, false},
				{mysql.ReferencesPriv, "", "", "", nil, false},
				{mysql.AlterPriv, "", "", "", nil, false},
				{mysql.ShowDBPriv, "", "", "", nil, false},
				{mysql.SuperPriv, "", "", "", nil, false},
				{mysql.ExecutePriv, "", "", "", nil, false},
				{mysql.IndexPriv, "", "", "", nil, false},
				{mysql.CreateUserPriv, "", "", "", nil, false},
				{mysql.TriggerPriv, "", "", "", nil, false},
				{mysql.CreateViewPriv, "", "", "", nil, false},
				{mysql.ShowViewPriv, "", "", "", nil, false},
				{mysql.CreateRolePriv, "", "", "", nil, false},
				{mysql.DropRolePriv, "", "", "", nil, false},
				{mysql.CreateTMPTablePriv, "", "", "", nil, false},
				{mysql.LockTablesPriv, "", "", "", nil, false},
				{mysql.CreateRoutinePriv, "", "", "", nil, false},
				{mysql.AlterRoutinePriv, "", "", "", nil, false},
				{mysql.EventPriv, "", "", "", nil, false},
				{mysql.ShutdownPriv, "", "", "", nil, false},
				{mysql.ReloadPriv, "", "", "", nil, false},
				{mysql.FilePriv, "", "", "", nil, false},
				{mysql.ConfigPriv, "", "", "", nil, false},
				{mysql.GrantPriv, "", "", "", nil, false},
			},
		},
		{
