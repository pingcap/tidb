...
func (s *testPlanSuite) TestVisitInfo(c *C) {
	...
	tests := []struct {
		...
		},
		{
			...
			ans: []visitInfo{
				{mysql.SelectPriv, "", "", "", nil},
				{mysql.InsertPriv, "", "", "", nil},
				{mysql.UpdatePriv, "", "", "", nil},
				{mysql.DeletePriv, "", "", "", nil},
				{mysql.CreatePriv, "", "", "", nil},
				{mysql.DropPriv, "", "", "", nil},
				{mysql.ProcessPriv, "", "", "", nil},
				{mysql.ReferencesPriv, "", "", "", nil},
				{mysql.AlterPriv, "", "", "", nil},
				{mysql.ShowDBPriv, "", "", "", nil},
				{mysql.SuperPriv, "", "", "", nil},
				{mysql.ExecutePriv, "", "", "", nil},
				{mysql.IndexPriv, "", "", "", nil},
				{mysql.CreateUserPriv, "", "", "", nil},
				{mysql.TriggerPriv, "", "", "", nil},
				{mysql.CreateViewPriv, "", "", "", nil},
				{mysql.ShowViewPriv, "", "", "", nil},
				{mysql.CreateRolePriv, "", "", "", nil},
				{mysql.DropRolePriv, "", "", "", nil},
				{mysql.CreateTMPTablePriv, "", "", "", nil},
				{mysql.LockTablesPriv, "", "", "", nil},
				{mysql.CreateRoutinePriv, "", "", "", nil},
				{mysql.AlterRoutinePriv, "", "", "", nil},
				{mysql.EventPriv, "", "", "", nil},
				{mysql.ShutdownPriv, "", "", "", nil},
				{mysql.ReloadPriv, "", "", "", nil},
				{mysql.FilePriv, "", "", "", nil},
				{mysql.ConfigPriv, "", "", "", nil},
				{mysql.GrantPriv, "", "", "", nil},
			},
		},
		{
