...
func (s *testPlanSuite) TestEliminateMaxOneRow(c *C) {
	...
	tk.MustExec("create table t1(a int(11) DEFAULT NULL, UNIQUE KEY idx_a (a))")
...
func (s *testPlanSuite) TestNotEliminateMaxOneRow(c *C) {
	var (
		input  []string
		output []struct {
			SQL    string
	...
	tk.MustExec("drop table if exists t1;")
	tk.MustExec("drop table if exists t2;")
	tk.MustExec("create table t1(a int(11) DEFAULT NULL, b int(11) DEFAULT NULL, UNIQUE KEY idx_b (b))")
	tk.MustExec("create table t2(a int(11) DEFAULT NULL, b int(11) DEFAULT NULL)")
