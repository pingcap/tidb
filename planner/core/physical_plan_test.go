...
func (s *testPlanSuite) TestQueryBlockHint(c *C) {
	...
	tests := []struct {
		...
		},
		{
			...
			plan: "IndexMergeJoin{TableReader(Table(t))->LeftHashJoin{IndexReader(Index(t.f)[[NULL,+inf]])->TableReader(Table(t))}(test.t2.a,test.t3.c)}(test.t2.a,test.t1.a)->Projection",
		},
		{
