...
func (s *testPlanSuite) TestDAGPlanBuilderSubquery(c *C) {
	...
	tests := []struct {
		...
		// Test Apply.
		{
			...
			best: "Apply{TableReader(Table(t))->IndexJoin{TableReader(Table(t))->TableReader(Table(t)->Sel([eq(t1.a, test.t.a)]))}(s.a,t1.a)->StreamAgg->Sel([not(isnull(7_col_0))])}->Projection",
		},
		{
