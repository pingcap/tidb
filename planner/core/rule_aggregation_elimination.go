...
func (a *aggregationEliminateChecker) tryToEliminateAggregation(agg *LogicalAggregate) *LogicalProject {
...
func ConvertAggToProj(agg *LogicalAggregate, schema *expression.Schema) (bool, *LogicalProject) {
	proj := LogicalProject{
