...
func (r *aggPushDownHelper) fillGbyCols(
	...
	*expression.Schema,
	...
	for _, gbyCol := range gbyCols {
		...
		firstRow.Mode = aggregation.CompleteMode
		if err != nil {
			return nil, nil, err
		}
...
func (r *aggPushDownHelper) decomposeAggFunc(
	...
	case ast.AggFuncAvg:
		...
		partialFuncs = []*aggregation.AggFuncDesc{partialSum, partialCount}
...
func (r *PushAggDownJoin) OnTransform(old *memo.ExprIter) (newExprs []*memo.GroupExpr, eraseOld bool, eraseAll bool, err error) {
	...
	valid, leftAggFuncs, rightAggFuncs, funcOrders := r.collectAggFuncs(agg, joinLeftChildSchema)
	if !valid {
		return nil, false, false, nil
	}
