...
<<<<<<< HEAD:planner/cascades/optimize.go
...
>>>>>>> 58e5284b3f4 (planner,executor: fix join resolveIndex won't find its column from children schema & amend join's lused and rused logic for reversed column ref from join schema to its children (#51203)):pkg/planner/cascades/optimize.go
	if err != nil {
		return nil, err
	}
	return plan, nil
