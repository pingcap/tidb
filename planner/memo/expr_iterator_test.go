...
func (s *testMemoSuite) TestNewExprIterFromGroupElem(c *C) {
	g0 := NewGroup(NewGroupExpr(plannercore.LogicalSelection{}.Init(s.sctx, 0)))
	...
	g1 := NewGroup(NewGroupExpr(plannercore.LogicalSelection{}.Init(s.sctx, 0)))
...
func (s *testMemoSuite) TestExprIterNext(c *C) {
	g0 := NewGroup(NewGroupExpr(plannercore.LogicalProjection{}.Init(s.sctx, 0)))
	g0.Insert(NewGroupExpr(plannercore.LogicalLimit{}.Init(s.sctx, 0)))
	g0.Insert(NewGroupExpr(plannercore.LogicalProjection{}.Init(s.sctx, 0)))
	g0.Insert(NewGroupExpr(plannercore.LogicalLimit{}.Init(s.sctx, 0)))
	g0.Insert(NewGroupExpr(plannercore.LogicalProjection{}.Init(s.sctx, 0)))
...
func (s *testMemoSuite) TestExprIterReset(c *C) {
	...
	g2 := NewGroup(NewGroupExpr(plannercore.LogicalSelection{}.Init(s.sctx, 0)))
