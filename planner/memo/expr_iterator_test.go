...
func (s *testMemoSuite) TestNewExprIterFromGroupElem(c *C) {
	g0 := NewGroupWithSchema(NewGroupExpr(plannercore.LogicalFilter{}.Init(s.sctx, 0)), s.schema)
	...
	g1 := NewGroupWithSchema(NewGroupExpr(plannercore.LogicalFilter{}.Init(s.sctx, 0)), s.schema)
...
func (s *testMemoSuite) TestExprIterNext(c *C) {
	...
	g1 := NewGroupWithSchema(NewGroupExpr(
		plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewNull()}}.Init(s.sctx, 0)), s.schema)
	g1.Insert(NewGroupExpr(
		plannercore.LogicalLimit{Count: 3}.Init(s.sctx, 0)))
	g1.Insert(NewGroupExpr(
		plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewOne()}}.Init(s.sctx, 0)))
	g1.Insert(NewGroupExpr(
		plannercore.LogicalLimit{Count: 4}.Init(s.sctx, 0)))
	g1.Insert(NewGroupExpr(
		plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewZero()}}.Init(s.sctx, 0)))
...
func (s *testMemoSuite) TestExprIterReset(c *C) {
	...
	sel1 := NewGroupExpr(plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewNull()}}.Init(s.sctx, 0))
	sel2 := NewGroupExpr(plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewOne()}}.Init(s.sctx, 0))
	sel3 := NewGroupExpr(plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewZero()}}.Init(s.sctx, 0))
...
func (s *testMemoSuite) TestExprIterWithEngineType(c *C) {
	g1 := NewGroupWithSchema(NewGroupExpr(
		plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewOne()}}.Init(s.sctx, 0)), s.schema).SetEngineType(EngineTiFlash)
	g1.Insert(NewGroupExpr(
		plannercore.LogicalLimit{Count: 1}.Init(s.sctx, 0)))
	g1.Insert(NewGroupExpr(
		plannercore.LogicalProject{Exprs: []expression.Expression{expression.NewOne()}}.Init(s.sctx, 0)))
	...
	g2 := NewGroupWithSchema(NewGroupExpr(
		plannercore.LogicalFilter{Conditions: []expression.Expression{expression.NewOne()}}.Init(s.sctx, 0)), s.schema).SetEngineType(EngineTiKV)
	g2.Insert(NewGroupExpr(
		plannercore.LogicalLimit{Count: 2}.Init(s.sctx, 0)))
	g2.Insert(NewGroupExpr(
		plannercore.LogicalProject{Exprs: []expression.Expression{expression.NewOne()}}.Init(s.sctx, 0)))
