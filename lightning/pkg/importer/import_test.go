...
func TestNewTableRestore(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		tr, err := NewTableImporter(tableName, nil, dbInfo, tableInfo, &checkpoints.TableCheckpoint{}, nil, nil, nil, nil, log.L())
		require.NotNil(t, tr)
		require.NoError(t, err)
	}
}
...
func TestNewTableRestoreFailure(t *testing.T) {
	...
	_, err := NewTableImporter(tableName, nil, dbInfo, tableInfo, &checkpoints.TableCheckpoint{}, nil, nil, nil, nil, log.L())
