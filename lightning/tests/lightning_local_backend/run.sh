...
export GO_FAILPOINTS='github.com/pingcap/tidb/pkg/ingestor/ingestctrl/FailIngestMeta=1*return("notleader");github.com/pingcap/tidb/br/pkg/restore/split/failToSplit=5*return("");github.com/pingcap/tidb/pkg/ingestor/ingestctrl/forceSplitRegion=5*return("")'
...
export GO_FAILPOINTS='github.com/pingcap/tidb/pkg/ingestor/ingestctrl/FailIngestMeta=2*return("epochnotmatch");github.com/pingcap/tidb/pkg/ingestor/ingestctrl/NoLeader=1*return()'
