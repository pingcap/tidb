...
run_lightning --backend import-into --sorted-kv-dir "$TEST_DIR/lightning_distributed_import.sorted1" \
...
run_lightning --backend import-into --sorted-kv-dir "$TEST_DIR/lightning_distributed_import.sorted2" \
