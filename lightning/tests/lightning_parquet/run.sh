...
for BACKEND in local tidb import-into; do
    ...
    check_contains "c_since: 2020-09-10 12:17:16"
    check_contains "c_discount: 0.0585"

    run_sql 'select CONVERT_TZ(ts, "+8:00", "+0:00") as ts from test.test_time;'
    check_contains "ts: 2022-09-10 01:09:00"
    check_contains "ts: 1997-08-10 18:01:10"
    check_contains "ts: 1995-12-31 15:00:01"
    check_contains "ts: 2020-02-29 15:00:00"
    check_contains "ts: 2038-01-18 16:00:00"
done
