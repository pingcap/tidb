...
export GO_FAILPOINTS="github.com/pingcap/tidb/pkg/ingestor/ingestctrl/changeEpochVersion=1*return(-1)"
...
export GO_FAILPOINTS="github.com/pingcap/tidb/pkg/ingestor/ingestctrl/changeEpochVersion=1*return(10)"
