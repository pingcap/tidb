...
- What is the impact(if any) will be on the mirgration from MySQL to TiDB?
-->
...
<!--
A brief description on how the implementation will be tested. The framework tests should be focused instead of unit tests:
