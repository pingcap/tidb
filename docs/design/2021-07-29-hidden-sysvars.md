...
* [Implementation Plan](#implementation-plan)
  ...
  * [Appendix #2 - Deleted system variables](#appendix-2---deleted-system-variables)
...
#### Appendix #2 - Deleted system variables
...
This proposes that we support "deleted system variables" by the sysvar framework. A deleted sysvar:
