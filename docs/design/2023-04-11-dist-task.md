...
TiDB is a distributed database that provides high scalability, available and performance for database service. It will introduce a unified distributed parallel execution framework to gradually support all backend tasks, such as DDL, data import, TTL, auto-analyze and Backup|Restore, in a distributed manner.
The framework may bring three outstanding benefits to TiDB user:
...
![disttaskflow.jpg](imgs/disttaskarchi.jpg)
