...
`pinyin` order for Chinese character supported by this proposal will add a new collation named `tidb_utf8mb4_general_zh_cs` which are exactly same with `gbk_bin`.
