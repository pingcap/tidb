...
- Encapsulate read and write functions, using the Transform functions of gbkDecoder and gbkEncoder in golang.org/x/text (The version of this package used between different components is preferably the same).
