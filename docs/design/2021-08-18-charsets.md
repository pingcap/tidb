...
- To support gbk_chinese_ci and gbk_bin collations, it needs to turn on the `new_collations_enabled_on_first_bootstrap` switch.
  - If `new_collations_enabled_on_first_bootstrap` is off, it only support gbk_utf8mb4_bin. gbk_utf8mb4_bin does not need to be converted to gbk code for processing.
