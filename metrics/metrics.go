...
func RegisterMetrics() {
	...
	prometheus.MustRegister(StatsControlPlaneHistogram)
	prometheus.MustRegister(StatsLockedTableCacheEntriesGauge)
	prometheus.MustRegister(StatsLockedTableCacheLastUpdateGauge)
