...
// AddPartitionRangeForTable mocks base method.
func (m *MockBackend) AddPartitionRangeForTable(arg0 context.Context, arg1 int64) (func(), error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddPartitionRangeForTable", arg0, arg1)
	ret0, _ := ret[0].(func())
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AddPartitionRangeForTable indicates an expected call of AddPartitionRangeForTable.
func (mr *MockBackendMockRecorder) AddPartitionRangeForTable(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddPartitionRangeForTable", reflect.TypeOf((*MockBackend)(nil).AddPartitionRangeForTable), arg0, arg1)
}
