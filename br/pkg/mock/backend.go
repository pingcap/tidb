...
// CollectRemoteDuplicateIndex mocks base method.
func (m *MockBackend) CollectRemoteDuplicateIndex(arg0 context.Context, arg1 table.Table, arg2 string, arg3 *kv.SessionOptions, arg4 int64) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CollectRemoteDuplicateIndex", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CollectRemoteDuplicateIndex indicates an expected call of CollectRemoteDuplicateIndex.
func (mr *MockBackendMockRecorder) CollectRemoteDuplicateIndex(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CollectRemoteDuplicateIndex", reflect.TypeOf((*MockBackend)(nil).CollectRemoteDuplicateIndex), arg0, arg1, arg2, arg3, arg4)
}
