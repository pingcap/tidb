...
// SplitWaitAndScatterOnRegion implements the SplitClient interface.
func (c *pdClient) SplitWaitAndScatterOnRegion(
	...
	newRegions, err := c.batchSplitRegions(ctx, region, keys)
	if err != nil {
		return nil, errors.Trace(err)
	}
