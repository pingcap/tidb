...
var (
	...
	pendingFileCount = metrics.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "tidb",
		Subsystem: "br_crr",
		Name:      "pending_file_count",
		Help:      "Pending file count in current CRR round.",
	}, []string{"task"})
	consecutiveFailures = metrics.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "tidb",
		Subsystem: "br_crr",
		Name:      "consecutive_failures",
		Help:      "Consecutive failure count in CRR service.",
	}, []string{"task"})
	upstreamReadMetaFileCount = metrics.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "tidb",
		Subsystem: "br_crr",
	...
	downstreamCheckFileCount = metrics.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "tidb",
		Subsystem: "br_crr",
