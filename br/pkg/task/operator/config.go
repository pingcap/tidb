...
func DefineFlagsForCRRCheckpointConfig(flags *pflag.FlagSet) {
	...
	flags.Bool(flagCheckSyncedFromDownstreamStorage, false, "Check object sync by file existence on downstream storage. Effective only when --downstream-storage is provided.")
}
