...
func (s *kvSuite) TestEncode(c *C) {
	c1 := &model.ColumnInfo{ID: 1, Name: model.NewCIStr("c1"), State: model.StatePublic, Offset: 0, FieldTypeBuilder: *types.NewFieldTypeBuilder(mysql.TypeTiny)}
...
func (s *kvSuite) TestDecodeIndex(c *C) {
	...
	tblInfo := &model.TableInfo{
		...
		Columns: []*model.ColumnInfo{
			{ID: 1, Name: model.NewCIStr("c1"), State: model.StatePublic, Offset: 0, FieldTypeBuilder: *types.NewFieldTypeBuilder(mysql.TypeInt24)},
...
func (s *kvSuite) TestEncodeTimestamp(c *C) {
	ty := *types.NewFieldTypeBuilder(mysql.TypeDatetime)
