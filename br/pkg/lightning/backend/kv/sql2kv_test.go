...
func TestEncode(t *testing.T) {
	...
	require.Equal(t, pairs, lkv.MakeRowFromKvPairs([]common.KvPair{
		{
			...
			Val:   []uint8{0x8, 0x2, 0x8, 0x2, 0x8, 0x0, 0x0},
			RowID: 2,
		},
	}))
	...
	require.Equal(t, pairs, lkv.MakeRowFromKvPairs([]common.KvPair{
		{
			Key:   []uint8{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x5f, 0x72, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1},
			Val:   []uint8{0x8, 0x2, 0x8, 0xfe, 0x1, 0x8, 0x0, 0x0},
			RowID: 1,
		},
	}))
}
	...
	require.Equal(t, pairs, lkv.MakeRowFromKvPairs([]common.KvPair{
		{
			...
			Val: []uint8{
				...
				0x1, 0x0, // number of null columns = 1
				0x1, 0x0, // column IDs = [0, 1]
	...
	require.Equal(t, pairs, lkv.MakeRowFromKvPairs([]common.KvPair{
		{
			...
			Val:   []uint8{0x8, 0x2, 0x9, 0x80, 0x80, 0x80, 0xf0, 0xfd, 0x8e, 0xf7, 0xc0, 0x19, 0x8, 0x0, 0x0},
			RowID: 70,
		},
	}))
}
...
func TestEncodeDoubleAutoIncrement(t *testing.T) {
	...
	require.Equal(t, lkv.MakeRowFromKvPairs([]common.KvPair{
		{
			Key:   []uint8{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x5f, 0x72, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x46},
			Val:   []uint8{0x80, 0x0, 0x1, 0x0, 0x1, 0x0, 0x1, 0x0, 0x8, 0x0, 0xbf, 0xf0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
			RowID: 70,
		},
		{
	...
	require.Equal(t, pairs, lkv.MakeRowFromKvPairs([]common.KvPair{
		{
			...
			Val:   []uint8{0x80, 0x0, 0x1, 0x0, 0x1, 0x0, 0x2, 0x0, 0x0, 0x0},
			RowID: 70,
		},
	}))
