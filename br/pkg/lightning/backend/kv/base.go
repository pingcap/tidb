...
// GetActualDatum returns the actual datum for the column.
func (e *BaseKVEncoder) GetActualDatum(rowID int64, colIndex int, inputDatum *types.Datum) (types.Datum, error) {
	var (
		value types.Datum
		err   error
	)
