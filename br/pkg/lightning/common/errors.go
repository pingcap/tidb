...
var (
	...
	ErrEncounterConflictForErrorMode = errors.Normalize("encounter duplicate rows when setting conflict.strategy to be 'error', will stop the import process", errors.RFCCodeText("Lightning:Restore:ErrEncounterConflictForErrorMode"))
)
