...
var (
	ErrUnknown = errors.Normalize(
		"internal error",
		errors.RFCCodeText("BR:Common:ErrUnknown"),
	)
	ErrInvalidArgument = errors.Normalize(
		"invalid argument",
		errors.RFCCodeText("BR:Common:ErrInvalidArgument"),
	)
	ErrOperationAborted = errors.Normalize(
		"operation aborted by user",
		errors.RFCCodeText("BR:Common:ErrOperationAborted"),
	)
	...
	ErrPiTRCheckpointWatchRestart = errors.Normalize(
		"checkpoint watch needs restart",
		errors.RFCCodeText("BR:PiTR:ErrCheckpointWatchRestart"),
	)
