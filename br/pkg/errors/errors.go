...
var (
	...
	// ErrHoleInKeySpace indicates a hole in the key space was found during scanning regions.
	ErrHoleInKeySpace = errors.Normalize("hole found in key space", errors.RFCCodeText("BR:PD:ErrHoleInKeySpace"))
