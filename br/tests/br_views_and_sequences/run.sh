...
val=$(run_sql "SELECT LASTVAL($DB.seq_1);")
echo "$val"
val=$(run_sql "SELECT LASTVAL($DB.seq_2);")
echo "$val"
val=$(run_sql "SELECT NEXTVAL($DB.seq_1);")
echo "$val"
val=$(run_sql "SELECT NEXTVAL($DB.seq_2);")
echo "$val"
val=$(run_sql "SELECT * from $DB.table_2;")
echo "$val"
[ "$seq_val" = 'g: 1' ]
