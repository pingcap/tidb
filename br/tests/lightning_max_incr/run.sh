...
# auto_random_max: 2^{64-1-10} - 1 = 2^53 - 1 
# sql succeed: though 9007199254740992 (2^53) is out-of-range of max_auto_random_base
# but lightning sets it to max_auto_random_base instead of 9007199254740991
