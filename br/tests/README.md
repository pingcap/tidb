...
1. The following 10 executables must be copied or linked into the `bin` folder under the TiDB root dir:
...
2. Check that all 10 required executables and `br` executable exist
