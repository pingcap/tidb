...
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs12_parent';"
check_contains "RESCNT: 1"
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs12_child';"
check_contains "RESCNT: 1"
...
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs13_child';"
check_contains "RESCNT: 1"
...
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs14_child';"
check_contains "RESCNT: 1"
...
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs15_parent';"
check_contains "RESCNT: 1"
...
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs16_parent';"
check_contains "RESCNT: 2"
run_sql "SELECT count(*) AS RESCNT FROM INFORMATION_SCHEMA.TIDB_INDEXES WHERE TABLE_NAME = 'test.pairs16_child';"
check_contains "RESCNT: 2"
