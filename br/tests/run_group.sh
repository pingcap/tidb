...
groups=(
  ...
  ["G03"]='br_incompatible_tidb_config br_incremental br_incremental_ddl br_incremental_index'
	...
	["G12"]='lightning_drop_other_tables_halfway lightning_duplicate_detection lightning_duplicate_detection_new lightning_duplicate_resolution_incremental lightning_duplicate_resolution_remove lightning_duplicate_resolution_replace_one_key'
	["G13"]='lightning_duplicate_resolution_replace_one_key_multiple_conflicts lightning_duplicate_resolution_replace_multiple_unique_keys lightning_duplicate_resolution_replace_one_unique_key lightning_duplicate_resolution_replace_one_unique_key_multiple_conflicts lightning_error_summary lightning_examples'
