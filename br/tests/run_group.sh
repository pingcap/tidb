...
groups=(
	...
	["G06"]='br_skip_checksum br_small_batch_size br_split_region_fail br_systables br_table_filter'
	...
	["G09"]='lightning_auto_random_default lightning_black-white-list lightning_bom_file lightning_character_sets lightning_check_partial_imported lightning_checkpoint lightning_checkpoint_chunks lightning_checkpoint_columns lightning_checkpoint_dirty_tableid'
	...
	["G12"]='lightning_duplicate_detection lightning_duplicate_detection_new lightning_duplicate_resolution lightning_duplicate_resolution_incremental lightning_error_summary lightning_examples lightning_exotic_filenames lightning_extend_routes lightning_fail_fast'
