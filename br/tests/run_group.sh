...
groups=(
  ...
  ["G03"]='br_incompatible_tidb_config br_incremental br_incremental_ddl br_incremental_index'
	...
	["G13"]='lightning_duplicate_resolution_replace_multiple_unique_keys_nonclustered_pk lightning_duplicate_resolution_replace_one_key lightning_duplicate_resolution_replace_one_key_multiple_conflicts lightning_duplicate_resolution_replace_one_unique_key lightning_duplicate_resolution_replace_one_unique_key_multiple_conflicts_clustered_pk'
