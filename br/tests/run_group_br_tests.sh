...
groups=(
	...
	["G02"]="br_full_cluster_restore br_full_index br_incremental_ddl br_pitr_failpoint br_pitr_gc_safepoint br_gc_keyspace_full_backup br_other br_pitr_long_running_schema_loading br_parallel_restore br_lease_lock"
