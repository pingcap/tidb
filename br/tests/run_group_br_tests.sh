...
groups=(
	...
	["G02"]="br_full_cluster_restore br_full_index br_pitr_failpoint"
	["G03"]='br_incompatible_tidb_config br_incremental br_incremental_ddl br_incremental_index br_rawkv'
