...
require (
	...
	github.com/tikv/client-go/v2 v2.0.3-0.20221125022819-f05c6886bbad
...
replace github.com/pingcap/kvproto => github.com/tiancaiamao/kvproto v0.0.0-20221128043225-16b52abd26c7
