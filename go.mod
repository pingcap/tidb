...
require (
	...
	github.com/xiekeyi98/parser v0.0.0-20190212082053-be35c04736d9 // indirect
...
replace github.com/pingcap/parser => github.com/xiekeyi98/parser v0.0.0-20190212082053-be35c04736d9
