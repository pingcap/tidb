...
require (
	...
	github.com/pingcap/parser v0.0.0-20181206080309-80784c39ca74
...
replace github.com/pingcap/parser => github.com/winkyao/parser v0.0.0-20181206022041-3fe4cf28da70
