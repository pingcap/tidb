...
require (
	...
	github.com/pingcap/parser v0.0.0-20191209121001-06cb36ea337f
...
replace github.com/pingcap/parser => github.com/lysu/parser v0.0.0-20191217073751-88d011a41fa1
