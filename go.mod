...
require (
	...
	github.com/pingcap/parser v0.0.0-20190227074025-3faad11cf6cb
...
replace github.com/pingcap/parser => github.com/spongedu/parser v0.0.0-20181102150703-2e6ac0258023
