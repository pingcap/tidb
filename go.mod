...
require (
	...
	github.com/pingcap/parser v0.0.0-20210913093605-d55197095f51
...
replace github.com/pingcap/parser => github.com/tangenta/parser v0.0.0-20210916071322-78f3739fc6a2
