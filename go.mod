...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20260617075037-fdf2f76691c1
...
replace (
	github.com/pingcap/kvproto => git.pingcap.net/pingkai/kvproto v0.0.0-20260617075037-fdf2f76691c1
