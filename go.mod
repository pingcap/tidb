...
replace (
	...
	github.com/pingcap/tipb => github.com/joechenrh/tipb v0.0.0-20260120073658-d91a0064b956
	github.com/tikv/client-go/v2 => github.com/joechenrh/client-go/v2 v2.0.0-20260120080010-eda931c0eb22
