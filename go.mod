...
require (
	...
	github.com/pingcap/parser v3.1.0-beta.2.0.20200420103716-1679ace3c5e4+incompatible
...
replace github.com/pingcap/parser => github.com/lysu/parser v0.0.0-20200420042425-d3003222e3a6
