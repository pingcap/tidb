...
require (
	...
	github.com/pingcap/parser v0.0.0-20181225054907-cae9754c056b
...
replace github.com/pingcap/parser => github.com/crazycs520/parser v0.0.0-20190105032941-f24e221ed7dd
