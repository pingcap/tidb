...
require (
	...
	github.com/pingcap/pd/v4 v4.0.0-beta.1.0.20200227095146-00c1cc15cb73
...
replace github.com/pingcap/tidb-tools => github.com/lysu/tidb-tools v4.0.0-beta.1.0.20200302123346-d5410f10aa2f+incompatible
