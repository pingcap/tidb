...
replace (
	...
	github.com/pingcap/kvproto => github.com/solotzg/kvproto v0.0.0-20230109071449-64b9fb7aeae7
	github.com/pingcap/tipb => github.com/solotzg/tipb v0.0.0-20230109071255-a24d6bb7d151
)
