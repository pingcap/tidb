...
require (
	...
	github.com/pingcap/tipb v0.0.0-20240628074510-6f66261de672
...
replace github.com/pingcap/tipb => github.com/guo-shaoge/tipb v0.0.0-20240702083345-d1a66a5b8b8f
