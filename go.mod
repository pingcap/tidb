...
require (
	...
	github.com/tikv/client-go/v2 v2.0.0-alpha.0.20210923095521-f65172694bc4
...
replace github.com/pingcap/parser => github.com/xuyifangreeneyes/parser v0.0.0-20210923103854-cbe03f5b02f6
