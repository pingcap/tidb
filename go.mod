...
require (
	...
	github.com/tikv/client-go/v2 v2.0.0-20260916111000-cdd6a9beb688
...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/lhy1024/client-go/v2 v2.0.0-20260916111000-cdd6a9beb688
