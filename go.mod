...
require (
	...
	github.com/pingcap/parser v0.0.0-20190211015504-9e785a6710a7
...
replace github.com/pingcap/parser => github.com/tiancaiamao/parser v0.0.0-20190130092843-247e080f218d
