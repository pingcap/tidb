...
require (
	...
	github.com/pingcap/parser v0.0.0-20190418074231-2cdba8195b40
...
replace github.com/pingcap/parser => github.com/lamxTyler/parser v0.0.0-20190419105045-751328f8c501
