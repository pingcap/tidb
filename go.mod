...
replace (
	...
	github.com/pingcap/kvproto => github.com/AilinKid/kvproto v0.0.0-20260907024454-fa40b23b2dfd
	...
	github.com/tikv/client-go/v2 => github.com/AilinKid/client-go/v2 v2.0.0-20260907025817-7f85179af40f
