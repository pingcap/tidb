...
require (
	...
	github.com/pingcap/parser v3.0.13-0.20200424080809-b7f2b6eb91c5+incompatible
...
replace github.com/pingcap/parser => github.com/crazycs520/parser v0.0.0-20200428055834-0cab22d7c6f1
