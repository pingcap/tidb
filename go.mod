...
require (
	...
	github.com/pingcap/parser v0.0.0-20181208021024-ce789e70c83b
...
replace github.com/pingcap/parser => github.com/tiancaiamao/parser v0.0.0-20181208150835-2e9241b4e355
