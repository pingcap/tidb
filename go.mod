...
replace (
	...
	// TODO: Remove after https://github.com/tikv/client-go/pull/1998 is merged.
	github.com/tikv/client-go/v2 => github.com/pingyu/client-go/v2 v2.0.1-0.20260808010911-3c5576bdc34b
