...
require (
	...
	github.com/pingcap/parser v0.0.0-20201221105933-6f7f1413abe3
...
replace github.com/pingcap/parser => github.com/xiongjiwei/parser v0.0.0-20201222023900-d48d72b37f29
