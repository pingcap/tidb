...
require (
	...
	github.com/pingcap/parser v0.0.0-20191204131342-259c92691fa4
...
replace github.com/pingcap/kvproto => github.com/MyonKeminta/kvproto v0.0.0-20191203095505-0e4f18415799
