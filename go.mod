...
require (
	...
	github.com/tikv/client-go/v2 v2.0.7-0.20230309033404-df993878bd98
...
replace (
	...
	github.com/pingcap/kvproto => github.com/Connor1996/kvproto v0.0.0-20230308070953-118ad9b34fb1
