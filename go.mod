...
replace (
	...
	github.com/pingcap/kvproto => github.com/ekexium/kvproto v0.0.0-20251106155322-a2d3fa565909
	github.com/pingcap/tidb/pkg/parser => ./pkg/parser

	github.com/tikv/client-go/v2 => github.com/ekexium/client-go/v2 v2.0.0-alpha.0.20251106160200-a5e58884f0ff
