...
require (
	...
	github.com/pingcap/parser v0.0.0-20191217103835-701d0da815ab
...
replace github.com/pingcap/parser => github.com/lysu/parser v0.0.0-20191218025457-b524fdec78e4
