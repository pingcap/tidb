...
require (
	...
	github.com/pingcap/parser v0.0.0-20191219054832-7df8c2c0e634
...
replace github.com/pingcap/parser => github.com/lysu/parser v0.0.0-20191224025422-aa760c8e7fa4
