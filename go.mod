...
require (
	...
	github.com/pingcap/parser v0.0.0-20200915104959-a60a80d218c9
...
replace github.com/pingcap/parser => github.com/xiaodong-ji/parser v0.0.0-20200916105502-eae565116c5e
