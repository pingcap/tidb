...
require (
	...
	github.com/pingcap/parser v0.0.0-20190212032338-99d1a3f8a8c5
...
replace github.com/pingcap/parser => github.com/imtbkcat/parser v0.0.0-20190128051815-db8939f8a2f5
