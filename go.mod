...
require (
	...
	github.com/pingcap/parser v0.0.0-20190222082040-fe59ebfc9e10
...
replace github.com/pingcap/parser => github.com/zimulala/parser v0.0.0-20190227030420-730934450eec
