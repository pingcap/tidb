...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/HuSharp/client-go/v2 v2.0.0-20230117105002-80de042f9218
	github.com/tikv/pd/client => github.com/HuSharp/pd/client v0.0.0-20230117104757-f43ee8c60837
