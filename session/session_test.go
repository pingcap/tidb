...
func (s *testSchemaSuite) TestLoadSchemaFailed(c *C) {
	atomic.StoreInt32(&schemachecker.SchemaOutOfDateRetryTimes, int32(3))
	atomic.StoreInt64(&schemachecker.SchemaOutOfDateRetryInterval, int64(20*time.Millisecond))
	defer func() {
		atomic.StoreInt32(&schemachecker.SchemaOutOfDateRetryTimes, 10)
		atomic.StoreInt64(&schemachecker.SchemaOutOfDateRetryInterval, int64(500*time.Millisecond))
	}()
