...
func (s *testSessionSuite3) TestEnablePartition(c *C) {
	...
	tk.MustExec("set tidb_enable_list_table_partition=off")
	tk.MustQuery("show variables like 'tidb_enable_list_table_partition'").Check(testkit.Rows("tidb_enable_list_table_partition OFF"))

	tk.MustExec("set tidb_enable_list_table_partition=1")
	tk.MustQuery("show variables like 'tidb_enable_list_table_partition'").Check(testkit.Rows("tidb_enable_list_table_partition ON"))

	tk.MustExec("set tidb_enable_list_table_partition=on")
	tk.MustQuery("show variables like 'tidb_enable_list_table_partition'").Check(testkit.Rows("tidb_enable_list_table_partition ON"))
