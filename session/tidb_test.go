...
func exec(se Session, sql string, args ...interface{}) (sessionctx.RecordSet, error) {
...
func mustExecSQL(c *C, se Session, sql string, args ...interface{}) sessionctx.RecordSet {
