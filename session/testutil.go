...
func MustExec(t *testing.T, se sessionapi.Session, sql string, args ...interface{}) {
...
func MustExecToRecodeSet(t *testing.T, se sessionapi.Session, sql string, args ...interface{}) sqlexec.RecordSet {
	rs, err := exec(se, sql, args...)
	require.NoError(t, err)
	return rs
}

func exec(se sessionapi.Session, sql string, args ...interface{}) (sqlexec.RecordSet, error) {
