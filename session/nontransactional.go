...
func runJobs(ctx context.Context, jobs []job, stmt *ast.NonTransactionalDMLStmt,
	tableName *ast.TableName, se sessionapi.Session, originalCondition ast.ExprNode) ([]string, error) {
...
func buildSelectSQL(stmt *ast.NonTransactionalDMLStmt, se sessionapi.Session) (
