...
const (
	...
	version82 = 82
	// version83 delete dateadd from expr pushdown blacklist
	version83 = 83
)
...
func deleteDateAddFromExprPushDownBlacklist(s Session) {
	mustExecute(s, "DELETE HIGH_PRIORITY FROM mysql.expr_pushdown_blacklist WHERE name='date_add'")
}
...
func upgradeToVer83(s Session, ver int64) {
	...
	deleteDateAddFromExprPushDownBlacklist(s)
}
