...
func writeStmtSummaryVars(s Session) {
	...
	mustExecute(s, sql, mysql.SystemDB, mysql.GlobalVariablesTable, strconv.FormatUint(uint64(stmtSummaryConfig.MaxEvictedCount), 10), variable.TiDBStmtSummaryMaxEvictedCount)
