...
func createSessionFunc(store kv.Storage) pools.Factory {
	return func() (pools.Resource, error) {
		...
		err = variable.SetSessionSystemVar(se.sessionVars, variable.AutoCommit, types.NewDefaultCollationStringDatum("1"))
		if err != nil {
			return nil, err
		}
		...
		err = variable.SetSessionSystemVar(se.sessionVars, variable.MaxAllowedPacket, types.NewDefaultCollationStringDatum("67108864"))
		if err != nil {
			return nil, errors.Trace(err)
		}
