...
type session struct {
	...
	idxUsageCollector *index_usage.SessionIndexUsageCollector
...
func (s *session) StoreIndexUsage(tblID int64, idxID int64, rowsSelected int64) {
	...
	s.idxUsageCollector.Update(tblID, idxID, &index_usage.IndexUsageInformation{QueryCount: 1, RowsSelected: rowsSelected})
}
