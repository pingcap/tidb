...
You may read the [design document](https://github.com/pingcap/community/blob/master/rfc/2019-12-06-dumpling.md) and [中文使用手册](docs/cn/user-guide.md) for details.
