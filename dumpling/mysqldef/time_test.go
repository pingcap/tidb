...
func (s *testTimeSuite) TestParseTimeFromNum(c *C) {
	table := []struct {
		...
		{2010101011111, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
		...
		{2010101011, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
		...
		{2010101, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
		...
		{2010, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
		{201, false, "2000-02-01 00:00:00", false, "2000-02-01 00:00:00", false, "2000-02-01"},
		{20, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
		{2, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
		{0, false, zeroDatetimeStr, false, zeroTimestampStr, false, zeroDateStr},
		{-1, true, zeroDatetimeStr, true, zeroTimestampStr, true, zeroDateStr},
