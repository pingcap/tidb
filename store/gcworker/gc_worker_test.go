...
func TestCheckNeedDeletePlacementRules(t *testing.T) {
	s, clean := createGCWorkerSuite(t)
	defer clean()

	res := s.gcWorker.checkNeedDeletePlacementRules(1, util.DelRangeTask{
		ElementID: 10,
		StartKey:  []byte("t\x80\x00\x00\x00\x00\x00\x00\x0a"),
		EndKey:    []byte("t\x80\x00\x00\x00\x00\x00\x00\x0b"),
	...
	res = s.gcWorker.checkNeedDeletePlacementRules(1, util.DelRangeTask{
		ElementID: 10,
		StartKey:  []byte("t\x80\x00\x00\x00\x00\x00\x00\x0b"),
		EndKey:    []byte("t\x80\x00\x00\x00\x00\x00\x00\x0c"),
	}, model.ActionDropTable)
	require.False(t, res)

	res = s.gcWorker.checkNeedDeletePlacementRules(1, util.DelRangeTask{
		ElementID: 10,
		StartKey:  []byte("t\x80\x00\x00\x00\x00\x00\x00\x0a_r"),
		EndKey:    []byte("t\x80\x00\x00\x00\x00\x00\x00\x0a_s"),
	}, model.ActionDropTable)
	require.False(t, res)

	res = s.gcWorker.checkNeedDeletePlacementRules(1, util.DelRangeTask{
		ElementID: 10,
		StartKey:  []byte("t\x80\x00\x00\x00\x00\x00\x00\x0a_i\x80\x00\x00\x00\x00\x00\x00\x0a"),
		EndKey:    []byte("t\x80\x00\x00\x00\x00\x00\x00\x0a_i\x80\x00\x00\x00\x00\x00\x00\x0b"),
	}, model.ActionDropTable)
	require.False(t, res)
