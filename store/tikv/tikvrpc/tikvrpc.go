...
type Response struct {
	...
	DestroyRange     *kvrpcpb.DestroyRangeResponse
...
func GenRegionErrorResp(req *Request, e *errorpb.Error) (*Response, error) {
	...
	case CmdDestroyRange:
		resp.DestroyRange = &kvrpcpb.DestroyRangeResponse{
			RegionError: e,
		}
	case CmdCop:
...
func (resp *Response) GetRegionError() (*errorpb.Error, error) {
	...
	case CmdDestroyRange:
		e = resp.DestroyRange.GetRegionError()
	case CmdCop:
...
func CallRPC(ctx context.Context, client tikvpb.TikvClient, req *Request) (*Response, error) {
	...
	case CmdDestroyRange:
		resp.DestroyRange, err = client.DestroyRange(ctx, req.DestroyRange)
	case CmdCop:
