...
func (s *testSnapshotSuite) TestWriteConflictPrettyFormat(c *C) {
	...
	expectedStr := `WriteConflict: txnStartTS=399402937522847774, conflictTS=399402937719455772, key={tableID=411, 
	indexID=1, indexValues={RW01, 768221109, , }} primary={tableID=411, indexID=1, indexValues={RW01, 768221109, , }}`
