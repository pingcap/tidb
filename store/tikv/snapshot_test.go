...
func (s *testSnapshotSuite) TestWriteConflictPrettyFormat(c *C) {
	conflict := &pb.WriteConflict{
		...
		Key:        []byte{116, 128, 0, 0, 0, 0, 0, 1, 255, 155, 95, 105, 128, 0, 0, 0, 0, 255, 0, 0, 1, 1, 82, 87, 48, 49, 255, 0, 0, 0, 0, 251, 1, 55, 54, 255, 56, 50, 50, 49, 49, 48, 255, 57, 255, 0, 0, 0, 0, 0, 0, 0, 248, 255, 1, 0, 0, 0, 0, 0, 0, 0, 255, 0, 247, 0, 0, 0, 0, 0, 0, 249},
	...
	str := `WriteConflict: startTS=399402937522847774, conflictTS=399402937719455772, key=[]byte{0x74, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0xff, 0x9b, 0x5f, 0x69, 0x80, 0x0, 0x0, 0x0, 0x0, 0xff, 0x0, 0x0, 0x1, 0x1, 0x52, 0x57, 0x30, 0x31, 0xff, 0x0, 0x0, 0x0, 0x0, 0xfb, 0x1, 0x37, 0x36, 0xff, 0x38, 0x32, 0x32, 0x31, 0x31, 0x30, 0xff, 0x39, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf8, 0xff, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff, 0x0, 0xf7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf9} primary={tableID=411, indexID=1, indexValues={6-[82 87 48 49], 6-[55 54 56 50 50 49 49 48 57], 6-[], }}`
	c.Assert(conflictToString(conflict), Equals, str)
}
