...
const (
	...
	ErrXBadMessage                      = 5000
	ErrXCapabilitiesPrepareFailed       = 5001
	ErrXCapabilityNotFound              = 5002
	ErrXInvalidProtocolData             = 5003
	ErrXServiceError                    = 5010
	ErrXSession                         = 5011
	ErrXInvalidArgument                 = 5012
	ErrXMissingArgument                 = 5013
	ErrXBadInsertData                   = 5014
	ErrXCmdNumArguments                 = 5015
	ErrXCmdArgumentType                 = 5016
	ErrXCmdArgumentValue                = 5017
	ErrXBadUpdateData                   = 5050
	ErrXBadTypeOfUpdate                 = 5051
	ErrXBadColumnToUpdate               = 5052
	ErrXBadMemberToUpdate               = 5053
	ErrXBadStatementID                  = 5110
	ErrXBadCursorID                     = 5111
	ErrXBadSchema                       = 5112
	ErrXBadTable                        = 5113
	ErrXBadProjection                   = 5114
	ErrXDocIDMissing                    = 5115
	ErrXDocIDDuplicate                  = 5116
	ErrXDocRequiredFieldMissing         = 5117
	ErrXProjBadKeyName                  = 5120
	ErrXBadDocPath                      = 5121
	ErrXCursorExists                    = 5122
	ErrXExprBadOperator                 = 5150
	ErrXExprBadNumArgs                  = 5151
	ErrXExprMissingArg                  = 5152
	ErrXExprBadTypeValue                = 5153
	ErrXExprBadValue                    = 5154
	ErrXInvalidCollection               = 5156
	ErrXInvalidAdminCommand             = 5157
	ErrXExpectNotOpen                   = 5158
	ErrXExpectFailed                    = 5159
	ErrXExpectBadCondition              = 5160
	ErrXExpectBadConditionValue         = 5161
	ErrXInvalidNamespace                = 5162
	ErrXBadNotice                       = 5163
	ErrXCannotDisableNotice             = 5164
	ErrXBadConfiguration                = 5165
	ErrXMysqlxAccountMissingPermissions = 5167
)
