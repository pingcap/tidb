...
func TestSample(t *testing.T) {
	...
	t.Run("SubTestWeightedSampling", SubTestWeightedSampling(s))
	t.Run("SubTestDistributedWeightedSampling", SubTestDistributedWeightedSampling(s))
	t.Run("SubTestBuildStatsOnRowSample", SubTestBuildStatsOnRowSample(s))
}
...
func SubTestWeightedSampling(s *testSampleSuite) func(*testing.T) {
	return func(t *testing.T) {
		sampleNum := int64(20)
		rowNum := 100
		loopCnt := 1000
...
func SubTestDistributedWeightedSampling(s *testSampleSuite) func(*testing.T) {
	return func(t *testing.T) {
		sampleNum := int64(10)
		rowNum := 100
		loopCnt := 1500
...
func SubTestBuildStatsOnRowSample(s *testSampleSuite) func(*testing.T) {
	return func(t *testing.T) {
		ctx := mock.NewContext()
