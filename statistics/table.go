...
var (
	// Below functions are used to solve cycle import problem in statistics_test.go.
	// TODO: solve this problem in a better way.

	// GetRowCountByColumnRanges is a hook for getting row count by column ranges.
	...
	// GetRowCountByIntColumnRanges is a hook for getting row count by int column ranges.
	...
	// GetRowCountByIndexRanges is a hook for getting row count by index ranges.
