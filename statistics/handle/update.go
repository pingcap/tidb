...
// Deprecated: StoreQueryFeedback merges the feedback into stats collector.
...
// Deprecated: DumpStatsFeedbackToKV dumps the stats feedback to KV.
...
// Deprecated: RecalculateExpectCount recalculates the expect row count if the origin row count is estimated by pseudo.
...
// Deprecated: DumpFeedbackForIndex dumps the feedback for index.
