...
type indexUsageMap map[stmtctx.IndexUsageID]IndexUsageInformation
...
func (m indexUsageMap) updateByKey(id stmtctx.IndexUsageID, value *IndexUsageInformation) {
	item := m[id]
...
func (m indexUsageMap) update(tableID int64, indexID int64, value *IndexUsageInformation) {
	id := stmtctx.IndexUsageID{TableID: tableID, IndexID: indexID}
