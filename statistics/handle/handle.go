...
// GetNum returns the number of stats in the globalStats.
func (gs *GlobalStats) GetNum() int {
	return gs.num
}

// GetCount returns the total number of rows in the table corresponding to globalStats.
func (gs *GlobalStats) GetCount() int64 {
	return gs.count
}

// GetHistogram returns the idx histogram in the globalStats.
// If the index is bigger than the number of stats, it will return nil.
...
// GetCMSketch returns the idx CMSketch in the globalStats.
// If the index is bigger than the number of stats, it will return nil.
...
// GetTopN returns the idx TopN in the globalStats.
// If the index is bigger than the number of stats, it will return nil.
