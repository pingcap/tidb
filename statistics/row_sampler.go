...
// BuildMultiColHistAndTopNOnRowSample build a histogram and TopN for an multi-column group from samples.
// We split it from BuildColumnHistAndTopNOnRowSample since their encoding is different. One is EncodeValue, the other is EncodeKey.
func BuildMultiColHistAndTopNOnRowSample(
	ctx sessionctx.Context,
	numBuckets, numTopN int,
	id int64,
	collector *SampleCollector,
