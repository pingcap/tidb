...
{{- else if eq .type.ETName "String" }}
		val := types.CompareString(buf0.GetString(i), buf1.GetString(i), b.args[0].GetType().Collate, b.args[0].GetType().Flen)
...
{{- else if eq .type.ETName "String" }}
		case types.CompareString(buf0.GetString(i), buf1.GetString(i), b.args[0].GetType().Collate, b.args[0].GetType().Flen) == 0:
{{- else if eq .type.ETName "Duration" }}
