...
func (s *InferTypeSuite) createTestCase4TimeFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		// for field in maketime field
		{"maketime(c_int_d, c_int_d,      c_int_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 10, 0},
		{"maketime(c_int_d, c_int_d,   c_bigint_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 10, 0},
		{"maketime(c_int_d, c_int_d,    c_float_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},
		...
		{"maketime(c_int_d, c_int_d,   c_datetime)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 13, 2},
		{"maketime(c_int_d, c_int_d,       c_time)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 14, 3},
		{"maketime(c_int_d, c_int_d,     c_time_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 10, 0},
		{"maketime(c_int_d, c_int_d,  c_timestamp)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 15, 4},
		{"maketime(c_int_d, c_int_d,c_timestamp_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 10, 0},
		...
		{"maketime(c_int_d, c_int_d,     c_text_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},
		{"maketime(c_int_d, c_int_d,     c_binary)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},
		{"maketime(c_int_d, c_int_d,  c_varbinary)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},
		{"maketime(c_int_d, c_int_d,     c_blob_d)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},
		{"maketime(c_int_d, c_int_d,        c_set)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},
		{"maketime(c_int_d, c_int_d,       c_enum)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 17, 6},

		// for const in maketime func
		{"maketime(c_int_d, c_int_d,                10)", mysql.TypeDuration, charset.CharsetBin, mysql.BinaryFlag, 10, 0},
