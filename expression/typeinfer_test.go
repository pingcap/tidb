...
func (s *testInferTypeSuite) createTestCase4Constants() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"'1234'", mysql.TypeVarString, charset.CharsetUTF8MB4, mysql.NotNullFlag, 4, types.UnspecifiedLength},
		{"_utf8'1234'", mysql.TypeVarString, charset.CharsetUTF8, mysql.NotNullFlag, 4, types.UnspecifiedLength},
...
func (s *testInferTypeSuite) createTestCase4MathFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"floor(18446744073709551615)", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 20, 0},
		...
		{"ceil(18446744073709551615)", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 20, 0},
		...
		{"ceiling(18446744073709551615)", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 20, 0},
...
func (s *testInferTypeSuite) createTestCase4OpFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"18446        is true", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 1, 0},
		{"1844674.1    is true", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 1, 0},
		...
		{"18446        is false", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 1, 0},
		{"1844674.1    is false", mysql.TypeLonglong, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 1, 0},
	}
}
...
func (s *testInferTypeSuite) createTestCase4TimeFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"unix_timestamp('12:12:12.123')", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 15, 3},
		{"unix_timestamp('12:12:12.1234')", mysql.TypeNewDecimal, charset.CharsetBin, mysql.BinaryFlag | mysql.NotNullFlag, 16, 4},
		...
		{"from_unixtime(20170101.123, '%H')", mysql.TypeVarString, charset.CharsetUTF8MB4, mysql.NotNullFlag, 2, types.UnspecifiedLength},
