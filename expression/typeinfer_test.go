...
func (s *testInferTypeSuite) createTestCase4StrFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"from_base64(c_decimal    )", mysql.TypeVarString, charset.CharsetBin, mysql.BinaryFlag, -1, types.UnspecifiedLength},
		...
		{"reverse(c_decimal    )", mysql.TypeVarString, charset.CharsetUTF8MB4, 0, -1, types.UnspecifiedLength},
