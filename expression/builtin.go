...
var funcs = map[string]functionClass{
	...
	// json functions
	ast.JSONType:          &jsonTypeFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONType, 1, 1}}},
	ast.JSONExtract:       &jsonExtractFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONExtract, 2, -1}}},
	ast.JSONUnquote:       &jsonUnquoteFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONUnquote, 1, 1}}},
	ast.JSONSet:           &jsonSetFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONSet, 3, -1}}},
	ast.JSONInsert:        &jsonInsertFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONInsert, 3, -1}}},
	ast.JSONReplace:       &jsonReplaceFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONReplace, 3, -1}}},
	ast.JSONRemove:        &jsonRemoveFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONRemove, 2, -1}}},
	ast.JSONMerge:         &jsonMergeFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONMerge, 2, -1}}},
	...
	ast.JSONContains:      &jsonContainsFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONContains, 2, 3}}},
	ast.JSONContainsPath:  &jsonContainsPathFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONContainsPath, 3, -1}}},
	ast.JSONValid:         &jsonValidFunctionClass{baseFunctionClass{ast.JSONValid, 1, 1}},
	ast.JSONArrayAppend:   &jsonArrayAppendFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONArrayAppend, 3, -1}}},
	ast.JSONArrayInsert:   &jsonArrayInsertFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONArrayInsert, 3, -1}}},
	ast.JSONMergePatch:    &jsonMergePatchFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONMergePatch, 2, -1}}},
	ast.JSONMergePreserve: &jsonMergePreserveFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONMergePreserve, 2, -1}}},
	ast.JSONPretty:        &jsonPrettyFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONPretty, 1, 1}}},
	ast.JSONQuote:         &jsonQuoteFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONQuote, 1, 1}}},
	ast.JSONSearch:        &jsonSearchFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONSearch, 3, -1}}},
	ast.JSONStorageFree:   &jsonStorageFreeFunctionClass{baseFunctionClass{ast.JSONStorageFree, 1, 1}},
	ast.JSONStorageSize:   &jsonStorageSizeFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONStorageSize, 1, 1}}},
	ast.JSONDepth:         &jsonDepthFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONDepth, 1, 1}}},
	ast.JSONKeys:          &jsonKeysFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONKeys, 1, 2}}},
	ast.JSONLength:        &jsonLengthFunctionClass{baseBuiltinJSONFunctionClass{baseFunctionClass{ast.JSONLength, 1, 2}}},
