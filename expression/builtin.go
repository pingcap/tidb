...
var funcs = map[string]functionClass{
	...
	ast.Concat:          &concatFunctionClass{stringFuncClass{baseFunctionClass{ast.Concat, 1, -1}}},
	ast.ConcatWS:        &concatWSFunctionClass{stringFuncClass{baseFunctionClass{ast.ConcatWS, 2, -1}}},
	ast.Convert:         &convertFunctionClass{baseFunctionClass{ast.Convert, 2, 2}},
	ast.Elt:             &eltFunctionClass{stringFuncClass{baseFunctionClass{ast.Elt, 2, -1}}},
	ast.ExportSet:       &exportSetFunctionClass{stringFuncClass{baseFunctionClass{ast.ExportSet, 3, 5}}},
	ast.Field:           &fieldFunctionClass{stringFuncClass{baseFunctionClass{ast.Field, 2, -1}}, types.ETString},
	...
	ast.InsertFunc:      &insertFunctionClass{stringFuncClass{baseFunctionClass{ast.InsertFunc, 4, 4}}},
	ast.Instr:           &instrFunctionClass{baseFunctionClass{ast.Instr, 2, 2}},
	ast.Lcase:           &lowerFunctionClass{stringFuncClass{baseFunctionClass{ast.Lcase, 1, 1}}},
	ast.Left:            &leftFunctionClass{stringFuncClass{baseFunctionClass{ast.Left, 2, 2}}},
	...
	ast.Locate:          &locateFunctionClass{stringFuncClass{baseFunctionClass{ast.Locate, 2, 3}}},
	ast.Lower:           &lowerFunctionClass{stringFuncClass{baseFunctionClass{ast.Lower, 1, 1}}},
	ast.Lpad:            &lpadFunctionClass{stringFuncClass{baseFunctionClass{ast.Lpad, 3, 3}}},
	ast.LTrim:           &lTrimFunctionClass{baseFunctionClass{ast.LTrim, 1, 1}},
	ast.Mid:             &substringFunctionClass{stringFuncClass{baseFunctionClass{ast.Mid, 3, 3}}},
	ast.MakeSet:         &makeSetFunctionClass{stringFuncClass{baseFunctionClass{ast.MakeSet, 2, -1}}},
	...
	ast.Position:        &locateFunctionClass{stringFuncClass{baseFunctionClass{ast.Position, 2, 2}}},
	ast.Quote:           &quoteFunctionClass{baseFunctionClass{ast.Quote, 1, 1}},
	ast.Repeat:          &repeatFunctionClass{stringFuncClass{baseFunctionClass{ast.Repeat, 2, 2}}},
	ast.Replace:         &replaceFunctionClass{stringFuncClass{baseFunctionClass{ast.Replace, 3, 3}}},
	ast.Reverse:         &reverseFunctionClass{stringFuncClass{baseFunctionClass{ast.Reverse, 1, 1}}},
	ast.Right:           &rightFunctionClass{stringFuncClass{baseFunctionClass{ast.Right, 2, 2}}},
	ast.RTrim:           &rTrimFunctionClass{baseFunctionClass{ast.RTrim, 1, 1}},
	ast.Rpad:            &rpadFunctionClass{stringFuncClass{baseFunctionClass{ast.Rpad, 3, 3}}},
	...
	ast.Substring:       &substringFunctionClass{stringFuncClass{baseFunctionClass{ast.Substring, 2, 3}}},
	ast.Substr:          &substringFunctionClass{stringFuncClass{baseFunctionClass{ast.Substr, 2, 3}}},
	ast.SubstringIndex:  &substringIndexFunctionClass{stringFuncClass{baseFunctionClass{ast.SubstringIndex, 3, 3}}},
	ast.ToBase64:        &toBase64FunctionClass{baseFunctionClass{ast.ToBase64, 1, 1}},
	ast.Trim:            &trimFunctionClass{stringFuncClass{baseFunctionClass{ast.Trim, 1, 3}}},
	ast.Translate:       &translateFunctionClass{baseFunctionClass{ast.Translate, 3, 3}},
	ast.Upper:           &upperFunctionClass{stringFuncClass{baseFunctionClass{ast.Upper, 1, 1}}},
	ast.Ucase:           &upperFunctionClass{stringFuncClass{baseFunctionClass{ast.Ucase, 1, 1}}},
