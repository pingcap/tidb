...
<<<<<<< HEAD:expression/builtin_convert_charset.go
...
>>>>>>> 4674b125fc7 (expression: fix charset conversion warning and error behavior (#51191)):pkg/expression/builtin_convert_charset.go
	f, err := fc.getFunction(ctx, []Expression{expr})
	if err != nil {
		return expr
	}
