...
func (s *testEvaluatorSuite) TestColumnHashCode(c *C) {
	...
	c.Assert(col1.HashCode(nil), DeepEquals, []byte{0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc})

	col2 := &Column{
		FromID:   11,
		Position: 2,
	}
	c.Assert(col2.HashCode(nil), DeepEquals, []byte{0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xb, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2})
}
