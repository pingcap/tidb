...
func (ts *testTypeInferrerSuite) TestInferType(c *C) {
	...
	tests := []struct {
		...
		{"rpad(c_binary, 12, 'go')", mysql.TypeVarString, charset.CharsetBin, 0},
		{"rpad(c_char, 12, c_binary)", mysql.TypeVarString, charset.CharsetBin, 0},
		{"lpad('TiDB', 12, 'go')", mysql.TypeVarString, charset.CharsetUTF8, 0},
		{"lpad(c_binary, 12, 'go')", mysql.TypeVarString, charset.CharsetBin, 0},
		{"lpad(c_char, 12, c_binary)", mysql.TypeVarString, charset.CharsetBin, 0},
