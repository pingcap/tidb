...
var vecBuiltinStringCases = map[string][]vecExprBenchCase{
	...
	ast.Substring: {
		...
		},
		{
			retEvalType:   types.ETString,
			childrenTypes: []types.EvalType{types.ETString, types.ETInt, types.ETInt},
			childrenFieldTypes: []*types.FieldType{{Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin},
	...
	ast.Locate: {
		...
		},
		{
			retEvalType:        types.ETInt,
			childrenTypes:      []types.EvalType{types.ETString, types.ETString},
			childrenFieldTypes: []*types.FieldType{nil, {Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin}},
			geners:             []dataGenerator{newRandLenStrGener(0, 10), newRandLenStrGener(0, 20)},
		},
		{
			retEvalType:        types.ETInt,
		...
		},
		{
			retEvalType:        types.ETInt,
			childrenTypes:      []types.EvalType{types.ETString, types.ETString},
			childrenFieldTypes: []*types.FieldType{{Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin}, nil},
			geners:             []dataGenerator{newRandLenStrGener(0, 10), newRandLenStrGener(0, 20)},
		},
		{
			retEvalType:        types.ETInt,
		...
		},
		{
			retEvalType:        types.ETInt,
			childrenTypes:      []types.EvalType{types.ETString, types.ETString},
			childrenFieldTypes: []*types.FieldType{{Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin}, {Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin}},
			geners:             []dataGenerator{newRandLenStrGener(0, 10), newRandLenStrGener(0, 20)},
		},
		{
			retEvalType:        types.ETInt,
		...
		},
		{
			retEvalType:        types.ETInt,
			childrenTypes:      []types.EvalType{types.ETString, types.ETString, types.ETInt},
			childrenFieldTypes: []*types.FieldType{{Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin}, {Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin}, {Tp: mysql.TypeInt24}},
			geners:             []dataGenerator{newRandLenStrGener(0, 10), newRandLenStrGener(0, 20), newRangeInt64Gener(-10, 20)},
		},
		{
			retEvalType:        types.ETInt,
	...
	ast.Instr: {
		...
		{retEvalType: types.ETInt, childrenTypes: []types.EvalType{types.ETString, types.ETString},
			childrenFieldTypes: []*types.FieldType{
				{Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin},
				{Tp: mysql.TypeString, Flag: mysql.BinaryFlag, Charset: charset.CharsetBin, Collate: charset.CollationBin},
			},
		},
		{retEvalType: types.ETInt, childrenTypes: []types.EvalType{types.ETString, types.ETString},
