...
var vecBuiltinArithmeticCases = map[string][]vecExprBenchCase{
	...
	ast.Minus: {
		...
		{retEvalType: types.ETInt, childrenTypes: []types.EvalType{types.ETInt, types.ETInt},
			childrenFieldTypes: []*types.FieldType{{Tp: mysql.TypeLonglong}, {Tp: mysql.TypeLonglong}},
			geners: []dataGenerator{
				newRangeInt64Gener(math.MinInt64, math.MaxInt64),
				newRangeInt64Gener(math.MinInt64, math.MaxInt64),
			},
		},
		{retEvalType: types.ETInt, childrenTypes: []types.EvalType{types.ETInt, types.ETInt},
		...
		{retEvalType: types.ETInt, childrenTypes: []types.EvalType{types.ETInt, types.ETInt},
			...
			sqlMode: mysql.ModeNoUnsignedSubtraction,
		},
		{retEvalType: types.ETInt, childrenTypes: []types.EvalType{types.ETInt, types.ETInt},
			childrenFieldTypes: []*types.FieldType{
				{Tp: mysql.TypeLonglong, Flag: mysql.UnsignedFlag},
