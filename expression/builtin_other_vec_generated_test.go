...
var vecBuiltinOtherGeneratedCases = map[string][]vecExprBenchCase{
	ast.In: {
		...
		// builtinInDecimalSig with const arguments
		{
			...
			constants: []*Constant{
				nil,
				{Value: types.NewDecimalDatum(types.NewDecFromInt(10)), RetType: types.NewFieldType(mysql.TypeUnspecified)},
				{Value: types.NewDecimalDatum(types.NewDecFromInt(20)), RetType: types.NewFieldType(mysql.TypeUnspecified)},
			},
		},
