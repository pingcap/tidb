...
func (s *testEvaluatorSuite) TestStrToDate(c *C) {
	tests := []struct {
		...
		{"31/may/2016 12:34:56.1234", "%d/%b/%Y %H:%i:%S.%f", true, time.Date(2016, 5, 31, 12, 34, 56, 123400000, time.Local)},
		{"30/april/2016 12:34:56.", "%d/%M/%Y %H:%i:%s.%f", true, time.Date(2016, 4, 30, 12, 34, 56, 0, time.Local)},
		{"31/mAy/2016 12:34:56.1234", "%d/%b/%Y %H:%i:%S.%f", true, time.Date(2016, 5, 31, 12, 34, 56, 123400000, time.Local)},
		{"30/apRil/2016 12:34:56.", "%d/%M/%Y %H:%i:%s.%f", true, time.Date(2016, 4, 30, 12, 34, 56, 0, time.Local)},
	}
