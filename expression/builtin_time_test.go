...
func (s *testEvaluatorSuite) TestZeroDateTimeCompatibility(c *C) {
	tests := []struct {
		f builtinFunc
		res int64
		isNull bool
		...
		{&builtinYearSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}}}}, 0, false, false},
		{&builtinYearSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinDayOfMonthSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}}}}, 0, false, false},
		{&builtinDayOfMonthSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinDayOfYearSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}}}}, 0, false, false},
		{&builtinDayOfYearSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinDayOfWeekSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}}}}, 0, false, false},
		{&builtinDayOfWeekSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinQuarterSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}}}}, 0, false, false},
		{&builtinQuarterSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}, &Constant{Value: types.NewStringDatum("DAY"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, false, false},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}, &Constant{Value: types.NewStringDatum("DAY"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}, &Constant{Value: types.NewStringDatum("Month"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, false, false},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}, &Constant{Value: types.NewStringDatum("Month"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}, &Constant{Value: types.NewStringDatum("YEAR"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, false, false},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}, &Constant{Value: types.NewStringDatum("YEAR"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}, &Constant{Value: types.NewStringDatum("QUARTER"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, false, false},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}, &Constant{Value: types.NewStringDatum("QUARTER"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewIntDatum(0), RetType: types.NewFieldType(mysql.TypeLonglong)}, &Constant{Value: types.NewStringDatum("WEEK"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, false, false},
		{&builtinExtractDatetimeSig{baseBuiltinFunc{args: []Expression{&Constant{Value: types.NewStringDatum("0000-00-00"), RetType: types.NewFieldType(mysql.TypeVarchar)}, &Constant{Value: types.NewStringDatum("WEEK"), RetType: types.NewFieldType(mysql.TypeVarchar)}}}}, 0, true, true},
	}

	for _, t := range tests {
		val, isNull, hasWarn := t.f.evalInt(chunk.Row{})
		c.Assert(val, Equals, t.res)
		c.Assert(isNull, Equals, t.isNull)
		c.Assert(hasWarn != nil, Equals, t.hasWarn)
	}
}
