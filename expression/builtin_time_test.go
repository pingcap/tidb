...
func (s *testEvaluatorSuite) TestMakeTime(c *C) {
	tbl := []struct {
		...
		{[]interface{}{838, 0, 59.1}, "838:00:59.1"},
		{[]interface{}{838, 50, 59.999}, "838:50:59.999"},
		{[]interface{}{838, 58, 59.1}, "838:58:59.1"},
		{[]interface{}{838, 58, 59.999}, "838:58:59.999"}, {[]interface{}{838, 59, 59.1}, "838:59:59.0"},
