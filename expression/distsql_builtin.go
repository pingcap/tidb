...
func getSignatureByPB(ctx sessionctx.Context, sigCode tipb.ScalarFuncSig, tp *tipb.FieldType, args []Expression) (f builtinFunc, e error) {
	...
	case tipb.ScalarFuncSig_RegexpSig:
		f = &builtinRegexpLikeFuncSig{regexpBaseFuncSig{base, regexpMemorizedSig{nil, nil}, sync.Once{}, sync.Mutex{}}}
	case tipb.ScalarFuncSig_RegexpUTF8Sig:
		f = &builtinRegexpLikeFuncSig{regexpBaseFuncSig{base, regexpMemorizedSig{nil, nil}, sync.Once{}, sync.Mutex{}}}
	case tipb.ScalarFuncSig_RegexpLikeSig:
		f = &builtinRegexpLikeFuncSig{regexpBaseFuncSig{base, regexpMemorizedSig{nil, nil}, sync.Once{}, sync.Mutex{}}}
	case tipb.ScalarFuncSig_RegexpSubstrSig:
		f = &builtinRegexpSubstrFuncSig{regexpBaseFuncSig{base, regexpMemorizedSig{nil, nil}, sync.Once{}, sync.Mutex{}}}
	case tipb.ScalarFuncSig_RegexpInStrSig:
		f = &builtinRegexpInStrFuncSig{regexpBaseFuncSig{base, regexpMemorizedSig{nil, nil}, sync.Once{}, sync.Mutex{}}}
	case tipb.ScalarFuncSig_RegexpReplaceSig:
		f = &builtinRegexpReplaceFuncSig{regexpBaseFuncSig{base, regexpMemorizedSig{nil, nil}, sync.Once{}, sync.Mutex{}}}
