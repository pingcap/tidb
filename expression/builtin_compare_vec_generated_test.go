...
var vecBuiltinCompareGeneratedCases = map[string][]vecExprBenchCase{

	ast.Coalesce: {
		// builtinCoalesceIntSig
		{
...
func (s *testEvaluatorSuite) TestVectorizedBuiltinCompareEvalOneVecGenerated(c *C) {
	testVectorizedEvalOneVec(c, vecBuiltinCompareGeneratedCases)
}

func (s *testEvaluatorSuite) TestVectorizedBuiltinCompareFuncGenerated(c *C) {
	testVectorizedBuiltinFunc(c, vecBuiltinCompareGeneratedCases)
}

func BenchmarkVectorizedBuiltinCompareEvalOneVecGenerated(b *testing.B) {
	benchmarkVectorizedEvalOneVec(b, vecBuiltinCompareGeneratedCases)
}

func BenchmarkVectorizedBuiltinCompareFuncGenerated(b *testing.B) {
	benchmarkVectorizedBuiltinFunc(b, vecBuiltinCompareGeneratedCases)
}
