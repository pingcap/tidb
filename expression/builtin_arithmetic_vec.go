...
func (b *builtinArithmeticIntDivideIntUnsignedUnsignedSig) vectorized() bool {
	return true
}

func (b *builtinArithmeticIntDivideIntUnsignedUnsignedSig) vecEvalInt(input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
...
func (b *builtinArithmeticIntDivideIntUnsignedSignedSig) vectorized() bool {
	return true
}

func (b *builtinArithmeticIntDivideIntUnsignedSignedSig) vecEvalInt(input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	lhsBuf, err := b.bufAllocator.get(types.ETInt, n)
	if err != nil {
		return err
...
func (b *builtinArithmeticIntDivideIntSignedSignedSig) vectorized() bool {
	return true
}

func (b *builtinArithmeticIntDivideIntSignedSignedSig) vecEvalInt(input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	lhsBuf, err := b.bufAllocator.get(types.ETInt, n)
	if err != nil {
		return err
...
func (b *builtinArithmeticIntDivideIntSignedUnsignedSig) vectorized() bool {
	return true
}

func (b *builtinArithmeticIntDivideIntSignedUnsignedSig) vecEvalInt(input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	lhsBuf, err := b.bufAllocator.get(types.ETInt, n)
	if err != nil {
		return err
