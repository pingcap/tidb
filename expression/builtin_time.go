...
func (c *strToDateFunctionClass) getRetTp(arg Expression, ctx sessionctx.Context) (tp byte, fsp int) {
...
// See https://dev.mysql.com/doc/refman/5.7/en/date-and-time-functions.html#function_time-format
func (b *builtinTimeFormatSig) formatTime(t types.Duration, formatMask string, ctx sessionctx.Context) (res string, err error) {
	t2 := types.Time{
