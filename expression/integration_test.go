...
func (s *testIntegrationSuite) TestMathBuiltin(c *C) {
	...
	tk.MustExec("insert into t values(2.99999999900000000000);")
	tk.MustQuery("select a, ceil(a) from t where ceil(a) > 1;").Check(testkit.Rows("2.99999999900000000000 3"))
	tk.MustQuery("select a, ceil(a) from t;").Check(testkit.Rows("2.99999999900000000000 3"))
