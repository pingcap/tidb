...
func (s *testIntegrationSuite) TestBuiltin(c *C) {
	...
	result = tk.MustQuery(`select cast("1101020304.111" as datetime);`)
	result.Check(testkit.Rows("2011-01-02 03:04:11"))
	tk.MustQuery("show warnings;").Check(testkit.Rows("Warning 1292 Truncated incorrect datetime value: '1101020304.111'"))
