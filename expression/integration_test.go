...
func (s *testIntegrationSerialSuite) TestMixCollation(c *C) {
	...
	tk.MustQuery("select field('s', mb4general, mb4unicode, mb4bin) from t;").Check(testkit.Rows("1"))
	...
	tk.MustGetErrMsg("select field('s', mb4general, mb4unicode collate utf8mb4_bin, mb4bin collate utf8mb4_unicode_ci) from t;", "[expression:1271]Illegal mix of collations for operation 'field'")
...
func (s *testIntegrationSerialSuite) TestCollateStringFunction(c *C) {
	...
	tk.MustQuery("select field('a', 'b', 'A' collate utf8mb4_unicode_ci);").Check(testkit.Rows("0"))
	tk.MustQuery("select field('a', 'b', 'a ' collate utf8mb4_unicode_ci);").Check(testkit.Rows("2"))
	tk.MustQuery("select field('a', 'b', 'A' collate utf8mb4_general_ci);").Check(testkit.Rows("0"))
	...
	tk.MustQuery("select INSTR(p2,n3) from t1;").Check(testkit.Rows("1"))
	...
	tk.MustQuery("select INSTR(p4,n3) from t1;").Check(testkit.Rows("1"))
	...
	tk.MustQuery("select LOCATE(p1,n2) from t1;").Check(testkit.Rows("0", "1", "1"))
	...
	tk.MustQuery("select LOCATE(p3,n2) from t1;").Check(testkit.Rows("0", "1", "1"))
	tk.MustQuery("select LOCATE(p3,n3) from t1;").Check(testkit.Rows("0", "0", "0"))
	tk.MustQuery("select LOCATE(p3,n4) from t1;").Check(testkit.Rows("0", "1", "1"))
	tk.MustQuery("select LOCATE(p4,n1) from t1;").Check(testkit.Rows("0", "0", "0"))
...
func (s *testIntegrationSerialSuite) TestIssue18662(c *C) {
	...
	tk.MustExec("create table t(a varchar(10) collate utf8mb4_bin, b varchar(10) collate utf8mb4_general_ci);")
	tk.MustExec("insert into t (a, b) values ('a', 'A');")
	tk.MustQuery("select * from t where field('A', a collate utf8mb4_general_ci, b) > 1;").Check(testkit.Rows("a A"))
	tk.MustQuery("select * from t where field('A', a, b collate utf8mb4_general_ci) > 1;").Check(testkit.Rows("a A"))
