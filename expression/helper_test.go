...
func TestIsCurrentTimestampExpr(t *testing.T) {
	...
	require.True(t, v)
	v = IsValidCurrentTimestampExpr(buildTimestampFuncCallExpr(3), &types.FieldTypeBuilder{Decimal: 3})
	require.True(t, v)
	v = IsValidCurrentTimestampExpr(buildTimestampFuncCallExpr(1), &types.FieldTypeBuilder{Decimal: 3})
	require.False(t, v)
	v = IsValidCurrentTimestampExpr(buildTimestampFuncCallExpr(0), &types.FieldTypeBuilder{Decimal: 3})
	require.False(t, v)
	v = IsValidCurrentTimestampExpr(buildTimestampFuncCallExpr(2), &types.FieldTypeBuilder{Decimal: 0})
	require.False(t, v)
