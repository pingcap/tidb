...
http_archive(
    ...
    urls = [
        "http://bazel-cache.pingcap.net:8080/bazelbuild/rules_go/releases/download/v0.49.0/rules_go-v0.49.0.zip",
        "http://ats.apps.svc/bazelbuild/rules_go/releases/download/v0.49.0/rules_go-v0.49.0.zip",
