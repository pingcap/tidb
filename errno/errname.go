...
var MySQLErrName = map[uint16]*mysql.ErrMessage{
	...
	ErrTxnRetryable:               mysql.Message("Error: KV error safe to retry %s ", nil),
	...
	ErrJSONObjectKeyTooLong: mysql.Message("TiDB doesn't yet support JSON object with key length >= 65536", nil),
