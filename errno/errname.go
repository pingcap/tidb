...
var MySQLErrName = map[uint16]string{
	...
	ErrFunctionalIndexOnJSONOrGeometryFunction:               "Cannot create a expression index on a function that returns a JSON or GEOMETRY value",
	ErrFunctionalIndexRefAutoIncrement:                       "Expression index '%s' cannot refer to an auto-increment column",
	ErrCannotDropColumnFunctionalIndex:                       "Cannot drop column '%s' because it is used by a expression index. In order to drop the column, you must remove the expression index",
	ErrFunctionalIndexPrimaryKey:                             "The primary key cannot be a expression index",
	ErrFunctionalIndexOnLob:                                  "Cannot create a expression index on an expression that returns a BLOB or TEXT. Please consider using CAST",
	...
	ErrDependentByFunctionalIndex:                            "Column '%s' has a expression index dependency and cannot be dropped or renamed",
