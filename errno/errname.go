...
var MySQLErrName = map[uint16]*mysql.ErrMessage{
	...
	ErrAccountHasBeenAutoLocked:                              mysql.Message("Access denied for user '%s'@'%s'. Account is blocked for %s day(s) (%s day(s) remaining) due to %d consecutive failed logins.", nil),
