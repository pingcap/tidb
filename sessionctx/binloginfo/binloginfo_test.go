...
func (s *testBinlogSuite) TestAddSpecialComment(c *C) {
	testCase := []struct {
		...
		{
			"create table t1 (id int auto_random ( 3 ) primary key) auto_random = 100;",
			"create table t1 (id int /*T![auto_rand] auto_random ( 3 ) */ primary key) /*T![auto_rand] auto_random = 100 */ ;",
		},
		{
			"create table t1 (id int auto_random primary key) auto_random = 50;",
			"create table t1 (id int /*T![auto_rand] auto_random */ primary key) /*T![auto_rand] auto_random = 50 */ ;",
		},
		{
