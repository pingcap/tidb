...
func (s *testVarsutilSuite) TestNewSessionVars(c *C) {
	...
	c.Assert(vars.IndexLookupConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.IndexSerialScanConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.IndexLookupJoinConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.HashJoinConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.ProjectionConcurrency, Equals, int64(ExecutorConcurrency))
	c.Assert(vars.HashAggPartialConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.HashAggFinalConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.WindowConcurrency, Equals, ExecutorConcurrency)
	c.Assert(vars.DistSQLScanConcurrency, Equals, ExecutorConcurrency)
