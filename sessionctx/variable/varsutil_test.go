...
func (s *testVarsutilSuite) TestVarsutil(c *C) {
	...
	c.Assert(err, IsNil)
	val, err := v.GetSystemVar("autocommit")
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar("foreign_key_checks")
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar("sql_mode")
	c.Assert(err, IsNil)
	...
	val, err = v.GetSystemVar(TiDBConfig)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBEnableStreaming)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "ON")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBRetryLimit)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBEnableTablePartition)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "ON")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBEnableListTablePartition)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "ON")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptJoinReorderThreshold)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBCheckMb4ValueInUTF8)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "ON")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBLowResolutionTSO)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "ON")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptCorrelationThreshold)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptCPUFactor)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptCopCPUFactor)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "5.0")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptTiFlashConcurrencyFactor)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "5.0")
	c.Assert(v.CopCPUFactor, Equals, 5.0)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptNetworkFactor)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptScanFactor)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "3.0")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptDescScanFactor)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "5.0")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptSeekFactor)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptMemoryFactor)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptDiskFactor)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBOptConcurrencyFactor)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "5.0")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBReplicaRead)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBStmtSummaryMaxSQLLength)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "10")
	...
	c.Assert(err, IsNil)
	val, err = v.GetSystemVar(TiDBEnableChangeColumnType)
	c.Assert(err, IsNil)
	c.Assert(val, Equals, "ON")
