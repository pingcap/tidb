...
type SessionVars struct {
	...
	// EnableAlterPartitionPlacement indicates whether a user can alter table partition placement rules.
	EnableAlterPartitionPlacement bool
...
func NewSessionVars() *SessionVars {
	vars := &SessionVars{
		...
		EnableAlterPartitionPlacement: DefTiDBAlterPartitionPlacement,
...
func (s *SessionVars) SetSystemVar(name string, val string) error {
	...
	case TiDBEnableAlterPartitionPlacement:
		s.EnableAlterPartitionPlacement = TiDBOptOn(val)
