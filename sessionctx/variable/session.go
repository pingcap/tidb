...
type Concurrency struct {
	...
	// streamAggConcurrency is the number of concurrent stream-agg worker.
...
// SetStreamAggConcurrency set the number of concurrent stream-agg worker.
...
// StreamAggConcurrency return the number of concurrent stream-agg worker.
