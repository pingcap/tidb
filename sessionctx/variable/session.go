...
type SessionVars struct {
	...
	// MPPOuterJoinWithFixedBuildSide means in MPP plan, always use right(left) table as build side for left(right) out join
	MPPOuterJoinWithFixedBuildSide bool
...
func NewSessionVars() *SessionVars {
	vars := &SessionVars{
		...
		MPPOuterJoinWithFixedBuildSide: DefOptMPPOuterJoinWithFixedBuildSide,
...
func (s *SessionVars) SetSystemVar(name string, val string) error {
	...
	case TiDBOptMPPOuterJoinWithFixedBuildSide:
		s.MPPOuterJoinWithFixedBuildSide = TiDBOptOn(val)
