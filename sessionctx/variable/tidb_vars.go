...
const (
	...
	// TiDBPrepPlanCacheMemoryMonitor indicates whether to enable prepared plan cache monitor
	TiDBPrepPlanCacheMemoryMonitor = "tidb_prepared_plan_cache_memory_monitor"
...
const (
	...
	DefTiDBPrepPlanCacheMemoryMonitor              = true
