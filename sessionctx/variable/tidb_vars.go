...
const (
	...
	// TiDBEnableMPPBalanceRegionWithContinuity indicates whether MPP balance logic will take account of region's continuity in TiFlash.
	TiDBEnableMPPBalanceRegionWithContinuity = "tidb_enable_mpp_balance_region_with_continuity"
