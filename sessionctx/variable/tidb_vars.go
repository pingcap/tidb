...
const (
	...
	// tidb_opt_always_prefer_index is used to enable/disable the optimizer to always prefer index scan over table scan, ignoring their costs.
	TiDBOptAlwaysPreferIndex = "tidb_opt_always_prefer_index"
