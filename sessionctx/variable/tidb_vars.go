...
const (
	...
	// TiDBMemoryUsageAlarmKeepFilesNum indicates the number of saved alarm files.
	TiDBMemoryUsageAlarmKeepFilesNum = "tidb_memory_usage_alarm_keep_files_num"
...
const (
	...
	DefMemoryUsageAlarmKeepFilesNum                = 5
...
var (
	...
	MemoryUsageAlarmKeepFilesNum        = atomic.NewInt64(DefMemoryUsageAlarmKeepFilesNum)
