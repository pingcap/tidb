...
var (
	...
	ErrWarnDeprecatedSyntaxIgnoreSetting = dbterror.ClassVariable.NewStdErr(mysql.ErrWarnDeprecatedSyntaxNoReplacement, pmysql.Message("%s is deprecated and setting it will not have any effect.", nil))
)
