...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBSlowLogMasking, Value: BoolToIntStr(DefTiDBRedactLog)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBRedactLog, Value: BoolToIntStr(DefTiDBRedactLog)},
