...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal, Name: TiDBSuperReadOnly, Value: BoolToOnOff(DefTiDBSuperReadOnly), Type: TypeBool, SetGlobal: func(s *SessionVars, val string) error {
		on := TiDBOptOn(val)
		if !on {
			if RestrictedReadOnly.Load() {
