...
var defaultSysVars = []*SysVar{
  ...
  {Scope: ScopeSession, Name: TIDBMemQuotaStatistics, Value: strconv.FormatInt(config.GetGlobalConfig().MemQuotaStatistics, 10), Type: TypeInt, MinValue: -1, MaxValue: math.MaxInt64},
