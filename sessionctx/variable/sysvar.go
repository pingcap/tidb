...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TmpTableSize, Value: "16777216"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxExecutionTime, Value: "0"},
	...
	{Scope: ScopeNone, Name: "tls_version", Value: "TLSv1TLSv1.1,TLSv1.2"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLAutoIsNull, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxSortLength, Value: "1024"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLBigSelects, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "optimizer_trace", Value: "enabled=offone_line=off"},
	...
	{Scope: ScopeNone, Name: "optimizer_switch", Value: "index_merge=onindex_merge_union=on,index_merge_sort_union=on,index_merge_intersection=on,engine_condition_pushdown=on,index_condition_pushdown=on,mrr=on,mrr_cost_based=on,block_nested_loop=on,batched_key_access=off,materialization=on,semijoin=on,loosescan=on,firstmatch=on,subquery_materialization_cost_based=on,use_index_extensions=on"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: UniqueChecks, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "optimizer_trace_features", Value: "greedy_search=onrange_optimizer=on,dynamic_range=on,repeated_subselect=on"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: InnodbLockWaitTimeout, Value: strconv.FormatInt(DefInnodbLockWaitTimeout, 10)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: GroupConcatMaxLen, Value: "1024"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLSafeUpdates, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: EndMakersInJSON, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: WindowingUseHighPrecision, Value: "ON"},
