...
var defaultSysVars = []*SysVar{
	...
	{ScopeGlobal | ScopeSession, TiDBDistSQLScanConcurrency, strconv.Itoa(concurrencyUnset)},
	...
	{ScopeGlobal | ScopeSession, TiDBIndexLookupConcurrency, strconv.Itoa(concurrencyUnset)},
	{ScopeGlobal | ScopeSession, TiDBIndexLookupJoinConcurrency, strconv.Itoa(concurrencyUnset)},
	...
	{ScopeGlobal | ScopeSession, TiDBHashJoinConcurrency, strconv.Itoa(concurrencyUnset)},
	{ScopeGlobal | ScopeSession, TiDBProjectionConcurrency, strconv.Itoa(concurrencyUnset)},
	{ScopeGlobal | ScopeSession, TiDBHashAggPartialConcurrency, strconv.Itoa(concurrencyUnset)},
	{ScopeGlobal | ScopeSession, TiDBHashAggFinalConcurrency, strconv.Itoa(concurrencyUnset)},
	{ScopeGlobal | ScopeSession, TiDBWindowConcurrency, strconv.Itoa(concurrencyUnset)},
