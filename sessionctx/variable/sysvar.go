...
const (
	...
	TypeDouble TypeFlag = 7
	// TypeUnsigned for Unsigned integer
	TypeUnsigned TypeFlag = 8
)
...
type SysVar struct {
	...
	// SetVarHintApply indicate whether variable is hintable (optional)
...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal, Name: FlushTime, Value: "0"},
	{Scope: ScopeNone, Name: "performance_schema_max_mutex_classes", Value: "200"},
	{Scope: ScopeGlobal | ScopeSession, Name: LowPriorityUpdates, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: OldPasswords, Value: "0"},
	{Scope: ScopeNone, Name: "innodb_version", Value: "5.6.25"},
	{Scope: ScopeGlobal, Name: MaxConnections, Value: "151"},
	{Scope: ScopeGlobal | ScopeSession, Name: BigTables, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: ValidatePasswordCheckUserName, Value: "0"},
	{Scope: ScopeGlobal, Name: "validate_password_number_count", Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: DefaultWeekFormat, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: MaxConnectErrors, Value: "100"},
	{Scope: ScopeGlobal, Name: SyncBinlog, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: InnodbFastShutdown, Value: "1"},
	...
	{Scope: ScopeGlobal, Name: TableDefinitionCache, Value: "-1"},
	{Scope: ScopeNone, Name: SkipNameResolve, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLModeVar, Value: mysql.DefaultSQLMode, SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TmpTableSize, Value: "16777216", SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: "innodb_max_purge_lag", Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: "preload_buffer_size", Value: "32768"},
	{Scope: ScopeGlobal, Name: CheckProxyUsers, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: RangeAllocBlockSize, Value: "4096", SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: ConnectTimeout, Value: "10"},
	{Scope: ScopeGlobal | ScopeSession, Name: MaxExecutionTime, Value: "0", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLLogBin, Value: "1"},
	{Scope: ScopeGlobal, Name: SuperReadOnly, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: InnodbCmpPerIndexEnabled, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: GeneralLog, Value: "0"},
	{Scope: ScopeGlobal, Name: "validate_password_dictionary_file", Value: ""},
	{Scope: ScopeGlobal, Name: BinlogOrderCommits, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: "time_zone", Value: "SYSTEM", SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: "innodb_max_dirty_pages_pct", Value: "75"},
	{Scope: ScopeGlobal, Name: InnodbFilePerTable, Value: "1"},
	...
	{Scope: ScopeGlobal, Name: InnodbPrintAllDeadlocks, Value: "0"},
	{Scope: ScopeNone, Name: "innodb_autoinc_lock_mode", Value: "1"},
	{Scope: ScopeGlobal, Name: "key_buffer_size", Value: "8388608"},
	{Scope: ScopeGlobal | ScopeSession, Name: ForeignKeyChecks, Value: "OFF", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: OfflineMode, Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: InnodbStrictMode, Value: "1"},
	{Scope: ScopeGlobal, Name: "innodb_rollback_segments", Value: "128"},
	{Scope: ScopeGlobal | ScopeSession, Name: JoinBufferSize, Value: "262144", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: InnodbAdaptiveHashIndex, Value: "1"},
	{Scope: ScopeGlobal, Name: InnodbFtEnableStopword, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxLengthForSortData, Value: "1024", SetVarHintApply: true},
	{Scope: ScopeNone, Name: "character_set_system", Value: "utf8"},
	{Scope: ScopeGlobal | ScopeSession, Name: InteractiveTimeout, Value: "28800"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxUserConnections, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: BinlogRowQueryLogEvents, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: InnodbStatusOutputLocks, Value: "0"},
	{Scope: ScopeNone, Name: "performance_schema_accounts_size", Value: "100"},
	{Scope: ScopeGlobal | ScopeSession, Name: MaxErrorCount, Value: "64", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: LogSlowAdminStatements, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: LogQueriesNotUsingIndexes, Value: "0"},
	{Scope: ScopeSession, Name: "timestamp", Value: ""},
	{Scope: ScopeGlobal | ScopeSession, Name: QueryCacheWlockInvalidate, Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: SQLBufferResult, Value: "OFF", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: AutoIncrementIncrement, Value: strconv.FormatInt(DefAutoIncrementIncrement, 10)},
	{Scope: ScopeGlobal | ScopeSession, Name: AutoIncrementOffset, Value: strconv.FormatInt(DefAutoIncrementOffset, 10)},
	{Scope: ScopeGlobal | ScopeSession, Name: MaxHeapTableSize, Value: "16777216", SetVarHintApply: true},
	{Scope: ScopeGlobal | ScopeSession, Name: DivPrecisionIncrement, Value: "4", SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: "innodb_lru_scan_depth", Value: "1024"},
	{Scope: ScopeGlobal, Name: "innodb_purge_rseg_truncate_frequency", Value: ""},
	{Scope: ScopeGlobal | ScopeSession, Name: SQLAutoIsNull, Value: "0", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SortBufferSize, Value: "262144", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: InnodbBufferPoolDumpNow, Value: "0"},
	{Scope: ScopeGlobal, Name: RelayLogPurge, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxJoinSize, Value: "18446744073709551615", SetVarHintApply: true},
	{Scope: ScopeNone, Name: CoreFile, Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: MaxSeeksForKey, Value: "18446744073709551615", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxSortLength, Value: "1024", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: InnodbBufferPoolLoadNow, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: Profiling, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLQuoteShowCreate, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: BulkInsertBufferSize, Value: "8388608", SetVarHintApply: true},
	{Scope: ScopeGlobal | ScopeSession, Name: BinlogDirectNonTransactionalUpdates, Value: "0"},
	{Scope: ScopeGlobal, Name: "innodb_change_buffering", Value: "all"},
	{Scope: ScopeGlobal | ScopeSession, Name: SQLBigSelects, Value: "1", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: ReadRndBufferSize, Value: "262144", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: InnodbBufferPoolLoadAbort, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: OldAlterTable, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: InnodbCommitConcurrency, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: InnodbRandomReadAhead, Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: UniqueChecks, Value: "1", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: ReadBufferSize, Value: "131072", SetVarHintApply: true},
	{Scope: ScopeNone, Name: "innodb_read_io_threads", Value: "4"},
	{Scope: ScopeGlobal | ScopeSession, Name: MaxSpRecursionDepth, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLWarnings, Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: KeepFilesOnCreate, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: AutoCommit, Value: "1"},
	{Scope: ScopeSession, Name: "insert_id", Value: ""},
	{Scope: ScopeGlobal | ScopeSession, Name: DefaultTmpStorageEngine, Value: "InnoDB", SetVarHintApply: true},
	{Scope: ScopeGlobal | ScopeSession, Name: OptimizerSearchDepth, Value: "62", SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: MaxPointsInGeometry, Value: "4096", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: MaxPreparedStmtCount, Value: strconv.FormatInt(DefMaxPreparedStmtCount, 10)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: UpdatableViewsWithLimit, Value: "YES", SetVarHintApply: true},
	{Scope: ScopeGlobal | ScopeSession, Name: OptimizerPruneLevel, Value: "1", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: ShowOldTemporals, Value: "0"},
	{Scope: ScopeGlobal, Name: "query_cache_limit", Value: "1048576"},
	{Scope: ScopeGlobal, Name: "innodb_buffer_pool_size", Value: "134217728"},
	{Scope: ScopeGlobal, Name: InnodbAdaptiveFlushing, Value: "1"},
	{Scope: ScopeNone, Name: "datadir", Value: "/usr/local/mysql/data/"},
	{Scope: ScopeGlobal | ScopeSession, Name: WaitTimeout, Value: strconv.FormatInt(DefWaitTimeout, 10)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: InnodbLockWaitTimeout, Value: strconv.FormatInt(DefInnodbLockWaitTimeout, 10), SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: LocalInFile, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: InnodbTableLocks, Value: "1"},
	{Scope: ScopeNone, Name: PerformanceSchema, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: GroupConcatMaxLen, Value: "1024", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: Flush, Value: "0"},
	{Scope: ScopeGlobal | ScopeSession, Name: EqRangeIndexDiveLimit, Value: "10", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal, Name: MyISAMUseMmap, Value: "0"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: MaxAllowedPacket, Value: "67108864"},
	...
	{Scope: ScopeGlobal, Name: "validate_password_length", Value: "8"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLSafeUpdates, Value: "0", SetVarHintApply: true},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: EndMakersInJSON, Value: "0", SetVarHintApply: true},
	{Scope: ScopeGlobal, Name: AvoidTemporalUpgrade, Value: "0"},
	{Scope: ScopeGlobal, Name: "key_cache_age_threshold", Value: "300"},
	{Scope: ScopeGlobal, Name: InnodbStatusOutput, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: "thread_pool_size", Value: "16"},
	{Scope: ScopeGlobal | ScopeSession, Name: WindowingUseHighPrecision, Value: "ON", SetVarHintApply: true},
	/* TiDB specific variables */
	{Scope: ScopeSession, Name: TiDBSnapshot, Value: ""},
	{Scope: ScopeSession, Name: TiDBOptAggPushDown, Value: BoolToIntStr(DefOptAggPushDown)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBOptBCJ, Value: BoolToIntStr(DefOptBCJ)},
	{Scope: ScopeSession, Name: TiDBOptDistinctAggPushDown, Value: BoolToIntStr(config.GetGlobalConfig().Performance.DistinctAggPushDown)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBExecutorConcurrency, Value: strconv.Itoa(DefExecutorConcurrency)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBDistSQLScanConcurrency, Value: strconv.Itoa(DefDistSQLScanConcurrency)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBOptInSubqToJoinAndAgg, Value: BoolToIntStr(DefOptInSubqToJoinAndAgg)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBOptCorrelationExpFactor, Value: strconv.Itoa(DefOptCorrelationExpFactor)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBIndexJoinBatchSize, Value: strconv.Itoa(DefIndexJoinBatchSize)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBIndexLookupSize, Value: strconv.Itoa(DefIndexLookupSize)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBIndexSerialScanConcurrency, Value: strconv.Itoa(DefIndexSerialScanConcurrency)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBSkipUTF8Check, Value: BoolToIntStr(DefSkipUTF8Check)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBSkipASCIICheck, Value: BoolToIntStr(DefSkipASCIICheck)},
	{Scope: ScopeSession, Name: TiDBBatchInsert, Value: BoolToIntStr(DefBatchInsert)},
	{Scope: ScopeSession, Name: TiDBBatchDelete, Value: BoolToIntStr(DefBatchDelete)},
	{Scope: ScopeSession, Name: TiDBBatchCommit, Value: BoolToIntStr(DefBatchCommit)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBDMLBatchSize, Value: strconv.Itoa(DefDMLBatchSize)},
	...
	{Scope: ScopeSession, Name: TIDBMemQuotaTopn, Value: strconv.FormatInt(DefTiDBMemQuotaTopn, 10)},
	{Scope: ScopeSession, Name: TIDBMemQuotaIndexLookupReader, Value: strconv.FormatInt(DefTiDBMemQuotaIndexLookupReader, 10)},
	{Scope: ScopeSession, Name: TIDBMemQuotaIndexLookupJoin, Value: strconv.FormatInt(DefTiDBMemQuotaIndexLookupJoin, 10)},
	{Scope: ScopeSession, Name: TIDBMemQuotaNestedLoopApply, Value: strconv.FormatInt(DefTiDBMemQuotaNestedLoopApply, 10)},
	{Scope: ScopeSession, Name: TiDBEnableStreaming, Value: "0"},
	{Scope: ScopeSession, Name: TiDBEnableChunkRPC, Value: "1"},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBProjectionConcurrency, Value: strconv.Itoa(DefTiDBProjectionConcurrency)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBDisableTxnAutoRetry, Value: BoolToIntStr(DefTiDBDisableTxnAutoRetry)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBConstraintCheckInPlace, Value: BoolToIntStr(DefTiDBConstraintCheckInPlace)},
	...
	{Scope: ScopeSession, Name: TiDBOptimizerSelectivityLevel, Value: strconv.Itoa(DefTiDBOptimizerSelectivityLevel)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableWindowFunction, Value: BoolToIntStr(DefEnableWindowFunction)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableVectorizedExpression, Value: BoolToIntStr(DefEnableVectorizedExpression)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableFastAnalyze, Value: BoolToIntStr(DefTiDBUseFastAnalyze)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBSkipIsolationLevelCheck, Value: BoolToIntStr(DefTiDBSkipIsolationLevelCheck)},
	/* The following variable is defined as session scope but is actually server scope. */
	{Scope: ScopeSession, Name: TiDBGeneralLog, Value: strconv.Itoa(DefTiDBGeneralLog)},
	{Scope: ScopeSession, Name: TiDBPProfSQLCPU, Value: strconv.Itoa(DefTiDBPProfSQLCPU)},
	...
	{Scope: ScopeGlobal, Name: TiDBDDLReorgWorkerCount, Value: strconv.Itoa(DefTiDBDDLReorgWorkerCount)},
	{Scope: ScopeGlobal, Name: TiDBDDLReorgBatchSize, Value: strconv.Itoa(DefTiDBDDLReorgBatchSize)},
	{Scope: ScopeGlobal, Name: TiDBDDLErrorCountLimit, Value: strconv.Itoa(DefTiDBDDLErrorCountLimit)},
	{Scope: ScopeSession, Name: TiDBDDLReorgPriority, Value: "PRIORITY_LOW"},
	{Scope: ScopeGlobal, Name: TiDBMaxDeltaSchemaCount, Value: strconv.Itoa(DefTiDBMaxDeltaSchemaCount)},
	{Scope: ScopeGlobal, Name: TiDBEnableChangeColumnType, Value: BoolToIntStr(DefTiDBChangeColumnType)},
	{Scope: ScopeSession, Name: TiDBForcePriority, Value: mysql.Priority2Str[DefTiDBForcePriority]},
	{Scope: ScopeSession, Name: TiDBEnableRadixJoin, Value: BoolToIntStr(DefTiDBUseRadixJoin)},
	...
	{Scope: ScopeGlobal, Name: TiDBScatterRegion, Value: BoolToIntStr(DefTiDBScatterRegion)},
	{Scope: ScopeSession, Name: TiDBWaitSplitRegionFinish, Value: BoolToIntStr(DefTiDBWaitSplitRegionFinish)},
	{Scope: ScopeSession, Name: TiDBWaitSplitRegionTimeout, Value: strconv.Itoa(DefWaitSplitRegionTimeout)},
	{Scope: ScopeSession, Name: TiDBLowResolutionTSO, Value: "0"},
	{Scope: ScopeSession, Name: TiDBExpensiveQueryTimeThreshold, Value: strconv.Itoa(DefTiDBExpensiveQueryTimeThreshold)},
	...
	{Scope: ScopeSession, Name: TiDBAllowRemoveAutoInc, Value: BoolToIntStr(DefTiDBAllowRemoveAutoInc)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBUsePlanBaselines, Value: boolToOnOff(DefTiDBUsePlanBaselines)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEvolvePlanBaselines, Value: boolToOnOff(DefTiDBEvolvePlanBaselines)},
	{Scope: ScopeGlobal, Name: TiDBEvolvePlanTaskMaxTime, Value: strconv.Itoa(DefTiDBEvolvePlanTaskMaxTime)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBStoreLimit, Value: strconv.FormatInt(atomic.LoadInt64(&config.GetGlobalConfig().TiKVClient.StoreLimit), 10)},
	...
	{Scope: ScopeSession, Name: TiDBSlowLogThreshold, Value: strconv.Itoa(logutil.DefaultSlowThreshold)},
	{Scope: ScopeSession, Name: TiDBRecordPlanInSlowLog, Value: strconv.Itoa(logutil.DefaultRecordPlanInSlowLog)},
	{Scope: ScopeSession, Name: TiDBEnableSlowLog, Value: BoolToIntStr(logutil.DefaultTiDBEnableSlowLog)},
	{Scope: ScopeSession, Name: TiDBQueryLogMaxLen, Value: strconv.Itoa(logutil.DefaultQueryLogMaxLen)},
	{Scope: ScopeSession, Name: TiDBCheckMb4ValueInUTF8, Value: BoolToIntStr(config.GetGlobalConfig().CheckMb4ValueInUTF8)},
	{Scope: ScopeSession, Name: TiDBFoundInPlanCache, Value: BoolToIntStr(DefTiDBFoundInPlanCache)},
	{Scope: ScopeSession, Name: TiDBEnableCollectExecutionInfo, Value: BoolToIntStr(DefTiDBEnableCollectExecutionInfo)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBAllowAutoRandExplicitInsert, Value: boolToOnOff(DefTiDBAllowAutoRandExplicitInsert)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableClusteredIndex, Value: BoolToIntStr(DefTiDBEnableClusteredIndex)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBShardAllocateStep, Value: strconv.Itoa(DefTiDBShardAllocateStep)},
	{Scope: ScopeGlobal, Name: TiDBEnableTelemetry, Value: BoolToIntStr(DefTiDBEnableTelemetry)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableAmendPessimisticTxn, Value: boolToOnOff(DefTiDBEnableAmendPessimisticTxn)},
	...
	{Scope: ScopeSession, Name: PseudoSlaveMode, Value: ""},
	...
	{Scope: ScopeGlobal, Name: MasterVerifyChecksum, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: LogSlowSlaveStatements, Value: "0"},
	...
	{Scope: ScopeGlobal, Name: "slave_rows_search_algorithms", Value: "TABLE_SCANINDEX_SCAN"},
	{Scope: ScopeGlobal, Name: SlaveAllowBatching, Value: "0"},
}
...
const (
	// BulkInsertBufferSize is the name for bulk_insert_buffer_size system variable.
	...
	// DefaultTmpStorageEngine is the name for 'default_tmp_storage_engine' system variable.
	DefaultTmpStorageEngine = "default_tmp_storage_engine"
	// DivPrecisionIncrement is the name for 'div_precision_increment' system variable.
	DivPrecisionIncrement = "div_precision_increment"
	// EqRangeIndexDiveLimit is the name for 'eq_range_index_dive_limit' system variable.
	EqRangeIndexDiveLimit = "eq_range_index_dive_limit"
	...
	// OptimizerPruneLevel is the name for 'optimizer_prune_level' system variable.
	...
	// MaxErrorCount is the name for 'max_error_count' system variable.
	MaxErrorCount = "max_error_count"
	// MaxHeapTableSize is the name for 'max_heap_table_size' system variable.
	MaxHeapTableSize = "max_heap_table_size"
	// MaxJoinSize is the name for 'max_join_size' system variable.
	MaxJoinSize = "max_join_size"
	// MaxLengthForSortData is the name for 'max_length_for_sort_data' system variable.
	MaxLengthForSortData = "max_length_for_sort_data"
	// MaxPointsInGeometry is the name for 'max_points_in_geometry' system variable.
	MaxPointsInGeometry = "max_points_in_geometry"
	// MaxSeeksForKey is the name for 'max_seeks_for_key' system variable.
	MaxSeeksForKey = "max_seeks_for_key"
	// RangeAllocBlockSize is the name for 'range_alloc_block_size' system variable.
	RangeAllocBlockSize = "range_alloc_block_size"
	// ReadBufferSize is the name for 'read_buffer_size' system variable.
	ReadBufferSize = "read_buffer_size"
	// ReadRndBufferSize is the name for 'read_rnd_buffer_size' system variable.
	ReadRndBufferSize = "read_rnd_buffer_size"
	// SortBufferSize is the name for 'sort_buffer_size' system variable.
	...
	// SQLBufferResult is the name for 'sql_buffer_result' system variable.
	...
	// UpdatableViewsWithLimit is the name for 'updatable_views_with_limit' system variable.
	UpdatableViewsWithLimit = "updatable_views_with_limit"
