...
var defaultSysVars = []*SysVar{
	...
	{ScopeGlobal | ScopeSession, TiDBDistSQLScanConcurrency, strconv.Itoa(ExecutorConcurrency)},
	...
	{ScopeGlobal | ScopeSession, TiDBIndexLookupConcurrency, strconv.Itoa(ExecutorConcurrency)},
	{ScopeGlobal | ScopeSession, TiDBIndexLookupJoinConcurrency, strconv.Itoa(ExecutorConcurrency)},
	{ScopeGlobal | ScopeSession, TiDBIndexSerialScanConcurrency, strconv.Itoa(ExecutorConcurrency)},
	...
	{ScopeGlobal | ScopeSession, TiDBHashJoinConcurrency, strconv.Itoa(ExecutorConcurrency)},
	{ScopeGlobal | ScopeSession, TiDBProjectionConcurrency, strconv.Itoa(ExecutorConcurrency)},
	{ScopeGlobal | ScopeSession, TiDBHashAggPartialConcurrency, strconv.Itoa(ExecutorConcurrency)},
	{ScopeGlobal | ScopeSession, TiDBHashAggFinalConcurrency, strconv.Itoa(ExecutorConcurrency)},
	{ScopeGlobal | ScopeSession, TiDBWindowConcurrency, strconv.Itoa(ExecutorConcurrency)},
