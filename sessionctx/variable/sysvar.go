...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBStreamAggConcurrency, Value: strconv.Itoa(DefTiDBStreamAggConcurrency)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableStreamAggRangePartition, Value: BoolToOnOff(DefEnableStreamAggRangePartition), Type: TypeBool},
