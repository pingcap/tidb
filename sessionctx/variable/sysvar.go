...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeSession, Name: TiDBAutoFreeOSMemoryThreshold, Value: strconv.FormatUint(config.GetGlobalConfig().AutoFreeOSMemoryThreshold, 10), Type: TypeInt, MinValue: 0, MaxValue: math.MaxInt64},
