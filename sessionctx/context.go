...
type Context interface {
	...
	// TODO: maybe we can use a method called GetSessionStatsCollector to replace both StoreQueryFeedback and UpdateColStatsUsage while we need to deal with import circle.
	UpdateColStatsUsage(colStatsUsage map[model.TableColumnID]time.Time)
