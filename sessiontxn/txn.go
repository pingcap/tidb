...
// CanReuseTxnWhenExplictBegin returns whether we should reuse the txn when starting a transacting explicitly
func CanReuseTxnWhenExplictBegin(sctx sessionctx.Context) bool {
