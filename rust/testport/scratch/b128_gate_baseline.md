# b128 gate baseline — recorded BEFORE any edit

Commit: 95aeb9c1ff636564d1538d4225800dbbe1f9ac0a (clean tree, `git status --porcelain` empty except nothing).

Command (from `rust/`, `PROTOC=/opt/protoc/bin/protoc` exported; the system
protoc 3.14 cannot compile tidb-proto's proto3-optional inputs — same
workaround as b110/b111/b113/b116):
...
Exit code 100 (pre-existing failures only).

Baseline failure set (48, full nextest test ids):
