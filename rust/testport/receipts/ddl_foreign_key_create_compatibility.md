...
CREATE matrix boundaries (self-reference, deferred parent validation,
temporary-table refusals, constraint-name checks, partitioning, and the pass
matrix) remain explicitly ignored in the source-shaped test.
