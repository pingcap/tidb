...
| `crates/tidb-util` | complete dependency-leaf utility packages | `pkg/util/{disjointset,zeropool,encrypt,checksum,intest}`, followed by whole utility packages only |
