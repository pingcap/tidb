...
| `crates/tidb-util` | complete dependency-leaf utility packages | `pkg/util/{disjointset,zeropool,encrypt,checksum,intest,sqlescape,mathutil,naming,size,israce,nocopy}`, followed by whole utility packages only |
