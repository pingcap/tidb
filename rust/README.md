...
| `crates/tidb-util` | complete dependency-leaf utility packages | `pkg/util/{disjointset,zeropool,encrypt,checksum,intest,sqlescape}`, followed by whole utility packages only |
