...
- [ ] Complete pinned `pkg/statistics/handle/history`; the metadata and data transactions now exist, but canonical live-table/partition dump-to-JSON and ANALYZE-to-background-worker production wiring remain open. No package completion claim is made yet.
