...
- [ ] Complete pinned `pkg/statistics/handle/history`; production metadata/data writes and live table/partition generation now exist, but the pinned cross-package executor/handler test inventory and receipts remain open. No package completion claim is made yet.
