...
const SYSVAR_NAME_CONSTANTS: &[(&str, &str)] = &[
    ...
    (
        "TIDB_OPT3_STAGE_DISTINCT_AGG",
        "tidb_opt_three_stage_distinct_agg",
    ),
    (
        "TIDB_OPT_ENABLE3_STAGE_MULTI_DISTINCT_AGG",
        "tidb_opt_enable_three_stage_multi_distinct_agg",
    ),
    (
        "TIDB_OPT_EXPLAIN_NO_EVALED_SUB_QUERY",
        "tidb_opt_enable_non_eval_scalar_subquery",
    ),
    (
        "TIDB_BCJ_THRESHOLD_SIZE",
        "tidb_broadcast_join_threshold_size",
    ),
    (
        "TIDB_BCJ_THRESHOLD_COUNT",
        "tidb_broadcast_join_threshold_count",
    ),
    (
        "TIDB_PREFER_BCJ_BY_EXCHANGE_DATA_SIZE",
    ...
    (
        "TIDB_OPTIMIZER_ENABLE_NEW_ONLY_FULL_GROUP_BY_CHECK",
        "tidb_enable_new_only_full_group_by_check",
    ),
    (
        "TIDB_OPTIMIZER_ENABLE_OUTER_JOIN_REORDER",
        "tidb_enable_outer_join_reorder",
    ),
    (
        "TIDB_OPTIMIZER_ENABLE_NAAJ",
    ...
    (
        "TIDB_ENABLE_LIST_TABLE_PARTITION",
    ...
    (
        "TIDB_ALLOW_AUTO_RAND_EXPLICIT_INSERT",
    ...
    (
        "TIDB_EXPLICIT_REQUEST_SOURCE_TYPE",
    ...
    (
        "TIDB_DIST_SQL_SCAN_CONCURRENCY",
        "tidb_distsql_scan_concurrency",
    ),
    (
        "TIDB_ANALYZE_DIST_SQL_SCAN_CONCURRENCY",
    ...
    (
        "TIDB_OPT_RISK_SCALE_NDV_SKEW_RATIO",
        "tidb_opt_scale_ndv_skew_ratio",
    ),
    (
        "TIDB_OPT_RISK_GROUP_NDV_SKEW_RATIO",
    ...
    (
        "TIDB_HASH_AGG_PARTIAL_CONCURRENCY",
        "tidb_hashagg_partial_concurrency",
    ),
    (
        "TIDB_HASH_AGG_FINAL_CONCURRENCY",
    ...
    (
        "TIDB_ENABLE_STRICT_NOT_NULL_CHECK",
        "tidb_enable_strict_not_null_check",
    ),
    (
    ...
    (
        "TIDB_OPT_JOIN_REORDER_THROUGH_PROJ",
        "tidb_opt_join_reorder_through_proj",
    ),
    (
    ...
    (
        "TIDB_NON_TRANSACTIONAL_IGNORE_ERROR",
    ...
    (
        "TIDB_MEMORY_DEBUG_MODE_MIN_HEAP_IN_USE",
    ...
    (
        "TIDB_OPT_PARTIAL_ORDERED_INDEX_FOR_TOP_N",
    ...
    (
        "TIDB_OPT_ORDERING_IDX_SEL_THRESH",
        "tidb_opt_ordering_index_selectivity_threshold",
    ),
    (
        "TIDB_OPT_ORDERING_IDX_SEL_RATIO",
    ...
    (
        "TIDB_ANALYZE_DEFAULT_NUM_TOP_N",
        "tidb_analyze_default_num_topn",
    ),
    (
        "TIDB_DISABLE_COLUMN_TRACKING_TIME",
        "tidb_disable_column_tracking_time",
    ),
    (
    ...
    (
        "TIDB_PREP_PLAN_CACHE_MEMORY_GUARD_RATIO",
    ...
    (
        "TIDB_SYS_PROC_SCAN_CONCURRENCY",
    ...
    (
        "AUTHENTICATION_LDAPSASL_AUTH_METHOD_NAME",
        "authentication_ldap_sasl_auth_method_name",
    ),
    (
        "AUTHENTICATION_LDAPSASLCA_PATH",
        "authentication_ldap_sasl_ca_path",
    ),
    ("AUTHENTICATION_LDAPSASLTLS", "authentication_ldap_sasl_tls"),
    (
        "AUTHENTICATION_LDAPSASL_SERVER_HOST",
        "authentication_ldap_sasl_server_host",
    ),
    (
        "AUTHENTICATION_LDAPSASL_SERVER_PORT",
        "authentication_ldap_sasl_server_port",
    ),
    (
        "AUTHENTICATION_LDAPSASL_REFERRAL",
        "authentication_ldap_sasl_referral",
    ),
    (
        "AUTHENTICATION_LDAPSASL_USER_SEARCH_ATTR",
        "authentication_ldap_sasl_user_search_attr",
    ),
    (
        "AUTHENTICATION_LDAPSASL_BIND_BASE_DN",
        "authentication_ldap_sasl_bind_base_dn",
    ),
    (
        "AUTHENTICATION_LDAPSASL_BIND_ROOT_DN",
        "authentication_ldap_sasl_bind_root_dn",
    ),
    (
        "AUTHENTICATION_LDAPSASL_BIND_ROOT_PWD",
        "authentication_ldap_sasl_bind_root_pwd",
    ),
    (
        "AUTHENTICATION_LDAPSASL_INIT_POOL_SIZE",
        "authentication_ldap_sasl_init_pool_size",
    ),
    (
        "AUTHENTICATION_LDAPSASL_MAX_POOL_SIZE",
    ...
    (
        "TIDB_ENABLE_TIFLASH_PIPELINE_MODE",
    ...
    (
        "TIDB_CIRCUIT_BREAKER_PD_METADATA_ERROR_RATE_THRESHOLD_RATIO",
        "tidb_cb_pd_metadata_error_rate_threshold_ratio",
    ),
    ("TIDB_ENABLE_TS_VALIDATION", "tidb_enable_ts_validation"),
    (
        "TIDB_ADVANCER_CHECK_POINT_LAG_LIMIT",
        "tidb_advancer_check_point_lag_limit",
    ),
    (
        "TIDB_INDEX_LOOK_UP_PUSH_DOWN_POLICY",
    ...
    (
        "INDEX_LOOK_UP_PUSH_DOWN_POLICY_AFFINITY_FORCE",
        "affinity-force",
    ),
