...
//! Mutation receipt gate for the complete Go `pkg/util/arena` lockdown.
...
const PLAN: &str = include_str!("../src/arena.mutation-plan.tsv");
const RESULTS: &str = include_str!("../src/arena.mutation-results.tsv");
...
#[test]
fn arena_mutation_receipt_is_current_and_killed() {
    ...
    assert_eq!(expected_counts.values().sum::<usize>(), 15);
    ...
    for row in results {
        ...
        assert_eq!(row[3], "4f47cc1b194b5438ae9f1d6950aa84a628b2ad3e");
