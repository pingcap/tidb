...
//! Mutation receipt gate for the complete Go `pkg/util/slice` lockdown.
...
const PLAN: &str = include_str!("../src/slice.mutation-plan.tsv");
const RESULTS: &str = include_str!("../src/slice.mutation-results.tsv");
const BASELINE: &str = "d61d25c49cae55e4c8271ddc25e89701a2ac8ae5";
...
#[test]
fn slice_mutation_receipt_is_current_and_killed() {
    ...
    assert_eq!(expected_counts.values().sum::<usize>(), 23);
