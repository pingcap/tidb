...
//! Compiled completeness and mutation receipt gate for `pkg/util/queue`.
...
const PLAN: &str = include_str!("../src/queue.mutation-plan.tsv");
const RESULTS: &str = include_str!("../src/queue.mutation-results.tsv");
...
#[test]
fn queue_mutation_receipt_is_current_and_killed() {
    ...
    assert_eq!(expected_counts.values().sum::<usize>(), 21);
    ...
    for row in results {
        ...
        assert_eq!(row[3], "834e7966fec7446cbc75486367988c4d8b04669b");
