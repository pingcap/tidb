...
//! Mutation receipt gate for the complete Go `pkg/util/texttree` lockdown.
...
const PLAN: &str = include_str!("../src/texttree.mutation-plan.tsv");
const RESULTS: &str = include_str!("../src/texttree.mutation-results.tsv");
const BASELINE: &str = "a818661ca8eec4f3225946ebad2aefbe613248ac";
...
#[test]
fn texttree_mutation_receipt_is_current_and_killed() {
    ...
    assert_eq!(expected_counts.values().sum::<usize>(), 32);
