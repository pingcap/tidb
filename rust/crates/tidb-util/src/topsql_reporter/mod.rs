...
//! Rust owners for Go `pkg/util/topsql/reporter` data models and its metrics
//! child package.
//!
//! **This is not a package claim for the parent `reporter` package.** Go's
//! `reporter` package also contains
...
//! - [`metrics`] — complete transcreation of `reporter/metrics/metrics.go`:
//!   the reporter's labeled Prometheus counter and histogram handles.
//!
...
//!   dependency.
//! - [`metrics`] fully owns Go's `reporter/metrics` Prometheus families and
//!   every labeled handle.
