...
fn benchmark_parse_simple() {
    for _ in 0..1_000 {
        for sql in [
            ...
            black_box(tidb_parser::parse(sql).expect("Go simple benchmark SQL parses"));
        }
    }
}
