...
const TIKV_SUPPORTED: &[&str] = &[
    // op functions.
    "and", "or", "xor", "not", "bitand", "bitor", "bitxor", "bitneg", "leftshift", "rightshift",
    "unaryminus",
    // compare functions.
    "lt", "le", "eq", "ne", "ge", "gt", "nulleq", "in", "isnull", "like", "istrue",
    "istrue_with_null", "isfalse",
    // arithmetical functions.
    "pi", "plus", "minus", "mul", "div", "abs", "mod", "intdiv",
    // math functions.
    "ceil", "ceiling", "floor", "sqrt", "sign", "ln", "log", "log2", "log10", "exp", "pow",
    "power", "sin", "asin", "cos", "acos", "atan", "atan2", "cot", "radians", "degrees", "crc32",
    // control flow functions.
    "case_when", "if", "ifnull", "coalesce",
    // string functions.
    "upper", "lower", "length", "bit_length", "concat", "concat_ws", "replace", "ascii", "hex",
    "reverse", "ltrim", "rtrim", "strcmp", "space", "elt", "field", "from_binary", "to_binary",
    "mid", "substring", "substr", "char_length", "right",
    // json functions.
    "json_type", "json_extract", "json_object", "json_array", "json_merge", "json_set",
    "json_insert", "json_replace", "json_remove", "json_length", "json_merge_patch",
    "json_unquote", "json_contains", "json_valid", "json_memberof", "json_array_append",
    // vector functions.
    "vec_dims", "vec_l1_distance", "vec_l2_distance", "vec_negative_inner_product",
    "vec_cosine_distance", "vec_l2_norm", "vec_as_text",
    // date functions.
    "date", "week", "datediff", "monthname", "makedate", "time_to_sec", "maketime",
    "date_format", "date_add", "adddate", "date_sub", "subdate", "hour", "minute", "second",
    "microsecond", "month", "dayofmonth", "dayofweek", "dayofyear", "weekofyear", "year",
    "from_days", "period_add", "period_diff", "timestampdiff", "from_unixtime", "sysdate",
    // encryption functions.
    "md5", "sha1", "sha2", "uncompressed_length",
    "cast",
    // misc functions.
    "uuid", "uuid_version", "uuid_timestamp",
];
...
mod tests {
    ...
    fn the_supported_table_admits_and_the_conditional_arms_refuse() {
        ...
        assert!(can_exprs_push_down_tikv(&[func("eq", vec![col.clone(), konst.clone()])]));
        // A conditional arm (`Round`, pb-code gated in Go) refuses
        // conservatively.
        assert!(!can_exprs_push_down_tikv(&[func("round", vec![col.clone()])]));
