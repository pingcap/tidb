...
/// Go `partitionsCols` (`infoschema/tables.go`).
const PARTITIONS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "TABLE_CATALOG",
        tp: FieldTypeCode::Varchar,
        size: 512,
...
const ENGINES_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "ENGINE",
        tp: FieldTypeCode::Varchar,
        size: 64,
...
const TRIGGERS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
...
const ROUTINES_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "SPECIFIC_NAME",
        tp: FieldTypeCode::Varchar,
        size: 64,
...
const EVENTS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "EVENT_CATALOG",
        tp: FieldTypeCode::Varchar,
        size: 512,
...
const CLUSTER_LOG_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "TIME",
        tp: FieldTypeCode::Varchar,
        size: 32,
...
const TIKV_STORE_STATUS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "STORE_ADDRESS",
        tp: FieldTypeCode::Varchar,
        size: 64,
...
const PARAMETERS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
...
const PLUGINS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "PLUGIN_NAME",
        tp: FieldTypeCode::Varchar,
        size: 64,
...
const SEQUENCES_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
...
const RUNAWAY_WATCHES_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
...
const TIFLASH_TABLES_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "TIDB_DATABASE",
        tp: FieldTypeCode::Varchar,
        size: 64,
...
const TIFLASH_SEGMENTS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "TIDB_DATABASE",
        tp: FieldTypeCode::Varchar,
        size: 64,
...
const RESOURCE_GROUPS_COLUMNS: &[InfoColumn] = &[
    InfoColumn {
        name: "NAME",
        tp: FieldTypeCode::Varchar,
        size: 32,
...
const SERVED_TABLES: &[(&str, &[InfoColumn])] = &[
    ...
    ("RESOURCE_GROUPS", RESOURCE_GROUPS_COLUMNS),
    ("RUNAWAY_WATCHES", RUNAWAY_WATCHES_COLUMNS),
    ("SEQUENCES", SEQUENCES_COLUMNS),
    ("TIFLASH_SEGMENTS", TIFLASH_SEGMENTS_COLUMNS),
    ("TIFLASH_TABLES", TIFLASH_TABLES_COLUMNS),
