...
//! Ports of `pkg/executor.part22`: deterministic items 1261--1320 of the
//! upstream executor test enumeration. The running rows use only the
//! in-memory catalog and executor seams owned by this crate. Tests that need
//! sessions, transactions, TiKV/PD, TiProxy, LOAD DATA, runtime memory
//! observations, or Go-only private helpers remain explicit parity gaps.
...
#[test]
#[ignore = "skipped-reason: Go suite bootstrap and goleak setup have no Rust product behavior"]
fn writetest_main_is_bootstrap_only() {}

/// Go `pkg/executor/test/writetest/write_test.go:42::TestInsertIgnore`.
#[test]
fn insert_ignore_keeps_the_nonduplicate_rows() {
...
fn load_data_missing_column_uses_timestamp_default() {}
...
fn issue18681_load_data_bit_columns_follow_non_strict_conversion() {}
...
fn issue34358_load_data_user_variables_accept_null_literals() {}
...
fn latch_allows_disjoint_writes_and_retries_conflicts() {}
...
fn replace_reports_a_dangling_index_row() {}
...
fn rebase_if_needed_does_not_rebase_unchanged_updates() {}
...
fn defer_constraint_check_for_insert_checks_at_the_configured_phase() {}
...
fn pessimistic_delete_your_writes_unblocks_the_second_insert() {}
...
fn tikv_region_peers_filters_mock_pd_rows() {}
...
fn trace_exec_returns_ordered_trace_rows() {}
...
fn traffic_form_maps_capture_and_replay_options() {}
...
fn traffic_errors_surface_proxy_and_storage_failures() {}
...
fn traffic_capture_assigns_one_path_per_proxy() {}
...
fn traffic_replay_selects_proxy_input_paths() {}
...
fn traffic_show_formats_capture_and_replay_jobs() {}
...
fn traffic_privilege_filters_capture_and_replay_jobs() {}
...
fn union_scan_merges_dirty_rows_for_table_and_index_reads() {}
...
fn issue53951_union_scan_filters_a_transactional_generated_column() {}
...
fn issue28073_does_not_write_partition_id_zero_keys() {}
...
fn issue32422_union_scan_reads_cached_table_rows() {}
...
fn snapshot_with_concurrent_write_is_consistent() {}
...
fn test_bench_daily_is_benchmark_bootstrap() {}
...
fn pessimistic_update_pk_lazy_check_tracks_presume_exists_keys() {}
...
fn lock_unchanged_unique_keys_gates_the_second_writer() {}
...
fn lock_unchanged_keys_global_index_handles_nulls() {}
...
fn update_row_retry_then_duplicate_key_preserves_the_original_row() {}
...
fn update_with_on_update_and_auto_generated_columns_stays_consistent() {}
...
fn batch_retriever_helper_emits_contiguous_ranges() {}
...
fn equal_datums_as_binary_compares_rows_without_coercion() {}
...
fn encode_password_with_plugin_delegates_to_the_auth_plugin() {}

/// Go `pkg/executor/utils_test.go:184::TestWorkerPool`.
#[test]
fn worker_pool_preserves_the_go_submission_contract() {
...
fn build_ordered_window_exec_consumes_partitioned_mock_chunks() {}
...
fn window_return_column_nullable_attribute_matches_function_contracts() {}
...
fn window_functions_cover_parallel_and_pipelined_modes() {}
...
fn window_functions_data_reference_survives_chunk_boundaries() {}
...
fn sliding_window_functions_cover_rows_range_and_precision_modes() {}
...
fn issue45964_and_46050_window_nullability_is_precise() {}
...
fn var_samp_is_accepted_as_a_window_function() {}

/// Go `pkg/executor/write_concurrent_test.go:25::TestBatchInsertWithOnDuplicate`.
#[test]
#[ignore = "go-parity-gap: async sessions, global/session batch-DML variables, concurrent ODKU, and ADMIN CHECK TABLE are unported"]
fn batch_insert_with_on_duplicate_is_consistent_under_concurrency() {}

/// Go `pkg/executor/test/loadremotetest/error_test.go:36::TestErrorMessage`.
#[test]
#[ignore = "go-parity-gap: fake-GCS remote LOAD DATA and importer error-message verification are unported"]
fn load_remote_error_messages_match_mysql_errors() {}

/// Go `pkg/executor/test/loadremotetest/error_test.go:82::TestColumnNumMismatch`.
#[test]
#[ignore = "go-parity-gap: remote CSV parsing and LOAD DATA column-count validation are unported"]
fn load_remote_column_number_mismatch_is_reported() {}

/// Go `pkg/executor/test/loadremotetest/error_test.go:149::TestEvalError`.
#[test]
#[ignore = "go-parity-gap: fake-GCS remote reader and importer expression-evaluation errors are unported"]
fn load_remote_eval_errors_preserve_row_context() {}

/// Go `pkg/executor/test/loadremotetest/error_test.go:192::TestDataError`.
#[test]
#[ignore = "go-parity-gap: remote LOAD DATA data-error accounting and warning output are unported"]
fn load_remote_data_errors_are_counted_and_reported() {}

/// Go `pkg/executor/test/loadremotetest/error_test.go:266::TestIssue43555`.
#[test]
#[ignore = "go-parity-gap: remote LOAD DATA duplicate/error handling and importer cleanup are unported"]
fn issue43555_remote_load_data_does_not_leak_resources() {}

/// Go `pkg/executor/test/loadremotetest/multi_file_test.go:28::TestFilenameAsterisk`.
#[test]
#[ignore = "go-parity-gap: remote wildcard object enumeration and multi-file LOAD DATA are unported"]
fn load_remote_filename_asterisk_expands_objects() {}

/// Go `pkg/executor/test/loadremotetest/multi_file_test.go:94::TestLastInsertID`.
#[test]
#[ignore = "go-parity-gap: remote LOAD DATA auto-ID/session LastInsertID behavior is unported"]
fn load_remote_last_insert_id_matches_loaded_rows() {}

/// Go `pkg/executor/test/loadremotetest/multi_file_test.go:127::TestMultiBatchWithIgnoreLines`.
#[test]
#[ignore = "go-parity-gap: remote multi-file batching and IGNORE n LINES importer behavior are unported"]
fn load_remote_multi_batch_ignore_lines_is_consistent() {}

/// Go `pkg/executor/test/loadremotetest/multi_file_test.go:165::TestMixedCompression`.
#[test]
#[ignore = "go-parity-gap: remote compressed-object readers and mixed-file LOAD DATA are unported"]
fn load_remote_mixed_compression_is_supported() {}

/// Go `pkg/executor/test/loadremotetest/one_csv_test.go:25::TestLoadCSV`.
#[test]
#[ignore = "go-parity-gap: fake-GCS remote CSV reader and LoadDataController row loop are unported"]
fn load_remote_csv_loads_quoted_rows() {}

/// Go `pkg/executor/test/loadremotetest/one_csv_test.go:88::TestLoadCsvInTransaction`.
#[test]
#[ignore = "go-parity-gap: remote LOAD DATA transaction rollback and session transaction state are unported"]
fn load_remote_csv_in_transaction_rolls_back() {}

/// Go `pkg/executor/test/loadremotetest/one_csv_test.go:129::TestIgnoreNLines`.
#[test]
#[ignore = "go-parity-gap: remote CSV terminator counting and IGNORE n LINES are implemented by the unported importer"]
fn load_remote_ignore_n_lines_counts_terminators() {}
