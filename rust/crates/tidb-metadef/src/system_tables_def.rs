...
/// Go `CreateTiDBMViewRefreshInfoTable`.
pub const CREATE_TI_DBMVIEW_REFRESH_INFO_TABLE: &str = r#"CREATE TABLE IF NOT EXISTS mysql.tidb_mview_refresh_info (
...
/// Go `CreateTiDBMLogPurgeInfoTable`.
pub const CREATE_TI_DBMLOG_PURGE_INFO_TABLE: &str = r#"CREATE TABLE IF NOT EXISTS mysql.tidb_mlog_purge_info (
		MLOG_ID bigint NOT NULL,
		NEXT_PURGE_UNIX_SECONDS bigint DEFAULT NULL,
		LAST_PURGED_TSO bigint unsigned DEFAULT NULL,
		PRIMARY KEY(MLOG_ID))"#;

/// Go `CreateTiDBMViewRefreshHistTable`.
pub const CREATE_TI_DBMVIEW_REFRESH_HIST_TABLE: &str = r#"CREATE TABLE IF NOT EXISTS mysql.tidb_mview_refresh_hist (
...
/// Go `CreateTiDBMViewRefreshAlertTable`.
pub const CREATE_TI_DBMVIEW_REFRESH_ALERT_TABLE: &str = r#"CREATE TABLE IF NOT EXISTS mysql.tidb_mview_refresh_alert (
		MVIEW_ID bigint NOT NULL,
		MVIEW_SCHEMA varchar(64) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
		MVIEW_NAME varchar(64) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
/// Go `CreateTiDBMLogPurgeHistTable`.
pub const CREATE_TI_DBMLOG_PURGE_HIST_TABLE: &str = r#"CREATE TABLE IF NOT EXISTS mysql.tidb_mlog_purge_hist (
