...
fn source_non_partition_identity_uses_table_id() {
    let table = tidb_stats::analyze_table_id::AnalyzeTableId::new(42, NON_PARTITION_TABLE_ID);
...
fn source_equals_compares_both_ids_and_nil_shape() {
    ...
    assert!(tidb_stats::analyze_table_id::AnalyzeTableId::equals_optional(None, None));
