...
pub struct KeyspaceIdValue {
    #[prost(oneof = "keyspace_id_value::Keyspace", tags = "1, 2")]
    pub keyspace: ::core::option::Option<keyspace_id_value::Keyspace>,
}
/// Nested message and enum types in `KeyspaceIDValue`.
pub mod keyspace_id_value {
