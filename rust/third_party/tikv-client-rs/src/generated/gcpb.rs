...
pub mod gc_server {
    ...
    #[async_trait]
    pub trait Gc: std::marker::Send + std::marker::Sync + 'static {
    ...
    pub const SERVICE_NAME: &str = "gcpb.GC";
    impl<T> tonic::server::NamedService for GcServer<T> {
