...
pub mod import_sst_server {
    ...
    #[async_trait]
    pub trait ImportSst: std::marker::Send + std::marker::Sync + 'static {
        /// Switch to normal/import mode.
    ...
    impl<T> Clone for ImportSstServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "import_sstpb.ImportSST";
    impl<T> tonic::server::NamedService for ImportSstServer<T> {
