...
pub mod scheduling_server {
    ...
    #[async_trait]
    pub trait Scheduling: std::marker::Send + std::marker::Sync + 'static {
    ...
    impl<T> Clone for SchedulingServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "schedulingpb.Scheduling";
    impl<T> tonic::server::NamedService for SchedulingServer<T> {
