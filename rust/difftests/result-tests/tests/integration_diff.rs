...
fn integrationtest_replay_matches_recorded_tidb_output() {
    ...
    // (MVCC-blocked), and autoid.
    //
    // 11 -> 10: `partition_pruner` fully closed (293 of 294 matched, one
    ...
    //
    // The ten that remain: through_projection 5, join_key_type_cast 2, and
    // one each of index_join, stale_txn (MVCC-blocked), and autoid.
    const KNOWN_DIVERGENCES: usize = 10;
    //
    //
