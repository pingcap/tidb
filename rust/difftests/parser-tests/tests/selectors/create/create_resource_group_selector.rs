...
fn is_create_resource_group(sql: &str) -> bool {
    ...
    words
        ...
        && words
            .next()
            .is_some_and(|word| word.eq_ignore_ascii_case("RESOURCE"))
        && words
            .next()
...
#[test]
fn create_resource_group_static_go_rows_match() {
    ...
    let selected: Vec<_> = records
        ...
        .filter(|record| {
            record.outcome == GoOutcome::Accepted
                ...
                && is_create_resource_group(&record.input.sql)
        })
        .collect();
