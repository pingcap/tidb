...
//! Exact checked-oracle coverage for accepted interval split rows.

use difftest::parser_oracle::{shared_golden, GoOutcome};

const ROWS: [(&str, usize); 2] = [
    ("tests/integrationtest/t/ddl/db_partition.test", 1564),
    ("tests/integrationtest/t/ddl/db_partition.test", 1593),
];

#[test]
fn alter_partition_split_maxvalue_lexical_rows_match_go() {
