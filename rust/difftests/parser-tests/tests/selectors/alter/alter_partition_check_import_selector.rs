...
//! Checked Go-oracle rows for CHECK/IMPORT PARTITION actions.

use difftest::parser_oracle::{shared_golden, GoOutcome};

const ROWS: [(&str, usize); 2] = [
    ("tests/integrationtest/t/ddl/db_partition.test", 1255),
    ("tests/integrationtest/t/ddl/db_partition.test", 1261),
];

#[test]
fn alter_partition_check_import_static_go_rows_match() {
