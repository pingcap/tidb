...
//! Exact checked-oracle coverage for `ADD PARTITION` with no payload.

use difftest::parser_oracle::{shared_golden, GoOutcome};

const ROW: (&str, usize) = ("tests/integrationtest/t/ddl/db_partition.test", 419);

#[test]
fn alter_add_partition_empty_lexical_row_matches_go() {
