...
//! Exact checked-oracle coverage for the partition tablespace discard row.

use difftest::parser_oracle::{shared_golden, GoOutcome};

const ROW: (&str, usize) = ("tests/integrationtest/t/ddl/db_partition.test", 1263);

#[test]
fn alter_partition_discard_lexical_row_matches_go() {
