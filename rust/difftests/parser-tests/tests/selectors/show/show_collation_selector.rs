...
fn is_show_collation(sql: &str) -> bool {
    ...
    words
        ...
        && words
            ...
            .is_some_and(|word| word.eq_ignore_ascii_case("COLLATION"))
}

#[test]
fn show_collation_static_go_rows_match() {
    ...
    let selected: Vec<_> = records
        ...
        .filter(|record| {
            record.outcome == GoOutcome::Accepted
                ...
                && is_show_collation(&record.input.sql)
        })
        .collect();
