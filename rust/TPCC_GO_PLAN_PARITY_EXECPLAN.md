...
- [x] (2026-08-24) Iteration 5 closing receipt: Go median 239.02, Rust median 157.43 QPS (ratio 0.6586) over 4x150s rounds — Rust +47% this iteration (120.14 -> 157.43), +196% across the loop. The remaining per-statement deltas are within ~0.3 ms of Go on every class in the nocost breakdown. clean A/B on origin tip — Go median 232.09, Rust median 120.14 QPS, ratio 0.5176; consistent with iteration 3 within noise, zero unexpected errors, no regressions from any landed commit.
