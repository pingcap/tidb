...
func (t *partitionedTable) UpdateRecord(gctx context.Context, ctx sessionctx.Context, h kv.Handle, currData, newData []types.Datum, touched []bool) error {
	return partitionedTableUpdateRecord(gctx, ctx, t, h, currData, newData, touched, nil)
}

func (t *partitionTableWithGivenSets) UpdateRecord(gctx context.Context, ctx sessionctx.Context, h kv.Handle, currData, newData []types.Datum, touched []bool) error {
	return partitionedTableUpdateRecord(gctx, ctx, t.partitionedTable, h, currData, newData, touched, t.partitions)
}
