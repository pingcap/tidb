...
func (ts *testSuite) TestConstraintCheckForUniqueIndex(c *C) {
	...
	tk.MustExec("begin")
	tk.MustExec("update ttt set k=1 where id=2")
	_, err := tk.Exec("commit")
	c.Assert(err.Error(), Equals, "previous statement: update ttt set k=1 where id=2: [kv:1062]Duplicate entry '1-tidb' for key 'k_1'")
