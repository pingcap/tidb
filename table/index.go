...
type CreateIdxOpt struct {
	...
	NewlyInserted bool // Marks if the index is generated by newly inserted rows.
}
...
// IndexIsNewlyCreated indicates the index kv is generated by newly inserted rows.
// It's used to optimize the `delete-your-write` situation trying to eliminate dangling records.
var IndexIsNewlyCreated CreateIdxOptFunc = func(opt *CreateIdxOpt) {
	opt.NewlyInserted = true
}
