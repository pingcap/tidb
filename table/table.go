...
type Table interface {
	...
	// bs is the tempory BufferStore to store kv generated by addindices.
	AddRecord(ctx context.Context, r []types.Datum, skipHandleCheck bool, bs *kv.BufferStore) (recordID int64, err error)
