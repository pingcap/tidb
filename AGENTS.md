...
| `tests/integrationtest/t/**` changed | `./run-tests.sh -r <TestName>` and verify regenerated result correctness |
...
- Integration test recording `MUST` use `./run-tests.sh -r <TestName>`.
