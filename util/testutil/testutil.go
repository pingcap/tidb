...
// todo: `mustNewCommonHandle` function in `decoder_test.go`, `keydecoder_test.go` and `key_test.go` should be replaced with this function after this mod migrate to testify
