...
func (s *testHexSuite) TestToHex(c *C) {
	...
	c.Assert(logutil.ToHex(&region), Equals, "{Id:6662 StartKey:74c85c0000005c000000252d0000000000000025 EndKey:3361736733617364 RegionEpoch:<nil> Peers:[]}")
}
