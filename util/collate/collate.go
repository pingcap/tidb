...
func ConvertAndGetCICollation(collate string) Collator {
	switch collate {
	case "utf8mb4_bin":
		return GetCollator("utf8mb4_unicode_ci")
	case "utf8_bin":
		return GetCollator("utf8_unicode_ci")
	case "gbk_bin":
		return GetCollator("gbk_chinese_ci")
	default:
