...
var (
	...
	ErrNotExist = ClassKV.NewStd(mysql.ErrNotExist)
	...
	ErrTxnRetryable = ClassKV.NewStdErr(mysql.ErrTxnRetryable,
		pmysql.Message(mysql.MySQLErrName[mysql.ErrTxnRetryable].Raw+TxnRetryableMark, []int{0}))
	// ErrCannotSetNilValue is the error when sets an empty value.
	ErrCannotSetNilValue = ClassKV.NewStd(mysql.ErrCannotSetNilValue)
	// ErrInvalidTxn is the error when commits or rollbacks in an invalid transaction.
	ErrInvalidTxn = ClassKV.NewStd(mysql.ErrInvalidTxn)
	// ErrTxnTooLarge is the error when transaction is too large, lock time reached the maximum value.
	ErrTxnTooLarge = ClassKV.NewStd(mysql.ErrTxnTooLarge)
	// ErrEntryTooLarge is the error when a key value entry is too large.
	ErrEntryTooLarge = ClassKV.NewStd(mysql.ErrEntryTooLarge)
	// ErrKeyExists returns when key is already exist.
	ErrKeyExists = ClassKV.NewStd(mysql.ErrDupEntry)
	// ErrNotImplemented returns when a function is not implemented yet.
	ErrNotImplemented = ClassKV.NewStd(mysql.ErrNotImplemented)
	// ErrWriteConflict is the error when the commit meets an write conflict error.
	ErrWriteConflict = ClassKV.NewStdErr(mysql.ErrWriteConflict,
	...
	ErrWriteConflictInTiDB = ClassKV.NewStdErr(mysql.ErrWriteConflictInTiDB,
	...
	ErrLockExpire = ClassTiKV.NewStd(mysql.ErrLockExpire)
	// ErrAssertionFailed is the error when an assertion fails.
	ErrAssertionFailed = ClassTiKV.NewStd(mysql.ErrAssertionFailed)
)
