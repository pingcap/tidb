...
func TestProfileToDatum(t *testing.T) {
	...
	datums := [][]types.Datum{
		...
		types.MakeDatums(`│ └─main.main`, "87.50%", "100%", 1, 2, `Z:/main_test.go:46`),
		types.MakeDatums(`│   ├─main.collatz`, "68.75%", "78.57%", 1, 3, `Z:/main_test.go:22`),
		...
		types.MakeDatums(`│   ├─main.collatz`, "12.50%", "14.29%", 1, 3, `Z:/main_test.go:30`),
		types.MakeDatums(`│   │ └─main.collatz`, "12.50%", "100%", 1, 4, `Z:/main_test.go:22`),
		...
		types.MakeDatums(`│   └─main.collatz`, "6.25%", "7.14%", 1, 3, `Z:/main_test.go:20`),
