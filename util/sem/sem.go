...
func IsInvisibleSysVar(varNameInLower string) bool {
	...
	case variable.TiDBDDLSlowOprThreshold, // ddl_slow_threshold
		...
		variable.TiDBMemoryUsageAlarmIntervalSeconds,
		variable.TiDBMemoryUsageAlarmDesensitizationEnable,
		variable.TiDBAutoGcMemoryRatio,
		variable.TiDBMemoryUsageAlarmTruncationEnable,
