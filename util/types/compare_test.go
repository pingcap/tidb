...
func (s *testCompareSuite) TestCompare(c *C) {
	...
	cmpTbl := []struct {
		...
		{NewBinStringFromUint(1, -1), 1, 0},
		{NewBinStringFromUint(0x4D7953514C, -1), "MySQL", 0},
		{NewBinStringFromUint(0, -1), uint64(10), -1},
		{NewBinStringFromUint(1, -1), float64(0), 1},
		{NewBinStringFromUint(1, -1), NewDecFromInt(1), 0},
		{NewBinStringFromUint(1, -1), NewBinStringFromUint(0, -1), 1},
		{NewBinStringFromUint(1, -1), NewBinStringFromUint(1, -1), 0},
		...
		{Enum{Name: "a", Value: 1}, NewBinStringFromUint(2, -1), -1},
		{Enum{Name: "a", Value: 1}, NewBinStringFromUint(1, -1), 0},
		...
		{Set{Name: "a", Value: 1}, NewBinStringFromUint(2, -1), -1},
		{Set{Name: "a", Value: 1}, NewBinStringFromUint(1, -1), 0},
