...
func (s *testCompareSuite) TestCompare(c *C) {
	...
	cmpTbl := []struct {
		...
		{mysql.Hex{Value: 1}, NewDecFromInt(1), 0},
		...
		{mysql.Bit{Value: 1, Width: 1}, NewDecFromInt(1), 0},
		...
		{mysql.Enum{Name: "a", Value: 1}, NewDecFromInt(1), 0},
		...
		{mysql.Set{Name: "a", Value: 1}, NewDecFromInt(1), 0},
