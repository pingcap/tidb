...
func DateDiff(startTime, endTime TimeInternal) (int, error) {
	return calcDaynr(startTime.Year(), startTime.Month(), startTime.Day()) - calcDaynr(endTime.Year(), endTime.Month(), endTime.Day()), nil
}
