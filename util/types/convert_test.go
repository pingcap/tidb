...
func (s *testTypeConvertSuite) TestConvert(c *C) {
	...
	signedDeny(c, mysql.TypeShort, int64(math.MinInt16)-1, strvalue(math.MinInt16))
	signedAccept(c, mysql.TypeShort, int64(math.MinInt16), strvalue(math.MinInt16))
	signedAccept(c, mysql.TypeShort, int64(math.MaxInt16), strvalue(math.MaxInt16))
	signedDeny(c, mysql.TypeShort, int64(math.MaxInt16)+1, strvalue(math.MaxInt16))
	unsignedDeny(c, mysql.TypeShort, -1, "0")
	unsignedAccept(c, mysql.TypeShort, 0, "0")
	unsignedAccept(c, mysql.TypeShort, uint64(math.MaxUint16), strvalue(math.MaxUint16))
	unsignedDeny(c, mysql.TypeShort, uint64(math.MaxUint16)+1, strvalue(math.MaxUint16))
	...
	signedDeny(c, mysql.TypeLong, int64(math.MinInt32)-1, strvalue(math.MinInt32))
	signedAccept(c, mysql.TypeLong, int64(math.MinInt32), strvalue(math.MinInt32))
	signedAccept(c, mysql.TypeLong, int64(math.MaxInt32), strvalue(math.MaxInt32))
	signedDeny(c, mysql.TypeLong, uint64(math.MaxUint64), strvalue(uint(math.MaxInt32)))
	signedDeny(c, mysql.TypeLong, int64(math.MaxInt32)+1, strvalue(math.MaxInt32))
	unsignedDeny(c, mysql.TypeLong, -1, "0")
	unsignedAccept(c, mysql.TypeLong, 0, "0")
	unsignedAccept(c, mysql.TypeLong, uint64(math.MaxUint32), strvalue(math.MaxUint32))
	unsignedDeny(c, mysql.TypeLong, uint64(math.MaxUint32)+1, strvalue(math.MaxUint32))

	signedDeny(c, mysql.TypeLonglong, math.MinInt64*1.1, strvalue(math.MinInt64))
	signedAccept(c, mysql.TypeLonglong, int64(math.MinInt64), strvalue(math.MinInt64))
	signedAccept(c, mysql.TypeLonglong, int64(math.MaxInt64), strvalue(math.MaxInt64))
