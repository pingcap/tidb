...
// equalSet: equalSet indicates which columns are evaluated as constant under the given conditions.
...
type DetachRangeResult struct {
	...
	// EqualCols is the set of columns evaluated as constant under the given conditions.
