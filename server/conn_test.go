...
import (
	...
	"github.com/pingcap/tidb/v4/util/arena"
...
func (ts *ConnTestSuite) TestConnExecutionTimeout(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/pingcap/tidb/v4/server/FakeClientConn", "return(1)"), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/pingcap/tidb/v4/server/FakeClientConn"), IsNil)
}
