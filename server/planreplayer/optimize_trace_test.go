...
func TestDumpOptimizeTraceAPI(t *testing.T) {
	...
	statsHandler := statshandler.NewStatsHandler(dom)
...
func prepareData4OptimizeTrace(t *testing.T, client *testutil.TestServerClient, statHandle *statshandler.StatsHandler) string {
