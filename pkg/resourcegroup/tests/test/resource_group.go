...
func RunResourceGroupBasic(t *testing.T) {
...
func RunResourceGroupRunaway(t *testing.T) {
...
func RunResourceGroupRunawayExceedTiDBSide(t *testing.T) {
...
func RunRunawayRecordFlushLoopAddAndFlush(t *testing.T) {
...
func RunResourceGroupRunawayFlood(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/resourcegroup/runaway/FastRunawayGC", `return(1)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/resourcegroup/runaway/FastRunawayGC"))
	}()
...
func RunAlreadyExistsDefaultResourceGroup(t *testing.T) {
...
func RunNewResourceGroupFromOptions(t *testing.T) {
...
func RunResourceGroupBurstLimit(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	re := require.New(t)
