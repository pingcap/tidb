...
func RunBatchFlusherAdd(t *testing.T) {
	re := require.New(t)
...
func RunBatchFlusherMergeFn(t *testing.T) {
	re := require.New(t)
...
func RunBatchFlusherFlush(t *testing.T) {
	re := require.New(t)
...
func RunBatchFlusherFlushEmpty(t *testing.T) {
	re := require.New(t)
