...
func RunActiveGroupCounterOrdering(t *testing.T) {
...
func RunConcurrentResetAndCheckThresholds(t *testing.T) {
	checker := &Checker{}
...
func RunNewChecker(t *testing.T) {
...
func RunExceedsThresholds(t *testing.T) {
...
func RunCheckerCheckAction(t *testing.T) {
...
func RunGetSettingConvictIdentifier(t *testing.T) {
	t.Run("NilSettings", func(t *testing.T) {
		c := &Checker{}
...
func RunNilCheckerSafety(t *testing.T) {
	var c *Checker
	assert.Equal(t, rmpb.RunawayAction_NoneAction, c.CheckAction())
...
func RunCheckThresholds(t *testing.T) {
...
func RunCheckRuleKillAction(t *testing.T) {
...
func RunMarkRunawayBySettingsCAS(t *testing.T) {
	m := &Manager{runawayQueriesChan: make(chan *Record, 10)}
	c := &Checker{
		manager:           m,
