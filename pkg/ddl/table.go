...
func getOldLabelRules(tblInfo *model.TableInfo, oldSchemaName, oldTableName string) (
	tableRuleID string, partRuleIDs, oldRuleIDs []string, oldRules map[string]*label.Rule, err error) {
