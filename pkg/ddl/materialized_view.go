...
func (e *executor) RefreshMaterializedView(sctx sessionctx.Context, s *ast.RefreshMaterializedViewStmt) error {
	...
	schemaName, tblInfo, err := e.resolveRefreshMaterializedViewTarget(sctx, s)
	if err != nil {
		return err
	}
	...
	restoreConstraintCheck, err := forceConstraintCheckInPlacePessimisticOn(sessVars)
	if err != nil {
		return err
	}
...
func (e *executor) resolveRefreshMaterializedViewTarget(
...
func (e *executor) getRefreshMaterializedViewSession() (sessionctx.Context, func(), error) {
	if e.sessPool == nil {
		return nil, nil, dbterror.ErrInvalidDDLJob.GenWithStackByArgs("refresh materialized view: internal session pool is not initialized")
	}
	refreshSctx, err := e.sessPool.Get()
	if err != nil {
		return nil, nil, errors.Trace(err)
	}
	return refreshSctx, func() {
		e.sessPool.Put(refreshSctx)
	}, nil
}

func forceConstraintCheckInPlacePessimisticOn(sessVars *variable.SessionVars) (func(), error) {
