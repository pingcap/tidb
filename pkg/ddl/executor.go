...
func (e *executor) CreateSchema(ctx sessionctx.Context, stmt *ast.CreateDatabaseStmt) (err error) {
	...
	if sessionVars.GlobalVarsAccessor != nil {
		charsetOptServer.Col, err = sessionVars.GetSessionOrGlobalSystemVar(context.Background(), vardef.CollationServer)
		if err != nil {
			return err
		}
		charsetOptServer.Chs, err = sessionVars.GetSessionOrGlobalSystemVar(context.Background(), vardef.CharacterSetServer)
		if err != nil {
			return err
		}
	}
