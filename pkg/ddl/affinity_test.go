...
func TestAffinityPDInteraction(t *testing.T) {
	...
	t1Info, err := dom.InfoSchema().TableByName(context.Background(), pmodel.NewCIStr("test"), pmodel.NewCIStr("t1"))
	require.NoError(t, err)
	t1ID := t1Info.Meta().ID
	...
	t2Info, err := dom.InfoSchema().TableByName(context.Background(), pmodel.NewCIStr("test"), pmodel.NewCIStr("t2"))
	require.NoError(t, err)
	...
	tblInfo, err := dom.InfoSchema().TableByName(context.Background(), pmodel.NewCIStr("test"), pmodel.NewCIStr("tp2"))
	require.NoError(t, err)
...
func TestAffinityDropDatabase(t *testing.T) {
	...
	t1Info, err := dom.InfoSchema().TableByName(context.Background(), pmodel.NewCIStr("test_affinity_db"), pmodel.NewCIStr("t1"))
	require.NoError(t, err)
	t2Info, err := dom.InfoSchema().TableByName(context.Background(), pmodel.NewCIStr("test_affinity_db"), pmodel.NewCIStr("t2"))
	require.NoError(t, err)
	tp1Info, err := dom.InfoSchema().TableByName(context.Background(), pmodel.NewCIStr("test_affinity_db"), pmodel.NewCIStr("tp1"))
	require.NoError(t, err)
