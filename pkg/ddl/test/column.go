...
func RunColumnBasic(t *testing.T) {
...
func RunAddColumns(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t, mockstore.WithDDLChecker())
...
func RunDropColumnInColumnTest(t *testing.T) {
...
func RunDropColumns(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t1 (c1 int, c2 int, c3 int, c4 int);")
...
func RunWriteDataWriteOnlyMode(t *testing.T) {
...
func RunModifyColumnWithIndex(t *testing.T) {
