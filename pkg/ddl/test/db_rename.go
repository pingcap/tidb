...
func RunRenameTableWithLocked(t *testing.T) {
...
func RunRenameTable2(t *testing.T) {
	isAlterTable := false
	renameTableTest(t, "rename table %s to %s", isAlterTable)
}

func RunAlterTableRenameTable(t *testing.T) {
	isAlterTable := true
...
func RunRenameMultiTablesIssue47064(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunRenameConcurrentAutoID(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunShowRunningRenameTable(t *testing.T) {
