...
func RunIssue22819(t *testing.T) {
...
func RunIssue22307(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
...
func RunAddExpressionIndexRollback(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunDropTableOnTiKVDiskFull(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunRebaseAutoID(t *testing.T) {
...
func RunProcessColumnFlags(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunForbidCacheTableForSystemTable(t *testing.T) {
...
func RunAlterShardRowIDBits(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/meta/autoid/mockAutoIDChange", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/meta/autoid/mockAutoIDChange"))
	}()
...
func RunDDLJobErrorCount(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAddIndexFailOnCaseWhenCanExit(t *testing.T) {
...
func RunCreateTableWithIntegerLengthWarning(t *testing.T) {
...
func RunShowCountWarningsOrErrors(t *testing.T) {
	// Inject the strict-integer-display-width variable in parser directly.
	parsertypes.TiDBStrictIntegerDisplayWidth = true
	defer func() { parsertypes.TiDBStrictIntegerDisplayWidth = false }()
...
func RunIssue60047(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunCancelJobWriteConflict(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
...
func RunTxnSavepointWithDDL(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("MDL is always enabled and read only in nextgen")
	}
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
...
func RunSnapshotVersion(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomainWithSchemaLease(t, dbTestLease)
...
func RunLogAndShowSlowLog(t *testing.T) {
...
func RunReportingMinStartTimestamp(t *testing.T) {
	_, dom := testkit.CreateMockStoreAndDomainWithSchemaLease(t, dbTestLease)
...
// for issue #34931
func RunBuildMaxLengthIndexWithNonRestrictedSqlMode(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBDownBeforeUpdateGlobalVersion(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDDLBlockedCreateView(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunHashPartitionAddColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSetInvalidDefaultValueAfterModifyColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMDLTruncateTable(t *testing.T) {
...
func RunTruncateTableAndSchemaDependence(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDDLJobErrEntrySizeTooLarge(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAdminAlterDDLJobUpdateSysTable(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunAdminAlterDDLJobUnsupportedCases(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t (a int);")
...
func RunAdminAlterDDLJobCommitFailed(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("resource params are calculated automatically on nextgen for add-index, we don't support alter them")
	}
	store := testkit.CreateMockStore(t)
...
func RunGetAllTableInfos(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunGetVersionFailed(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("MDL is always enabled and read only in nextgen")
	}
	store := testkit.CreateMockStore(t)
