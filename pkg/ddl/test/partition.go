...
func RunDropAndTruncatePartition(t *testing.T) {
...
func RunReorganizePartitionRollback(t *testing.T) {
...
func RunUpdateDuringAddColumn(t *testing.T) {
...
func RunExchangePartitionMultiColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
