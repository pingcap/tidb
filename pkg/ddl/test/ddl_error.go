...
func RunTableError(t *testing.T) {
...
func RunForeignKeyError(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, testLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIndexError(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, testLease)
...
func RunColumnError(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, testLease)
...
func RunCreateDatabaseError(t *testing.T) {
...
func RunCreateIndexErrTooManyKeys(t *testing.T) {
