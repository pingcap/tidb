...
func RunSetTableFlashReplica(t *testing.T) {
...
func RunInfoSchemaForTiFlashReplica(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/infoschema/mockTiFlashStoreCount", `return(true)`))
	defer func() {
...
func RunSetTiFlashReplicaForTemporaryTable(t *testing.T) {
...
func RunSetTiFlashReplicaForAddGBKColumn(t *testing.T) {
...
func RunSetTableFlashReplicaForSystemTable(t *testing.T) {
...
func RunSkipSchemaChecker(t *testing.T) {
...
func RunCreateTableWithLike2(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, tiflashReplicaLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTruncateTable2(t *testing.T) {
