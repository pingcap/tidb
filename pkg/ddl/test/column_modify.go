...
func RunAddAndDropColumn(t *testing.T) {
...
func RunChangeColumn(t *testing.T) {
...
func RunVirtualColumnDDL(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, columnModifyLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTransactionWithWriteOnlyColumn(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, columnModifyLease)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t1")
...
// For issue #31735.
func RunAddGeneratedColumnAndInsert(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, columnModifyLease)
...
func RunColumnTypeChangeGenUniqueChangingName(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, columnModifyLease)
...
func RunModifyColumnReorgCheckpoint(t *testing.T) {
