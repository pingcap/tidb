...
func RunCheckOwner(t *testing.T) {
...
func RunInvalidDDLJob(t *testing.T) {
...
func RunAddBatchJobError(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomainWithSchemaLease(t, testLease)
	ctx := testkit.NewSession(t, store)
...
func RunParallelDDL(t *testing.T) {
