...
func RunAddNotNullColumn(t *testing.T) {
...
func RunAddNotNullColumnWhileInsertOnDupUpdate(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTransactionOnAddDropColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCreateTableWithSetCol(t *testing.T) {
...
func RunCreateTableWithEnumCol(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunCreateTableWithIntegerColWithDefault(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunCreateTableWithInfo(t *testing.T) {
...
func RunBatchCreateTable(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTableLocksLostCommit(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk2 := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunWriteLocal(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk2 := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunLockTables(t *testing.T) {
...
func RunTablesLockDelayClean(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk2 := testkit.NewTestKit(t, store)
	tk2.MustExec("use test")
...
func RunAddColumn2(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t1")
...
func RunDropTables(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunCreateConstraintForTable(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunCreateTableHandleAutoIDOnce(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCreateTableWithBR(t *testing.T) {
