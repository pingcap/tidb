...
func RunAlterTableCache(t *testing.T) {
...
func RunAlterTableNoCacheRemovesTableCacheMeta(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	dom.SetStatsUpdating(true)
...
func RunCacheTableSizeLimit(t *testing.T) {
...
func RunIssue34069(t *testing.T) {
