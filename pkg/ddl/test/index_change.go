...
func RunIndexChange(t *testing.T) {
...
func RunAddIndexRowCountUpdate(t *testing.T) {
...
func RunFastReOrgAlwaysEnabledOnNextGen(t *testing.T) {
...
func RunReadOnlyVarsInNextGen(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("This test is only for next-gen TiDB")
	}
	store := testkit.CreateMockStore(t)
