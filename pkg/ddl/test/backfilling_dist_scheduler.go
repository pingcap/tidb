...
func RunBackfillingSchedulerLocalMode(t *testing.T) {
...
func RunCalculateRegionBatch(t *testing.T) {
...
func RunBackfillingSchedulerGlobalSortMode(t *testing.T) {
	// init test env.
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	...
	defer pool.Close()
	ctx := context.WithValue(context.Background(), contextKey("etcd"), true)
...
func RunGetNextStep(t *testing.T) {
	task := &proto.Task{
...
func RunBackfillTaskMetaVersion(t *testing.T) {
