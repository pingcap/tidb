...
func RunGetDDLJobs(t *testing.T) {
...
func RunGetDDLJobsIsSort(t *testing.T) {
	store := testkit.CreateMockStore(t)
	ctx := context.Background()
...
func RunIsJobRollbackable(t *testing.T) {
	cases := []struct {
		tp     model.ActionType
...
func RunCreateViewConcurrently(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCreateDropCreateTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunHandleLockTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
