...
func RunModifyColumnReorgInfo(t *testing.T) {
...
func RunModifyColumnNullToNotNullWithChangingVal2(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunModifyColumnNullToNotNull(t *testing.T) {
...
func RunModifyColumnNullToNotNullWithChangingVal(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, 600*time.Millisecond)
	tk1 := testkit.NewTestKit(t, store)
	tk2 := testkit.NewTestKit(t, store)
...
func RunModifyColumnBetweenStringTypes(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunModifyColumnCharset(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunModifyColumnTime(t *testing.T) {
	now := time.Now().UTC()
...
func RunModifyColumnTypeWhenInterception(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunModifyColumnWithIndexesWriteConflict(t *testing.T) {
...
func RunMultiSchemaModifyColumnWithSkipReorg(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunModifyColumnWithSkipReorg(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunGetModifyColumnType(t *testing.T) {
...
func RunMultiSchemaModifyColumnWithIndex(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunParallelAlterTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunModifyIntegerColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	var reorgType byte
...
func RunModifyStringColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	var reorgType byte
...
func RunModifyColumnWithDifferentCollation(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunStatsAfterModifyColumn(t *testing.T) {
	type query struct {
		pred string
		idx  string
	}
