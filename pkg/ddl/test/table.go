...
func testLockTable(
	...
	args := &model.LockTablesArgs{
		...
		SessionInfo: model.SessionInfo{
			ServerID:  uuid,
			SessionID: sessVars.ConnectionID,
		},
	}
	job := &model.Job{
		Version:    model.GetJobVerInUse(),
...
func RunCreateView(t *testing.T) {
	store, domain := testkit.CreateMockStoreAndDomainWithSchemaLease(t, testLease)
...
func RunRenameTables(t *testing.T) {
	store, domain := testkit.CreateMockStoreAndDomainWithSchemaLease(t, testLease)
...
func RunCreateTables(t *testing.T) {
	store, domain := testkit.CreateMockStoreAndDomainWithSchemaLease(t, testLease)
...
func RunRenameTableIntermediateState(t *testing.T) {
...
func RunCreateSameTableOrDBOnOwnerChange(t *testing.T) {
...
func RunDropTableAccessibleInInfoSchema(t *testing.T) {
...
func RunCreateViewTwice(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk2 := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue59238(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunRefreshMetaBasic(t *testing.T) {
