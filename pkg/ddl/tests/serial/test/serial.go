...
func RunIssue23872(t *testing.T) {
...
func RunChangeMaxIndexLength(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCreateTableWithLike(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCreateTableWithLikeAtTemporaryMode(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCancelAddIndexPanic(t *testing.T) {
...
func RunRecoverTableWithTTL(t *testing.T) {
	store := createMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunRecoverTableByJobID(t *testing.T) {
	store := createMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("create database if not exists test_recover")
	tk.MustExec("use test_recover")
...
func RunRecoverTableByJobIDFail(t *testing.T) {
	store := createMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("create database if not exists test_recover")
	tk.MustExec("use test_recover")
...
func RunRecoverTableByTableNameFail(t *testing.T) {
	store := createMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("create database if not exists test_recover")
	tk.MustExec("use test_recover")
...
func RunCancelJobByErrorCountLimit(t *testing.T) {
	store := createMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunTruncateTableUpdateSchemaVersionErr(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCanceledJobTakeTime(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTableLocksDisable(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAutoRandom(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAutoRandomWithPreSplitRegion(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("create database if not exists auto_random_db")
	tk.MustExec("use auto_random_db")
...
func RunForbidUnsupportedCollations(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCreateTableNoBlock(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCheckEnumLength(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunGetReverseKey(t *testing.T) {
...
func RunForbiddenDDLInNextGen(t *testing.T) {
