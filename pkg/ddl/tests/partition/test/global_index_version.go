...
func RunGlobalIndexVersion0(t *testing.T) {
...
func RunGlobalIndexVersion1(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunGlobalIndexVersionConstants(t *testing.T) {
...
func RunGlobalIndexTruncateAndDropPartition(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunUpdateIndexesResetsGlobalIndexVersion(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
