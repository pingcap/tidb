...
func RunMultiSchemaReorganizePartitionIssue56819(t *testing.T) {
...
func RunMultiSchemaDropRangePartition(t *testing.T) {
...
func RunMultiSchemaDropListDefaultPartition(t *testing.T) {
...
func RunMultiSchemaDropListColumnsDefaultPartition(t *testing.T) {
...
func RunMultiSchemaReorganizePartition(t *testing.T) {
	createSQL := `create table t (a int primary key, b varchar(255), unique index idx_b_global (b) global) partition by range (a) (partition p1 values less than (200), partition pMax values less than (maxvalue))`
	initFn := func(tkO *testkit.TestKit) {
...
func RunMultiSchemaPartitionByGlobalIndex(t *testing.T) {
...
func RunMultiSchemaModifyColumn(t *testing.T) {
...
func RunMultiSchemaModifyColumnConcurrentDMLAcrossPartitions(t *testing.T) {
...
func RunMultiSchemaDropUniqueIndex(t *testing.T) {
...
func RunMultiSchemaReorganizePK(t *testing.T) {
...
func RunMultiSchemaReorganizePKBackfillDML(t *testing.T) {
	createSQL := `create table t (c1 INT primary key, c2 CHAR(255), c3 CHAR(255), c4 CHAR(255), c5 CHAR(255)) partition by range (c1) (partition p1 values less than (200), partition pMax values less than (maxvalue))`
	i := 1
	initFn := func(tkO *testkit.TestKit) {
		tkO.MustExec(fmt.Sprintf(`insert into t values (%d,'%s','Original',%d,%d)`, i, "init O", 4185725186-i, 7483634197-i))
...
func RunMultiSchemaReorganizeNoPK(t *testing.T) {
...
func RunMultiSchemaReorganizeNoPKBackfillDML(t *testing.T) {
	createSQL := `create table t (c1 INT, c2 CHAR(255), c3 CHAR(255), c4 CHAR(255), c5 CHAR(255)) partition by range (c1) (partition p1 values less than (200), partition pMax values less than (maxvalue))`
	i := 1
	initFn := func(tkO *testkit.TestKit) {
		tkO.MustExec(fmt.Sprintf(`insert into t values (%d,'%s','Original',repeat('%d', 25),repeat('%d', 25))`, i, "init O", 4185725186-i, 7483634197-i))
...
func RunMultiSchemaTruncatePartitionWithGlobalIndex(t *testing.T) {
...
func RunMultiSchemaTruncatePartitionWithPKGlobal(t *testing.T) {
...
func RunRemovePartitioningNoPKCovering(t *testing.T) {
...
func RunReorganizePartitionNoPKCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d))` +
		` partition by range (a) ` +
		`(partition p0 values less than (10),` +
		` partition p1 values less than (20),` +
...
func RunRePartitionByKeyNoPKCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d))` +
		` partition by range (a) ` +
		`(partition p0 values less than (10),` +
		` partition p1 values less than (20),` +
...
func RunPartitionByKeyNoPKCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d))`
	alterSQL := `alter table t partition by key(a) partitions 3`
	runCoveringTest(t, createSQL, alterSQL)
}

func RunAddKeyPartitionNoPKCovering(t *testing.T) {
...
func RunCoalesceKeyPartitionNoPKCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d)) partition by key (a) partitions 3`
	alterSQL := `alter table t coalesce partition 1`
	runCoveringTest(t, createSQL, alterSQL)
}

func RunRemovePartitioningCovering(t *testing.T) {
...
func RunReorganizePartitionCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned PRIMARY KEY NONCLUSTERED, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d))` +
		` partition by range (a) ` +
		`(partition p0 values less than (10),` +
		` partition p1 values less than (20),` +
...
func RunRePartitionByKeyCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned PRIMARY KEY NONCLUSTERED, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d))` +
		` partition by range (a) ` +
		`(partition p0 values less than (10),` +
		` partition p1 values less than (20),` +
...
func RunPartitionByKeyCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned PRIMARY KEY NONCLUSTERED, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d))`
	alterSQL := `alter table t partition by key(a) partitions 3`
	runCoveringTest(t, createSQL, alterSQL)
}

func RunAddKeyPartitionCovering(t *testing.T) {
...
func RunCoalesceKeyPartitionCovering(t *testing.T) {
	createSQL := `create table t (a int unsigned PRIMARY KEY NONCLUSTERED, b varchar(255), c int, d varchar(255), key (b), key (c,b), key(c), key(d)) partition by key (a) partitions 3`
	alterSQL := `alter table t coalesce partition 1`
	runCoveringTest(t, createSQL, alterSQL)
}
...
func RunIssue58692(t *testing.T) {
...
func RunDuplicateRowsNoPK(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDuplicateRowsPK59680(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue58864(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMultiSchemaNewTiDBRowID(t *testing.T) {
	createSQL := "CREATE TABLE `t` (\n" +
...
func RunBackfillConcurrentDML(t *testing.T) {
...
func RunBackfillConcurrentDMLRange(t *testing.T) {
	// We want to test the scenario where one batch fails and one succeeds,
	// so it will retry both batches (since it never updated the reorgInfo).
	// Additionally, we want to test if it can cause duplication due to it may not know
	// the committed new record IDs.
...
func RunMultiSchemaReorgDeleteNonClusteredRange(t *testing.T) {
...
func RunNonClusteredUpdateReorgUpdate(t *testing.T) {
...
func RunNonClusteredReorgUpdate(t *testing.T) {
...
func RunNonClusteredReorgUpdateHash(t *testing.T) {
