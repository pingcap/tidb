...
func RunReorgPartitionFailures(t *testing.T) {
...
func RunRemovePartitionFailures(t *testing.T) {
...
func RunPartitionByFailures(t *testing.T) {
	create := `create table t (a int unsigned primary key nonclustered, b int not null, c varchar(255)) partition by range(a) (
                        partition p0 values less than (100),
                        partition p1 values less than (200))`
...
func RunReorganizePartitionListFailures(t *testing.T) {
...
func RunPartitionByListFailures(t *testing.T) {
...
func RunAddHashPartitionFailures(t *testing.T) {
...
func RunCoalesceKeyPartitionFailures(t *testing.T) {
...
func RunPartitionByNonPartitionedTable(t *testing.T) {
...
func RunReorgPartitionConcurrent(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunReorgPartitionFailConcurrent(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunReorgPartitionFailInject(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunReorgPartitionRollback(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPartitionByColumnChecks(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunPartitionIssue56634(t *testing.T) {
...
func RunReorgPartitionFailuresPlacementPolicy(t *testing.T) {
	create := `create table t (a int unsigned PRIMARY KEY, b varchar(255), c int, key (b), key (c,b))` +
		` partition by range (a) ` +
		`(partition p0 values less than (10),` +
		` partition p1 values less than (20),` +
...
func RunRemovePartitionFailuresPlacementPolicy(t *testing.T) {
	create := `create table t (a int unsigned primary key nonclustered, b int not null, c varchar(255)) partition by range(a) (
...
func RunPartitionByFailuresPlacementPolicy(t *testing.T) {
	create := `create table t (a int unsigned primary key nonclustered, b int not null, c varchar(255)) partition by range(a) (
                        partition p0 values less than (100),
                        partition p1 values less than (200))`
	beforeDML := []string{
...
func RunPartitionNonPartitionedFailuresPlacementPolicy(t *testing.T) {
...
func RunReorganizePartitionFailuresAddPlacementPolicy(t *testing.T) {
	create := `create table t (a int unsigned primary key nonclustered, b int not null, c varchar(255)) partition by range(a) (
                        partition p0 values less than (50),
                        partition p1 values less than (100),
                        partition p2 values less than (200))`
...
func RunPartitionByFailuresAddPlacementPolicyGlobalIndex(t *testing.T) {
