...
func RunHalfwayCancelOperations(t *testing.T) {
...
func RunUpdateHandleFailed(t *testing.T) {
	s := createFailDBSuite(t)
...
func RunAddIndexFailed(t *testing.T) {
	s := createFailDBSuite(t)
...
func RunFailSchemaSyncer(t *testing.T) {
...
func RunGenGlobalIDFail(t *testing.T) {
	s := createFailDBSuite(t)
	defer func() {
...
func RunRunDDLJobPanicEnableFastCreateTable(t *testing.T) {
	s := createFailDBSuite(t)
	tk := testkit.NewTestKit(t, s.store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunRunDDLJobPanic(t *testing.T) {
	s := createFailDBSuite(t)
	defer func() {
...
func RunPartitionAddIndexGC(t *testing.T) {
	s := createFailDBSuite(t)
	tk := testkit.NewTestKit(t, s.store)
...
func RunModifyColumn(t *testing.T) {
	s := createFailDBSuite(t)
...
func RunPartitionAddPanic(t *testing.T) {
	s := createFailDBSuite(t)
	tk := testkit.NewTestKit(t, s.store)
	tk.MustExec(`use test;`)
	tk.MustExec(`drop table if exists t;`)
