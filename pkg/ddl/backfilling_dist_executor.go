...
type BackfillTaskMeta struct {
	...
	SampleAllEncodingPredictedTiKVIndexBytes uint64                  `json:"sample_all_encoding_predicted_tikv_index_bytes,omitempty"`
	SampleNewEncodingPredictedTiKVIndexBytes uint64                  `json:"sample_new_encoding_tikv_index_bytes,omitempty"`
	...
	// earlier builds. New task submissions store the sample-new-encoding prediction here.
