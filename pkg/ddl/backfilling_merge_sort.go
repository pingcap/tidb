...
func (m *mergeSortExecutor) RunSubtask(ctx context.Context, subtask *proto.Subtask) error {
	...
	return external.MergeOverlappingFiles(ctx, sm.DataFiles, store, 64*1024, prefix, external.DefaultBlockSize, 8*1024, 1*size.MB, 8*1024, onClose, int(variable.GetDDLReorgWorkerCounter()))
}
