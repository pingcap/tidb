...
func onModifySchemaActiveActiveAndSoftDelete(jobCtx *jobContext, job *model.Job) (ver int64, _ error) {
	...
	if args.SoftDeleteRetention != "" {
		dbInfo.SoftDeleteRetention = args.SoftDeleteRetention
	}
	if args.SoftDeleteJobEnable != "" {
		dbInfo.SoftDeleteJobEnable = args.SoftDeleteJobEnable
	}
	if args.SoftDeleteJobInterval != "" {
		dbInfo.SoftDeleteJobInterval = args.SoftDeleteJobInterval
	}
