...
func RunSessionPool(t *testing.T) {
...
func RunPessimisticTxn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunSessionPoolDestroyResourcePool(t *testing.T) {
	store := testkit.CreateMockStore(t)
	resourcePool := pools.NewResourcePool(func() (pools.Resource, error) {
		newTk := testkit.NewTestKit(t, store)
		return newTk.Session(), nil
...
func RunSessionPoolDestroyDestroyableSessionPool(t *testing.T) {
	store := testkit.CreateMockStore(t)
