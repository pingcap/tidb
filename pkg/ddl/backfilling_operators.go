...
func NewOperatorCtx(ctx context.Context, taskID, subtaskID int64) *operator.Context {
	ctx = logutil.WithFields(ctx, zap.Int64("task-id", taskID), zap.Int64("subtask-id", subtaskID))
