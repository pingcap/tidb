...
func TestGetTableDataKeyRanges(t *testing.T) {
	...
	require.Equal(t, keyRanges[0].EndKey, tablecodec.EncodeTablePrefix(metadef.ReservedSchemaIDLowerBound))
	...
	require.Equal(t, keyRanges[1].EndKey, tablecodec.EncodeTablePrefix(metadef.ReservedSchemaIDLowerBound))
	...
	require.Equal(t, keyRanges[3].EndKey, tablecodec.EncodeTablePrefix(metadef.ReservedSchemaIDLowerBound))
}
