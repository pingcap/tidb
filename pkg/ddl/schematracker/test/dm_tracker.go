...
func RunNoNumLimit(t *testing.T) {
...
func RunCreateTableLongIndex(t *testing.T) {
...
func RunDropColumn(t *testing.T) {
...
func RunCreateTableWithIndex(t *testing.T) {
	// See issue 56045
...
func RunBitDefaultValues(t *testing.T) {
...
func RunAtomicMultiSchemaChange(t *testing.T) {
	sql := "create table test.t (a int);"
...
func RunImmutableTableInfo(t *testing.T) {
...
func RunModifyFromNullToNotNull(t *testing.T) {
...
func RunDropListPartition(t *testing.T) {
	sql := `
