...
func TestCreateTableAsSelect(t *testing.T) {
	...
	// tk.MustQuery("select * from t5").Check(testkit.Rows("<nil> 1 1", "<nil> 2 2"))
	...
	// tk.MustQuery("select * from t7").Check(testkit.Rows("1 1", "2 2"))
	...
	tk.MustGetErrCode("create table t11 (id int primary key, b int, name varchar(20), "+
	...
	// Case 14: Create table with complex union query  (TODO)
	...
	// Case 15: Create table with window function  (TODO)
