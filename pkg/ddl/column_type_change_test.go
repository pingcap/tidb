...
func TestRowFormatWithChecksums(t *testing.T) {
	...
	expected := []byte{0x80, 0x2, 0x3, 0x0, 0x0, 0x0, 0x1, 0x2, 0x3, 0x1, 0x0, 0x4, 0x0, 0x7, 0x0, 0x1, 0x31, 0x32, 0x33, 0x31, 0x32, 0x33, 0x1, 0x68, 0xc3, 0x98, 0x90}
...
func TestRowLevelChecksumWithMultiSchemaChange(t *testing.T) {
	...
	expected := []byte{0x80, 0x2, 0x3, 0x0, 0x1, 0x0, 0x1, 0x2, 0x4, 0x3, 0x1, 0x0, 0x4, 0x0, 0x7, 0x0, 0x1, 0x31, 0x32, 0x33, 0x31, 0x32, 0x33, 0x1, 0x2a, 0xfb, 0xb6, 0x78}
	require.Equal(t, expected, data.Info.Writes[0].ShortValue)
	tk.MustExec("drop table if exists t")
}
