...
func buildMaskingPolicyInfo(
	...
	// Disable some special characters to avoid such case:
	...
	//
	if strings.ContainsAny(policyName.O, "/*") {
		return nil, errors.New("Cannot use character * or / in masking policy name")
	}
