...
func TestParallelAlterAddVectorIndex(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/ddl/MockCheckTiFlashIndexProcess", `return(1)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/"+
			"ddl/MockCheckTiFlashIndexProcess"))
	}()
...
func TestParallelAlterAddColumnarIndex(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/ddl/MockCheckTiFlashIndexProcess", `return(1)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/ddl/MockCheckTiFlashIndexProcess"))
	}()
	tiflash := infosync.NewMockTiFlash()
	infosync.SetMockTiFlash(tiflash)
	defer func() {
