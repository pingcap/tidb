...
func RunStatementRUV2RPCInterceptor(t *testing.T) {
...
func RunStatementRUV2RPCInterceptorNilMetrics(t *testing.T) {
	require.Nil(t, NewStatementRUV2RPCInterceptor(nil))
}

func RunStatementRUV2RPCInterceptorWithGetterFollowsCurrentStatement(t *testing.T) {
