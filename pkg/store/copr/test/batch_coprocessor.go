...
func RunBalanceBatchCopTaskWithContinuity(t *testing.T) {
...
func RunBalanceBatchCopTaskWithEmptyTaskSet(t *testing.T) {
	{
...
func RunDeepCopyStoreTaskMap(t *testing.T) {
...
func RunConsistentHash(t *testing.T) {
...
func RunDispatchPolicyRR(t *testing.T) {
	allAddrs := generateDifferentAddrs(100)
	for range 100 {
...
func RunTopoFetcherBackoff(t *testing.T) {
...
func RunGetAllUsedTiFlashStores(t *testing.T) {
...
func RunAliveStoreSkipCheck(t *testing.T) {
...
func RunCheckAliveStore(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/store/copr/mockNoAliveTiFlash", `return(false)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/store/copr/mockNoAliveTiFlash"))
	}()
