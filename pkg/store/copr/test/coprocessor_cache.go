...
func RunBuildCacheKey(t *testing.T) {
...
func RunCacheValueLen(t *testing.T) {
	v := coprCacheValue{
		TimeStamp:         0x123,
		RegionID:          0x1,
...
func RunIssue24118(t *testing.T) {
