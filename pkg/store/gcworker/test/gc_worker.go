...
func RunGetOracleTime(t *testing.T) {
...
func RunStatusVars(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunDoGCForOneRegion(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunGetGCConcurrency(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunCheckGCMode(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunNeedsGCOperationForStore(t *testing.T) {
...
func RunDeleteRangesFailure(t *testing.T) {
	tests := []struct {
		name     string
		failType int
	}{
...
func RunConcurrentDeleteRanges(t *testing.T) {
...
func RunUnsafeDestroyRangeForRaftkv2(t *testing.T) {
...
func RunLeaderTick(t *testing.T) {
...
func RunResolveLockRangeInfine(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunResolveLockRangeMeetRegionCacheMiss(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunResolveLockRangeMeetRegionEnlargeCausedByRegionMerge(t *testing.T) {
...
func RunResolveLocksWithKeyspaces_NullKeyspaceOnly(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "NullKeyspaceOnly")
}

func RunResolveLocksWithKeyspaces_NullKeyspaceOnlyMultiRegion(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "NullKeyspaceOnlyMultiRegion")
}

func RunResolveLocksWithKeyspaces_NullKeyspaceInMultiKeyspaceEnvironment(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "NullKeyspaceInMultiKeyspaceEnvironment")
}

func RunResolveLocksWithKeyspaces_NonNullKeyspaceInMultiKeyspaceEnvironment(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "NonNullKeyspaceInMultiKeyspaceEnvironment")
}

func RunResolveLocksWithKeyspaces_UnifiedGCInMixedUsage(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "UnifiedGCInMixedUsage")
}

func RunResolveLocksWithKeyspaces_UnifiedGCWithMaxKeyspaceID(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "UnifiedGCWithMaxKeyspaceID")
}

func RunResolveLocksWithKeyspaces_UnifiedGCInMultiBatchesOfKeyspaces_8(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "UnifiedGCInMultiBatchesOfKeyspaces_8")
}

func RunResolveLocksWithKeyspaces_UnifiedGCInMultiBatchesOfKeyspaces_Last8_Step2(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "UnifiedGCInMultiBatchesOfKeyspaces_Last8_Step2")
}

func RunResolveLocksWithKeyspaces_UnifiedGCInMultiBatchesOfKeyspaces_MultipleOfBatchSize(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "UnifiedGCInMultiBatchesOfKeyspaces_MultipleOfBatchSize")
}

func RunResolveLocksWithKeyspaces_UnifiedGCInMultiBatchesOfKeyspaces_MultipleOfBatchSizeToEnd(t *testing.T) {
	testResolveLocksWithKeyspacesImpl(t, "UnifiedGCInMultiBatchesOfKeyspaces_MultipleOfBatchSizeToEnd")
}

func RunResolveLocksNearTxnSafePoint(t *testing.T) {
...
func RunSetServiceSafePoint(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunRunGCJobAPI(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunRunDistGCJobAPI(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunStartWithRunGCJobFailures(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunGCPlacementRules(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunGCLabelRules(t *testing.T) {
	s := createGCWorkerSuite(t)
...
func RunGCWithPendingTxn(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunGCWithPendingTxn2(t *testing.T) {
	// as we are adjusting the base TS, we need a larger schema lease to avoid
	// the info schema outdated error.
...
func RunSkipGCAndOnlyResolveLock(t *testing.T) {
	// as we are adjusting the base TS, we need a larger schema lease to avoid
	// the info schema outdated error.
	s := createGCWorkerSuite(t, withStoreType(mockstore.EmbedUnistore), withSchemaLease(10*time.Minute))
...
func RunCalcDeleteRangeConcurrency(t *testing.T) {
	testCases := []struct {
		name        string
