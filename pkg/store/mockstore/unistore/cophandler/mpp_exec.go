...
func (e *indexLookUpExec) next() (ret *chunk.Chunk, _ error) {
	tblScans, indexChk, err := e.fetchTableScans()
	if err != nil {
...
func (e *indexLookUpExec) fetchTableScans() (tableScans []*tableScanExec, indexChk *chunk.Chunk, err error) {
