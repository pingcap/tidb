...
// EstimateParquetReaderMemory estimates parser memory for the parquet file.
func (ti *TableImporter) EstimateParquetReaderMemory(ctx context.Context, fileMeta mydump.SourceFileMeta) (int64, error) {
	return mydump.EstimateParquetReaderMemory(ctx, ti.LoadDataController.dataStore, fileMeta)
}
