...
func RunJobHappyPath(t *testing.T) {
...
func RunGetAndCancelJob(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	ctx := context.Background()
	conn := tk.Session().GetSQLExecutor()
...
func RunFailJobBeforeStart(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	ctx := context.Background()
	conn := tk.Session().GetSQLExecutor()
...
func RunJobInfo_CanCancel(t *testing.T) {
	jobInfo := &importer.JobInfo{}
...
func RunGetJobInfoNullField(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	ctx := context.Background()
	conn := tk.Session().GetSQLExecutor()
