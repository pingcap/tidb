...
func RunVerifyChecksum(t *testing.T) {
...
func RunGetTargetNodeCpuCnt(t *testing.T) {
...
func RunPostProcess(t *testing.T) {
	ctx := context.Background()
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	pool := pools.NewResourcePool(func() (pools.Resource, error) {
...
func RunProcessChunkWith(t *testing.T) {
	ctx := context.Background()
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPopulateChunks(t *testing.T) {
...
func RunCalResourceParams(t *testing.T) {
	if kerneltype.IsClassic() {
