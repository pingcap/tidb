...
func (e *groupConcat) SerializePartialResult(partialResult PartialResult, chk *chunk.Chunk, spillHelper *AggSpillSerializeHelper) {
...
func (e *groupConcat) deserializeForSpill(helper *aggSpillDeserializeHelper) (PartialResult, int64) {
