...
type serializer interface {
	...
	SerializePartialResult(partialResult PartialResult, chk *chunk.Chunk, spillHelper *AggSpillSerializeHelper)
...
func (*baseAggFunc) SerializePartialResult(_ PartialResult, _ *chunk.Chunk, _ *AggSpillSerializeHelper) {
}
...
type deserializeFunc func(*aggSpillDeserializeHelper) (PartialResult, int64)
