...
func RunMergePartialResult4MaxMin(t *testing.T) {
...
func RunMaxSlidingWindow(t *testing.T) {
...
func RunDequeReset(t *testing.T) {
...
func RunDequePushPop(t *testing.T) {
	deque := aggfuncs.NewDeque(true, func(i, j any) int {
		return cmp.Compare(i.(int64), j.(int64))
	})
	times := 15
