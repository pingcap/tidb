...
func genLeftOuterAntiSemiJoinResult(t *testing.T, sessCtx sessionctx.Context, leftFilter expression.CNFExprs, leftChunks []*chunk.Chunk, rightChunks []*chunk.Chunk, leftKeyIndex []int, rightKeyIndex []int,
	...
	return genLeftOuterAntiSemiOrAntiSemiJoinResultImpl(t, sessCtx, leftFilter, leftChunks, rightChunks, leftKeyIndex, rightKeyIndex, leftTypes, rightTypes, leftKeyTypes, rightKeyTypes, leftUsedColumns, otherConditions, resultTypes, true)
}

// generate left outer semi join result using nested loop
func genLeftOuterAntiSemiOrAntiSemiJoinResultImpl(t *testing.T, sessCtx sessionctx.Context, leftFilter expression.CNFExprs, leftChunks []*chunk.Chunk, rightChunks []*chunk.Chunk, leftKeyIndex []int, rightKeyIndex []int,
	leftTypes []*types.FieldType, rightTypes []*types.FieldType, leftKeyTypes []*types.FieldType, rightKeyTypes []*types.FieldType, leftUsedColumns []int, otherConditions expression.CNFExprs,
...
func testLeftOuterAntiSemiJoinProbeBasic(t *testing.T, isLeftOuter bool) {
...
func testLeftOuterAntiSemiJoinProbeAllJoinKeys(t *testing.T, isLeftOuter bool) {
	tinyTp := types.NewFieldType(mysql.TypeTiny)
	tinyTp.AddFlag(mysql.NotNullFlag)
	intTp := types.NewFieldType(mysql.TypeLonglong)
	intTp.AddFlag(mysql.NotNullFlag)
...
func testLeftOuterAntiSemiJoinProbeOtherCondition(t *testing.T, isLeftOuter bool) {
	intTp := types.NewFieldType(mysql.TypeLonglong)
	intTp.AddFlag(mysql.NotNullFlag)
...
func testLeftOuterAntiSemiJoinProbeWithSel(t *testing.T, isLeftOuter bool) {
	intTp := types.NewFieldType(mysql.TypeLonglong)
	intTp.AddFlag(mysql.NotNullFlag)
	nullableIntTp := types.NewFieldType(mysql.TypeLonglong)
	uintTp := types.NewFieldType(mysql.TypeLonglong)
...
func TestLeftOuterAntiSemiJoinProbeBasic(t *testing.T) {
	testLeftOuterAntiSemiJoinProbeBasic(t, true)
}

func TestLeftOuterAntiSemiJoinProbeAllJoinKeys(t *testing.T) {
	testLeftOuterAntiSemiJoinProbeAllJoinKeys(t, true)
}

func TestLeftOuterAntiSemiJoinProbeOtherCondition(t *testing.T) {
	testLeftOuterAntiSemiJoinProbeOtherCondition(t, true)
}

func TestLeftOuterAntiSemiJoinProbeWithSel(t *testing.T) {
	testLeftOuterAntiSemiJoinProbeWithSel(t, true)
}
