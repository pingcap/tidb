...
func (e *IndexNestedLoopHashJoin) supportIncrementalLookUp() bool {
	return !e.KeepOuterOrder &&
		(JoinerType(e.Joiners[0]) == logicalop.InnerJoin ||
			JoinerType(e.Joiners[0]) == logicalop.LeftOuterJoin ||
			JoinerType(e.Joiners[0]) == logicalop.RightOuterJoin ||
			JoinerType(e.Joiners[0]) == logicalop.AntiSemiJoin)
}
