...
func RunAntiSemiJoinBasic(t *testing.T) {
...
func RunAntiSemiJoinDuplicateKeys(t *testing.T) {
...
func RunNotInWithAntiSemi(t *testing.T) {
	testNotInAntiSemi(t, true)
	testNotInAntiSemi(t, false)
}

func RunAntiSemiJoinProbeBasic(t *testing.T) {
...
func RunAntiSemiJoinProbeAllJoinKeys(t *testing.T) {
	tinyTp := types.NewFieldType(mysql.TypeTiny)
	tinyTp.AddFlag(mysql.NotNullFlag)
	intTp := types.NewFieldType(mysql.TypeLonglong)
	intTp.AddFlag(mysql.NotNullFlag)
...
func RunAntiSemiJoinJoinProbeWithSel(t *testing.T) {
	intTp := types.NewFieldType(mysql.TypeLonglong)
	intTp.AddFlag(mysql.NotNullFlag)
