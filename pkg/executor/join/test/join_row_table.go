...
func RunHeapObjectCanMove(t *testing.T) {
	require.Equal(t, false, heapObjectsCanMove())
}

func RunFixedOffsetInRowLayout(t *testing.T) {
	require.Equal(t, 8, sizeOfNextPtr)
	require.Equal(t, 4, sizeOfElementSize)
}

func RunBitMaskInUint32(t *testing.T) {
...
func RunUintptrCanHoldPointer(t *testing.T) {
