...
func RunSemiJoinBasic(t *testing.T) {
...
func RunSemiJoinDuplicateKeys(t *testing.T) {
...
func RunSemiAndAntiSemiJoinSpill(t *testing.T) {
...
func RunSemiJoinProbeBasic(t *testing.T) {
	testLeftOuterSemiOrSemiJoinProbeBasic(t, false, false)
}

func RunSemiJoinProbeAllJoinKeys(t *testing.T) {
	testLeftOuterSemiJoinProbeAllJoinKeys(t, false, false)
}

func RunSemiJoinProbeWithSel(t *testing.T) {
