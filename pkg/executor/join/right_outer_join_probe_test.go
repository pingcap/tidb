...
func genRightOuterJoinResult(t *testing.T, sessCtx sessionapi.Context, rightFilter expression.CNFExprs, leftChunks []*chunk.Chunk, rightChunks []*chunk.Chunk, leftKeyIndex []int, rightKeyIndex []int,
