...
func RunGlobalMemoryControl(t *testing.T) {
	...
	sm := &testkit.MockSessionManager{
		PS: []*sessmgr.ProcessInfo{tk1.Session().ShowProcess(), tk2.Session().ShowProcess(), tk3.Session().ShowProcess()},
	}
...
func RunPBMemoryLeak(t *testing.T) {
	// will timeout when data race enabled
	skip.UnderShort(t)
