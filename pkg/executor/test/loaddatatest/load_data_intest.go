...
func RunLoadDataInitParam(t *testing.T) {
...
func RunLoadDataEscape(t *testing.T) {
	trivialMsg := "Records: 1  Deleted: 0  Skipped: 0  Warnings: 0"
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunLoadDataSpecifiedColumns(t *testing.T) {
	trivialMsg := "Records: 1  Deleted: 0  Skipped: 0  Warnings: 0"
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test; drop table if exists load_data_test;")
...
func RunLoadDataIgnoreLines(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test; drop table if exists load_data_test;")
	tk.MustExec("CREATE TABLE load_data_test (id INT NOT NULL PRIMARY KEY, value TEXT NOT NULL) CHARACTER SET utf8")
...
func RunLoadDataNULL(t *testing.T) {
...
func RunLoadDataReplace(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunLoadDataOverflowBigintUnsigned(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test; drop table if exists load_data_test;")
...
func RunLoadDataWithUppercaseUserVars(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test; drop table if exists load_data_test;")
...
func RunLoadDataIntoPartitionedTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunLoadDataFromServerFile(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunLoadDataAutoRandomError(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunLoadDataLowPrioritySetsKVLowPriority(t *testing.T) {
