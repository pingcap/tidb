...
func RunAnalyzeColumnsWithPrimaryKey(t *testing.T) {
...
func RunAnalyzeColumnsWithIndex(t *testing.T) {
	for _, val := range []ast.ColumnChoice{ast.ColumnList, ast.PredicateColumns} {
		func(choice ast.ColumnChoice) {
			store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunAnalyzeColumnsWithClusteredIndex(t *testing.T) {
	for _, val := range []ast.ColumnChoice{ast.ColumnList, ast.PredicateColumns} {
		func(choice ast.ColumnChoice) {
			store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunAnalyzeColumnsWithDynamicPartitionTable(t *testing.T) {
	for _, val := range []ast.ColumnChoice{ast.ColumnList, ast.PredicateColumns} {
		func(choice ast.ColumnChoice) {
			store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunAnalyzeColumnsWithStaticPartitionTable(t *testing.T) {
	for _, val := range []ast.ColumnChoice{ast.ColumnList, ast.PredicateColumns} {
		func(choice ast.ColumnChoice) {
			store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunAnalyzeColumnsWithVirtualColumnIndex(t *testing.T) {
	for _, val := range []ast.ColumnChoice{ast.ColumnList, ast.PredicateColumns} {
		func(choice ast.ColumnChoice) {
			store, dom := testkit.CreateMockStoreAndDomain(t)
