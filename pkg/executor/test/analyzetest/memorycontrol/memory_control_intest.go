...
func RunGlobalMemoryControlForAnalyze(t *testing.T) {
...
func RunGlobalMemoryControlForPrepareAnalyze(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunGlobalMemoryControlForAutoAnalyze(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunMemQuotaAnalyze(t *testing.T) {
...
func RunMemQuotaAnalyze2(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAnalyzeV2MemoryUsageMetricNeverNegative(t *testing.T) {
...
func RunAnalyzeSessionMemTrackerDetachOnClose(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
