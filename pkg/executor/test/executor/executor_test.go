...
<<<<<<< HEAD:pkg/executor/test/executor/executor_test.go
...
>>>>>>> 7b2d727c0e9 (table: fix issue of get default value from column when column doesn't have default value (#51309) (#51386)):executor/executor_test.go
}
