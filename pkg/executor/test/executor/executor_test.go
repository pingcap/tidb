...
func TestPointGetPreparedPlan(t *testing.T) {
	...
	require.NoError(t, err)
	tk.Session().GetSessionVars().PreparedStmts[pspk1Id].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
	pspk2Id, _, _, err := tk.Session().PrepareStmt("select * from t where ? = a ")
	require.NoError(t, err)
	tk.Session().GetSessionVars().PreparedStmts[pspk2Id].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
	...
	require.NoError(t, err)
	tk.Session().GetSessionVars().PreparedStmts[psuk1Id].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
...
func TestPointGetPreparedPlanWithCommitMode(t *testing.T) {
	...
	require.NoError(t, err)
	tk1.Session().GetSessionVars().PreparedStmts[pspk1Id].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
...
func TestPointUpdatePreparedPlan(t *testing.T) {
	...
	require.NoError(t, err)
	tk.Session().GetSessionVars().PreparedStmts[updateID1].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
	require.Equal(t, 1, pc)
	updateID2, pc, _, err := tk.Session().PrepareStmt(`update t set c = c + 2 where ? = a`)
	require.NoError(t, err)
	tk.Session().GetSessionVars().PreparedStmts[updateID2].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
	require.Equal(t, 1, pc)
	...
	require.NoError(t, err)
	tk.Session().GetSessionVars().PreparedStmts[updUkID1].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
...
func TestPointUpdatePreparedPlanWithCommitMode(t *testing.T) {
	...
	tk1.Session().GetSessionVars().PreparedStmts[updateID1].(*plannercore.PlanCacheStmt).UncacheableReasonWarning = false
	require.NoError(t, err)
