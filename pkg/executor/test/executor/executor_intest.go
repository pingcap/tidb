...
func RunTimezonePushDown(t *testing.T) {
	...
	count := 0
	//lint:ignore SA1029 test hook key must match the production lookup in the executor path
...
func RunNotFillCacheFlag(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCheckIndex(t *testing.T) {
...
func RunTimestampDefaultValueTimeZone(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBCurrentTS(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBLastTxnInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBLastQueryInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPartitionHashCode(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPrevStmtDesensitization(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue19148(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunUnreasonablyClose(t *testing.T) {
	store := testkit.CreateMockStore(t)
	...
	if opsAlreadyCoveredMask != opsNeedsCoveredMask {
		for i := range opsNeedsCovered {
			if opsAlreadyCoveredMask&(1<<i) != 1<<i {
				fmt.Fprintf(&commentBuf, " %v", reflect.TypeOf(opsNeedsCovered[i]))
			}
		}
	}
...
func RunTwiceCloseUnionExec(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunApplyCache(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCollectDMLRuntimeStats(t *testing.T) {
...
func RunTableSampleTemporaryTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGetResultRowsCount(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAdminShowDDLJobs(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAdminShowDDLJobsInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunUnionLimit(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunLowResolutionTSORead(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunLowResolutionTSOReadScope(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAdapterStatement(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunIsPointGet(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPointGetOrderby(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunClusteredIndexIsPointGet(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunColumnName(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunHistoryRead(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunHistoryReadInTxn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunCurrentTimestampValueSelection(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIsFastPlan(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunGlobalMemoryControl2(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunSignalCheckpointForSort(t *testing.T) {
...
func RunSessionRootTrackerDetach(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	defer tk.MustExec("set global tidb_mem_oom_action = DEFAULT")
	tk.MustExec("set global tidb_mem_oom_action='CANCEL'")
	...
	err := tk.ExecToErr("select /*+inl_join(t1)*/ t.a, t1.a from t use index(idx), t1 use index(idx) where t.a = t1.a")
	require.True(t, exeerrors.ErrMemoryExceedForQuery.Equal(err))
	tk.MustExec("set tidb_mem_quota_query=1000")
	rs, err := tk.Exec("select /*+inl_join(t1)*/ t.a, t1.a from t use index(idx), t1 use index(idx) where t.a = t1.a")
	require.NoError(t, err)
...
func RunProcessInfoOfSubQuery(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk2 := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssues49377(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssues40463(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunIssue38756(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunIssue50043(t *testing.T) {
	testIssue50043WithInitSQL(t, "")
}

func RunIssue50043WithPipelinedDML(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunIssue51324(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunDecimalDivPrecisionIncrement(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue48756(t *testing.T) {
...
func RunIssue50308(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunQueryWithKill(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test;")
...
func RunIssue63329(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue52984(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t;")
