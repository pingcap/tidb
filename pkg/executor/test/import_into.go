...
func RunClassicS3ExternalID(t *testing.T) {
...
func RunNextGenS3ExternalID(t *testing.T) {
...
func RunNextGenUnsupportedLocalSortAndOptions(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("only for nextgen")
	}
	store := testkit.CreateMockStore(t)
...
func RunImportIntoValidateColAssignmentsWithEncodeCtx(t *testing.T) {
	cases := []struct {
		exprs []string
		error string
	}{
