...
//  3. Execute DDL.
func RunInTxnExecDDLFail(t *testing.T) {
...
func RunCreateTable(t *testing.T) {
...
func RunCreateDropDatabase(t *testing.T) {
...
func RunAlterTableAddColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAlterTableAddColumns(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table if not exists alter_test (c1 int)")
...
func RunAddNotNullColumnNoDefault(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAlterTableModifyColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunColumnCharsetAndCollate(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunShardRowIDBits(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAutoRandomBitsData(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAutoRandomTableOption(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunSetDDLErrorCountLimit(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunSetDDLReorgMaxWriteSpeed(t *testing.T) {
...
func RunLoadDDLDistributeVars(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunRenameWithSmallAutoIDStep(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
...
func RunRenameTableWithReload(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t, mockstore.WithDDLChecker())
...
func RunRenameTable(t *testing.T) {
...
func RunRenameMultiTables(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/meta/autoid/mockAutoIDChange", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/meta/autoid/mockAutoIDChange"))
	}()
...
func RunDefShardTables(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithDDLChecker())
