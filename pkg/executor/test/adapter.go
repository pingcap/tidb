...
func RunContextCancelWhenReadFromCopIterator(t *testing.T) {
...
func RunPrepareAndCompleteSlowLogItemsForRules(t *testing.T) {
	ctx := mock.NewContext()
...
func RunShouldWriteSlowLog(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunWriteSlowLog(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunFinishExecuteStmtReportsTiDBRUV2WithoutSyncingRUDetails(t *testing.T) {
...
func RunSlowLogMaxPerSec(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunMaxExecutionTimeIncludesTSOWaitTime(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
