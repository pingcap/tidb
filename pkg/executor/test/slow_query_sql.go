...
func RunSlowQueryWithoutSlowLog(t *testing.T) {
...
func RunSlowQuerySensitiveQuery(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
...
func RunSlowQueryNonPrepared(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
...
func RunSlowQueryMisc(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
...
func RunLogSlowLogIndex(t *testing.T) {
	f, err := os.CreateTemp("", "tidb-slow-*.log")
	require.NoError(t, err)
	require.NoError(t, f.Close())
...
func RunSlowQuerySessionAlias(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
...
func RunIssue37066(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
	f, err := os.CreateTemp("", "tidb-slow-*.log")
	require.NoError(t, err)
...
func RunWarningsInSlowQuery(t *testing.T) {
...
func RunStorageEnginesInSlowQuery(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
	f, err := os.CreateTemp("", "tidb-slow-*.log")
	require.NoError(t, err)
...
func RunSessionConnectAttrsInSlowQuery(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
	f, err := os.CreateTemp("", "tidb-slow-*.log")
	require.NoError(t, err)
...
func RunSessionConnectAttrsMissingAndTruncatedInSlowQuery(t *testing.T) {
	originCfg := config.GetGlobalConfig()
	newCfg := *originCfg
	f, err := os.CreateTemp("", "tidb-slow-*.log")
	require.NoError(t, err)
