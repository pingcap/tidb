...
func RunMemTracker4UpdateExec(t *testing.T) {
...
func RunMemTracker4InsertAndReplaceExec(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMemTracker4DeleteExec(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunOOMActionPriority(t *testing.T) {
	store := testkit.CreateMockStore(t)
