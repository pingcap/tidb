...
func RunDistsqlPartitionTableConcurrency(t *testing.T) {
	...
	//lint:ignore SA1029 test hook key must match the production lookup in the distsql path
...
func RunDistSQLSharedKVRequestRace(t *testing.T) {
