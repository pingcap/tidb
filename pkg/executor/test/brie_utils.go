...
func RunSplitBatchCreateTableWithTableId(t *testing.T) {
...
// batch create table with table id reused
func RunSplitBatchCreateTable(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
// batch create table with table id reused
func RunSplitBatchCreateTableFailWithEntryTooLarge(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists table_1")
...
func RunBRIECreateDatabase(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunBRIECreateTable(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists table_1")
...
func RunBRIECreateTables(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func (f *fakeDDLExecutor) BatchCreateTableWithInfo(
	...
	if len(info) > f.maxCount {
		// #nosec G404 -- test code, weak RNG acceptable
		switch rand.Int() % 2 {
		case 0:
...
func RunSplitTablesQueryMatch(t *testing.T) {
	ddlexecutor := &fakeDDLExecutor{
		maxCount:         1,
