...
func RunAnalyzeIndexExtractTopN(t *testing.T) {
...
func RunAnalyzePartitionTableByConcurrencyInDynamic(t *testing.T) {
...
func RunAnalyzeSaveResultErrorDoesNotHang(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAnalyzeKillDuringSaveDoesNotHang(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAnalyzeV2ReleaseColumnCollectorMemoryImmediately(t *testing.T) {
