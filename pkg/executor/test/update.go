...
func RunPessimisticUpdatePKLazyCheck(t *testing.T) {
...
func getPresumeExistsCount(t *testing.T, se sessionapi.Session) int {
...
func RunLockUnchangedUniqueKeys(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunLockUnchangedKeysGlobalIndex(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunUpdateRowRetryAndThenDupKey(t *testing.T) {
...
func RunUpdateWithOnUpdateAndAutoGenerated(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewSteppedTestKit(t, store)
	tk.MustExec("use test")
