...
func RunInvalidReadTemporaryTable(t *testing.T) {
	...
	genLocalTemporarySQL := func(sql string) string {
		return strings.ReplaceAll(sql, "tmp1", "tmp2")
	}
...
func RunInvalidReadCacheTable(t *testing.T) {
...
func RunTxnSavepoint0(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTxnSavepoint1(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t(id int, a int, unique index idx(id))")
...
func RunRollbackToSavepointReleasePessimisticLock(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSavepointInPessimisticAndOptimistic(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk1 := testkit.NewTestKit(t, store)
	tk1.MustExec("use test")
	tk1.MustExec("create table t(id int key, a int)")
...
func RunSavepointInBigTxn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk1 := testkit.NewTestKit(t, store)
	tk1.MustExec("use test")
	tk1.MustExec("create table t(id int key, a int)")
...
func RunSavepointWithCacheTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunColumnNotMatchError(t *testing.T) {
...
func RunSavepointWithForeignKey(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunInnodbLockWaitTimeout(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
