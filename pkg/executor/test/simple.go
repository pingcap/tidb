...
func RunRefreshTableStats(t *testing.T) {
...
func RunRefreshStatsWarningsForMissingObjects(t *testing.T) {
...
func RunRefreshAllNonExistentTables(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunRefreshStatsNoTables(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunRefreshStatsRequiresDefaultDB(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunRefreshStatsWhenDatabaseIsEmpty(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunRefreshStatsPrivilegeChecks(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunRefreshStatsWithRestoreAdmin(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunRefreshStatsWithFullMode(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunRefreshStatsWithLiteMode(t *testing.T) {
...
func RunRefreshStatsConcurrently(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunFlushStatsDelta(t *testing.T) {
