...
func TestReadPartitionTable(t *testing.T) {
	...
	tk.MustExec("alter table t set tiflash replica 1")
	tb := external.GetTableByName(context.Background(), t, tk, "test", "t")
...
func TestReadUnsigedPK(t *testing.T) {
	...
	tb = external.GetTableByName(context.Background(), t, tk, "test", "t1")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestMppExecution(t *testing.T) {
	...
	tb = external.GetTableByName(context.Background(), t, tk, "test", "t2")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestTiFlashPartitionTableShuffledHashJoin(t *testing.T) {
	...
	for _, tbl := range []string{`thash`, `trange`, `tlist`, `tnormal`} {
		...
		tb := external.GetTableByName(context.Background(), t, tk, "tiflash_partition_SHJ", tbl)
		err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
		require.NoError(t, err)
	}
...
func TestTiFlashPartitionTableReader(t *testing.T) {
	...
	for _, tbl := range []string{`thash`, `trange`, `tlist`, `tnormal`} {
		tk.MustExec("alter table " + tbl + " set tiflash replica 1")
		tb := external.GetTableByName(context.Background(), t, tk, "tiflash_partition_tablereader", tbl)
		err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
		require.NoError(t, err)
	}
	// mock executor does not support use outer table as build side for outer join, so need to
...
func TestPartitionTable(t *testing.T) {
	...
	tb = external.GetTableByName(context.Background(), t, tk, "test", "t3")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestMppUnionAll(t *testing.T) {
	...
	tb := external.GetTableByName(context.Background(), t, tk, "test", "x1")
	err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
	tb = external.GetTableByName(context.Background(), t, tk, "test", "x2")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
	...
	tb = external.GetTableByName(context.Background(), t, tk, "test", "x3")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
	...
	tb = external.GetTableByName(context.Background(), t, tk, "test", "x4")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestAvgOverflow(t *testing.T) {
	...
	tb = external.GetTableByName(context.Background(), t, tk, "test", "td")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestTiFlashPartitionTableShuffledHashAggregation(t *testing.T) {
	...
	for _, tbl := range []string{`thash`, `trange`, `tlist`, `tnormal`} {
		tk.MustExec("alter table " + tbl + " set tiflash replica 1")
		tb := external.GetTableByName(context.Background(), t, tk, "tiflash_partition_AGG", tbl)
		err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
		require.NoError(t, err)
	}
...
func TestTiFlashPartitionTableBroadcastJoin(t *testing.T) {
	...
	for _, tbl := range []string{`thash`, `trange`, `tlist`, `tnormal`} {
		tk.MustExec("alter table " + tbl + " set tiflash replica 1")
		tb := external.GetTableByName(context.Background(), t, tk, "tiflash_partition_BCJ", tbl)
		err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
		require.NoError(t, err)
	}
...
func TestAggPushDownCountStar(t *testing.T) {
	...
	tb := external.GetTableByName(context.Background(), t, tk, "test", "c")
	err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
	tk.MustExec("alter table o set tiflash replica 1")
	tb = external.GetTableByName(context.Background(), t, tk, "test", "o")
	err = domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestGroupStreamAggOnTiFlash(t *testing.T) {
	...
	tb := external.GetTableByName(context.Background(), t, tk, "test", "foo")
	err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestTiflashEmptyDynamicPruneResult(t *testing.T) {
	...
	tb := external.GetTableByName(context.Background(), t, tk, "test", "IDT_RP24833")
	err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
...
func TestDisaggregatedTiFlashQuery(t *testing.T) {
	...
	tb := external.GetTableByName(context.Background(), t, tk, "test", "tbl_1")
	err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
	tk.MustExec("set @@session.tidb_isolation_read_engines=\"tiflash\"")
...
func TestMPP47766(t *testing.T) {
	...
	tb := external.GetTableByName(context.Background(), t, tk, "test", "traces")
	err := domain.GetDomain(tk.Session()).DDL().UpdateTableReplicaInfo(tk.Session(), tb.Meta().ID, true)
	require.NoError(t, err)
