...
func RunPlanCacheWithDifferentVariableTypes(t *testing.T) {
...
func RunParameterPushDown(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
	tk.MustExec(`use test`)
...
func RunPrepareStmtAfterIsolationReadChange(t *testing.T) {
...
func RunMaxPreparedStmtCount(t *testing.T) {
...
func RunExecuteWithWrongType(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunIssue58870(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
