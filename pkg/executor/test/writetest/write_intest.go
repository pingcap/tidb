...
func RunInsertIgnore(t *testing.T) {
...
func RunLoadDataMissingColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue18681(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue34358(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	ctx := tk.Session().(sessionctx.Context)
...
func RunReplaceLog(t *testing.T) {
...
func RunRebaseIfNeeded(t *testing.T) {
	store, domain := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunDeferConstraintCheckForInsert(t *testing.T) {
	store := testkit.CreateMockStore(t)
	setTxnTk := testkit.NewTestKit(t, store)
	setTxnTk.MustExec("set global tidb_txn_mode=''")
	tk := testkit.NewTestKit(t, store)
...
func RunPessimisticDeleteYourWrites(t *testing.T) {
	store := testkit.CreateMockStore(t)
