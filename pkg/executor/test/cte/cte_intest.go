...
func RunCTEIssue49096(t *testing.T) {
...
func RunSpillToDisk(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCTEExecError(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCTEDelSpillFile(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test;")
	tk.MustExec("drop table if exists t1, t2;")
...
func RunCTEShareCorColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test;")
	tk.MustExec("drop table if exists t1, t2;")
...
func RunCTEIterationMemTracker(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCTETableInvalidTask(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
