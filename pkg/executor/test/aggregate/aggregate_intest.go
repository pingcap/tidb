...
func RunHashAggRuntimeStat(t *testing.T) {
...
func RunParallelStreamAggGroupConcat(t *testing.T) {
...
func RunIssue20658(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunRandomPanicConsume(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("set @@tidb_max_chunk_size=32")
...
func genListPartition(begin, end int) string {
	...
	fmt.Fprintf(buf, "%v)", end-1)
	return buf.String()
}

func RunParallelHashAgg(t *testing.T) {
...
func RunIssue50849(t *testing.T) {
	store, _ := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test;")
	tk.MustExec("drop table if exists t;")
