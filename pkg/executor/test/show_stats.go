...
func RunShowStatsMeta(t *testing.T) {
...
func RunShowStatsLocked(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunShowStatsHistograms(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunShowStatsBuckets(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunShowStatsBucketWithDateNullValue(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunShowStatsHasNullValue(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunShowStatusSnapshot(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunShowColumnStatsUsage(t *testing.T) {
...
func RunShowAnalyzeStatus(t *testing.T) {
	store := testkit.CreateMockStore(t)
