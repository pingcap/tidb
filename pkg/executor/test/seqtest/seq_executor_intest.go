...
func RunEarlyClose(t *testing.T) {
...
func RunShowStatsHealthy(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIndexDoubleReadClose(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
// leak.
func RunIndexMergeReaderClose(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunParallelHashAggClose(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
	tk.MustExec(`drop table if exists t`)
...
func RunUnparallelHashAggClose(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
	tk.MustExec(`drop table if exists t`)
...
func RunAdminShowNextID(t *testing.T) {
	step := int64(10)
	autoid.SetStep(step)
	store := testkit.CreateMockStore(t)
...
func RunPrepareMaxParamCountCheck(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCartesianProduct(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunBatchInsertDelete(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCoprocessorPriority(t *testing.T) {
	cli := &checkPrioClient{}
...
func RunPessimisticConflictRetryAutoID(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunInsertFromSelectConflictRetryAutoID(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAutoRandRecoverTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunOOMPanicInHashJoinWhenFetchBuildRows(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue18744(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAnalyzeNextRawErrorNoLeak(t *testing.T) {
	store := testkit.CreateMockStore(t)
