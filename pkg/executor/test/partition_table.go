...
func RunPointGetwithRangeAndListPartitionTable(t *testing.T) {
...
func RunPartitionInfoDisable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunOrderByAndLimit(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunBatchGetandPointGetwithHashPartition(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDirectReadingwithIndexJoin(t *testing.T) {
...
func RunDynamicPruningUnderIndexJoin(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
	store := testkit.CreateMockStore(t)
...
func RunBatchGetforRangeandListPartitionTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPartitionTableWithDifferentJoin(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
	store := testkit.CreateMockStore(t)
...
func RunMPPQueryExplainInfo(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
	store := testkit.CreateMockStore(t)
...
func RunSubqueries(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSplitRegion(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
	store := testkit.CreateMockStore(t)
...
func RunParallelApply(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
...
func RunDirectReadingWithUnionScan(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunUnsignedPartitionColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDirectReadingWithAgg(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDropGlobalIndex(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSelectLockOnPartitionTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue26251(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunLeftJoinForUpdate(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue31024(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGlobalIndexWithSelectLock(t *testing.T) {
	store := testkit.CreateMockStore(t)
