...
func RunFilterDifferentAllocators(t *testing.T) {
...
func RunInsertWithAutoidSchema(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
...
func RunMockAutoIDServiceError(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("USE test;")
...
func RunIssue39528(t *testing.T) {
	...
	var codeRun bool
	//lint:ignore SA1029 test hook key must match the production lookup in autoid allocation
...
func RunIssue52622(t *testing.T) {
	store := testkit.CreateMockStore(t)
