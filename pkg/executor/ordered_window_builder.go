...
func BuildOrdered(sctx sessionctx.Context, v *plannercore.PhysicalWindow, childExec exec.Executor) (exec.Executor, error) {
	windowExec, err := buildWindowExec(sctx, v, childExec, true)
	if err != nil {
		return nil, err
	}
...
func buildWindowExec(sctx sessionctx.Context, v *plannercore.PhysicalWindow, childExec exec.Executor, forcePipelined bool) (exec.Executor, error) {
