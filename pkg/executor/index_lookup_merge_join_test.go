...
<<<<<<< HEAD:pkg/executor/index_lookup_merge_join_test.go
...
=======
>>>>>>> 628b7ed6739 (planner: deprecate index lookup merge join. (#54681)):pkg/executor/join/index_lookup_merge_join_test.go
