...
func RunVecGroupCheckerDATARACE(t *testing.T) {
	ctx := mock.NewContext()
...
func RunVecGroupChecker4GroupCount(t *testing.T) {
	testCases := []struct {
		chunkRows      []int
		expectedGroups int
		expectedFlag   []bool
...
func RunVecGroupChecker(t *testing.T) {
...
func RunIssue53867(t *testing.T) {
