...
# Plan_digest: 60e9378c746d9a2be1c791047e008967cf252eb6de9167ad3aa6098fa2d523f4
# Trace_ID: db325225c4db4fb0987edb623bf89ce0
# Prev_stmt: update t set i = 1;
use test;
select * from t;`
	reader := bufio.NewReader(bytes.NewBufferString(slowLogStr))
	...
	expectRecordString := `2019-04-28 15:24:04.309074,` +
		...
		`0,0,1,0,1,1,0,default,2.158,2.123,0.05,,60e9378c746d9a2be1c791047e008967cf252eb6de9167ad3aa6098fa2d523f4,db325225c4db4fb0987edb623bf89ce0,` +
