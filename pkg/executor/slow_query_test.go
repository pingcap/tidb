...
select * from t;`
	...
	expectRecordString := `2019-04-28 15:24:04.309074,` +
		...
		`0,0,1,0,1,1,0,default,2.158,2.123,0.05,0.01,0.021,1,1,150,total_ru:150.00, tidb_ru:0.00, tikv_ru:100.00, tiflash_ru:50.00,RRU=read_rpc_count(1)*READ_BASE_COST(0.125)=0.125000; RU=RRU(0.125000)=0.125000,,60e9378c746d9a2be1c791047e008967cf252eb6de9167ad3aa6098fa2d523f4,` +
