...
# Request_unit_detail: {"version":2,"total_ru":123.45}
...
`)
	...
	tk.MustQuery("select Request_unit_v2, Request_unit_v2 + 1, Request_unit_v2_detail, Request_unit_detail from `information_schema`.`slow_query` " +
		...
		Check(testkit.Rows(`123.45 124.45 total_ru:123.45, tidb_ru:100.00, tikv_ru:20.00, tiflash_ru:3.45 {"version":2,"total_ru":123.45}`))
}
