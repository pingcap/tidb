...
func TestSetVar(t *testing.T) {
	...
	tk.MustQuery("select @@pd_enable_follower_region_api").Check(testkit.Rows("0"))
	tk.MustExec("set global pd_enable_follower_region_api = 1")
	tk.MustQuery("select @@pd_enable_follower_region_api").Check(testkit.Rows("1"))
	tk.MustExec("set global pd_enable_follower_region_api = 0")
	tk.MustQuery("select @@pd_enable_follower_region_api").Check(testkit.Rows("0"))
	require.Error(t, tk.ExecToErr("set pd_enable_follower_region_api = 1"))
