...
func TestSetVar(t *testing.T) {
	...
	tk.MustQuery("select @@tidb_enable_pd_follower_handle_region_api").Check(testkit.Rows("0"))
	tk.MustExec("set global tidb_enable_pd_follower_handle_region_api = 1")
	tk.MustQuery("select @@tidb_enable_pd_follower_handle_region_api").Check(testkit.Rows("1"))
	tk.MustExec("set global tidb_enable_pd_follower_handle_region_api = 0")
	tk.MustQuery("select @@tidb_enable_pd_follower_handle_region_api").Check(testkit.Rows("0"))
	require.Error(t, tk.ExecToErr("set tidb_enable_pd_follower_handle_region_api = 1"))
