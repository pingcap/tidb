...
func TestSetVar(t *testing.T) {
	...
	// test tidb_kill_idle_transaction
	tk.MustQuery("select @@session.tidb_kill_idle_transaction").Check(testkit.Rows("0"))
	tk.MustExec("SET SESSION tidb_kill_idle_transaction = 2")
	tk.MustQuery("select @@session.tidb_kill_idle_transaction").Check(testkit.Rows("2"))
	tk.MustGetErrMsg("SET SESSION tidb_kill_idle_transaction='x';", "[variable:1232]Incorrect argument type to variable 'tidb_kill_idle_transaction'")
	tk.MustExec("SET SESSION tidb_kill_idle_transaction=31536001;")
	tk.MustQuery("show warnings").Check(testkit.Rows("Warning 1292 Truncated incorrect tidb_kill_idle_transaction value: '31536001'"))
	tk.MustQuery("select @@session.tidb_kill_idle_transaction").Check(testkit.Rows("31536000"))
	tk.MustExec("SET SESSION tidb_kill_idle_transaction = 0")
	tk.MustQuery("select @@session.tidb_kill_idle_transaction").Check(testkit.Rows("0"))
	tk.MustExec("SET SESSION tidb_kill_idle_transaction=31536000;")
	tk.MustQuery("select @@session.tidb_kill_idle_transaction").Check(testkit.Rows("31536000"))
	tk.MustQuery("select @@global.tidb_kill_idle_transaction").Check(testkit.Rows("0"))
	tk.MustExec("SET GLOBAL tidb_kill_idle_transaction = 1")
	tk.MustQuery("select @@global.tidb_kill_idle_transaction").Check(testkit.Rows("1"))
	tk.MustGetErrMsg("SET GLOBAL tidb_kill_idle_transaction='x';", "[variable:1232]Incorrect argument type to variable 'tidb_kill_idle_transaction'")
	tk.MustExec("SET GLOBAL tidb_kill_idle_transaction=31536001;")
	tk.MustQuery("show warnings").Check(testkit.Rows("Warning 1292 Truncated incorrect tidb_kill_idle_transaction value: '31536001'"))
	tk.MustQuery("select @@global.tidb_kill_idle_transaction").Check(testkit.Rows("31536000"))
	tk.MustExec("SET GLOBAL tidb_kill_idle_transaction = 0")
	tk.MustQuery("select @@global.tidb_kill_idle_transaction").Check(testkit.Rows("0"))
	tk.MustExec("SET GLOBAL tidb_kill_idle_transaction=31536000;")
	tk.MustQuery("select @@global.tidb_kill_idle_transaction").Check(testkit.Rows("31536000"))
}
