...
func TestSetConcurrency(t *testing.T) {
	...
	tk.MustQuery("show warnings").Check(testkit.Rows("Warning 1287 tidb_merge_partition_stats_concurrency is deprecated and will be removed in a future release. It no longer affects behavior."))
	tk.MustQuery("select @@tidb_merge_partition_stats_concurrency;").Check(testkit.Rows("1"))
