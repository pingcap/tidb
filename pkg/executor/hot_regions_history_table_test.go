...
func TestTiDBHotRegionsHistory(t *testing.T) {
	...
	fullHotRegions := [][]string{
		...
		{"2019-10-10 10:10:21", "MYSQL", "STATS_META", statsMetaTidStr, "IDX_LAST_STATS_HISTOGRAMS_VERSION", "2", "5", "5", "55555", "0", "1", "READ", "99", "99", "99", "99"},
		{"2019-10-10 10:10:22", "MYSQL", "STATS_META", statsMetaTidStr, "IDX_LAST_STATS_HISTOGRAMS_VERSION", "2", "6", "6", "66666", "0", "0", "WRITE", "99", "99", "99", "99"},
