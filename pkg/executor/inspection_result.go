...
func (inspectVirtualMemUsage) genSQL(timeRange util2.QueryTimeRange) string {
...
func (inspectSwapMemoryUsed) genSQL(timeRange util2.QueryTimeRange) string {
...
func (inspectDiskUsage) genSQL(timeRange util2.QueryTimeRange) string {
...
func (i inspectCPULoad) genSQL(timeRange util2.QueryTimeRange) string {
...
type ruleChecker interface {
	genSQL(timeRange util2.QueryTimeRange) string
...
func (c compareStoreStatus) genSQL(timeRange util2.QueryTimeRange) string {
	condition := fmt.Sprintf(`where t1.time>='%[1]s' and t1.time<='%[2]s' and
		 t2.time>='%[1]s' and t2.time<='%[2]s'`, timeRange.From.Format(util2.MetricTableTimeFormat),
		timeRange.To.Format(util2.MetricTableTimeFormat))
	return fmt.Sprintf(`
		SELECT t1.address,
        	max(t1.value),
        	t2.address,
...
func (checkRegionHealth) genSQL(timeRange util2.QueryTimeRange) string {
...
func (checkStoreRegionTooMuch) genSQL(timeRange util2.QueryTimeRange) string {
	condition := timeRange.Condition()
