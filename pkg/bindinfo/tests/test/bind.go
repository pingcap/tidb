...
func RunPrepareCacheWithBinding(t *testing.T) {
...
func RunIssue50646(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunBindingWithIsolationRead(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunInvisibleIndex(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGCBindRecord(t *testing.T) {
...
func RunBindSQLDigest(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunSimplifiedCreateBinding(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
	tk.MustExec(`create table t (a int, b int, key(a))`)
...
func RunDropBindBySQLDigest(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunJoinOrderHintWithBinding(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunFuzzyBindingHints(t *testing.T) {
	t.Skip("fix later on")
	testFuzzyBindingHints(t)
}

func RunBatchDropBindings(t *testing.T) {
	originLease := bindinfo.Lease
	bindinfo.Lease = 0
	defer func() {
		bindinfo.Lease = originLease
...
func RunInvalidBindingCheck(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
