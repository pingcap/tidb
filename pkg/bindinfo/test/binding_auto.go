...
func RunGenPlanWithSCtx(t *testing.T) {
...
func RunExplainExploreBasic(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunExplainExploreIndexHints(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunExplainExploreIndexHintWithAlias(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunExplainExploreNoDecorrelateHint(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIsSimplePointPlan(t *testing.T) {
...
func RunRelevantOptVarsAndFixes(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunRelevantOptVarsCorrelateSubquery(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	...
	// correlate-to-Apply path is reached while exploring alternatives.
...
func RunExplainExploreAnalyze(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunExplainExploreVerifyAndBind(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPlanGeneration(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	...
	for i, sql := range input {
		...
		for rowID, row := range rows {
			plan := strings.Split(strings.ReplaceAll(row[2].(string), "\t", "  "), "\n")
			testdata.OnRecord(func() {
				output[i].SQL = sql
