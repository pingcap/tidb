...
func RunGlobalAndSessionBindingBothExist(t *testing.T) {
...
func RunSessionBinding(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunShowGlobalBindings(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDuplicateBindings(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue19836(t *testing.T) {
...
func RunDropSingleBindings(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue53834(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
...
func RunPreparedStmt(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
