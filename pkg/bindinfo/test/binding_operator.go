...
func RunBindingCache(t *testing.T) {
...
func RunBindingLastUpdateTime(t *testing.T) {
...
func RunBindingLastUpdateTimeWithInvalidBind(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSetBindingStatus(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSetBindingStatusWithoutBindingInCache(t *testing.T) {
	store := testkit.CreateMockStore(t)
	...
	// #nosec G202 -- test code, SQL string concatenation is acceptable
...
func RunLoadBindingTimeLag(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunGlobalBinding(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunOutdatedInfoSchema(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunReloadBindings(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSetVarFixControlWithBinding(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunRemoveDuplicatedPseudoBinding(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunShowBindingDigestField(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunIssue63032(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunIssue64558(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
	tk.MustExec(`create table t (a int)`)
...
func RunOptimizeOnlyOnce(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunNormalizeStmtForBinding(t *testing.T) {
	tests := []struct {
		sql        string
		normalized string
		digest     string
...
func RunHintsSetID(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunBestPlanInBaselines(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunBindingSymbolList(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunBindingQueryInList(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec(`create table t (a int)`)
...
func RunIssue64070(t *testing.T) {
...
func RunBindingInListWithSingleLiteral(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
