...
func RunStaleReadProcessorWithSelectTable(t *testing.T) {
...
func RunStaleReadSupportDateTimeAndTSO(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithStoreType(mockstore.EmbedUnistore))
	tk := testkit.NewTestKit(t, store)
	p1 := genStaleReadPoint(t, tk)
	p2 := genStaleReadPoint(t, tk)
...
func RunStaleReadCompactDateTime(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithStoreType(mockstore.EmbedUnistore))
	tk := testkit.NewTestKit(t, store)
	p1 := genStaleReadPoint(t, tk)
...
func RunStaleReadInvalidExpression(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithStoreType(mockstore.EmbedUnistore))
	tk := testkit.NewTestKit(t, store)
...
func RunStaleReadProcessorWithExecutePreparedStmt(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithStoreType(mockstore.EmbedUnistore))
	tk := testkit.NewTestKit(t, store)
	p1 := genStaleReadPoint(t, tk)
	//p2 := genStaleReadPoint(t, tk)
...
func RunStaleReadProcessorInTxn(t *testing.T) {
...
func RunConsistentCalculateAsOfTsExpr(t *testing.T) {
	store := testkit.CreateMockStore(t, mockstore.WithStoreType(mockstore.EmbedUnistore))
	tk := testkit.NewTestKit(t, store)
