...
func RunStaleReadTxnScope(t *testing.T) {
...
func RunStaleReadReplicaReadScope(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGetStmtReadTSActivateTxnWhenAutocommitOff(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGetSnapshotWithStmtReadTSActivateTxnWhenAutocommitOff(t *testing.T) {
	store := testkit.CreateMockStore(t)
