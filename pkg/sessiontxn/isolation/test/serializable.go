...
func RunPessimisticSerializableTxnProviderTS(t *testing.T) {
...
func RunPessimisticSerializableTxnContextProviderLockError(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSerializableInitialize(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTidbSnapshotVarInSerialize(t *testing.T) {
