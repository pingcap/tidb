...
func RunPessimisticRCTxnContextProviderRCCheck(t *testing.T) {
...
func RunPessimisticRCTxnContextProviderRCCheckForPrepareExecute(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPessimisticRCTxnContextProviderLockError(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPessimisticRCTxnContextProviderTS(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunRCProviderInitialize(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTidbSnapshotVarInRC(t *testing.T) {
...
func RunConflictErrorsInRC(t *testing.T) {
...
func RunFailedDMLConsistency1(t *testing.T) {
...
func RunFailedDMLConsistency2(t *testing.T) {
	if kerneltype.IsNextGen() {
		// NextGen hangs when acquiring pessimistic locks after failed DML with fair locking disabled
		// root cause: cleanup not triggered properly for non-fair mode.
		// this 35682 might be related.
