...
func RunPessimisticRRErrorHandle(t *testing.T) {
...
func RunRepeatableReadProviderTS(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	defer tk.MustExec("rollback")
	se := tk.Session()
...
func RunRepeatableReadProviderInitialize(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTidbSnapshotVarInPessimisticRepeatableRead(t *testing.T) {
...
func RunOptimizeWithPlanInPessimisticRR(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunConflictErrorInInsertInRR(t *testing.T) {
...
func RunConflictErrorInPointGetForUpdateInRR(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/executor/assertPessimisticLockErr", "return"))
	store := testkit.CreateMockStore(t)
...
func RunConflictErrorInDeleteInRR(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/executor/assertPessimisticLockErr", "return"))
	store := testkit.CreateMockStore(t)
...
func RunConflictErrorInUpdateInRR(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/executor/assertPessimisticLockErr", "return"))
	store := testkit.CreateMockStore(t)
...
func RunConflictErrorInOtherQueryContainingPointGet(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/executor/assertPessimisticLockErr", "return"))
	store := testkit.CreateMockStore(t)
...
func RunRRWaitTSTimeInSlowLog(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue41194(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
