...
func RunContextDetach(t *testing.T) {
	warnHandler := contextutil.NewStaticWarnHandler(5)
	obj := &planctx.ExportedBuildPBContext{
	...
	deeptest.AssertRecursivelyNotEqual(t, obj, &planctx.ExportedBuildPBContext{}, deeptest.WithIgnorePath(ignorePath))
