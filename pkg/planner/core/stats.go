...
// deriveStats4LogicalTableScan derives stats for logical table scan.
...
// deriveStats4LogicalIndexScan	derives stats for logical index scan.
...
// deriveStats4DS implements base.LogicalPlan.<11th> interface.
func deriveStats4DS(lp base.LogicalPlan, colGroups [][]*expression.Column) (*property.StatsInfo, error) {
