...
var OptimizeAstNode func(ctx context.Context, sctx sessionctx.Context, node *ddlmodel.NodeW, is infoschema.InfoSchema) (base.Plan, types.NameSlice, error)
...
func BuildLogicalPlanForTest(ctx context.Context, sctx sessionctx.Context, node *ddlmodel.NodeW, infoSchema infoschema.InfoSchema) (base.Plan, error) {
