...
func (b *PlanBuilder) pushTableHints(hints []*ast.TableOptimizerHint, currentLevel int) {
	...
	b.tableHintInfo = append(b.tableHintInfo, h.TableHintInfo{
		...
		IndexNestedLoopJoinTables: h.IndexNestedLoopJoinTables{inljTables, inlhjTables, inlmjTables},
		NoIndexJoinTables:         h.IndexNestedLoopJoinTables{noIndexJoinTables, noIndexHashJoinTables, noIndexMergeJoinTables},
