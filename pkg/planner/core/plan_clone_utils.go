...
// are intentionally omitted: index merge paths are synthesized later by
// generateIndexMergePath, which runs as part of DeriveStats after fillIndexPath
// populates these fresh paths.
