...
func (b *PlanBuilder) rewriteInsertExpression(
	ctx context.Context,
	...
	expr, plan, err := rewriteExprNode(rewriter, exprNode, true)
	return expr, plan, err
}

func (b *PlanBuilder) rewriteInsertOnDuplicateUpdate(
	ctx context.Context,
	exprNode ast.ExprNode,
	mockPlan base.LogicalPlan,
	insertPlan *physicalop.Insert,
