...
func (*resolveExpand) optimize(_ context.Context, p LogicalPlan, opt *coreUtil.LogicalOptimizeOp) (LogicalPlan, bool, error) {
	planChanged := false
...
func genExpand(p LogicalPlan, opt *coreUtil.LogicalOptimizeOp) (LogicalPlan, error) {
