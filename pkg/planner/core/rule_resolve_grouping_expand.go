...
func (*resolveExpand) optimize(_ context.Context, p base.LogicalPlan, opt *coreusage.LogicalOptimizeOp) (base.LogicalPlan, bool, error) {
	planChanged := false
...
func genExpand(p base.LogicalPlan, opt *coreusage.LogicalOptimizeOp) (base.LogicalPlan, error) {
