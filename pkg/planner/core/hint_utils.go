...
func genJoinMethodHintForSinglePhysicalJoin(sctx base.PlanContext, joinType string, parentOffset int, nodeType h.NodeType, children ...base.PhysicalPlan) (res *ast.TableOptimizerHint) {
	if parentOffset == -1 {
		return res
	}
