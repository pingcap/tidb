...
var (
	...
	ExtractSelectAndNormalizeDigest func(stmtNode ast.StmtNode, specifiledDB string, forBinding, forUniversalBinding bool) (ast.StmtNode, string, string, error)
)
...
func GeneratePlanCacheStmtWithAST(ctx context.Context, sctx sessionctx.Context, isPrepStmt bool,
	...
	if (isPrepStmt && !vars.EnablePreparedPlanCache) || // prepared statement
		...
		selectStmtNode, normalizedSQL4PC, digest4PC, err = ExtractSelectAndNormalizeDigest(paramStmt, vars.CurrentDB, false, false)
