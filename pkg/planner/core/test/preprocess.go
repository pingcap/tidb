...
func RunDropGlobalTempTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
// For issue #30328
func RunLargeVarcharAutoConv(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunPreprocessCTE(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test;")
...
func RunPreprocessDeleteFromWithAlias(t *testing.T) {
