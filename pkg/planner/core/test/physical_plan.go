...
func RunAnalyzeBuildSucc(t *testing.T) {
...
func RunAnalyzeSetRate(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunRequestTypeSupportedOff(t *testing.T) {
...
func RunDoSubQuery(t *testing.T) {
...
func RunIndexLookupCartesianJoin(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunMPPHintsWithBinding(t *testing.T) {
...
func RunJoinHintCompatibilityWithBinding(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunJoinHintCompatibilityWithVariable(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunIndexJoinRowModeWithInnerTopN(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		if cascades == "on" {
...
func RunIndexJoinRowModeWithInnerTopNOuterJoin(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		if cascades == "on" {
...
func RunIndexJoinHintInSubquery(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunDAGPlanBuilderSplitAvg(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunPhysicalPlanMemoryTrace(t *testing.T) {
	// PhysicalSort
...
func RunPhysicalTableScanExtractCorrelatedCols(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, tk *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		tk.MustExec("use test")
...
func RunAvoidColumnEvaluatorForProjBelowUnion(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
...
func RunExchangeSenderResolveIndices(t *testing.T) {
