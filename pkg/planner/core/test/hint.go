...
func RunSetVarTimestampHintsWorks(t *testing.T) {
...
func RunSetVarTimestampHintsWorksWithBindings(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec(`use test`)
...
func RunSetVarInQueriesAndBindingsWorkTogether(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec(`use test`)
...
func RunSetVarHintsWithExplain(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec(`use test`)
...
func RunWriteSlowLogHint(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec(`use test`)
		testKit.MustExec(`drop table if exists t`)
		testKit.MustExec(`create table t(a int);`)
		...
		checkWriteSlowLog := func(expectWrite bool) {
			...
			writeMsg := slices.ContainsFunc(recorded.All(), func(entry observer.LoggedEntry) bool {
				return entry.Level == zap.WarnLevel && strings.Contains(entry.Message, sql)
			})
...
func RunSetVarPartialOrderedIndexForTopN(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec(`use test`)
