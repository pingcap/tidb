...
AND aaa.v2 = bbb.v2;`).Check(testkit.Rows(
		"HashAgg 1.00 root  funcs:count(1)->Column#17",
		"└─HashJoin 47683.72 root  inner join, equal:[eq(test.t1.v1, test.t1.v1) eq(test.t1.v2, test.t1.v2)]",
		"  ├─TableReader(Build) 19531.25 root  MppVersion: 3, data:ExchangeSender",
		...
		"  └─TableReader(Probe) 19531.25 root  MppVersion: 3, data:ExchangeSender",
		"    └─ExchangeSender 19531.25 mpp[tiflash]  ExchangeType: PassThrough",
