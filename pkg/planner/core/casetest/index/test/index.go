...
func RunNullConditionForPrefixIndex(t *testing.T) {
...
func RunRangeDerivation(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunRowFunctionMatchTheIndexRangeScan(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
		testKit.MustExec(`set @@tidb_opt_fix_control = "54337:ON"`)
...
func RunRangeIntersection(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
		testKit.MustExec(`set @@tidb_opt_fix_control = "54337:ON"`)
...
func RunOrderedIndexWithIsNull(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunVectorIndex(t *testing.T) {
...
func RunAnalyzeColumnarIndex(t *testing.T) {
...
func RunPartialIndexWithPlanCache(t *testing.T) {
...
func RunPartialIndexWithIndexPrune(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
		tk.MustExec("set @@tidb_enable_collect_execution_info=0;")
		tk.MustExec("drop table if exists t")
...
func RunForceIndexLimit(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec(`use test`)
