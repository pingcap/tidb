...
func RunEnforceMPP(t *testing.T) {
...
// general cases.
func RunEnforceMPPWarning1(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test query
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
...
// partition table.
func RunEnforceMPPWarning2(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test query
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
...
// new collation.
func RunEnforceMPPWarning3(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test query
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
...
func RunEnforceMPPWarning4(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test table
		testKit.MustExec("use test")
...
func RunMPP2PhaseAggPushDown(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test table
		testKit.MustExec("use test")
...
func RunMPPSkewedGroupDistinctRewrite(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test table
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
...
func RunMPPSingleDistinct3Stage(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		// test table
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
...
func RunMPPMultiDistinct3Stage(t *testing.T) {
...
func RunMPPNullAwareSemiJoinPushDown(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		// test table
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
...
func RunMPPSharedCTEScan(t *testing.T) {
...
func RunEnforceMPPNewest(t *testing.T) {
...
func RunReadCommittedWithTiflash(t *testing.T) {
