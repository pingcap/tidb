...
func TestCommonHandleIndexRanges(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		...
		// ---------------------------------------------------------------
		rows := tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ia) where a = 10 and tenant = 2",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ia) where a = 10 and tenant = 1 and seq > 100",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ia) where a = 10 and tenant > 1",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ia) where a in (10, 20) and tenant = 2",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ia) where a = 10 and seq = 100",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ia_overlap) where a = 10 and tenant = 1 and seq > 100",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr use index(ub) where b > 0 and tenant = 2",
		).Rows()
		...
		// ---------------------------------------------------------------
		rows = tk.MustQuery(
			"explain format = 'brief' select tenant, seq, a from t_chr use index(ia) where a = 10 and tenant = 2",
		).Rows()
		...
		tk.MustExec(`insert into t_chr_single values
			...
			('u4', 20, 4)`)
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr_single use index(ia) where a = 10 and pk = 'u2'",
		).Rows()
		...
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr_single use index(ia) where a = 10 and pk > 'u1'",
		).Rows()
		...
		rows = tk.MustQuery(
			"explain format = 'brief' select pk, a from t_chr_single use index(ia) where a = 10 and pk = 'u2'",
		).Rows()
		require.True(t, explainHas(rows, "IndexReader"),
		...
		rows = tk.MustQuery(
			"explain format = 'brief' select * from t_chr_dec use index(ia) where a = 10 and pk = 2.50",
		).Rows()
