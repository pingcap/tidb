...
func TestCorrelatedSubquery(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		...
		testKit.MustExec(`CREATE TABLE tlc07c2a51 (
...
PARTITION BY HASH (col_7) PARTITIONS 6;`)
		testKit.MustExec(`CREATE TABLE tc4cf4a6b (
  col_1 date DEFAULT NULL,
  col_2 json NOT NULL,
  col_3 varbinary(345) DEFAULT 'vE5ARCSlc%iI$Q',
  col_4 json NOT NULL,
...
PARTITION BY HASH (col_7) PARTITIONS 6;`)
		...
		testKit.MustExec("analyze table tlc07c2a51;")
		testKit.MustExec("analyze table tc4cf4a6b;")
		testKit.MustQuery(`SELECT 1
FROM tlc07c2a51
