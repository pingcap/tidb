...
func RunPreferRangeScan(t *testing.T) {
...
func RunPreferRangeScanForDNF(t *testing.T) {
...
func testNormalizedPlan(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
	tk.MustExec("use test")
...
func RunNormalizedPlan(t *testing.T) {
...
func RunNormalizedPlanForNextGen(t *testing.T) {
	if !kerneltype.IsNextGen() {
...
func RunPlanDigest4InList(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
		tk.MustExec("drop table if exists t")
...
func RunNormalizedPlanForDiffStore(t *testing.T) {
...
func testJSONPlanInExplain(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
	tk.MustExec("use test")
...
func RunJSONPlanInExplain(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunJSONPlanInExplainForNextGen(t *testing.T) {
	if !kerneltype.IsNextGen() {
...
func RunHandleEQAll(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunOuterJoinElimination(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
...
func RunCTEErrNotSupportedYet(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
		tk.MustExec(`
