...
func RunHashPartitionPruner(t *testing.T) {
...
func RunListColumnsPartitionPruner(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
...
func RunPointGetIntHandleNotFirst(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
...
func RunRangeDatePruningExtract(t *testing.T) {
...
func RunRangeTimePruningExtract(t *testing.T) {
...
func RunPartitionPrunerRegression(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, tk *testkit.TestKit, cascades, caller string) {
		tk.MustExec("use test")
		tk.MustExec("drop table if exists t")
		tk.MustExec("CREATE TABLE `t` (" +
