...
func RunListPartitionOrderLimit(t *testing.T) {
...
func RunListPartitionAgg(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunListPartitionView(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunListPartitionRandomTransaction(t *testing.T) {
	store := testkit.CreateMockStore(t)
