...
func RunListPartitionPruning(t *testing.T) {
...
func RunListPartitionPruningForNextGen(t *testing.T) {
...
func RunPartitionTableExplain(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
...
func RunBatchPointGetTablePartition(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
...
func RunBatchPointGetPartitionForAccessObject(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/planner/core/forceDynamicPrune", `return(true)`)
...
// Issue 58475
func RunGeneratedColumnWithPartition(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunPartitionPruneWithPredicateSimplification(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
