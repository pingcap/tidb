...
func RunPlanCacheForIntersectionIndexMerge(t *testing.T) {
...
func RunIndexMergeWithOrderProperty(t *testing.T) {
...
func RunHintForIntersectionIndexMerge(t *testing.T) {
