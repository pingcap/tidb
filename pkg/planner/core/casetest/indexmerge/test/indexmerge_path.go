...
func RunCollectFilters4MVIndexMutations(t *testing.T) {
...
func RunMultiMVIndexRandom(t *testing.T) {
...
func RunMVIndexRandom(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	for _, testCase := range []struct {
...
func RunPlanCacheMVIndex(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunAnalyzeVectorIndex(t *testing.T) {
