...
func RunReadFromStorageHint(t *testing.T) {
...
func RunAllViewHintType(t *testing.T) {
...
func RunJoinHintCompatibility(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		testKit.MustExec("use test")
		testKit.MustExec("set @@session.tidb_allow_mpp=ON")
		testKit.MustExec("set @@session.tidb_isolation_read_engines='tiflash, tikv'")
...
func RunReadFromStorageHintAndIsolationRead(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t, tt, ttt")
		testKit.MustExec("create table t(a int, b int, index ia(a))")
...
func RunIsolationReadTiFlashUseIndexHint(t *testing.T) {
...
func RunOptimizeHintOnPartitionTable(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunQBHintHandlerDuplicateObjects(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunOptimizerCostFactorHints(t *testing.T) {
	testkit.RunTestUnderCascades(t, func(t *testing.T, testKit *testkit.TestKit, cascades, caller string) {
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
