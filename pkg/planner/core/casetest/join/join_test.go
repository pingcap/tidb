...
func TestJoinWithNullEQ(t *testing.T) {
	...
	tk.MustQuery(`explain SELECT * FROM tt1
		...
		"└─HashJoin_16(Probe) 12500.00 root  left outer join, equal:[eq(Column#11, Column#12)]",
		"  ├─Projection_21(Build) 10000.00 root  0->Column#7, 0->Column#12",
		...
		"  └─Projection_18(Probe) 10000.00 root  test.tt1.c0, cast(test.tt1.c0, double BINARY)->Column#11",
