...
func RunInstancePlanCacheDMLTPCC(t *testing.T) {
...
func RunInstancePlanCacheDMLBasic(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunInstancePlanCacheUpdateSpecifiedPartition(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec(`set global tidb_enable_instance_plan_cache=1`)
...
func RunInstancePlanCacheDMLPartitioning(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec(`set global tidb_enable_instance_plan_cache=1`)
