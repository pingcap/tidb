...
func RunPlanStatsLoad(t *testing.T) {
...
func RunPlanStatsLoadForCTE(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		testKit.MustExec("use test")
		testKit.MustExec("drop table if exists t")
		testKit.MustExec("set @@session.tidb_analyze_version=2")
...
func RunPlanStatsLoadTimeout(t *testing.T) {
	p := parser.New()
...
func RunPreparedPlanCacheInvalidatedAfterSyncLoadTimeoutFallback(t *testing.T) {
	originConfig := config.GetGlobalConfig()
	newConfig := config.NewConfig()
	newConfig.Performance.StatsLoadConcurrency = -1 // no worker to consume channel
	newConfig.Performance.StatsLoadQueueSize = 1
...
func RunPlanStatsStatusRecord(t *testing.T) {
...
func RunCollectDependingVirtualCols(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunStatsAnalyzedInDDL(t *testing.T) {
	testkit.RunTestUnderCascadesWithDomain(t, func(t *testing.T, testKit *testkit.TestKit, dom *domain.Domain, cascades, caller string) {
		testKit.MustExec("use test")
...
func RunPartialStatsInExplain(t *testing.T) {
