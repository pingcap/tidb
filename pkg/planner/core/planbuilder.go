...
func (b *PlanBuilder) buildShow(ctx context.Context, show *ast.ShowStmt) (base.Plan, error) {
	...
	case ast.ShowCreateTable, ast.ShowCreateSequence, ast.ShowPlacementForTable, ast.ShowPlacementForPartition:
		var err error
		if table, err := b.is.TableByName(context.Background(), show.Table.Schema, show.Table.Name); err == nil {
	...
	case ast.ShowRegions:
		tableInfo, err := b.is.TableByName(context.Background(), show.Table.Schema, show.Table.Name)
		if err != nil {
			return nil, err
		}
