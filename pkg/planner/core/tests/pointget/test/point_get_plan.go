...
func RunPointGetPlanCache(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Please run the TestPointGetPlanCacheForNextGen")
	}
...
func RunPointGetPlanCacheForNextGen(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("Please run the TestPointGetPlanCache")
	}
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set @@tidb_enable_non_prepared_plan_cache=0`) // affect hit counter in this ut
...
func RunPointGetId(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunIssue20692(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunIssue18042(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunIssue52592(t *testing.T) {
	if kerneltype.IsNextGen() {
...
func RunIssue52592ForNextGen(t *testing.T) {
	if kerneltype.IsClassic() {
...
func RunIssue56832(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
