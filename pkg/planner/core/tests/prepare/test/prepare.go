...
func RunPointGetPreparedPlan4PlanCache(t *testing.T) {
...
func RunRandomFlushPlanCache(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPrepareCache(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPrepareCacheChangingParamType(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPrepareCacheDeferredFunction(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPrepareCacheNow(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPrepareOverMaxPreparedStmtCount(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunPrepareWithSnapshot(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPrepareCacheForPartition(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunIssue33031(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPlanCacheUnionScan(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPlanCacheSwitchDB(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunInvisibleIndexPrepare(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPlanCacheSnapshot(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPartitionTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPartitionWithVariedDataSources(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunCachedTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`set tidb_enable_prepared_plan_cache=1`)
...
func RunPlanCacheWithRCWhenInfoSchemaChange(t *testing.T) {
...
func RunConsistencyBetweenPrepareExecuteAndNormalSql(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("MDL is always enabled and read only in nextgen")
	}
	ctx := context.Background()
...
func RunCacheHitInRc(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("MDL is always enabled and read only in nextgen")
	}
	ctx := context.Background()
...
func RunCacheHitInForUpdateRead(t *testing.T) {
	ctx := context.Background()
	store := testkit.CreateMockStore(t)
...
func RunPointGetForUpdateAutoCommitCache(t *testing.T) {
	ctx := context.Background()
	store := testkit.CreateMockStore(t)
...
func RunPrepareCacheForDynamicPartitionPruning(t *testing.T) {
	// https://github.com/pingcap/tidb/issues/33031
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunHashPartitionAndPlanCache(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustQuery(`select @@session.tidb_enable_prepared_plan_cache`).Check(testkit.Rows("1"))
	tkExplain := testkit.NewTestKit(t, store)
