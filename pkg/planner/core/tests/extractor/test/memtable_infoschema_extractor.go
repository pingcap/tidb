...
func RunMemtableInfoschemaExtractorPart1(t *testing.T) {
	tcs := []testCase{
		{
...
func RunMemtableInfoschemaExtractorPart2(t *testing.T) {
	tcs := []testCase{
		{
...
func RunMemtableInfoschemaExtractorPart3(t *testing.T) {
	tcs := []testCase{
		{
...
func RunMemtableInfoschemaExtractorPart4(t *testing.T) {
	tcs := []testCase{
		{
