...
func RunCanBePrune(t *testing.T) {
...
func RunPruneUseBinarySearchSigned(t *testing.T) {
...
func RunPruneUseBinarySearchUnSigned(t *testing.T) {
...
func RunPartitionRangeForExpr(t *testing.T) {
...
func RunPartitionRangeOperation(t *testing.T) {
...
func RunPartitionRangePruner2VarChar(t *testing.T) {
...
func RunPartitionRangePruner2CharWithCollation(t *testing.T) {
	tc := prepareTestCtx(t,
...
func RunPartitionRangePruner2Date(t *testing.T) {
	tc := prepareTestCtx(t,
...
func RunPartitionRangeColumnsForExpr(t *testing.T) {
...
func RunPartitionRangeColumnsForExprWithSpecialCollation(t *testing.T) {
