...
func (s *PartitionProcessor) prune(ds *logicalop.DataSource, opt *optimizetrace.LogicalOptimizeOp) (base.LogicalPlan, error) {
	...
	ds.PushedDownConds, _ = applyPredicateSimplification(ds.SCtx(), ds.PushedDownConds, false, nil)
	ds.AllConds, _ = applyPredicateSimplification(ds.SCtx(), ds.AllConds, false, nil)
