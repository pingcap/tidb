...
func checkIndexCoveringColumns(p *PointGetPlan, columns []*expression.Column, idxInfo *model.IndexInfo) bool {
	// Get index columns
...
func isColumnCoveredByIndex(p *PointGetPlan, column *expression.Column, indexColumns []*expression.Column, idxColLens []int) bool {
	// Handle primary key
