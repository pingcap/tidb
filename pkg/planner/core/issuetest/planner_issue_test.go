...
func TestIssue50080(t *testing.T) {
	...
	tk.MustQuery("explain select * from test where updated_date > '2023-12-31 23:59:00' and updated_date<'2023-12-31 23:59:59';").Check(testkit.Rows(
		"IndexLookUp_7 133.66 root  ",
		"├─IndexRangeScan_5(Build) 133.66 cop[tikv] table:test, index:IX_CUST_RELA_DATE(updated_date) range:(2023-12-31 23:59:00,2023-12-31 23:59:59), keep order:false",
	...
	tk.MustQuery("explain select * from test where updated_date > '2023-12-31 23:59:00' and updated_date<'2024-01-01 00:00:01';").Check(testkit.Rows(
		"IndexLookUp_7 133.66 root  ",
		"├─IndexRangeScan_5(Build) 133.66 cop[tikv] table:test, index:IX_CUST_RELA_DATE(updated_date) range:(2023-12-31 23:59:00,2024-01-01 00:00:01), keep order:false",
		"└─TableRowIDScan_6(Probe) 133.66 cop[tikv] table:test keep order:false"))
