...
GROUP BY field1;`).Check(testkit.Rows("HashJoin 2.00 root  CARTESIAN left outer semi join, left side:HashAgg",
		...
		"│ └─Union 1.00 root  ",
		"│   ├─Projection 1.00 root  8->Column#18, 0->Column#19",
		"│   │ └─TableDual 1.00 root  rows:0",
		"│   └─Projection 1.00 root  8->Column#18, 8->Column#19",
		"│     └─TableDual 1.00 root  rows:0",
		...
		"    │ └─Union 1.00 root  ",
		"    │   ├─Projection 1.00 root  8->Column#8, 0->Column#9",
		"    │   │ └─TableDual 1.00 root  rows:0",
		"    │   └─Projection 1.00 root  8->Column#8, 8->Column#9",
		"    │     └─TableDual 1.00 root  rows:0",
