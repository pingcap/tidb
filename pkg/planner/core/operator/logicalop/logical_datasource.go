...
func (ds *DataSource) PredicateSimplification(*optimizetrace.LogicalOptimizeOp) base.LogicalPlan {
	...
	p.PushedDownConds = utilfuncp.ApplyPredicateSimplification(p.SCtx(), p.PushedDownConds, true, nil)
	p.AllConds = utilfuncp.ApplyPredicateSimplification(p.SCtx(), p.AllConds, true, nil)
	return p
}
