...
func (ds *DataSource) PredicatePushDown(predicates []expression.Expression, opt *optimizetrace.LogicalOptimizeOp) ([]expression.Expression, base.LogicalPlan, error) {
	predicates, _ = ruleutil.ApplyPredicateSimplification(ds.SCtx(), predicates, true, nil)
...
func (ds *DataSource) PredicateSimplification(*optimizetrace.LogicalOptimizeOp) base.LogicalPlan {
	...
	p.PushedDownConds, _ = ruleutil.ApplyPredicateSimplification(p.SCtx(), p.PushedDownConds, true, nil)
	p.AllConds, _ = ruleutil.ApplyPredicateSimplification(p.SCtx(), p.AllConds, true, nil)
	return p
}
