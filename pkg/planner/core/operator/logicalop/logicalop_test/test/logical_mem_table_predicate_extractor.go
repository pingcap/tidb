...
func RunClusterConfigTableExtractor(t *testing.T) {
...
func RunClusterLogTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunMetricTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunMetricsSummaryTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunInspectionResultTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunInspectionSummaryTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunInspectionRuleTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunTiDBHotRegionsHistoryTableExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunTikvRegionPeersExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunTikvRegionStatusExtractor(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
...
func RunExtractorInPreparedStmt(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunInfoSchemaTableExtract(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
