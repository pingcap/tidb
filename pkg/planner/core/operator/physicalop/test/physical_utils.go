...
type PhysicalLimit = physicalop.ExportPhysicalLimit
type PhysicalSelection = physicalop.ExportPhysicalSelection
type PhysicalProjection = physicalop.ExportPhysicalProjection
type PhysicalTableReader = physicalop.ExportPhysicalTableReader
type PhysicalLocalIndexLookUp = physicalop.ExportPhysicalLocalIndexLookUp
type PhysicalIndexScan = physicalop.ExportPhysicalIndexScan
type PhysicalTableScan = physicalop.ExportPhysicalTableScan

// FlattenListPushDownPlan is an alias for the exported function
var FlattenListPushDownPlan = physicalop.ExportFlattenListPushDownPlan

// FlattenTreePushDownPlan is an alias for the exported function
var FlattenTreePushDownPlan = physicalop.ExportFlattenTreePushDownPlan
...
func RunFlattenListPushDownPlan(t *testing.T) {
...
func RunFlattenTreePushDownPlan(t *testing.T) {
