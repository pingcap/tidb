...
func RunFDSet_ExtractFD(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fd:   "{(1)-->(2-4), (2,3)~~>(1,4)} >>> {(1)-->(2-4), (2,3)~~>(1,4), (2)-->(5)} >>> {(2)-->(5,6)}",
		},
		{
		...
		// test for table x1 and x2
		{
			...
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2,3)}",
		},
		{
			...
			fd: "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {}",
		},
		{
		...
		},
		{
			...
			fd: "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5), (2,3)-->(6)} >>> {(2,3)-->(6)}",
		},
		{
			...
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5), (2,3)-->(7,8), (7,8)-->(6)} >>> {(2,3)-->(7,8), (7,8)-->(6)}",
		},
		{
			sql:  "select b+c, min(a) from x1 group by b, c",
			best: "DataScan(x1)->Aggr(min(test.x1.a),firstrow(test.x1.b),firstrow(test.x1.c))->Projection",
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5), (2,3)-->(6)} >>> {(2,3)-->(6,7)}",
		},
		{
			sql:  "select b+c from x1 group by b,c",
			best: "DataScan(x1)->Aggr(firstrow(test.x1.b),firstrow(test.x1.c))->Projection",
			// b --> b is naturally existed, so it won't exist in fd.
			fd: "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(2,3)-->(6)}",
		},
		{
			sql:  "select case b when 1 then c when 2 then d else d end from x1 group by b,c,d",
			best: "DataScan(x1)->Projection",
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(2,4)-->(3,6)}",
		},
		{
			...
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(3)-->(19)}",
		},
		{
			...
			fd: "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {()-->(21)}",
		},
		{
			sql:  "select c is null from x1 group by c",
			best: "DataScan(x1)->Aggr(firstrow(test.x1.c))->Projection",
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(3)-->(6)}",
		},
		{
		...
		},
		{
			...
			best: "DataScan(x1)->Aggr(firstrow(test.x1.b))->Projection",
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(2)-->(6)}",
		},
		// test functional dependency on primary key
		{
			...
			best: "DataScan(x1)->Projection",
			fd:   "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-4), (2,4)-->(1,3)}",
		},
		...
		// test functional dependency derived from keys in where condition
		{
			...
			fd: "{(1)-->(2-5), (2,3)~~>(1,4,5), (2,4)-->(1,3,5)} >>> {(1)-->(2-5), (2,3)-->(1,4,5), (2,4)-->(1,3,5), (3,4)==(3,4)} >>> {(1)-->(2-4), (2,3)-->(1,4), (2,4)-->(1,3), (3,4)==(3,4)}",
		},
		{
...
func RunFDSet_ExtractFDForApplyAndUnion(t *testing.T) {
	store := testkit.CreateMockStore(t)
	par := parser.New()
	par.SetParserConfig(parser.ParserConfig{EnableWindowFunction: true, EnableStrictDoubleTypeCheck: true})
...
func RunFDSet_MakeOuterJoin(t *testing.T) {
	store := testkit.CreateMockStore(t)
	par := parser.New()
	par.SetParserConfig(parser.ParserConfig{EnableWindowFunction: true, EnableStrictDoubleTypeCheck: true})
	...
	tests := []struct {
	...
	}{
		{
			...
			fd:   "{(1)-->(2-6), (2,3)~~>(1,4-6), (7,8)-->(9,10,13), (9,10)-->(13), (1,7,8)-->(2-6,9,10,13)} >>> {(1)-->(2-5), (7,8)-->(9,10,13), (9,10)-->(13), (1,7,8)-->(2-5,9,10,13)}",
		},
	}
