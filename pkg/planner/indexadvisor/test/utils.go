...
func RunCollectTableFromQuery(t *testing.T) {
...
func RunCollectSelectColumnsFromQuery(t *testing.T) {
...
func RunCollectOrderByColumnsFromQuery(t *testing.T) {
...
func RunCollectDNFColumnsFromQuery(t *testing.T) {
...
func RunRestoreSchemaName(t *testing.T) {
...
func RunFilterSQLAccessingSystemTables(t *testing.T) {
	set1 := s.NewSet[indexadvisor.Query]()
...
func RunFilterInvalidQueries(t *testing.T) {
...
func RunCollectIndexableColumnsForQuerySet(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
...
func RunCollectIndexableColumnsFromQuery(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
