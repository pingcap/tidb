...
type Rule interface {
	...
	PreCheck(holder base.LogicalPlan, mctx *memo.MemoContext) bool
	...
	Match(holder base.LogicalPlan, mctx *memo.MemoContext) bool
...
func (*BaseRule) PreCheck(_ base.LogicalPlan, _ *memo.MemoContext) bool {
	return true
}

// Match implements Rule interface.
func (*BaseRule) Match(_ base.LogicalPlan, _ *memo.MemoContext) bool {
	return true
}
