...
type Rule interface {
	...
	// second value: RuleType means the next triggered rule based on current holder GE.
	XForm(_ corebase.LogicalPlan) ([]corebase.LogicalPlan, Type, error)
}
...
func (*BaseRule) XForm(_ corebase.LogicalPlan) ([]corebase.LogicalPlan, Type, error) {
	return nil, DefaultNone, nil
}
