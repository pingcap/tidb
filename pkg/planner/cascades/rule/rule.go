...
type Rule interface {
	...
	PreCheck(holder *memo.MemoExpression, mctx *Ta) bool
	...
	Match(holder *memo.MemoExpression, sctx sessionctx.Context) bool
	...
	XForm(holder *memo.MemoExpression, sctx sessionctx.Context) ([]*memo.MemoExpression, error)
}
...
func (*BaseRule) PreCheck(_ *memo.MemoExpression, _ sessionctx.Context) bool {
	return true
}

// Match implements Rule interface.
func (*BaseRule) Match(_ *memo.MemoExpression, _ sessionctx.Context) bool {
	return true
}

// XForm implements Rule interface.
func (*BaseRule) XForm(_ *memo.MemoExpression, _ sessionctx.Context) ([]*memo.MemoExpression, error) {
	return nil, nil
}
