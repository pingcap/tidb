...
type Rule interface {
	...
	XForm(holder *GroupExprHolder, sctx sessionctx.Context) ([]*memo.GroupExpr, error)
}
...
func (*BaseRule) XForm(_ *GroupExprHolder, _ sessionctx.Context) ([]*memo.GroupExpr, error) {
	return nil, nil
}
