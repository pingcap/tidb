...
type Rule interface {
	...
	// @first: GE list indicates the new GroupExprs generated by the transformation rule.
	// @second: bool indicates whether we need to rm the src GE, cause some src GE is intermediary.
	// @third: error
	XForm(_ corebase.LogicalPlan) ([]corebase.LogicalPlan, bool, error)
}
...
func (*BaseRule) XForm(_ corebase.LogicalPlan) ([]corebase.LogicalPlan, bool, error) {
