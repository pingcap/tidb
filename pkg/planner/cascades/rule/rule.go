...
type Rule interface {
	...
	PreCheck(holder *memo.MemoExpression, mctx *memo.MemoContext) bool
	...
	Match(holder *memo.MemoExpression, mctx *memo.MemoContext) bool
	...
	XForm(holder *memo.MemoExpression, mctx *memo.MemoContext) ([]*memo.MemoExpression, error)
}
...
func (*BaseRule) PreCheck(_ *memo.MemoExpression, _ *memo.MemoContext) bool {
	return true
}

// Match implements Rule interface.
func (*BaseRule) Match(_ *memo.MemoExpression, _ *memo.MemoContext) bool {
	return true
}

// XForm implements Rule interface.
func (*BaseRule) XForm(_ *memo.MemoExpression, _ *memo.MemoContext) ([]*memo.MemoExpression, error) {
	return nil, nil
}
