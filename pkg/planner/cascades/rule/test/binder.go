...
func RunBinderSuccess(t *testing.T) {
	...
	binder := rule.ExportedNewBinder(pa, rootGE)
	holder := binder.Next()
...
func RunBinderFail(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats"))
	}()
	...
	rule.ExportedSetBinderBSW(binder, buf)
	holder := binder.Next()
...
func RunBinderTopNode(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats"))
	}()
	...
	pa := pattern.NewPattern(pattern.OperandJoin, pattern.EngineAll)
	binder := rule.ExportedNewBinder(pa, mm.GetRootGroup().GetLogicalExpressions().Back().Value.(*memo.GroupExpression))
	holder := binder.Next()
	require.NotNil(t, holder)
	require.Equal(t, pattern.OperandJoin, pattern.GetOperand(rule.ExportedGetBinderHolder(binder).(*memo.GroupExpression).LogicalPlan))
}

func RunBinderOneNode(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats"))
	}()
...
func RunBinderSubTreeMatch(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats"))
	}()
	...
	binder = rule.ExportedNewBinder(pa2, rootGE)
...
func RunBinderMultiNext(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats"))
	}()
	...
	pa := pattern.NewPattern(pattern.OperandJoin, pattern.EngineAll)
	pa.SetChildren(pattern.NewPattern(pattern.OperandDataSource, pattern.EngineAll), pattern.NewPattern(pattern.OperandDataSource, pattern.EngineAll))
	binder := rule.ExportedNewBinder(pa, gE)
	b := bytes.Buffer{}
	buf := util.NewStrBuffer(&b)
	rule.ExportedSetBinderBSW(binder, buf)
...
func RunBinderMultiAny(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/pingcap/tidb/pkg/planner/cascades/memo/MockPlanSkipMemoDeriveStats"))
	}()
