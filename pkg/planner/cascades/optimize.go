...
func (opt *Optimizer) FindBestPlan(sctx plannercore.PlanContext, logical plannercore.LogicalPlan) (p operator.PhysicalPlan, cost float64, err error) {
...
func (opt *Optimizer) onPhaseImplementation(_ plannercore.PlanContext, g *memo.Group) (operator.PhysicalPlan, float64, error) {
