...
func (e *GroupExpression) ExhaustPhysicalPlans(prop *property.PhysicalProperty) (physicalPlans [][]base.PhysicalPlan, hintCanWork bool, err error) {
	...
	case *logicalop.LogicalWindow:
		ops, hintCanWork, err = utilfuncp.ExhaustPhysicalPlans4LogicalWindow(x, prop)
	case *logicalop.LogicalExpand:
		ops, hintCanWork, err = utilfuncp.ExhaustPhysicalPlans4LogicalExpand(x, prop)
	case *logicalop.LogicalUnionAll:
		ops, hintCanWork, err = utilfuncp.ExhaustPhysicalPlans4LogicalUnionAll(x, prop)
	case *logicalop.LogicalSequence:
		ops, hintCanWork, err = utilfuncp.ExhaustPhysicalPlans4LogicalSequence(e, prop)
	case *logicalop.LogicalSelection:
		ops, hintCanWork, err = physicalop.ExhaustPhysicalPlans4LogicalSelection(x, prop)
	case *logicalop.LogicalMaxOneRow:
		ops, hintCanWork, err = utilfuncp.ExhaustPhysicalPlans4LogicalMaxOneRow(x, prop)
	...
	case *logicalop.LogicalPartitionUnionAll:
		ops, hintCanWork, err = utilfuncp.ExhaustPhysicalPlans4LogicalPartitionUnionAll(x, prop)
	default:
		panic("unreachable")
	}
