...
const (
	...
	// Fix65531 controls whether to do heuristic rule to covers more about index cols, rather than left the decision
	// to used index cols' group ndv
	Fix65531 uint64 = 65531
)
