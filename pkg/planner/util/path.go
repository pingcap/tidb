...
type AccessPath struct {
	...
	*/
	...
	// MatchedIdxDesc records the uniform stored direction of the index columns
	// matched against the required PhysicalProperty by matchProperty. Meaningful
	// only when matchProperty returns PropMatched or PropMatchedNeedMergeSort.
	// The scan-direction XOR (queryDesc != MatchedIdxDesc) decides whether the
	// cop scan should be forward or reverse.
	MatchedIdxDesc bool
