...
func NewCommonHandleColsWithoutOffsetAlign(sc *stmtctx.StatementContext, tblInfo *model.TableInfo,
	idxInfo *model.IndexInfo, alignedTableCols []*expression.Column) *CommonHandleCols {
