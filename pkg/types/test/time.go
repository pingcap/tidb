...
func RunTimeEncoding(t *testing.T) {
	tests := []struct {
...
func RunDurationAdd(t *testing.T) {
	table := []struct {
		Input    string
		Fsp      int
		InputAdd string
...
func RunDurationSub(t *testing.T) {
	typeCtx := types.NewContext(types.StrictFlags.WithIgnoreZeroInDate(true), time.UTC, contextutil.IgnoreWarn)
	table := []struct {
		Input    string
		Fsp      int
...
func RunParseTimeFromNum(t *testing.T) {
	table := []struct {
		Input                int64
...
func RunParseTimeFromFloatString(t *testing.T) {
	typeCtx := types.NewContext(types.StrictFlags.WithIgnoreZeroInDate(true), time.UTC, contextutil.IgnoreWarn)
	table := []struct {
		Input       string
		Fsp         int
...
func RunRoundFrac(t *testing.T) {
	...
	losAngelesTz, err := time.LoadLocation("America/Los_Angeles")
	require.NoError(t, err)
	typeCtx = typeCtx.WithLocation(losAngelesTz)
	tbl = []struct {
		Input  string
		Fsp    int
		Except string
...
func RunConvert(t *testing.T) {
	...
	for _, tt := range tblDuration {
		...
		require.NoError(t, err)
		t2, _ := t1.GoTime(typeCtx.Location())
...
func RunDurationClock(t *testing.T) {
...
func RunParseDateFormat(t *testing.T) {
	tbl := []struct {
		Input  string
		Result []string
	}{
...
func RunTimestampDiff(t *testing.T) {
	tests := []struct {
		unit   string
		t1     types.CoreTime
		t2     types.CoreTime
...
func RunConvertTimeZone(t *testing.T) {
...
func RunTruncateOverflowMySQLTime(t *testing.T) {
	v := types.MaxTime + 1
...
func RunCheckTimestamp(t *testing.T) {
...
func RunExtractDurationValue(t *testing.T) {
	tests := []struct {
		unit   string
		format string
		ans    string
...
func RunExtractDatetimeNum(t *testing.T) {
...
func RunExtractDurationNum(t *testing.T) {
...
func RunParseDurationValue(t *testing.T) {
	tbl := []struct {
		format string
		unit   string
		res1   int64
...
func RunIsClockUnit(t *testing.T) {
	tbl := []struct {
		input    string
		expected bool
	}{
...
func RunIsDateUnit(t *testing.T) {
	tbl := []struct {
		input    string
		expected bool
	}{
...
func RunIsMicrosecondUnit(t *testing.T) {
	tbl := []struct {
		input    string
		expected bool
	}{
...
func RunIsDateFormat(t *testing.T) {
	input := "1234:321"
...
func RunParseTimeFromInt64(t *testing.T) {
	typeCtx := types.NewContext(types.StrictFlags.WithIgnoreZeroInDate(true), time.UTC, contextutil.IgnoreWarn)
...
func RunParseTimeFromFloat64(t *testing.T) {
	typeCtx := types.NewContext(types.StrictFlags.WithIgnoreZeroInDate(true), time.UTC, contextutil.IgnoreWarn)
...
func RunParseTimeFromDecimal(t *testing.T) {
	typeCtx := types.NewContext(types.StrictFlags.WithIgnoreZeroInDate(true), time.UTC, contextutil.IgnoreWarn)
...
func RunGetFormatType(t *testing.T) {
	input := "TEST"
...
func RunGetFracIndex(t *testing.T) {
	testCases := []struct {
		str         string
		expectIndex int
	}{
...
func RunTimeOverflow(t *testing.T) {
	typeCtx := types.NewContext(types.StrictFlags.WithIgnoreZeroInDate(true), time.UTC, contextutil.IgnoreWarn)
	table := []struct {
		Input  string
		Output bool
...
func RunTruncateFrac(t *testing.T) {
	cols := []struct {
		input  time.Time
		fsp    int
		output time.Time
...
func RunCheckMonthDay(t *testing.T) {
	dates := []struct {
		date        types.CoreTime
		isValidDate bool
	}{
...
func RunFormatIntWidthN(t *testing.T) {
	cases := []struct {
		num    int
		width  int
		result string
...
func RunFromGoTime(t *testing.T) {
...
func RunGetTimezone(t *testing.T) {
	cases := []struct {
		input    string
		idx      int
		tzSign   string
...
func RunParseWithTimezone(t *testing.T) {
...
func RunMarshalTime(t *testing.T) {
	typeCtx := types.DefaultStmtNoWarningContext
...
func RunDurationConvertToYearFromNow(t *testing.T) {
	cases := []struct {
		dur        types.Duration
		nowLit     string
		sysTZ      *time.Location
