...
func RunVectorEndianess(t *testing.T) {
...
func RunZeroVector(t *testing.T) {
...
func RunVectorParse(t *testing.T) {
...
func RunVectorDatum(t *testing.T) {
...
func RunVectorCompare(t *testing.T) {
...
func RunVectorSerialize(t *testing.T) {
	v1, err := types.ParseVectorFloat32(`[1.1, 2.2, 3.3]`)
	require.NoError(t, err)
