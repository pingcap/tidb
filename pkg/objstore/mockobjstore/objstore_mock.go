...
//
//	mockgen -package mockstorage github.com/pingcap/tidb/pkg/objstore Storage
//
...
// MockExternalStorage is a mock of Storage interface.
...
func (m *MockExternalStorage) Create(arg0 context.Context, arg1 string, arg2 *objstore.WriterOption) (objstore.FileWriter, error) {
	m.ctrl.T.Helper()
...
func (m *MockExternalStorage) Open(arg0 context.Context, arg1 string, arg2 *objstore.ReaderOption) (objstore.FileReader, error) {
	m.ctrl.T.Helper()
