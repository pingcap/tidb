...
func RunClientPermission(t *testing.T) {
	s := CreateSuite(t)
...
func RunClientGetObject(t *testing.T) {
	s := CreateSuite(t)
	ctx := context.Background()
	cli := &client{
		svc:          s.MockCli,
...
func RunClientDeleteObjects(t *testing.T) {
	s := CreateSuite(t)
	ctx := context.Background()
	cli := &client{
		svc:          s.MockCli,
...
func RunClientIsObjectExists(t *testing.T) {
	s := CreateSuite(t)
	ctx := context.Background()
	cli := &client{
		svc:          s.MockCli,
...
func RunClientListObjects(t *testing.T) {
	s := CreateSuite(t)
	ctx := context.Background()
	cli := &client{
		svc:          s.MockCli,
...
func RunClientCopyObject(t *testing.T) {
	s := CreateSuite(t)
	ctx := context.Background()
	cli := &client{
		svc:          s.MockCli,
