...
func RunPrivString(t *testing.T) {
	for i := 0; ; i++ {
		p := PrivilegeType(1 << i)
		if p > AllPriv {
			break
...
func RunPrivColumn(t *testing.T) {
...
func RunPrivSetString(t *testing.T) {
...
func RunPrivAllConsistency(t *testing.T) {
