...
func (p *HandParser) parsePlacementStringOption(tokType int, optType ast.PlacementOptionType) *ast.PlacementOption {
	if _, ok := p.accept(tokType); ok {
...
func (p *HandParser) parsePlacementUintOption(tokType int, optType ast.PlacementOptionType) *ast.PlacementOption {
	if _, ok := p.accept(tokType); ok {
		opt := Alloc[ast.PlacementOption](p.arena)
		opt.Tp = optType
		p.accept(tokEq)
...
func (p *HandParser) parsePlacementOption() *ast.PlacementOption {
	...
	stringOpts := []struct {
		...
		{tokPrimaryRegion, ast.PlacementOptionPrimaryRegion},
		{tokRegions, ast.PlacementOptionRegions},
		{tokSchedule, ast.PlacementOptionSchedule},
		{tokConstraints, ast.PlacementOptionConstraints},
		{tokLeaderConstraints, ast.PlacementOptionLeaderConstraints},
		{tokFollowerConstraints, ast.PlacementOptionFollowerConstraints},
		{tokVoterConstraints, ast.PlacementOptionVoterConstraints},
		{tokLearnerConstraints, ast.PlacementOptionLearnerConstraints},
		{tokSurvivalPreferences, ast.PlacementOptionSurvivalPreferences},
	}
	...
	uintOpts := []struct {
		...
		{tokFollowers, ast.PlacementOptionFollowerCount},
		{tokVoters, ast.PlacementOptionVoterCount},
		{tokLearners, ast.PlacementOptionLearnerCount},
	}
