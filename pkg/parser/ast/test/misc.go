...
func RunMiscVisitorCover(t *testing.T) {
...
func RunDDLVisitorCoverMisc(t *testing.T) {
	sql := `
...
func RunDMLVistorCover(t *testing.T) {
...
func RunSensitiveStatement(t *testing.T) {
...
func RunTableOptimizerHintRestore(t *testing.T) {
...
func RunBRIESecureText(t *testing.T) {
	testCases := []struct {
		input   string
		secured string
	}{
...
func RunCompactTableStmtRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunPlanReplayerStmtRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAddQueryWatchStmtRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{
...
func RunRedactTrafficStmt(t *testing.T) {
	testCases := []struct {
		input   string
		secured string
	}{
