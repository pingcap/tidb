...
func RunDMLVisitorCover(t *testing.T) {
	ce := &checkExpr{}
...
func RunTableNameRestore(t *testing.T) {
...
func RunTableNameIndexHintsRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunLimitRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"limit 10", "LIMIT 10"},
...
func RunWildCardFieldRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"*", "*"},
		{"t.*", "`t`.*"},
		{"testdb.t.*", "`testdb`.`t`.*"},
...
func RunSelectFieldRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"*", "*"},
		{"t.*", "`t`.*"},
		{"testdb.t.*", "`testdb`.`t`.*"},
...
func RunFieldListRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"*", "*"},
		{"t.*", "`t`.*"},
		{"testdb.t.*", "`testdb`.`t`.*"},
...
func RunTableSourceRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"tbl", "`tbl`"},
		{"tbl as t", "`tbl` AS `t`"},
...
func RunOnConditionRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunJoinRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunTableRefsClauseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"t", "`t`"},
...
func RunDeleteTableListRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"t1,t2", "`t1`,`t2`"},
	}
	extractNodeFunc := func(node Node) Node {
...
func RunDeleteTableIndexHintRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunByItemRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"a", "`a`"},
		{"a desc", "`a` DESC"},
		{"NULL", "NULL"},
...
func RunGroupByClauseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunOrderByClauseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAssignmentRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"a=1", "`a`=1"},
		{"b=1+2", "`b`=1+2"},
	}
...
func RunHavingClauseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"HAVING a", "HAVING `a`"},
...
func RunFrameBoundRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunFrameClauseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunPartitionByClauseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunWindowSpecRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"w as ()", "`w` AS ()"},
		{"w as (w1)", "`w` AS (`w1`)"},
...
func RunLoadDataRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{
...
func RunImportActions(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{
...
func RunImportIntoRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{
...
func RunFulltextSearchModifier(t *testing.T) {
...
func RunImportIntoSecureText(t *testing.T) {
	testCases := []struct {
		input   string
		secured string
	}{
...
func RunImportIntoFromSelectInvalidStmt(t *testing.T) {
	p := parser.New()
