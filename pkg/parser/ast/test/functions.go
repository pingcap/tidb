...
func RunFunctionsVisitorCover(t *testing.T) {
...
func RunFuncCallExprRestore(t *testing.T) {
...
func RunFuncCastExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAggregateFuncExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunWindowFuncExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunGenericFuncRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"s.a()", "`s`.`a`()"},
		{"`s`.`a`()", "`s`.`a`()"},
		{"now()", "NOW()"},
...
func RunRestoreWithError(t *testing.T) {
	testCases := []string{
		"json_memberof()",
	}
