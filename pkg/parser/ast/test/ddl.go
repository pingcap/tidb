...
func RunDDLVisitorCover(t *testing.T) {
	ce := &checkExpr{}
...
func RunDDLIndexColNameRestore(t *testing.T) {
...
func RunDDLIndexExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"world", "`world`"},
		{"world(2)", "`world`(2)"},
	}
...
func RunDDLOnDeleteRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunDDLOnUpdateRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunDDLIndexOption(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunTableToTableRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"t1 to t2", "`t1` TO `t2`"},
	}
	extractNodeFunc := func(node Node) Node {
...
func RunDDLReferenceDefRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunDDLConstraintRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunDDLColumnOptionRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunGeneratedRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"generated always as(id + 1)", "GENERATED ALWAYS AS(`id`+1) VIRTUAL"},
		{"generated always as(id + 1) virtual", "GENERATED ALWAYS AS(`id`+1) VIRTUAL"},
		{"generated always as(id + 1) stored", "GENERATED ALWAYS AS(`id`+1) STORED"},
...
func RunDDLColumnDefRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		// for type
		{"id json", "`id` JSON"},
		{"id time(5)", "`id` TIME(5)"},
...
func RunDDLTruncateTableStmtRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunDDLDropTableStmtRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunColumnPositionRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"", ""},
		{"first", "FIRST"},
		{"after b", "AFTER `b`"},
...
func RunAlterTableSpecRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAlterTableWithSpecialCommentRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAlterTableOptionRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAdminRepairTableRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunAdminOptimizeTableRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunSequenceRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunIfExistsRestore(t *testing.T) {
	cases := []struct {
		sourceSQL          string
...
func RunAlterDatabaseRestore(t *testing.T) {
...
func RunCreatePlacementPolicyRestore(t *testing.T) {
...
func RunAlterPlacementPolicyRestore(t *testing.T) {
...
func RunDropPlacementPolicyRestore(t *testing.T) {
...
func RunRemovePlacementRestore(t *testing.T) {
...
func RunFlashBackDatabaseRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunTableOptionTTLRestore(t *testing.T) {
...
func RunTableOptionTTLRestoreWithTTLEnableOffFlag(t *testing.T) {
	sourceSQL1 := "create table t (created_at datetime) ttl = created_at + INTERVAL 1 YEAR"
...
func RunPresplitIndexSpecialComments(t *testing.T) {
...
func RunResourceGroupDDLStmtRestore(t *testing.T) {
