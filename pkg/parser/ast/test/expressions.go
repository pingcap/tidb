...
func RunExpresionsVisitorCover(t *testing.T) {
	ce := &checkExpr{}
	stmts :=
		[]struct {
			node             Node
...
func RunUnaryOperationExprRestore(t *testing.T) {
...
func RunColumnNameExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"abc", "`abc`"},
		{"`abc`", "`abc`"},
		{"`ab``c`", "`ab``c`"},
...
func RunIsNullExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"a is null", "`a` IS NULL"},
...
func RunIsTruthRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"a is true", "`a` IS TRUE"},
...
func RunBetweenExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunBinaryOperationExpr(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"'a'!=1", "_UTF8MB4'a'!=1"},
		{"a!=1", "`a`!=1"},
		{"3<5", "3<5"},
...
func RunBinaryOperationExprWithFlags(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"'a'!=1", "_UTF8MB4'a' != 1"},
		{"a!=1", "`a` != 1"},
		{"3<5", "3 < 5"},
...
func RunParenthesesExpr(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"(1+2)*3", "(1+2)*3"},
		{"1+2*3", "1+2*3"},
	}
...
func RunWhenClause(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunDefaultExpr(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"default", "DEFAULT"},
		{"default(i)", "DEFAULT(`i`)"},
	}
...
func RunPatternInExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunPatternLikeExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunValuesExpr(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"values(a)", "VALUES(`a`)"},
...
func RunPatternRegexpExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunRowExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"(1,2)", "ROW(1,2)"},
...
func RunMaxValueExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"maxvalue", "MAXVALUE"},
	}
	extractNodeFunc := func(node Node) Node {
...
func RunPositionExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"1", "1"},
	}
	extractNodeFunc := func(node Node) Node {
...
func RunExistsSubqueryExprRestore(t *testing.T) {
	testCases := []NodeRestoreTestCase{
...
func RunVariableExpr(t *testing.T) {
	testCases := []NodeRestoreTestCase{
		{"@a>1", "@`a`>1"},
		{"@`aB`+1", "@`aB`+1"},
		{"@'a':=1", "@`a`:=1"},
...
func RunMatchAgainstExpr(t *testing.T) {
	testCases := []NodeRestoreTestCase{
