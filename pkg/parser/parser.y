...
CreateMaterializedViewLogStmt:
	"CREATE" "MATERIALIZED" "VIEW" "LOG" "ON" TableName '(' ColumnNameList ')'
	{
		$$ = &ast.CreateMaterializedViewLogStmt{
			Table:   $6.(*ast.TableName),
			Columns: $8.([]*ast.ColumnName),
		}
	}
...
CreateMaterializedViewStmt:
	"CREATE" "MATERIALIZED" "VIEW" ViewName "AS" CreateViewSelectOpt "REFRESH" MaterializedViewRefreshMode "EVERY" Int64Num
	{
		$$ = &ast.CreateMaterializedViewStmt{
			ViewName:               $4.(*ast.TableName),
			Select:                 $6.(ast.StmtNode),
			RefreshMode:            $8.(ast.MaterializedViewRefreshMode),
			RefreshIntervalSeconds: $10.(int64),
		}
	}
...
MaterializedViewRefreshMode:
	"FAST"
	{
		$$ = ast.MaterializedViewRefreshModeFast
	}
|	"COMPLETE"
	{
