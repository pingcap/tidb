...
func RunErrorEqual(t *testing.T) {
...
func RunLog(t *testing.T) {
	err := fmt.Errorf("xxx")
	Log(err)
}

func RunTraceAndLocation(t *testing.T) {
	err := example()
