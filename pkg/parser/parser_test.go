...
func TestPrivilege(t *testing.T) {
	table := []testCase{
		...
		{`CREATE USER 'ttt'@'localhost' DEFAULT ROLE 'test_role' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 1 MAX_UPDATES_PER_HOUR 10 PASSWORD EXPIRE DEFAULT ACCOUNT UNLOCK;`, true, "CREATE USER `ttt`@`localhost` DEFAULT ROLE `test_role`@`%` REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 1 MAX_UPDATES_PER_HOUR 10 PASSWORD EXPIRE DEFAULT ACCOUNT UNLOCK"},
		{`CREATE USER 'ttt'@'localhost' DEFAULT ROLE 'test_role';`, true, "CREATE USER `ttt`@`localhost` DEFAULT ROLE `test_role`@`%`"},
		{`CREATE USER 'ttt'@'localhost' DEFAULT ROLE 'test_role', 'test_role2';`, true, "CREATE USER `ttt`@`localhost` DEFAULT ROLE `test_role`@`%`, `test_role2`@`%`"},
		{`CREATE USER 'ttt'@'localhost' DEFAULT ROLE 'test_role'@'%';`, true, "CREATE USER `ttt`@`localhost` DEFAULT ROLE `test_role`@`%`"},
		{`CREATE USER 'ttt'@'localhost' DEFAULT ROLE NONE;`, false, ""},
		...
		{"ALTER USER 'ttt'@'localhost' DEFAULT ROLE test_role REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 1 MAX_UPDATES_PER_HOUR 10 PASSWORD EXPIRE DEFAULT ACCOUNT UNLOCK;", false, ""},
		{"ALTER USER 'ttt'@'localhost' DEFAULT ROLE test_role;", true, "ALTER USER `ttt`@`localhost` DEFAULT ROLE `test_role`@`%`"},
		{"ALTER USER 'ttt'@'localhost' DEFAULT ROLE test_role, test_role2;", true, "ALTER USER `ttt`@`localhost` DEFAULT ROLE `test_role`@`%`, `test_role2`@`%`"},
		{"ALTER USER 'ttt'@'localhost' DEFAULT ROLE ALL;", true, "ALTER USER `ttt`@`localhost` DEFAULT ROLE ALL"},
		{"ALTER USER 'ttt'@'localhost' DEFAULT ROLE ALL EXCEPT 'test_role';", false, ""},
		{"ALTER USER 'ttt'@'localhost' DEFAULT ROLE NONE;", true, "ALTER USER `ttt`@`localhost` DEFAULT ROLE NONE"},
