...
func TestBRIE(t *testing.T) {
	table := []testCase{
		...
		{"BACKUP TABLE a TO 'noop://' checksum_concurrency 4 compression_level 4 ignore_stats 1 backup_compression 'lz4'", true, "BACKUP TABLE `a` TO 'noop://' CHECKSUM_CONCURRENCY = 4 COMPRESSION_LEVEL = 4 IGNORE_STATS = 1 BACKUP_COMPRESSION = 'lz4'"},
