...
func TestPrivilege(t *testing.T) {
	table := []testCase{
		...
		{`CREATE USER 'aaa'@'127.0.0.1' IDENTIFIED BY 'aaa' PASSWORD REQUIRE CURRENT`, true, "CREATE USER `aaa`@`127.0.0.1` IDENTIFIED BY 'aaa' PASSWORD REQUIRE CURRENT"},
		{`CREATE USER 'bbb'@'127.0.0.1' IDENTIFIED BY 'bbb' PASSWORD REQUIRE CURRENT DEFAULT`, true, "CREATE USER `bbb`@`127.0.0.1` IDENTIFIED BY 'bbb' PASSWORD REQUIRE CURRENT DEFAULT"},
		{`CREATE USER 'ccc'@'127.0.0.1' IDENTIFIED BY 'ccc' PASSWORD REQUIRE CURRENT OPTIONAL`, true, "CREATE USER `ccc`@`127.0.0.1` IDENTIFIED BY 'ccc' PASSWORD REQUIRE CURRENT OPTIONAL"},
		...
		{"ALTER USER 'aaa'@'127.0.0.1' IDENTIFIED BY 'aab' REPLACE 'aaa'", true, "ALTER USER `aaa`@`127.0.0.1` IDENTIFIED BY 'aab' REPLACE 'aaa'"},
		{"ALTER USER 'bbb'@'127.0.0.1' PASSWORD REQUIRE CURRENT", true, "ALTER USER `bbb`@`127.0.0.1` PASSWORD REQUIRE CURRENT"},
		{"ALTER USER 'bbb'@'127.0.0.1' PASSWORD REQUIRE CURRENT DEFAULT", true, "ALTER USER `bbb`@`127.0.0.1` PASSWORD REQUIRE CURRENT DEFAULT"},
		{"ALTER USER 'bbb'@'127.0.0.1' PASSWORD REQUIRE CURRENT OPTIONAL", true, "ALTER USER `bbb`@`127.0.0.1` PASSWORD REQUIRE CURRENT OPTIONAL"},
