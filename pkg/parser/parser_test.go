...
'`},
		...
		{"SHOW PLACEMENT FORMAT = RAW", true, "SHOW PLACEMENT FORMAT = RAW"},
		...
		{"SHOW PLACEMENT FOR DATABASE db1 FORMAT = RAW", true, "SHOW PLACEMENT FOR DATABASE `db1` FORMAT = RAW"},
		...
		{"SHOW PLACEMENT FOR TABLE tb1 FORMAT = RAW", true, "SHOW PLACEMENT FOR TABLE `tb1` FORMAT = RAW"},
		...
		{"SHOW PLACEMENT FOR TABLE tb1 PARTITION p1 FORMAT = RAW", true, "SHOW PLACEMENT FOR TABLE `tb1` PARTITION `p1` FORMAT = RAW"},
