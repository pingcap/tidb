...
func RunCheckSM3PasswordGood(t *testing.T) {
	pwd := "foobar"
...
func RunCheckSM3PasswordBad(t *testing.T) {
	pwd := "not_foobar"
...
func RunCheckSM3PasswordShort(t *testing.T) {
	pwd := "not_foobar"
...
func RunCheckSM3PasswordDigestTypeIncompatible(t *testing.T) {
	pwd := "not_foobar"
...
func RunCheckSM3PasswordIterationsInvalid(t *testing.T) {
	pwd := "not_foobar"
...
func RunNewSM3Password(t *testing.T) {
	pwd := "testpwd"
