...
func RunCheckShaPasswordGood(t *testing.T) {
	pwd := "foobar"
...
func RunCheckShaPasswordBad(t *testing.T) {
	pwd := "not_foobar"
...
func RunCheckShaPasswordShort(t *testing.T) {
	pwd := "not_foobar"
...
func RunCheckShaPasswordDigestTypeIncompatible(t *testing.T) {
	pwd := "not_foobar"
...
func RunCheckShaPasswordIterationsInvalid(t *testing.T) {
	pwd := "not_foobar"
...
func RunNewSha2Password(t *testing.T) {
	pwd := "testpwd"
