...
var tokenMap = map[string]int{
	...
	"AZBLOB_ACCOUNT_NAME":      azblobAccountName,
	"AZBLOB_ENCRYPTION_KEY":    azblobEncryptionKey,
	"AZBLOB_ENCRYPTION_SCOPE":  azblobEncryptionScope,
	"AZBLOB_ENDPOINT":          azblobEndpoint,
	"AZBLOB_SAS_TOKEN":         azblobSasToken,
