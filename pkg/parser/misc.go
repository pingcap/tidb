...
var tokenMap = map[string]int{
	...
	"ADD":                            add,
	"ADDDATE":                        addDate,
	"ADD_COLUMNAR_REPLICA_ON_DEMAND": identifier,
	"ADMIN":                          admin,
	"ADVISE":                         advise,
	"AFFINITY":                       affinity,
	"AFTER":                          after,
	...
	"ENGINE":                         engine,
	"ENGINES":                        engines,
	"ENGINE_ATTRIBUTE":               identifier,
	"SECONDARY_ENGINE_ATTRIBUTE":     identifier,
	"ENUM":                           enum,
	"ERROR":                          errorKwd,
	...
	"PACK_KEYS":                      packKeys,
	"PAGE":                           pageSym,
	"PAGE_CHECKSUM":                  identifier,
	"PAGE_COMPRESSED":                identifier,
	"PAGE_COMPRESSION_LEVEL":         identifier,
	"PARSER":                         parser,
	"PARTIAL":                        partial,
	"PARTITION":                      partition,
