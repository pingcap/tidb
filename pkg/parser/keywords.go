...
var Keywords = []KeywordsType{
	...
	{"TOPN", false, "tidb"},
	{"WIDTH", false, "tidb"},
	{"WITH_SYS_TABLE", false, "tidb"},
	{"WAIT_TIFLASH_READY", false, "tidb"},
	{"IGNORE_STATS", false, "tidb"},
	{"CHECKSUM_CONCURRENCY", false, "tidb"},
	{"COMPRESSION_LEVEL", false, "tidb"},
	{"BACKUP_COMPRESSION", false, "tidb"},
	{"ENCRYPTION_METHOD", false, "tidb"},
	{"ENCRYPTION_KEY_FILE", false, "tidb"},
}
