...
func RunNormalizeRedact(t *testing.T) {
	cases := []struct {
		input  string
		expect string
	}{
...
func RunNormalizeKeepHint(t *testing.T) {
	tests := []struct {
		input  string
		expect string
	}{
...
func RunNormalizeDigest(t *testing.T) {
	tests := []struct {
		sql        string
		normalized string
		digest     string
...
func RunDigestHashEqForSimpleSQL(t *testing.T) {
	sqlGroups := [][]string{
...
func RunDigestHashNotEqForSimpleSQL(t *testing.T) {
	sqlGroups := [][]string{
