...
func RunSpecialComments(t *testing.T) {
	p := parser.New()
...
func RunRecommendIndex(t *testing.T) {
	table := []testCase{
...
func RunSetVariable(t *testing.T) {
	table := []struct {
		Input      string
		Name       string
		IsGlobal   bool
...
func RunFlushTable(t *testing.T) {
	p := parser.New()
...
func RunFlushPrivileges(t *testing.T) {
	p := parser.New()
...
func RunExpression(t *testing.T) {
	table := []testCase{
		// sign expression
		{"SELECT ++1", true, "SELECT ++1"},
...
func RunIdentifier(t *testing.T) {
	table := []testCase{
...
func RunBuiltinFuncAsIdentifier(t *testing.T) {
...
func RunOptimizerHints(t *testing.T) {
	p := parser.New()
	// Test USE_INDEX
...
func RunPrivilegeMariaDBEnabled(t *testing.T) {
...
func RunPrivilegeMariaDBDisabled(t *testing.T) {
...
func RunParserErrMsg(t *testing.T) {
...
func RunSetOperator(t *testing.T) {
	table := []testCase{
		// union and union all
...
func RunUnionOrderBy(t *testing.T) {
	p := parser.New()
...
func RunLikeEscape(t *testing.T) {
	table := []testCase{
		// for like escape
...
func RunLockUnlockTables(t *testing.T) {
	table := []testCase{
...
func RunWithRollup(t *testing.T) {
	table := []testCase{
...
func RunSQLNoCache(t *testing.T) {
	table := []testCase{
...
func RunDeallocate(t *testing.T) {
	table := []testCase{
...
func RunTimestampDiffUnit(t *testing.T) {
...
func RunFuncCallExprOffset(t *testing.T) {
...
func RunSessionManage(t *testing.T) {
	table := []testCase{
		// Kill statement.
...
func RunParseShowOpenTables(t *testing.T) {
	table := []testCase{
...
func RunSQLModeANSIQuotes(t *testing.T) {
	p := parser.New()
	p.SetSQLMode(mysql.ModeANSIQuotes)
	tests := []string{
...
func RunDDLStatements(t *testing.T) {
	p := parser.New()
...
func RunTableSample(t *testing.T) {
	table := []testCase{
		// positive test cases
...
func RunGeneratedColumn(t *testing.T) {
	tests := []struct {
		input string
		ok    bool
		expr  string
...
func RunSetTransaction(t *testing.T) {
...
func RunSideEffect(t *testing.T) {
...
func RunTablePartition(t *testing.T) {
	table := []testCase{
...
func RunTablePartitionNameList(t *testing.T) {
	table := []testCase{
...
func RunNotExistsSubquery(t *testing.T) {
	table := []testCase{
...
func RunWindowFunctionIdentifier(t *testing.T) {
	//nolint: prealloc
	var table []testCase
	for key := range GetWindowFuncTokenMap() {
...
func RunWindowFunctions(t *testing.T) {
	table := []testCase{
...
func RunVisitFrameBound(t *testing.T) {
	p := parser.New()
...
func RunQuotedSystemVariables(t *testing.T) {
	p := parser.New()
...
func RunQuotedVariableColumnName(t *testing.T) {
	p := parser.New()
...
func RunUnderscoreCharset(t *testing.T) {
	p := parser.New()
	tests := []struct {
		cs        string
		parseFail bool
...
func RunFulltextSearch(t *testing.T) {
	p := parser.New()
...
func RunStartTransaction(t *testing.T) {
	cases := []testCase{
...
func RunSignedInt64OutOfRange(t *testing.T) {
	p := parser.New()
	cases := []string{
...
func RunStatisticsOps(t *testing.T) {
	table := []testCase{
...
func RunHighNotPrecedenceMode(t *testing.T) {
	p := parser.New()
	var sb strings.Builder
...
func RunAsOfClause(t *testing.T) {
	table := []testCase{
...
func RunPartitionKeyAlgorithm(t *testing.T) {
	table := []testCase{
...
func RunWithoutCharsetFlags(t *testing.T) {
...
func RunRestoreBinOpWithBrackets(t *testing.T) {
	cases := []testCase{
...
// For CTE bindings.
func RunCTEBindings(t *testing.T) {
	table := []testCase{
...
func RunPlanReplayer(t *testing.T) {
	table := []testCase{
...
func RunTrafficStmt(t *testing.T) {
	table := []testCase{
...
func RunGBKEncoding(t *testing.T) {
	p := parser.New()
...
func RunGB18030Encoding(t *testing.T) {
	p := parser.New()
...
func RunInsertStatementMemoryAllocation(t *testing.T) {
...
func RunCharsetIntroducer(t *testing.T) {
	p := parser.New()
...
func RunNonTransactionalDML(t *testing.T) {
	cases := []testCase{
		// deletes
...
func RunIntervalPartition(t *testing.T) {
	table := []testCase{
...
func RunTTLTableOption(t *testing.T) {
	table := []testCase{
...
func RunIssue45898(t *testing.T) {
	p := parser.New()
	p.ParseSQL("a.")
...
func RunCompatTypes(t *testing.T) {
	table := []testCase{
...
func RunExplainExplore(t *testing.T) {
	cases := []testCase{
...
func RunCompatMariaDB(t *testing.T) {
	cases := []testCase{
...
func RunSecondaryEngineAttribute(t *testing.T) {
	table := []testCase{
...
func RunPartialIndex(t *testing.T) {
	cases := []testCase{
...
func RunTableAffinityOption(t *testing.T) {
	table := []testCase{
...
func RunSplitPartition(t *testing.T) {
	cases := []testCase{
