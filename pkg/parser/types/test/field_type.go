...
func RunHasCharsetFromStmt(t *testing.T) {
...
func RunEnumSetFlen(t *testing.T) {
	p := parser.New()
	cases := []struct {
		sql string
		ex  int
...
func RunFieldTypeEqual(t *testing.T) {
	// tp not equal
...
func RunCompactStr(t *testing.T) {
	cases := []struct {
		t     byte   // Field Type
