...
func RunNewMeterEmptyBucket(t *testing.T) {
...
func RunNewMeterValidConfig(t *testing.T) {
	testCases := []struct {
		name string
		cfg  *mconfig.MeteringConfig
	}{
...
func RunMeterRegisterUnregisterRecorderInClassic(t *testing.T) {
...
func RunMeterRegisterUnregisterRecorder(t *testing.T) {
...
func RunMeterFlush(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("metering is a feature of nextgen")
	}
	ctrl := gomock.NewController(t)
...
func RunMeterRetryWrite(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("metering is a feature of nextgen")
	}
	ctrl := gomock.NewController(t)
...
func RunMeterStartFlushLoop(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("metering is a feature of nextgen")
	}
	ctrl := gomock.NewController(t)
...
func RunMeterClose(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("metering is a feature of nextgen")
	}
	ctrl := gomock.NewController(t)
...
func RunMeterSimpleFlushAndReadBack(t *testing.T) {
	if kerneltype.IsClassic() {
		t.Skip("metering is a feature of nextgen")
	}
