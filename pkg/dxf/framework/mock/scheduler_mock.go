...
// Source: github.com/pingcap/tidb/pkg/dxf/framework/scheduler (interfaces: Scheduler,Cleaner,ExpiredFileCleaner,TaskManager)
//
// Generated by this command:
//
//	mockgen -package mock github.com/pingcap/tidb/pkg/dxf/framework/scheduler Scheduler,Cleaner,ExpiredFileCleaner,TaskManager
//
...
// ISGOMOCK indicates that this struct is a gomock mock.
func (m *MockCleaner) ISGOMOCK() struct{} {
	return struct{}{}
}

// Clean mocks base method.
func (m *MockCleaner) Clean(arg0 context.Context, arg1 *proto.Task) error {
	m.ctrl.T.Helper()
...
func (mr *MockCleanerMockRecorder) Clean(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Clean", reflect.TypeOf((*MockCleaner)(nil).Clean), arg0, arg1)
}

// MockExpiredFileCleaner is a mock of ExpiredFileCleaner interface.
type MockExpiredFileCleaner struct {
	ctrl     *gomock.Controller
	recorder *MockExpiredFileCleanerMockRecorder
}

// MockExpiredFileCleanerMockRecorder is the mock recorder for MockExpiredFileCleaner.
type MockExpiredFileCleanerMockRecorder struct {
	mock *MockExpiredFileCleaner
}

// NewMockExpiredFileCleaner creates a new mock instance.
func NewMockExpiredFileCleaner(ctrl *gomock.Controller) *MockExpiredFileCleaner {
	mock := &MockExpiredFileCleaner{ctrl: ctrl}
	mock.recorder = &MockExpiredFileCleanerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockExpiredFileCleaner) EXPECT() *MockExpiredFileCleanerMockRecorder {
	return m.recorder
}

// ISGOMOCK indicates that this struct is a gomock mock.
func (m *MockExpiredFileCleaner) ISGOMOCK() struct{} {
	return struct{}{}
}

// Clean mocks base method.
func (m *MockExpiredFileCleaner) Clean(arg0 context.Context, arg1 *proto.Task) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Clean", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
...
// Clean indicates an expected call of Clean.
func (mr *MockExpiredFileCleanerMockRecorder) Clean(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Clean", reflect.TypeOf((*MockExpiredFileCleaner)(nil).Clean), arg0, arg1)
}

// CleanExpiredFiles mocks base method.
func (m *MockExpiredFileCleaner) CleanExpiredFiles(arg0 context.Context, arg1 storage.TaskCleanupInfoGetter, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanExpiredFiles", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanExpiredFiles indicates an expected call of CleanExpiredFiles.
func (mr *MockExpiredFileCleanerMockRecorder) CleanExpiredFiles(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanExpiredFiles", reflect.TypeOf((*MockExpiredFileCleaner)(nil).CleanExpiredFiles), arg0, arg1, arg2)
}
...
// GetCleanupTasks mocks base method.
func (m *MockTaskManager) GetCleanupTasks(arg0 context.Context) ([]*proto.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCleanupTasks", arg0)
	ret0, _ := ret[0].([]*proto.Task)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetCleanupTasks indicates an expected call of GetCleanupTasks.
func (mr *MockTaskManagerMockRecorder) GetCleanupTasks(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCleanupTasks", reflect.TypeOf((*MockTaskManager)(nil).GetCleanupTasks), arg0)
}
