...
func RunTaskFailInManager(t *testing.T) {
...
func RunSimpleErrStage(t *testing.T) {
	checkSchedule(t, 1, false, false, false, false)
}

func RunSimpleCancel(t *testing.T) {
	checkSchedule(t, 1, false, true, false, false)
}

func RunSimpleSubtaskCancel(t *testing.T) {
...
func RunParallelErrStage(t *testing.T) {
	checkSchedule(t, 3, false, false, false, false)
}

func RunParallelCancel(t *testing.T) {
	checkSchedule(t, 3, false, true, false, false)
}

func RunParallelSubtaskCancel(t *testing.T) {
...
func RunParallelPause(t *testing.T) {
	checkSchedule(t, 3, false, false, false, true)
}

func RunVerifyTaskStateTransform(t *testing.T) {
	testCases := []struct {
...
func RunIsCancelledErr(t *testing.T) {
...
func RunManagerScheduleLoop(t *testing.T) {
	// Mock 16 cpu node.
