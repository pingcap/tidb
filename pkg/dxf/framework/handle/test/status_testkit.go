...
func RunGetScheduleStatus(t *testing.T) {
...
func RunNodeInfoAndBusyNodes(t *testing.T) {
...
func RunScheduleFlag(t *testing.T) {
...
func RunGetScheduleTuneFactors(t *testing.T) {
	store := testkit.CreateMockStore(t)
	ctx := context.Background()
	// factors not set
