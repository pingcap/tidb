...
func RunGetActiveTaskCountsByKeyspace(t *testing.T) {
	_, gm, ctx := testutil.InitTableTest(t)
	require.NoError(t, gm.InitMeta(ctx, ":4000", ""))
...
func RunSwitchTaskStep(t *testing.T) {
...
func RunGetSubtaskSummaries(t *testing.T) {
	store, tm, ctx := testutil.InitTableTest(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSwitchTaskStepInBatch(t *testing.T) {
	store, tm, ctx := testutil.InitTableTest(t)
	tk := testkit.NewTestKit(t, store)
	...
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/dxf/framework/storage/waitBeforeInsertSubtasks", `1*return(true)`)
...
func RunGetTopUnfinishedTasks(t *testing.T) {
	_, gm, ctx := testutil.InitTableTest(t)
...
func RunGetUsedSlotsOnNodesAndBusyNodes(t *testing.T) {
...
func RunGetActiveSubtasks(t *testing.T) {
...
func RunSubTaskTable(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
	timeBeforeCreate := time.Unix(time.Now().Unix(), 0)
...
func RunBothTaskAndSubTaskTable(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
	require.NoError(t, sm.InitMeta(ctx, ":4000", ""))
	id, err := sm.CreateTask(ctx, "key1", "test", "", 4, "", 0, proto.ExtraParams{}, []byte("test"))
	require.NoError(t, err)
...
func RunGetSubtaskCntByStates(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
...
func RunDistFrameworkMeta(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
...
func RunSubtaskHistoryTable(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
...
func RunTaskHistoryTable(t *testing.T) {
	_, gm, ctx := testutil.InitTableTest(t)
...
func RunPauseAndResume(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
...
func RunCancelAndExecIdChanged(t *testing.T) {
...
func RunTaskNotFound(t *testing.T) {
	_, gm, ctx := testutil.InitTableTest(t)
...
func RunSubtaskType(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
...
func RunRunningSubtasksBack2Pending(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
	subtasks := []*proto.Subtask{
...
func RunSubtasksState(t *testing.T) {
	_, sm, ctx := testutil.InitTableTest(t)
	ts := time.Now()
...
func RunGetActiveTaskExecInfo(t *testing.T) {
	_, tm, ctx := testutil.InitTableTest(t)
...
func RunTaskManagerEntrySize(t *testing.T) {
	store, tm, ctx := testutil.InitTableTest(t)
