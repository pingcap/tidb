...
func getSortedKVMetasOfEncodeStep(ctx context.Context, subTaskMetas [][]byte, store objstore.ExternalStorage) (map[string]*external.SortedKVMeta, error) {
...
func getSortedKVMetasOfMergeStep(ctx context.Context, subTaskMetas [][]byte, store objstore.ExternalStorage) (map[string]*external.SortedKVMeta, error) {
...
func getSortedKVMetasForIngest(planCtx planner.PlanCtx, p *LogicalPlan, store objstore.ExternalStorage) (map[string]*external.SortedKVMeta, error) {
...
func collectConflictInfos(ctx context.Context, store objstore.ExternalStorage, planCtx planner.PlanCtx) (*KVGroupConflictInfos, error) {
