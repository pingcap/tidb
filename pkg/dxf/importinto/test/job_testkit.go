...
func RunSubmitTaskNextgen(t *testing.T) {
...
func RunGetTaskImportedRows(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/domain/MockDisableDistTask", "return(true)")
...
func RunShowImportProgress(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/domain/MockDisableDistTask", "return(true)")
...
func RunShowImportGroup(t *testing.T) {
	testfailpoint.Enable(t, "github.com/pingcap/tidb/pkg/domain/MockDisableDistTask", "return(true)")
...
func RunFormatTime(t *testing.T) {
