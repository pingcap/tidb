...
// Define custom types for context keys to avoid collisions with built-in string type
type contextKey string

func RunSchedulerExtLocalSort(t *testing.T) {
...
func RunSchedulerOnDoneCancelResetsTableMode(t *testing.T) {
...
func RunSchedulerExtGlobalSort(t *testing.T) {
	host := "127.0.0.1"
	port := uint16(4448)
