...
func RunUpdateCopRuntimeStats(t *testing.T) {
	ctx := mock.NewContext()
...
func RunNewSelRespChannelIter(t *testing.T) {
	r := &selectResult{
...
func RunSelRespChannelIterRead(t *testing.T) {
...
func RunSelectResultIter(t *testing.T) {
	intermediateOutputTypes := [][]*types.FieldType{
		{types.NewFieldType(mysql.TypeLong)},
		{types.NewFieldType(mysql.TypeString)},
	}
