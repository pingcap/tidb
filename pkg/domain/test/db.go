...
func RunDomainSession(t *testing.T) {
...
func RunNormalSessionPool(t *testing.T) {
...
func RunAbnormalSessionPool(t *testing.T) {
	lease := 100 * time.Millisecond
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
...
func RunTetchAllSchemasWithTables(t *testing.T) {
	lease := 100 * time.Millisecond
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
...
func RunFetchAllSchemasWithTablesWithFailpoint(t *testing.T) {
	lease := 100 * time.Millisecond
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
