...
func RunCreateAffinityGroupsIfNotExistsUseSkipExistCheck(t *testing.T) {
...
func RunCreateAffinityGroupsIfNotExistsFallbackWhenSkipExistRejected(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunCreateAffinityGroupsIfNotExistsFallbackForHTTPServiceError(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunCreateAffinityGroupsIfNotExistsDoNotFallbackForNonCompatibilityError(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunGetAffinityGroupsFilterDirectResponse(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunGetAffinityGroupsFallbackByEscapedQueryLen(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunGetAffinityGroupsFallbackWhenIDsQueryUnsupported(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunGetAffinityGroupsFallbackForHTTPServiceError(t *testing.T) {
	ctx := context.Background()
	client := &mockPDClient{}
	manager := &pdManager{Client: client}
...
func RunAffinityGroupIDsEscapedQueryLenBoundary(t *testing.T) {
...
func RunShouldUseGetAllAffinityGroupsByIDCount(t *testing.T) {
...
func RunIsPDHTTPStatusErrorMatchByCodeOnly(t *testing.T) {
