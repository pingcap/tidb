...
func TestAcquireRuntimeHandleRejectsEmptyBookkeeper(t *testing.T) {
...
func TestAcquireRuntimeHandleRejectsClassicKernel(t *testing.T) {
...
func TestRuntimeHandleBookkeeperTracking(t *testing.T) {
