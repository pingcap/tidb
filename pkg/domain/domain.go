...
func NewDomainWithEtcdClient(
	...
	do := &Domain{
		...
		dumpFileGcChecker: &dumpFileGcChecker{gcLease: dumpFileGcLease, paths: []string{replayer.GetPlanReplayerDirName(nil), GetOptimizerTraceDirName(), GetExtractTaskDirName()}},
