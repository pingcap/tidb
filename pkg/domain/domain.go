...
func (do *Domain) loadInfoSchema(startTS uint64, isSnapshot bool) (infoschema.InfoSchema, bool, int64, *transaction.RelatedSchemaChange, error) {
	...
	newISBuilder, err := infoschema.NewBuilderV3(do, do.sysFacHack, do.infoCache.Data, useV2).InitWithDBInfos(fullSchemas, schemas, policies, resourceGroups, neededSchemaVersion)
