...
func (m *MockTaskManager) GetSubtaskCntGroupByStates(arg0 context.Context, arg1 int64, arg2 proto.Step) (map[proto.TaskState]int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSubtaskCntGroupByStates", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[proto.TaskState]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTaskManagerMockRecorder) GetSucceedSubtasksByStep(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskManagerMockRecorder) UpdateFailedSchedulerIDs(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
