...
// Source: github.com/pingcap/tidb/pkg/disttask/framework/taskexecutor/execute (interfaces: TaskTable,Pool,TaskExecutor,Extension)
//
// Generated by this command:
//
//	mockgen -package mock github.com/pingcap/tidb/pkg/disttask/framework/taskexecutor/execute TaskTable,Pool,TaskExecutor,Extension
//
...
// UpdateSubtaskRowCount mocks base method.
func (m *MockTaskTable) UpdateSubtaskRowCount(arg0 context.Context, arg1, arg2 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateSubtaskRowCount", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateSubtaskRowCount indicates an expected call of UpdateSubtaskRowCount.
func (mr *MockTaskTableMockRecorder) UpdateSubtaskRowCount(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateSubtaskRowCount", reflect.TypeOf((*MockTaskTable)(nil).UpdateSubtaskRowCount), arg0, arg1, arg2)
}
