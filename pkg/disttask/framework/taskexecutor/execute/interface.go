...
type TaskTable interface {
	...
	// UpdateSubtaskRowCount update the row count in summary field, used for execution summary.
	UpdateSubtaskRowCount(ctx context.Context, subtaskID int64, rowCount int64) error
}
...
type Extension interface {
	...
	GetSubtaskExecutor(ctx context.Context, task *proto.Task, summary *Summary) (SubtaskExecutor, error)
...
var _ SubtaskExecutor = &EmptySubtaskExecutor{}
