...
func TestHandle(t *testing.T) {
	...
	require.NoError(t, err)
	// require.Equal(t, int64(1), task.ID) TODO: unstable for infoschema v2
	...
	require.NoError(t, err)
	// require.Equal(t, int64(2), task.ID) TODO: unstable for infoschema v2
	...
	require.NoError(t, err)
	// require.Equal(t, int64(3), task.ID) TODO: unstable for infoschema v2
