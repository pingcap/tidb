...
func (mgr *TaskManager) CancelTask(ctx context.Context, taskID int64) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error CancelTask")); err != nil {
		return err
	}
...
func (mgr *TaskManager) FailTask(ctx context.Context, taskID int64, currentState proto.TaskState, taskErr error) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error FailTask")); err != nil {
		return err
	}
	_, err := mgr.ExecuteSQLWithNewSession(ctx,
		`update mysql.tidb_global_task
...
func (mgr *TaskManager) RevertTask(ctx context.Context, taskID int64, taskState proto.TaskState, taskErr error) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error RevertTask")); err != nil {
		return err
	}
...
func (mgr *TaskManager) AwaitingResolveTask(ctx context.Context, taskID int64, taskState proto.TaskState, taskErr error) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error AwaitingResolveTask")); err != nil {
		return err
	}
...
func (mgr *TaskManager) RevertedTask(ctx context.Context, taskID int64) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error RevertedTask")); err != nil {
		return err
	}
	_, err := mgr.ExecuteSQLWithNewSession(ctx,
		`update mysql.tidb_global_task
...
func (mgr *TaskManager) PauseTask(ctx context.Context, taskKey string) (bool, error) {
	found := false
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error PauseTask")); err != nil {
		return false, err
	}
...
func (mgr *TaskManager) PausedTask(ctx context.Context, taskID int64) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error PausedTask")); err != nil {
		return err
	}
	_, err := mgr.ExecuteSQLWithNewSession(ctx,
		`update mysql.tidb_global_task
...
func (mgr *TaskManager) ResumedTask(ctx context.Context, taskID int64) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error ResumedTask")); err != nil {
		return err
	}
	_, err := mgr.ExecuteSQLWithNewSession(ctx, `
		update mysql.tidb_global_task
...
func (mgr *TaskManager) ModifiedTask(ctx context.Context, task *proto.Task) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error ModifiedTask")); err != nil {
		return err
	}
...
func (mgr *TaskManager) SucceedTask(ctx context.Context, taskID int64) error {
	if err := injectfailpoint.DXFRandomError(0.01, errors.New("injected random error SucceedTask")); err != nil {
		return err
	}
