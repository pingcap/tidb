...
func RunGetKeyAccessedTableID(t *testing.T) {
...
func RunGetRangeAccessedTableID(t *testing.T) {
	cases := []struct {
		start kv.Key
		end   kv.Key
		ok    bool
...
func RunNotTableRange(t *testing.T) {
	falseCases := [][]kv.Key{
		{nil, nil},
...
func RunGetSessionTemporaryTableKey(t *testing.T) {
...
func RunInterceptorTemporaryTableInfoByID(t *testing.T) {
	is := newMockedInfoSchema(t).
...
func RunInterceptorOnGet(t *testing.T) {
	is := newMockedInfoSchema(t).
		AddTable(model.TempTableNone, 1).
		AddTable(model.TempTableGlobal, 3).
		AddTable(model.TempTableLocal, 5)
...
func RunInterceptorBatchGetTemporaryTableKeys(t *testing.T) {
	localTempTableData := []*kv.Entry{
		{Key: encodeTableKey(5), Value: []byte("v5")},
		{Key: encodeTableKey(5, 0), Value: []byte("v50")},
		{Key: encodeTableKey(5, 1), Value: []byte("v51")},
...
func RunInterceptorOnBatchGet(t *testing.T) {
	is := newMockedInfoSchema(t).
		AddTable(model.TempTableNone, 1).
		AddTable(model.TempTableGlobal, 3).
		AddTable(model.TempTableLocal, 5)
...
func RunCreateUnionIter(t *testing.T) {
...
func RunErrorCreateUnionIter(t *testing.T) {
...
func RunOnIterReverse(t *testing.T) {
	is := newMockedInfoSchema(t).
		AddTable(model.TempTableNone, 1).
		AddTable(model.TempTableGlobal, 3).
		AddTable(model.TempTableLocal, 5)
