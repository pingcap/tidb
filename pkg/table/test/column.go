...
func RunHandleBadNull(t *testing.T) {
	col := newCol("a")
...
func RunGetZeroValue(t *testing.T) {
	tp1 := &types.FieldType{}
...
func RunGetDefaultValue(t *testing.T) {
...
func RunCastValueStrict(t *testing.T) {
