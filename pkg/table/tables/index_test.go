...
func TestExtractColumnsFromCondition(t *testing.T) {
	...
	tblInfo := &model.TableInfo{
		...
		Columns: []*model.ColumnInfo{
			{Name: pmodel.NewCIStr("c1"), Offset: 0, State: model.StatePublic},
			{Name: pmodel.NewCIStr("c2"), Offset: 1, State: model.StatePublic},
			{Name: pmodel.NewCIStr("c3"), Offset: 2, State: model.StatePublic, GeneratedExprString: "c1 + c2", GeneratedStored: false},
			{Name: pmodel.NewCIStr("c4"), Offset: 3, State: model.StatePublic, GeneratedExprString: "c1 + c2", GeneratedStored: true},
		},
	}
	...
	tests := []struct {
		...
		{
			cond:     "c1 AND c2",
			expected: []*model.IndexColumn{{Name: pmodel.NewCIStr("c1"), Offset: 0}, {Name: pmodel.NewCIStr("c2"), Offset: 1}},
			expectedColumnInWithVirtualGeneratedColumn: []*model.IndexColumn{{Name: pmodel.NewCIStr("c1"), Offset: 0}, {Name: pmodel.NewCIStr("c2"), Offset: 1}},
		},
		{
			cond:     "c1 > 100",
			expected: []*model.IndexColumn{{Name: pmodel.NewCIStr("c1"), Offset: 0}},
			expectedColumnInWithVirtualGeneratedColumn: []*model.IndexColumn{{Name: pmodel.NewCIStr("c1"), Offset: 0}},
		},
		{
			cond:     "c3 > 50",
			expected: []*model.IndexColumn{{Name: pmodel.NewCIStr("c3"), Offset: 2}},
			expectedColumnInWithVirtualGeneratedColumn: []*model.IndexColumn{{Name: pmodel.NewCIStr("c1"), Offset: 0}, {Name: pmodel.NewCIStr("c2"), Offset: 1}, {Name: pmodel.NewCIStr("c3"), Offset: 2}},
		},
		{
			cond:     "c4 > 50",
			expected: []*model.IndexColumn{{Name: pmodel.NewCIStr("c4"), Offset: 3}},
			expectedColumnInWithVirtualGeneratedColumn: []*model.IndexColumn{{Name: pmodel.NewCIStr("c4"), Offset: 3}},
		},
	}
