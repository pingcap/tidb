...
func RunPartitionAddRecord(t *testing.T) {
...
func RunHashPartitionAddRecord(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPartitionGetPhysicalID(t *testing.T) {
	createTable1 := `CREATE TABLE test.t1 (id int(11), index(id))
PARTITION BY RANGE ( id ) (
		PARTITION p0 VALUES LESS THAN (6),
		PARTITION p1 VALUES LESS THAN (11),
...
func RunGeneratePartitionExpr(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	_, err := tk.Session().Execute(context.Background(), "use test")
	require.NoError(t, err)
...
func RunLocatePartition(t *testing.T) {
...
func RunIssue31629(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunExchangePartitionStates(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunExchangePartitionCheckConstraintStates(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunExchangePartitionCheckConstraintStatesTwo(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAddKeyPartitionStates(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	dbName := "partSchemaVer"
	tk.MustExec("create database " + dbName)
...
func RunKeyPartitionTableBasic(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunKeyPartitionTableAllFeildType(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPruneModeWarningInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPartitionByIntListExtensivePart(t *testing.T) {
...
func RunPartitionByIntExtensivePart(t *testing.T) {
	limitSizeOfTest := true
	store, dom := testkit.CreateMockStoreAndDomain(t)
	dom.TTLJobManager().Stop()
	tk := testkit.NewTestKit(t, store)
...
func RunGlobalIndexPartitionByIntExtensivePart(t *testing.T) {
	limitSizeOfTest := true
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	schemaName := "PartitionByIntExtensive"
...
func RunPartitionByExtensivePart(t *testing.T) {
	limitSizeOfTest := true
	store, dom := testkit.CreateMockStoreAndDomain(t)
	dom.TTLJobManager().Stop()
	tk := testkit.NewTestKit(t, store)
...
func RunReorgPartExtensivePart(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	dom.TTLJobManager().Stop()
	tk := testkit.NewTestKit(t, store)
...
func RunPointGetKeyPartitioning(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
...
func RunExplainPartition(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
...
func RunPruningOverflow(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
...
func RunPartitionCoverage(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(`use test`)
	tk.MustExec(`set tidb_partition_prune_mode = 'dynamic'`)
...
// Issue TiDB #51090.
func RunAlterTablePartitionRollback(t *testing.T) {
	store := testkit.CreateMockStore(t)
