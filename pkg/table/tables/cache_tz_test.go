...
func TestCachedTableTimestampTZConvert(t *testing.T) {
	...
	tk.MustExec("create table t_ts (id int, ts timestamp)")
...
func TestCachedTableTimestampNULL(t *testing.T) {
	...
	tk.MustExec("use test")
	tk.MustExec("set @@time_zone = '+00:00'")
	tk.MustExec("create table t_ts_null (id int, ts timestamp null)")
...
func TestCachedTableTimestampZero(t *testing.T) {
	...
	tk.MustExec("create table t_ts_zero (id int, ts timestamp null)")
...
func TestCachedTableTimestampFilter(t *testing.T) {
	...
	tk.MustExec("use test")
	tk.MustExec("set @@time_zone = '+00:00'")
	tk.MustExec("create table t_ts_filter (id int, ts timestamp)")
...
func TestCachedTableMultiTimestampCols(t *testing.T) {
	...
	tk.MustExec("use test")
	tk.MustExec("set @@time_zone = '+00:00'")
	tk.MustExec("create table t_multi_ts (id int, created_at timestamp, updated_at timestamp)")
...
func TestCachedTableNoTimestamp(t *testing.T) {
	...
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t_no_ts (id int, name varchar(100), dt datetime)")
...
func TestCachedTableTimestampConsistency(t *testing.T) {
	...
	tk.MustExec("use test")
	tk.MustExec("set @@time_zone = '+00:00'")
	tk.MustExec("create table t_ts_consist (id int, ts timestamp, val varchar(20))")
