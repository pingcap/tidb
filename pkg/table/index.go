...
type Index interface {
	...
	// It will return `true, nil` if the index has no partial condition. It means any row meets the condition.
	MeetPartialConditionWithChunk(row chunk.Row) (bool, error)
	// ColumnsInPartialCondition returns the referenced columns in the partial condition of the index.
	ColumnsInPartialCondition() []*model.ColumnInfo
