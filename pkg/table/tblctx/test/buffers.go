...
func RunEncodeBufferReserve(t *testing.T) {
	stmtBufs, ctx := newMockMutateCtx()
	mb := &mockMemBuffer{}
...
func RunCheckRowBuffer(t *testing.T) {
...
func RunMutateBuffersGetter(t *testing.T) {
	stmtBufs := &variable.WriteStmtBufs{}
	buffers := NewMutateBuffers(stmtBufs)
...
func RunEnsureCapacityAndReset(t *testing.T) {
