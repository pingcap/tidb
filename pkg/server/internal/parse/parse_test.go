...
func TestParseAttrsUnderscoreWarning(t *testing.T) {
	...
	defer variable.ConnectAttrsSize.Store(origSize)
	variable.ConnectAttrsSize.Store(-1)
	...
	t.Run("server may overwrite client _truncated on truncation", func(t *testing.T) {
		...
		defer variable.ConnectAttrsLost.Store(origLost)
		variable.ConnectAttrsLost.Store(0)
		variable.ConnectAttrsSize.Store(20)
