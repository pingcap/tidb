...
func RunPacketIOWrite(t *testing.T) {
...
func RunPacketIOWriteCompressed(t *testing.T) {
...
func RunPacketIORead(t *testing.T) {
...
func RunCompressedWriterShort(t *testing.T) {
...
func RunCompressedWriterLong(t *testing.T) {
	t.Run("zlib", func(t *testing.T) {
...
func RunCompressedReaderShort(t *testing.T) {
...
func RunCompressedReaderLong(t *testing.T) {
	t.Run("zlib", func(t *testing.T) {
...
func RunSubHeaderWithWrongSequenceNumber(t *testing.T) {
	var inBuffer bytes.Buffer
