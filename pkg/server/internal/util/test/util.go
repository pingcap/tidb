...
func RunAppendFormatFloat(t *testing.T) {
...
func RunParseLengthEncodedInt(t *testing.T) {
	testCases := []struct {
		buffer []byte
		num    uint64
		isNull bool
...
func RunParseLengthEncodedBytes(t *testing.T) {
	buffer := []byte{'\xfb'}
...
func RunParseNullTermString(t *testing.T) {
