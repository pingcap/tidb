...
func TestQueryAttributes(t *testing.T) {
	inputs := []dispatchInput{
		{
			com: mysql.ComQuery,
			in:  append([]byte{0x0, 0x01}, append([]byte("SELECT mysql_query_attribute_string('a');"), 0x0)...),
			err: nil,
			out: []byte{0x1, 0x0, 0x0, 0x0, 0x1, 0x37, 0x0, 0x0, 0x1,
				0x3, 0x64, 0x65, 0x66, 0x0, 0x0, 0x0, 0x21, 0x6d, 0x79,
				0x73, 0x71, 0x6c, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f,
				0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x5f,
				0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x28, 0x27, 0x61, 0x27, 0x29,
				0x0, 0xc, 0x2e, 0x0, 0xfc, 0xff, 0x3, 0x0, 0xfd, 0x0, 0x0, 0x1f, 0x0,
				0x0, 0x1, 0x0, 0x0, 0x2, 0xfe, 0x1, 0x0, 0x0, 0x3, 0xfb, 0x1,
				0x0, 0x0, 0x4, 0xfe},
		},
		{
			com: mysql.ComQuery,
			in:  append([]byte{0x1, 0x1, 0x0, 0x1, 0xfe, 0x0, 0x1, 0x61, 0x1, 0x62}, append([]byte("SELECT mysql_query_attribute_string('a');"), 0x0)...),
			err: nil,
			out: []byte{0x1, 0x0, 0x0, 0x5, 0x1, 0x37, 0x0, 0x0, 0x6,
				0x3, 0x64, 0x65, 0x66, 0x0, 0x0, 0x0, 0x21, 0x6d, 0x79,
				0x73, 0x71, 0x6c, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f,
				0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x5f,
				0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x28, 0x27, 0x61, 0x27,
				0x29, 0x0, 0xc, 0x2e, 0x0, 0xfc, 0xff, 0x3, 0x0, 0xfd, 0x0,
				0x0, 0x1f, 0x0, 0x0, 0x1, 0x0, 0x0, 0x7, 0xfe, 0x2, 0x0,
				0x0, 0x8, 0x1, 0x62, 0x1, 0x0, 0x0, 0x9, 0xfe},
		},
	}
	testDispatch(t, inputs, mysql.ClientQueryAttributes)
}
