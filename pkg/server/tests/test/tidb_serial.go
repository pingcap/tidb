...
func RunLoadDataInTransaction(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)

	ts.RunTestLoadDataInTransaction(t)
}

func RunConfigDefaultValue(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
...
func RunLoadDataAutoRandom(t *testing.T) {
...
func RunLoadDataAutoRandomWithSpecialTerm(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)

	ts.RunTestLoadDataAutoRandomWithSpecialTerm(t)
}

func RunExplainFor(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)

	ts.RunTestExplainForConn(t)
}

func RunStmtCount(t *testing.T) {
...
func RunDBStmtCount(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)

	ts.RunTestDBStmtCount(t)
}

func RunLoadDataListPartition(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
...
func RunPrepareExecute(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
...
func RunDefaultCharacterAndCollation(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
