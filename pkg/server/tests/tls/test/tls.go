...
func RunErrorNoRollback(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
...
func RunStatusAPIWithTLS(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
...
func RunStatusAPIWithTLSCNCheck(t *testing.T) {
	ts := servertestkit.CreateTidbTestSuite(t)
