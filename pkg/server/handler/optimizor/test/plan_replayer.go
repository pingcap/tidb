...
//nolint:rowserrcheck // Test code intentionally doesn't check all rows.Err
package test
...
func RunDumpPlanReplayerAPI(t *testing.T) {
...
func RunPlanReplayerLoadWithSemicolonInColumnComment(t *testing.T) {
	origin := config.GetGlobalConfig().TempDir
	defer func() {
		config.GetGlobalConfig().TempDir = origin
	}()
...
func RunPlanReplayerWithMultiForeignKey(t *testing.T) {
	origin := config.GetGlobalConfig().TempDir
	defer func() {
		config.GetGlobalConfig().TempDir = origin
	}()
...
func RunIssue43192(t *testing.T) {
	origin := config.GetGlobalConfig().TempDir
	defer func() {
		config.GetGlobalConfig().TempDir = origin
	}()
...
func RunIssue64802(t *testing.T) {
	testIssue64802(t, false)
}

func RunIssue64802WithPanic(t *testing.T) {
...
func RunDumpPlanReplayerAPIWithHistoryStats(t *testing.T) {
