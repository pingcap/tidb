...
type CreateIndexRequest struct {
	...
	// Parser information for index creation.
...
func (m *GetIndexProgressRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
type GetIndexProgressResponse struct {
	...
	State GetIndexProgressResponse_State `protobuf:"varint,3,opt,name=state,proto3,enum=tici.GetIndexProgressResponse_State" json:"state,omitempty"`
}
...
type PreSplitImportShardMeta struct {
	EleId         int64  `protobuf:"varint,1,opt,name=ele_id,json=eleId,proto3" json:"ele_id,omitempty"`
	StartKey      []byte `protobuf:"bytes,2,opt,name=start_key,json=startKey,proto3" json:"start_key,omitempty"`
	EndKey        []byte `protobuf:"bytes,3,opt,name=end_key,json=endKey,proto3" json:"end_key,omitempty"`
	TotalKvSize   uint64 `protobuf:"varint,4,opt,name=total_kv_size,json=totalKvSize,proto3" json:"total_kv_size,omitempty"`
	TotalKvCnt    uint64 `protobuf:"varint,5,opt,name=total_kv_cnt,json=totalKvCnt,proto3" json:"total_kv_cnt,omitempty"`
	DataFileCount int32  `protobuf:"varint,6,opt,name=data_file_count,json=dataFileCount,proto3" json:"data_file_count,omitempty"`
	StatFileCount int32  `protobuf:"varint,7,opt,name=stat_file_count,json=statFileCount,proto3" json:"stat_file_count,omitempty"`
}

func (m *PreSplitImportShardMeta) Reset()      { *m = PreSplitImportShardMeta{} }
func (*PreSplitImportShardMeta) ProtoMessage() {}
func (*PreSplitImportShardMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{44}
}
func (m *PreSplitImportShardMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PreSplitImportShardMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PreSplitImportShardMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PreSplitImportShardMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreSplitImportShardMeta.Merge(m, src)
}
func (m *PreSplitImportShardMeta) XXX_Size() int {
	return m.Size()
}
func (m *PreSplitImportShardMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_PreSplitImportShardMeta.DiscardUnknown(m)
}

var xxx_messageInfo_PreSplitImportShardMeta proto.InternalMessageInfo

func (m *PreSplitImportShardMeta) GetEleId() int64 {
	if m != nil {
		return m.EleId
	}
	return 0
...
func (m *PreSplitImportShardMeta) GetStartKey() []byte {
	if m != nil {
		return m.StartKey
	}
	return nil
...
func (m *PreSplitImportShardMeta) GetEndKey() []byte {
	if m != nil {
		return m.EndKey
	}
	return nil
...
func (m *PreSplitImportShardMeta) GetTotalKvSize() uint64 {
	if m != nil {
		return m.TotalKvSize
	}
	return 0
}

func (m *PreSplitImportShardMeta) GetTotalKvCnt() uint64 {
	if m != nil {
		return m.TotalKvCnt
	}
	return 0
...
func (m *PreSplitImportShardMeta) GetDataFileCount() int32 {
	if m != nil {
		return m.DataFileCount
	}
	return 0
}

func (m *PreSplitImportShardMeta) GetStatFileCount() int32 {
	if m != nil {
		return m.StatFileCount
	}
	return 0
}
...
type PreSplitImportShardsRequest struct {
	...
	// to multiple indexes, this field should contain all the index IDs.
	IndexIds       []int64                    `protobuf:"varint,3,rep,packed,name=index_ids,json=indexIds,proto3" json:"index_ids,omitempty"`
	ScanSnapshotTs uint64                     `protobuf:"varint,4,opt,name=scan_snapshot_ts,json=scanSnapshotTs,proto3" json:"scan_snapshot_ts,omitempty"`
	...
	TotalKvSize    uint64                     `protobuf:"varint,7,opt,name=total_kv_size,json=totalKvSize,proto3" json:"total_kv_size,omitempty"`
	TotalKvCnt     uint64                     `protobuf:"varint,8,opt,name=total_kv_cnt,json=totalKvCnt,proto3" json:"total_kv_cnt,omitempty"`
	DataFileCount  int32                      `protobuf:"varint,9,opt,name=data_file_count,json=dataFileCount,proto3" json:"data_file_count,omitempty"`
	StatFileCount  int32                      `protobuf:"varint,10,opt,name=stat_file_count,json=statFileCount,proto3" json:"stat_file_count,omitempty"`
	MetaGroups     []*PreSplitImportShardMeta `protobuf:"bytes,11,rep,name=meta_groups,json=metaGroups,proto3" json:"meta_groups,omitempty"`
	// Keyspace ID
	KeyspaceId uint32 `protobuf:"varint,12,opt,name=keyspace_id,json=keyspaceId,proto3" json:"keyspace_id,omitempty"`
}

func (m *PreSplitImportShardsRequest) Reset()      { *m = PreSplitImportShardsRequest{} }
func (*PreSplitImportShardsRequest) ProtoMessage() {}
func (*PreSplitImportShardsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{45}
}
func (m *PreSplitImportShardsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PreSplitImportShardsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PreSplitImportShardsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PreSplitImportShardsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreSplitImportShardsRequest.Merge(m, src)
}
func (m *PreSplitImportShardsRequest) XXX_Size() int {
	return m.Size()
}
func (m *PreSplitImportShardsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_PreSplitImportShardsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_PreSplitImportShardsRequest proto.InternalMessageInfo

func (m *PreSplitImportShardsRequest) GetTidbTaskId() string {
	if m != nil {
		return m.TidbTaskId
	}
	return ""
...
func (m *PreSplitImportShardsRequest) GetTableId() int64 {
	if m != nil {
		return m.TableId
	}
	return 0
...
func (m *PreSplitImportShardsRequest) GetIndexIds() []int64 {
	if m != nil {
		return m.IndexIds
	}
	return nil
...
func (m *PreSplitImportShardsRequest) GetScanSnapshotTs() uint64 {
	if m != nil {
		return m.ScanSnapshotTs
	}
	return 0
}

func (m *PreSplitImportShardsRequest) GetStartKey() []byte {
	if m != nil {
		return m.StartKey
	}
	return nil
...
func (m *PreSplitImportShardsRequest) GetEndKey() []byte {
	if m != nil {
		return m.EndKey
	}
	return nil
...
func (m *PreSplitImportShardsRequest) GetTotalKvSize() uint64 {
	if m != nil {
		return m.TotalKvSize
	}
	return 0
...
func (m *PreSplitImportShardsRequest) GetTotalKvCnt() uint64 {
	if m != nil {
		return m.TotalKvCnt
	}
	return 0
...
func (m *PreSplitImportShardsRequest) GetDataFileCount() int32 {
	if m != nil {
		return m.DataFileCount
	}
	return 0
...
func (m *PreSplitImportShardsRequest) GetStatFileCount() int32 {
	if m != nil {
		return m.StatFileCount
	}
	return 0
...
func (m *PreSplitImportShardsRequest) GetMetaGroups() []*PreSplitImportShardMeta {
	if m != nil {
		return m.MetaGroups
	}
	return nil
...
func (m *PreSplitImportShardsRequest) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
type PreSplitImportIndexResult struct {
	TableId              int64  `protobuf:"varint,1,opt,name=table_id,json=tableId,proto3" json:"table_id,omitempty"`
	IndexId              int64  `protobuf:"varint,2,opt,name=index_id,json=indexId,proto3" json:"index_id,omitempty"`
	SplitCount           uint32 `protobuf:"varint,3,opt,name=split_count,json=splitCount,proto3" json:"split_count,omitempty"`
	ShardCountAfterSplit uint32 `protobuf:"varint,4,opt,name=shard_count_after_split,json=shardCountAfterSplit,proto3" json:"shard_count_after_split,omitempty"`
}

func (m *PreSplitImportIndexResult) Reset()      { *m = PreSplitImportIndexResult{} }
func (*PreSplitImportIndexResult) ProtoMessage() {}
func (*PreSplitImportIndexResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{46}
}
func (m *PreSplitImportIndexResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PreSplitImportIndexResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PreSplitImportIndexResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PreSplitImportIndexResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreSplitImportIndexResult.Merge(m, src)
}
func (m *PreSplitImportIndexResult) XXX_Size() int {
	return m.Size()
}
func (m *PreSplitImportIndexResult) XXX_DiscardUnknown() {
	xxx_messageInfo_PreSplitImportIndexResult.DiscardUnknown(m)
}

var xxx_messageInfo_PreSplitImportIndexResult proto.InternalMessageInfo

func (m *PreSplitImportIndexResult) GetTableId() int64 {
	if m != nil {
		return m.TableId
	}
	return 0
...
func (m *PreSplitImportIndexResult) GetIndexId() int64 {
	if m != nil {
		return m.IndexId
	}
	return 0
...
func (m *PreSplitImportIndexResult) GetSplitCount() uint32 {
	if m != nil {
		return m.SplitCount
	}
	return 0
...
func (m *PreSplitImportIndexResult) GetShardCountAfterSplit() uint32 {
	if m != nil {
		return m.ShardCountAfterSplit
	}
	return 0
}
...
type PreSplitImportShardsResponse struct {
	...
	IndexResults []*PreSplitImportIndexResult `protobuf:"bytes,4,rep,name=index_results,json=indexResults,proto3" json:"index_results,omitempty"`
}

func (m *PreSplitImportShardsResponse) Reset()      { *m = PreSplitImportShardsResponse{} }
func (*PreSplitImportShardsResponse) ProtoMessage() {}
func (*PreSplitImportShardsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{47}
}
func (m *PreSplitImportShardsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PreSplitImportShardsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PreSplitImportShardsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PreSplitImportShardsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreSplitImportShardsResponse.Merge(m, src)
}
func (m *PreSplitImportShardsResponse) XXX_Size() int {
	return m.Size()
}
func (m *PreSplitImportShardsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_PreSplitImportShardsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_PreSplitImportShardsResponse proto.InternalMessageInfo

func (m *PreSplitImportShardsResponse) GetStatus() ErrorCode {
	if m != nil {
		return m.Status
	}
	return ErrorCode_SUCCESS
...
func (m *PreSplitImportShardsResponse) GetErrorMessage() string {
	if m != nil {
		return m.ErrorMessage
	}
	return ""
...
func (m *PreSplitImportShardsResponse) GetSplitKeys() [][]byte {
	if m != nil {
		return m.SplitKeys
	}
	return nil
...
func (m *PreSplitImportShardsResponse) GetIndexResults() []*PreSplitImportIndexResult {
	if m != nil {
		return m.IndexResults
	}
	return nil
}
...
func (*FinishImportPartitionBuildRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{48}
}
...
func (*FinishImportIndexUploadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{49}
}
...
func (*FinishImportResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_80e84b3910d5cd39, []int{50}
}
...
func init() {
	...
	proto.RegisterType((*PreSplitImportShardMeta)(nil), "tici.PreSplitImportShardMeta")
	proto.RegisterType((*PreSplitImportShardsRequest)(nil), "tici.PreSplitImportShardsRequest")
	proto.RegisterType((*PreSplitImportIndexResult)(nil), "tici.PreSplitImportIndexResult")
	proto.RegisterType((*PreSplitImportShardsResponse)(nil), "tici.PreSplitImportShardsResponse")
...
var fileDescriptor_80e84b3910d5cd39 = []byte{
	...
	,
}
...
func (this *PreSplitImportShardMeta) Equal(that interface{}) bool {
	...
	that1, ok := that.(*PreSplitImportShardMeta)
	if !ok {
		that2, ok := that.(PreSplitImportShardMeta)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.TotalKvSize != that1.TotalKvSize {
		return false
	}
	if this.TotalKvCnt != that1.TotalKvCnt {
		return false
	}
	if this.DataFileCount != that1.DataFileCount {
		return false
	}
	if this.StatFileCount != that1.StatFileCount {
		return false
	}
	return true
}
func (this *PreSplitImportShardsRequest) Equal(that interface{}) bool {
	...
	that1, ok := that.(*PreSplitImportShardsRequest)
	if !ok {
		that2, ok := that.(PreSplitImportShardsRequest)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ScanSnapshotTs != that1.ScanSnapshotTs {
		return false
	}
	if !bytes.Equal(this.StartKey, that1.StartKey) {
		return false
	...
	if len(this.MetaGroups) != len(that1.MetaGroups) {
		return false
	}
	for i := range this.MetaGroups {
		if !this.MetaGroups[i].Equal(that1.MetaGroups[i]) {
			return false
		}
	}
	if this.KeyspaceId != that1.KeyspaceId {
...
func (this *PreSplitImportIndexResult) Equal(that interface{}) bool {
	...
	that1, ok := that.(*PreSplitImportIndexResult)
	if !ok {
		that2, ok := that.(PreSplitImportIndexResult)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ShardCountAfterSplit != that1.ShardCountAfterSplit {
		return false
	}
	return true
}
func (this *PreSplitImportShardsResponse) Equal(that interface{}) bool {
	...
	that1, ok := that.(*PreSplitImportShardsResponse)
	if !ok {
		that2, ok := that.(PreSplitImportShardsResponse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.SplitKeys) != len(that1.SplitKeys) {
		return false
	}
	for i := range this.SplitKeys {
		if !bytes.Equal(this.SplitKeys[i], that1.SplitKeys[i]) {
			return false
		}
	}
	if len(this.IndexResults) != len(that1.IndexResults) {
		return false
	}
	for i := range this.IndexResults {
		if !this.IndexResults[i].Equal(that1.IndexResults[i]) {
			return false
		}
	}
	return true
...
func (this *ParserInfo) GoString() string {
	...
	s = append(s, "StopWords: "+fmt.Sprintf("%#v", this.StopWords)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *PreSplitImportShardMeta) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&tici.PreSplitImportShardMeta{")
	s = append(s, "EleId: "+fmt.Sprintf("%#v", this.EleId)+",\n")
	s = append(s, "StartKey: "+fmt.Sprintf("%#v", this.StartKey)+",\n")
	s = append(s, "EndKey: "+fmt.Sprintf("%#v", this.EndKey)+",\n")
	s = append(s, "TotalKvSize: "+fmt.Sprintf("%#v", this.TotalKvSize)+",\n")
	s = append(s, "TotalKvCnt: "+fmt.Sprintf("%#v", this.TotalKvCnt)+",\n")
	s = append(s, "DataFileCount: "+fmt.Sprintf("%#v", this.DataFileCount)+",\n")
	s = append(s, "StatFileCount: "+fmt.Sprintf("%#v", this.StatFileCount)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *PreSplitImportShardsRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 16)
	s = append(s, "&tici.PreSplitImportShardsRequest{")
	s = append(s, "TidbTaskId: "+fmt.Sprintf("%#v", this.TidbTaskId)+",\n")
	s = append(s, "TableId: "+fmt.Sprintf("%#v", this.TableId)+",\n")
	s = append(s, "IndexIds: "+fmt.Sprintf("%#v", this.IndexIds)+",\n")
	s = append(s, "ScanSnapshotTs: "+fmt.Sprintf("%#v", this.ScanSnapshotTs)+",\n")
	s = append(s, "StartKey: "+fmt.Sprintf("%#v", this.StartKey)+",\n")
	s = append(s, "EndKey: "+fmt.Sprintf("%#v", this.EndKey)+",\n")
	s = append(s, "TotalKvSize: "+fmt.Sprintf("%#v", this.TotalKvSize)+",\n")
	s = append(s, "TotalKvCnt: "+fmt.Sprintf("%#v", this.TotalKvCnt)+",\n")
	s = append(s, "DataFileCount: "+fmt.Sprintf("%#v", this.DataFileCount)+",\n")
	s = append(s, "StatFileCount: "+fmt.Sprintf("%#v", this.StatFileCount)+",\n")
	if this.MetaGroups != nil {
		s = append(s, "MetaGroups: "+fmt.Sprintf("%#v", this.MetaGroups)+",\n")
	}
	s = append(s, "KeyspaceId: "+fmt.Sprintf("%#v", this.KeyspaceId)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *PreSplitImportIndexResult) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&tici.PreSplitImportIndexResult{")
	s = append(s, "TableId: "+fmt.Sprintf("%#v", this.TableId)+",\n")
	s = append(s, "IndexId: "+fmt.Sprintf("%#v", this.IndexId)+",\n")
	s = append(s, "SplitCount: "+fmt.Sprintf("%#v", this.SplitCount)+",\n")
	s = append(s, "ShardCountAfterSplit: "+fmt.Sprintf("%#v", this.ShardCountAfterSplit)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *PreSplitImportShardsResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&tici.PreSplitImportShardsResponse{")
	s = append(s, "Status: "+fmt.Sprintf("%#v", this.Status)+",\n")
	s = append(s, "ErrorMessage: "+fmt.Sprintf("%#v", this.ErrorMessage)+",\n")
	s = append(s, "SplitKeys: "+fmt.Sprintf("%#v", this.SplitKeys)+",\n")
	if this.IndexResults != nil {
		s = append(s, "IndexResults: "+fmt.Sprintf("%#v", this.IndexResults)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type MetaServiceClient interface {
	...
	// Called before Import Into full index build to pre-split shards by
	// aggregated SortedKV metadata groups.
	PreSplitImportShards(ctx context.Context, in *PreSplitImportShardsRequest, opts ...grpc.CallOption) (*PreSplitImportShardsResponse, error)
...
func (c *metaServiceClient) PreSplitImportShards(ctx context.Context, in *PreSplitImportShardsRequest, opts ...grpc.CallOption) (*PreSplitImportShardsResponse, error) {
	out := new(PreSplitImportShardsResponse)
	err := c.cc.Invoke(ctx, "/tici.MetaService/PreSplitImportShards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetaServiceServer interface {
	...
	// Called before Import Into full index build to pre-split shards by
	// aggregated SortedKV metadata groups.
	PreSplitImportShards(context.Context, *PreSplitImportShardsRequest) (*PreSplitImportShardsResponse, error)
	// Called by Import DXF to notify Meta Service after a partition for
	// the given index are uploaded.
...
func (*UnimplementedMetaServiceServer) PreSplitImportShards(ctx context.Context, req *PreSplitImportShardsRequest) (*PreSplitImportShardsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreSplitImportShards not implemented")
}
...
func _MetaService_PreSplitImportShards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(MetaServiceServer).PreSplitImportShards(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var _MetaService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PreSplitImportShards",
			Handler:    _MetaService_PreSplitImportShards_Handler,
		},
		{
...
func (m *GetImportStoragePrefixRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IndexIds) > 0 {
		dAtA22 := make([]byte, len(m.IndexIds)*10)
		var j21 int
		...
		i = encodeVarintTici(dAtA, i, uint64(j21))
		i--
		dAtA[i] = 0x1a
	}
	if m.TableId != 0 {
...
func (m *PreSplitImportShardMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PreSplitImportShardMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PreSplitImportShardMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.StatFileCount != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.StatFileCount))
		i--
		dAtA[i] = 0x38
	}
	if m.DataFileCount != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.DataFileCount))
		i--
		dAtA[i] = 0x30
	}
	if m.TotalKvCnt != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.TotalKvCnt))
		i--
		dAtA[i] = 0x28
	}
	if m.TotalKvSize != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.TotalKvSize))
		i--
		dAtA[i] = 0x20
	}
	if len(m.EndKey) > 0 {
	...
	if m.EleId != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.EleId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PreSplitImportShardsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PreSplitImportShardsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PreSplitImportShardsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.MetaGroups) > 0 {
		for iNdEx := len(m.MetaGroups) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.MetaGroups[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.ScanSnapshotTs != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.ScanSnapshotTs))
		i--
		dAtA[i] = 0x20
	}
	if len(m.IndexIds) > 0 {
		dAtA25 := make([]byte, len(m.IndexIds)*10)
		var j24 int
		for _, num1 := range m.IndexIds {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintTici(dAtA, i, uint64(j24))
		i--
		dAtA[i] = 0x1a
	}
	if m.TableId != 0 {
...
func (m *PreSplitImportIndexResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PreSplitImportIndexResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PreSplitImportIndexResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ShardCountAfterSplit != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.ShardCountAfterSplit))
		i--
		dAtA[i] = 0x20
	}
	if m.SplitCount != 0 {
		i = encodeVarintTici(dAtA, i, uint64(m.SplitCount))
		i--
		dAtA[i] = 0x18
	}
	if m.IndexId != 0 {
...
func (m *PreSplitImportShardsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PreSplitImportShardsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PreSplitImportShardsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.IndexResults) > 0 {
		for iNdEx := len(m.IndexResults) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.IndexResults[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.SplitKeys) > 0 {
		for iNdEx := len(m.SplitKeys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTici(dAtA, i, uint64(len(m.SplitKeys[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *PreSplitImportShardMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TotalKvSize != 0 {
		n += 1 + sovTici(uint64(m.TotalKvSize))
	}
	if m.TotalKvCnt != 0 {
		n += 1 + sovTici(uint64(m.TotalKvCnt))
	}
	if m.DataFileCount != 0 {
		n += 1 + sovTici(uint64(m.DataFileCount))
	}
	if m.StatFileCount != 0 {
		n += 1 + sovTici(uint64(m.StatFileCount))
	}
	return n
}

func (m *PreSplitImportShardsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.ScanSnapshotTs != 0 {
		n += 1 + sovTici(uint64(m.ScanSnapshotTs))
	}
	l = len(m.StartKey)
	if l > 0 {
		n += 1 + l + sovTici(uint64(l))
...
func (m *PreSplitImportIndexResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.SplitCount != 0 {
		n += 1 + sovTici(uint64(m.SplitCount))
	}
	if m.ShardCountAfterSplit != 0 {
		n += 1 + sovTici(uint64(m.ShardCountAfterSplit))
	}
	return n
}

func (m *PreSplitImportShardsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ParserInfo) String() string {
	...
	s := strings.Join([]string{`&ParserInfo{`,
		...
		`StopWords:` + fmt.Sprintf("%v", this.StopWords) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PreSplitImportShardMeta) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PreSplitImportShardMeta{`,
		`EleId:` + fmt.Sprintf("%v", this.EleId) + `,`,
		`StartKey:` + fmt.Sprintf("%v", this.StartKey) + `,`,
		`EndKey:` + fmt.Sprintf("%v", this.EndKey) + `,`,
		`TotalKvSize:` + fmt.Sprintf("%v", this.TotalKvSize) + `,`,
		`TotalKvCnt:` + fmt.Sprintf("%v", this.TotalKvCnt) + `,`,
		`DataFileCount:` + fmt.Sprintf("%v", this.DataFileCount) + `,`,
		`StatFileCount:` + fmt.Sprintf("%v", this.StatFileCount) + `,`,
		`}`,
	}, "")
	return s
}
func (this *PreSplitImportShardsRequest) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForMetaGroups := "[]*PreSplitImportShardMeta{"
	for _, f := range this.MetaGroups {
		repeatedStringForMetaGroups += strings.Replace(f.String(), "PreSplitImportShardMeta", "PreSplitImportShardMeta", 1) + ","
	}
	repeatedStringForMetaGroups += "}"
	s := strings.Join([]string{`&PreSplitImportShardsRequest{`,
		`TidbTaskId:` + fmt.Sprintf("%v", this.TidbTaskId) + `,`,
		`TableId:` + fmt.Sprintf("%v", this.TableId) + `,`,
		`IndexIds:` + fmt.Sprintf("%v", this.IndexIds) + `,`,
		`ScanSnapshotTs:` + fmt.Sprintf("%v", this.ScanSnapshotTs) + `,`,
		`StartKey:` + fmt.Sprintf("%v", this.StartKey) + `,`,
		`EndKey:` + fmt.Sprintf("%v", this.EndKey) + `,`,
		`TotalKvSize:` + fmt.Sprintf("%v", this.TotalKvSize) + `,`,
		`TotalKvCnt:` + fmt.Sprintf("%v", this.TotalKvCnt) + `,`,
		`DataFileCount:` + fmt.Sprintf("%v", this.DataFileCount) + `,`,
		`StatFileCount:` + fmt.Sprintf("%v", this.StatFileCount) + `,`,
		`MetaGroups:` + repeatedStringForMetaGroups + `,`,
		`KeyspaceId:` + fmt.Sprintf("%v", this.KeyspaceId) + `,`,
		`}`,
	}, "")
	return s
}
func (this *PreSplitImportIndexResult) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PreSplitImportIndexResult{`,
		`TableId:` + fmt.Sprintf("%v", this.TableId) + `,`,
		`IndexId:` + fmt.Sprintf("%v", this.IndexId) + `,`,
		`SplitCount:` + fmt.Sprintf("%v", this.SplitCount) + `,`,
		`ShardCountAfterSplit:` + fmt.Sprintf("%v", this.ShardCountAfterSplit) + `,`,
		`}`,
	}, "")
	return s
}
func (this *PreSplitImportShardsResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForIndexResults := "[]*PreSplitImportIndexResult{"
	for _, f := range this.IndexResults {
		repeatedStringForIndexResults += strings.Replace(f.String(), "PreSplitImportIndexResult", "PreSplitImportIndexResult", 1) + ","
	}
	repeatedStringForIndexResults += "}"
	s := strings.Join([]string{`&PreSplitImportShardsResponse{`,
		`Status:` + fmt.Sprintf("%v", this.Status) + `,`,
		`ErrorMessage:` + fmt.Sprintf("%v", this.ErrorMessage) + `,`,
		`SplitKeys:` + fmt.Sprintf("%v", this.SplitKeys) + `,`,
		`IndexResults:` + repeatedStringForIndexResults + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PreSplitImportShardMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreSplitImportShardMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreSplitImportShardMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EleId", wireType)
			}
			m.EleId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalKvSize", wireType)
			}
			m.TotalKvSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalKvSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalKvCnt", wireType)
			}
			m.TotalKvCnt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalKvCnt |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DataFileCount", wireType)
			}
			m.DataFileCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DataFileCount |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatFileCount", wireType)
			}
			m.StatFileCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StatFileCount |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PreSplitImportShardsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreSplitImportShardsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreSplitImportShardsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScanSnapshotTs", wireType)
			}
			m.ScanSnapshotTs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ScanSnapshotTs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetaGroups", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MetaGroups = append(m.MetaGroups, &PreSplitImportShardMeta{})
			if err := m.MetaGroups[len(m.MetaGroups)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
func (m *PreSplitImportIndexResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreSplitImportIndexResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreSplitImportIndexResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShardCountAfterSplit", wireType)
			}
			m.ShardCountAfterSplit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTici
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ShardCountAfterSplit |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PreSplitImportShardsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreSplitImportShardsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreSplitImportShardsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexResults", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IndexResults = append(m.IndexResults, &PreSplitImportIndexResult{})
			if err := m.IndexResults[len(m.IndexResults)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
