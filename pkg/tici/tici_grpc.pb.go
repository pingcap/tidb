...
func (c *metaServiceClient) GetCloudStoragePath(ctx context.Context, in *GetCloudStoragePathRequest, opts ...grpc.CallOption) (*GetCloudStoragePathResponse, error) {
	...
	err := c.cc.Invoke(ctx, MetaService_GetCloudStoragePath_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetaService_GetCloudStoragePath_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
