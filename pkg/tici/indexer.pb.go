...
const file_indexer_proto_rawDesc = "" +
	...
	"\x05epoch\x18\x04 \x01(\x04R\x05epoch\"\xf0\x02\n" +
	"\x0fAddShardRequest\x122\n" +
	"\x05shard\x18\x01 \x01(\v2\x1c.indexer.ShardManifestHeaderR\x05shard\x121\n" +
	"\n" +
	"index_info\x18\x02 \x01(\v2\x12.indexer.IndexInfoR\tindexInfo\x121\n" +
	"\n" +
	"table_info\x18\x03 \x01(\v2\x12.indexer.TableInfoR\ttableInfo\x12'\n" +
	...
	"\x06status\x18\x01 \x01(\x05R\x06status\"z\n" +
	...
	"\btable_id\x18\x01 \x01(\x03R\atableId\x12\x19\n" +
	"\bindex_id\x18\x02 \x01(\x03R\aindexId\"\xf8\x02\n" +
	"\x18GetIndexProgressResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12#\n" +
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\x12%\n" +
	"\x0edocument_count\x18\x03 \x01(\x04R\rdocumentCount\x12=\n" +
	"\x05state\x18\x04 \x01(\x0e2'.indexer.GetIndexProgressResponse.StateR\x05state\x12\x1f\n" +
	...
	"\fOTHER_PARSER\x10\x022\xb8\x02\n" +
	...
	"\x10GetIndexProgress\x12 .indexer.GetIndexProgressRequest\x1a!.indexer.GetIndexProgressResponse\x12?\n" +
	"\bAddShard\x12\x18.indexer.AddShardRequest\x1a\x19.indexer.AddShardResponseB\x03Z\x01.b\x06proto3"
