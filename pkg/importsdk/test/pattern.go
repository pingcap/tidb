...
func RunLongestCommonPrefix(t *testing.T) {
...
func RunLongestCommonSuffix(t *testing.T) {
...
func RunGeneratePrefixSuffixPattern(t *testing.T) {
...
func RunGenerateMydumperPattern(t *testing.T) {
...
func RunValidatePattern(t *testing.T) {
...
func RunGenerateWildcardPath(t *testing.T) {
