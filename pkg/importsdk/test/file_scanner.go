...
func RunCreateDataFileMeta(t *testing.T) {
	fi := mydump.FileInfo{
...
func RunProcessDataFiles(t *testing.T) {
...
func RunFileScanner(t *testing.T) {
	tmpDir := t.TempDir()
...
func RunFileScannerWithEstimateRealSize(t *testing.T) {
	tmpDir := t.TempDir()
	ctx := context.Background()
...
func RunFileScannerWithSkipInvalidFiles(t *testing.T) {
	tmpDir := t.TempDir()
	ctx := context.Background()
