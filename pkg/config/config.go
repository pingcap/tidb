...
type Config struct {
	...
	// ExternalStoragePath is used to storage files generated by TiDB.
	ExternalStoragePath string `toml:"external-storage-path" json:"external-storage-path"`
	// PresignedURLTTL is used to control the TTL of the URL that presigned by external storage.
	PresignedURLTTL time.Duration `toml:"presigned-url-ttl" json:"presigned-url-ttl"`
	// AWSWebIdentity is config for aws web identity.
	AWSWebIdentity AWSWebIdentity `toml:"aws-web-identity" json:"aws-web-identity"`

	// EnableAutoAnalyzeSysTable is used to control whether to enable auto analyze system tables.
	EnableAutoAnalyzeSysTable bool
