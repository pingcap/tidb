...
var getConnectionMaxRetry = 10

// ldapTimeout is set to 15s. It works on both the TCP/TLS dialing timeout, and the LDAP request timeout. For connection with TLS, the
...
var ldapTimeout = 15 * time.Second
