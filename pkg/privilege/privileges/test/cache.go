...
func RunLoadUserTable(t *testing.T) {
...
func RunLoadGlobalPrivTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunLoadDBTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunLoadTablesPrivTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunLoadColumnsPrivTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunMatchColumns(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunLoadDefaultRoleTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunPatternMatch(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunCaseInsensitive(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunLoadRoleGraph(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunRoleGraphBFS(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunFindAllUserEffectiveRoles(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunSortUserTable(t *testing.T) {
	p := privileges.NewMySQLPrivilege()
...
func RunGlobalPrivValueRequireStr(t *testing.T) {
	var (
...
func RunDBIsVisible(t *testing.T) {
	store := createStoreAndPrepareDB(t)
