...
func RunCheckDBPrivilege(t *testing.T) {
...
func RunCheckTablePrivilege(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunCheckViewPrivilege(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	rootTk := testkit.NewTestKit(t, store)
...
func RunCheckPrivilegeWithRoles(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	rootTk := testkit.NewTestKit(t, store)
...
// for consistency.
func RunErrorMessage(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunDropTablePrivileges(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunAlterUserStmt(t *testing.T) {
...
func RunShowViewPriv(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunCheckCertBasedAuth(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunCheckAuthenticate(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunConfigPrivilege(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunShowCreateTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunAnalyzeTable(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunSystemSchema(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunPerformanceSchema(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunMetricsSchema(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunAdminCommand(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunLoadDataPrivilege(t *testing.T) {
	// Create file.
...
func RunDefaultRoles(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunUserTableConsistency(t *testing.T) {
...
func RunDynamicPrivs(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunDynamicGrantOption(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunSecurityEnhancedModeRestrictedTables(t *testing.T) {
...
func RunSecurityEnhancedModeInfoschema(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSecurityEnhancedLocalBackupRestore(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunSecurityEnhancedModeSysVars(t *testing.T) {
...
func RunViewDefiner(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunSecurityEnhancedModeRestrictedUsers(t *testing.T) {
...
func RunDynamicPrivsRegistration(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunInfoSchemaUserPrivileges(t *testing.T) {
...
func RunGrantOptionAndRevoke(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunDashboardClientDynamicPriv(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunGrantCreateTmpTables(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunCreateTmpTablesPriv(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunGrantEvent(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunSkipGrantTable(t *testing.T) {
...
func RunIssue29823(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunIssue37488(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunCheckPasswordExpired(t *testing.T) {
...
func RunPasswordExpireWithoutSandBoxMode(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	rootTk := testkit.NewTestKit(t, store)
...
func RunPasswordExpireWithSandBoxMode(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	rootTk := testkit.NewTestKit(t, store)
	rootTk.MustExec(`CREATE USER 'testuser'@'localhost' PASSWORD EXPIRE`)
...
func RunVerificationInfoWithSessionTokenPlugin(t *testing.T) {
...
func RunNilHandleInSkipWithGrant(t *testing.T) {
...
func RunShowGrantsSQLMode(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunEnsureActiveUserCoverage(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSQLVariableAccelerateUserCreationUpdate(t *testing.T) {
	store := createStoreAndPrepareDB(t)
	tk := testkit.NewTestKit(t, store)
...
func RunGrantOptionWithSEMv2(t *testing.T) {
	store := createStoreAndPrepareDB(t)
...
func RunProtectUserAndRoleWithRestrictedPrivileges(t *testing.T) {
