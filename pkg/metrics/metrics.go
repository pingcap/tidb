...
func RegisterMetrics() {
	...
	if err := prometheus.Register(collectors.NewGoCollector(collectors.WithGoCollections(collectors.GoRuntimeMetricsCollection | collectors.GoRuntimeMemStatsCollection))); err != nil {
	...
	prometheus.MustRegister(RemotePlanForwardCounter)
	prometheus.MustRegister(RemotePlanForwardDuration)
	prometheus.MustRegister(RemotePlanExecDuration)
	prometheus.MustRegister(RemotePlanFirstRespDuration)
	prometheus.MustRegister(RemotePlanClientConsumeDuration)
	prometheus.MustRegister(RemotePlanCacheCounter)
	prometheus.MustRegister(RemotePlanBatchClientPendingRequests)
	prometheus.MustRegister(RemotePlanBatchClientActiveStreams)
	prometheus.MustRegister(RemotePlanBatchClientBatchSize)
	prometheus.MustRegister(RemotePlanBatchClientSendChFull)
	prometheus.MustRegister(RemotePlanBatchClientRespChFull)
	prometheus.MustRegister(RemotePlanWorkerPoolWorkers)
	prometheus.MustRegister(RemotePlanWorkerPoolSoftMax)
	prometheus.MustRegister(RemotePlanWorkerPoolHardMax)
	prometheus.MustRegister(RemotePlanWorkerPoolSubmitWaitDuration)
	prometheus.MustRegister(RemotePlanWorkerPoolQueueFull)
	prometheus.MustRegister(RemotePlanWorkerPoolQueueLen)
	prometheus.MustRegister(RemotePlanWorkerPoolBufferFull)
	prometheus.MustRegister(RemotePlanSessionPoolSize)
	prometheus.MustRegister(RemotePlanSessionPoolInUse)
	prometheus.MustRegister(RemotePlanChannelWaitDuration)
	prometheus.MustRegister(RemotePlanChunkDecodeDuration)
	prometheus.MustRegister(RemotePlanRowCopyDuration)
	prometheus.MustRegister(RemotePlanFirstResultWaitDuration)
	prometheus.MustRegister(RemotePlanChunkEncodeDuration)
	prometheus.MustRegister(RemotePlanStreamSendDuration)
	prometheus.MustRegister(RemotePlanChunkRows)
	prometheus.MustRegister(RemotePlanChunkBytes)
	prometheus.MustRegister(RemotePlanGrpcSendDuration)
	prometheus.MustRegister(RemotePlanRespBatchSize)
	prometheus.MustRegister(RemotePlanGrpcRecvDuration)
	prometheus.MustRegister(RemotePlanRSNextDuration)
	prometheus.MustRegister(RemotePlanRSFirstNextDuration)
	prometheus.MustRegister(RemotePlanRespBatchWaitDuration)
	prometheus.MustRegister(RemotePlanRSNextCopCount)
	prometheus.MustRegister(RemotePlanSessionAcquireDuration)
	prometheus.MustRegister(RemotePlanProcessRequestDuration)
