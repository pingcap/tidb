...
func RegisterMetrics() {
	...
	prometheus.MustRegister(RUV2PrewriteRegionNum)
	...
	prometheus.MustRegister(ExplainRUPreviewRUCounter)
	...
	prometheus.MustRegister(ReadBillingDemoStatementsCounter)
	prometheus.MustRegister(ReadBillingDemoOperatorStatusCounter)
	prometheus.MustRegister(ReadBillingDemoBaseUnitsCounter)
	prometheus.MustRegister(ReadBillingDemoRowWidthHistogram)
