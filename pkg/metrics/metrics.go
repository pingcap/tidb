...
func RegisterMetrics() {
	...
	prometheus.MustRegister(NonTransactionalDMLTaskCounter)
	prometheus.MustRegister(NonTransactionalDMLChunkCounter)
	prometheus.MustRegister(NonTransactionalDMLRowsCounter)
	prometheus.MustRegister(NonTransactionalDMLRetryCounter)
	prometheus.MustRegister(NonTransactionalDMLDuration)
