...
func TestExplainRUMetrics(t *testing.T) {
	...
	RecordReadBillingDemoStatement("success", "v2", "weights-v2")
	RecordReadBillingDemoOperatorStatus("tidb", "projection_eval", "projection", "ok", "none", "v2", "weights-v2")
	AddReadBillingDemoBaseUnits("tidb", "projection_eval", "projection", "input_rows", "runtime_chunk_bytes", "all", "v2", "weights-v2", 3)
	AddReadBillingDemoBaseUnits("tikv", "agg_hash", "hashagg", "output_rows", "runtime_operator_act_rows", "all", "v3", "weights-v3", 0)
	AddReadBillingDemoBaseUnits("tidb", "kv_mutation", "memdb_mutation", "cpu_work", "stmt_memdb_mutation_calls", "all", "v6", "test-v6-calibrated", 3.5)
	AddReadBillingDemoBaseUnits("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_count", "stmt_memdb_mutation_calls", "all", "v6", "test-v6-calibrated", 2)
	AddReadBillingDemoBaseUnits("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_bytes", "stmt_memdb_mutation_calls", "all", "v6", "test-v6-calibrated", 15)
	AddReadBillingDemoBaseUnits("tidb", "reader_transport", "mixed_reader", "net_bytes", "ruv2_metrics", "all", "v6", "test-v6-calibrated", 4)
	AddReadBillingDemoBaseUnits("tidb", "sql_frontend", "parser_optimizer", "frontend_compile_bytes", "statement_original_sql", "all", "v6", "test-v6-calibrated", 29)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "scan_bytes", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 74)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "net_bytes", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 17)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "total_keys", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 2)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "processed_keys", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 1)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "processed_keys_size", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 37)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "detail_records", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 1)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "payload_records", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 1)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "completed_responses", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 1)
	AddReadBillingDemoBaseUnits("tikv", "kv_write", "txn_write", "write_keys", "commit_detail", "all", "v6", "test-v6-calibrated", 3)
	AddReadBillingDemoBaseUnits("tikv", "kv_write", "txn_write", "write_bytes", "commit_detail", "all", "v6", "test-v6-calibrated", 66)
	ObserveReadBillingDemoRowWidth("tidb", "projection_eval", "projection", "runtime_chunk_avg", "v2", "weights-v2", 8)
	...
	require.Equal(t, 1.0, readCounterValue(t, ReadBillingDemoStatementsCounter.WithLabelValues("success", "v2", "weights-v2")))
	require.Equal(t, 1.0, readCounterValue(t, ReadBillingDemoOperatorStatusCounter.WithLabelValues("tidb", "projection_eval", "projection", "ok", "none", "v2", "weights-v2")))
	require.Equal(t, 3.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "projection_eval", "projection", "input_rows", "runtime_chunk_bytes", "all", "v2", "weights-v2")))
	require.Equal(t, 3.5, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "kv_mutation", "memdb_mutation", "cpu_work", "stmt_memdb_mutation_calls", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 2.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_count", "stmt_memdb_mutation_calls", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 15.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_bytes", "stmt_memdb_mutation_calls", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 4.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "reader_transport", "mixed_reader", "net_bytes", "ruv2_metrics", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 29.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "sql_frontend", "parser_optimizer", "frontend_compile_bytes", "statement_original_sql", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 74.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "scan_bytes", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 17.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "net_bytes", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 2.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "total_keys", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 1.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "processed_keys", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 37.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "processed_keys_size", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 1.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "detail_records", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 1.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "payload_records", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 1.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "completed_responses", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 3.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_write", "txn_write", "write_keys", "commit_detail", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 66.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_write", "txn_write", "write_bytes", "commit_detail", "all", "v6", "test-v6-calibrated")))
	...
	requireMetricFamilyHasLabels(t, readBillingStatementFamily, "status", "model_version", "weight_version")
	...
	requireMetricFamilyHasLabels(t, readBillingOperatorFamily, "site", "op_class", "operator_kind", "status", "reason", "model_version", "weight_version")
	...
	requireMetricFamilyHasLabels(t, readBillingBaseUnitFamily, "site", "op_class", "operator_kind", "unit", "input_source", "input_side", "model_version", "weight_version")
	...
	requireMetricFamilyHasLabels(t, readBillingRowWidthFamily, "site", "op_class", "operator_kind", "row_width_source", "model_version", "weight_version")
}
...
func TestExplainRUMetricsIgnoreEmptyLabelsAndMissingValues(t *testing.T) {
	...
	RecordReadBillingDemoStatement("", "v2", "weights-v2")
	RecordReadBillingDemoStatement("success", "v2", "")
	RecordReadBillingDemoOperatorStatus("tidb", "projection_eval", "projection", "", "none", "v2", "weights-v2")
	RecordReadBillingDemoOperatorStatus("tidb", "projection_eval", "projection", "ok", "none", "v2", "")
	AddReadBillingDemoBaseUnits("tidb", "projection_eval", "projection", "input_rows", "runtime_chunk_bytes", "all", "v2", "weights-v2", -1)
	AddReadBillingDemoBaseUnits("tidb", "projection_eval", "projection", "input_rows", "runtime_chunk_bytes", "all", "v2", "", 1)
	ObserveReadBillingDemoRowWidth("tidb", "projection_eval", "projection", "runtime_chunk_avg", "v2", "weights-v2", 0)
