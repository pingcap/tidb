...
func TestExplainRUMetrics(t *testing.T) {
	...
	ObserveExplainRURow("plan", "", "projection", "read_billing_model", "runtime_chunk_avg", 1.25, 3, 24, 8)
...
func TestExplainRUMetricsIgnoreEmptyLabelsAndMissingValues(t *testing.T) {
	...
	ObserveExplainRURow("plan", "", "", "read_billing_model", "runtime_chunk_avg", -1, -1, -1, 32)
