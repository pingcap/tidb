...
func TestExplainRUMetrics(t *testing.T) {
	...
	AddReadBillingDemoBaseUnits("tidb", "kv_mutation", "memdb_mutation", "cpu_work", "stmt_memdb_mutation_calls", "all", "v4", "test-v4-calibrated", 3.5)
	AddReadBillingDemoBaseUnits("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_count", "stmt_memdb_mutation_calls", "all", "v4", "test-v4-calibrated", 2)
	AddReadBillingDemoBaseUnits("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_bytes", "stmt_memdb_mutation_calls", "all", "v4", "test-v4-calibrated", 15)
	AddReadBillingDemoBaseUnits("tidb", "reader_transport", "mixed_reader", "read_request_count", "ruv2_metrics", "all", "v4", "test-v4-calibrated", 4)
	AddReadBillingDemoBaseUnits("tikv", "kv_write", "txn_write", "write_request_count", "ruv2_metrics", "all", "v4", "test-v4-calibrated", 2)
	...
	require.Equal(t, 3.5, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "kv_mutation", "memdb_mutation", "cpu_work", "stmt_memdb_mutation_calls", "all", "v4", "test-v4-calibrated")))
	require.Equal(t, 2.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_count", "stmt_memdb_mutation_calls", "all", "v4", "test-v4-calibrated")))
	require.Equal(t, 15.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "kv_mutation", "memdb_mutation", "encoded_mutation_bytes", "stmt_memdb_mutation_calls", "all", "v4", "test-v4-calibrated")))
	require.Equal(t, 4.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tidb", "reader_transport", "mixed_reader", "read_request_count", "ruv2_metrics", "all", "v4", "test-v4-calibrated")))
	require.Equal(t, 2.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_write", "txn_write", "write_request_count", "ruv2_metrics", "all", "v4", "test-v4-calibrated")))
