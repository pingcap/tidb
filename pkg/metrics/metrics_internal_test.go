...
func TestExplainRUMetrics(t *testing.T) {
	...
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "cpu_work", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 2)
	AddReadBillingDemoBaseUnits("tikv", "kv_point_lookup", "point_get", "scan_bytes", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated", 37)
	...
	require.Equal(t, 2.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "cpu_work", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
	require.Equal(t, 37.0, readCounterValue(t, ReadBillingDemoBaseUnitsCounter.WithLabelValues("tikv", "kv_point_lookup", "point_get", "scan_bytes", "snapshot_runtime_stats", "all", "v6", "test-v6-calibrated")))
