...
func RunExtensionFuncCtx(t *testing.T) {
...
func RunInvokeExtensionFunc(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
...
func RunExtensionFuncDynamicArgLen(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
...
func RunRegisterExtensionFunc(t *testing.T) {
	defer extension.Reset()
...
func RunExtensionFuncPrivilege(t *testing.T) {
...
func RunShouldNotOptimizeExtensionFunc(t *testing.T) {
	defer func() {
		extension.Reset()
	}()
