...
func RunSetupExtensions(t *testing.T) {
	defer func() {
		extension.Reset()
	}()
...
func RunExtensionRegisterName(t *testing.T) {
...
func RunRegisterExtensionWithClose(t *testing.T) {
	defer extension.Reset()
...
func RunRegisterExtensionWithDyncPrivs(t *testing.T) {
	defer extension.Reset()
...
func RunRegisterExtensionWithSysVars(t *testing.T) {
	defer extension.Reset()
...
func RunSetVariablePrivilege(t *testing.T) {
...
func RunCustomAccessCheck(t *testing.T) {
...
func RunAuthPluginValidation(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
