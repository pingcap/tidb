...
import (
	// #nosec G505 -- test code for MySQL authentication compatibility
	"crypto/sha1"
	"testing"
...
// #nosec G401 -- test code for MySQL authentication compatibility
...
func RunAuthPlugin(t *testing.T) {
...
func RunAuthPluginSwitchPlugins(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
...
func RunCreateUserWhenGrant(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
...
func RunCreateViewWithPluginUser(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
...
func RunPluginUserModification(t *testing.T) {
	defer extension.Reset()
	extension.Reset()
