...
import (
	...
	ttlclient "github.com/pingcap/tidb/pkg/ttl/client"
...
func RunCommandClient(t *testing.T) {
	...
	etcdCli := ttlclient.ExportedNewCommandClient(etcd)
	mockCli := ttlclient.ExportedNewMockCommandClient()
	...
	for _, cli := range []ttlclient.CommandClient{etcdCli, mockCli} {
