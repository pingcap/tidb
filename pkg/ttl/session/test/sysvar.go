...
func RunSysVarTTLJobEnable(t *testing.T) {
...
func RunSysVarTTLScanBatchSize(t *testing.T) {
...
func RunSysVarTTLScanDeleteBatchSize(t *testing.T) {
	origScanBatchSize := vardef.TTLScanBatchSize.Load()
	defer func() {
		vardef.TTLScanBatchSize.Store(origScanBatchSize)
	}()
...
func RunSysVarTTLScanDeleteLimit(t *testing.T) {
