...
func RunAutoIncPool(t *testing.T) {
	assert := assert.New(t)
...
func RunLockFreePoolBasic(t *testing.T) {
	assert := assert.New(t)
...
func RunLockFreePoolInitEmpty(t *testing.T) {
	assert := assert.New(t)
...
func RunLockFreePoolBasicConcurrencySafety(t *testing.T) {
	assert := assert.New(t)
...
func RunLockBasedPoolConcurrencySafety(t *testing.T) {
	var (
		expected int64
		actual   int64
	)
...
func RunLockFreePoolConcurrencySafety(t *testing.T) {
	const (
		poolSizeInBits = 16
		requests       = 1 << 20
		concurrency    = 1000
