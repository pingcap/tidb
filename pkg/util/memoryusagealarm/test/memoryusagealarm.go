...
func RunIfNeedDoRecord(t *testing.T) {
...
func RunGetTop10Sql(t *testing.T) {
	record := memoryUsageAlarm{
		configProvider: &MockConfigProvider{ratio: 0.7, keepNum: 5, componentName: "test-component"},
	}
	record.initMemoryUsageAlarmRecord()
...
func RunUpdateVariables(t *testing.T) {
...
func RunRecordGoroutineProfileWithBackgroundGoroutine(t *testing.T) {
	recordDir := t.TempDir()
