...
func RunResourceGroupTagEncodingPB(t *testing.T) {
...
func RunGetFirstKeyFromRequest(t *testing.T) {
	...
	require.Equal(t, testK2, resourcegrouptag.GetFirstKeyFromRequest(req))
