...
func RunRaceToCreateTablesWorker(t *testing.T) {
...
func RunMultipleWorker(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunGlobalWorker(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAdminWorkloadRepo(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSamplingTimingWorker(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSnapshotTimingWorker(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunStoppingAndRestartingWorker(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSettingSQLVariables(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	tk := testkit.NewTestKit(t, store)
...
func RunCreatePartition(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	wrk := setupWorker(ctx, t, addr, dom, "worker", true)
	tk := testkit.NewTestKit(t, store)
...
func RunDropOldPartitions(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	wrk := setupWorker(ctx, t, addr, dom, "worker", true)
	tk := testkit.NewTestKit(t, store)
...
func RunAddNewPartitionsOnStart(t *testing.T) {
...
func RunHouseKeeperThread(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
	wrk := setupWorker(ctx, t, addr, dom, "worker", true)
	tk := testkit.NewTestKit(t, store)
...
func RunCalcNextTick(t *testing.T) {
...
func RunOwnerRandomDown(t *testing.T) {
	workerNum := 3
	testNum := 9
...
func RunRecoverSnapID(t *testing.T) {
	ctx, store, dom, addr := setupDomainAndContext(t)
