...
var columnFactoryMap = map[string]columnFactory{
	ClusterTableInstanceColumnNameStr: func(info columnInfo, record *StmtRecord) any {
	...
	StmtTypeStr: func(info columnInfo, record *StmtRecord) any {
		return record.StmtType
	},
	SchemaNameStr: func(info columnInfo, record *StmtRecord) any {
		return convertEmptyToNil(record.SchemaName)
	},
	DigestStr: func(info columnInfo, record *StmtRecord) any {
		return convertEmptyToNil(record.Digest)
	},
	DigestTextStr: func(info columnInfo, record *StmtRecord) any {
		return record.NormalizedSQL
	},
	TableNamesStr: func(info columnInfo, record *StmtRecord) any {
		return convertEmptyToNil(record.TableNames)
	},
	IndexNamesStr: func(info columnInfo, record *StmtRecord) any {
		return convertEmptyToNil(strings.Join(record.IndexNames, ","))
	},
	SampleUserStr: func(info columnInfo, record *StmtRecord) any {
		sampleUser := ""
	...
	ExecCountStr: func(info columnInfo, record *StmtRecord) any {
		return record.ExecCount
	},
	SumErrorsStr: func(info columnInfo, record *StmtRecord) any {
		return record.SumErrors
	},
	SumWarningsStr: func(info columnInfo, record *StmtRecord) any {
		return record.SumWarnings
	},
	SumLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.SumLatency)
	},
	MaxLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxLatency)
	},
	MinLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MinLatency)
	},
	AvgLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumLatency), record.ExecCount)
	},
	AvgParseLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumParseLatency), record.ExecCount)
	},
	MaxParseLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxParseLatency)
	},
	AvgCompileLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumCompileLatency), record.ExecCount)
	},
	MaxCompileLatencyStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxCompileLatency)
	},
	SumCopTaskNumStr: func(info columnInfo, record *StmtRecord) any {
		return record.SumNumCopTasks
	},
	MaxCopProcessTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxCopProcessTime)
	},
	MaxCopProcessAddressStr: func(info columnInfo, record *StmtRecord) any {
		return convertEmptyToNil(record.MaxCopProcessAddress)
	},
	MaxCopWaitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxCopWaitTime)
	},
	MaxCopWaitAddressStr: func(info columnInfo, record *StmtRecord) any {
		return convertEmptyToNil(record.MaxCopWaitAddress)
	},
	AvgProcessTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumProcessTime), record.ExecCount)
	},
	MaxProcessTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxProcessTime)
	},
	AvgWaitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumWaitTime), record.ExecCount)
	},
	MaxWaitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxWaitTime)
	},
	AvgBackoffTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumBackoffTime), record.ExecCount)
	},
	MaxBackoffTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxBackoffTime)
	},
	AvgTotalKeysStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumTotalKeys, record.ExecCount)
	},
	MaxTotalKeysStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxTotalKeys
	},
	AvgProcessedKeysStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumProcessedKeys, record.ExecCount)
	},
	MaxProcessedKeysStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxProcessedKeys
	},
	AvgRocksdbDeleteSkippedCountStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumRocksdbDeleteSkippedCount), record.ExecCount)
	},
	MaxRocksdbDeleteSkippedCountStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxRocksdbDeleteSkippedCount
	},
	AvgRocksdbKeySkippedCountStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumRocksdbKeySkippedCount), record.ExecCount)
	},
	MaxRocksdbKeySkippedCountStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxRocksdbKeySkippedCount
	},
	AvgRocksdbBlockCacheHitCountStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumRocksdbBlockCacheHitCount), record.ExecCount)
	},
	MaxRocksdbBlockCacheHitCountStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxRocksdbBlockCacheHitCount
	},
	AvgRocksdbBlockReadCountStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumRocksdbBlockReadCount), record.ExecCount)
	},
	MaxRocksdbBlockReadCountStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxRocksdbBlockReadCount
	},
	AvgRocksdbBlockReadByteStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumRocksdbBlockReadByte), record.ExecCount)
	},
	MaxRocksdbBlockReadByteStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxRocksdbBlockReadByte
	},
	AvgPrewriteTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumPrewriteTime), record.CommitCount)
	},
	MaxPrewriteTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxPrewriteTime)
	},
	AvgCommitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumCommitTime), record.CommitCount)
	},
	MaxCommitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxCommitTime)
	},
	AvgGetCommitTsTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumGetCommitTsTime), record.CommitCount)
	},
	MaxGetCommitTsTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxGetCommitTsTime)
	},
	AvgCommitBackoffTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumCommitBackoffTime, record.CommitCount)
	},
	MaxCommitBackoffTimeStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxCommitBackoffTime
	},
	AvgResolveLockTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumResolveLockTime, record.CommitCount)
	},
	MaxResolveLockTimeStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxResolveLockTime
	},
	AvgLocalLatchWaitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumLocalLatchTime), record.CommitCount)
	},
	MaxLocalLatchWaitTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxLocalLatchTime)
	},
	AvgWriteKeysStr: func(info columnInfo, record *StmtRecord) any {
		return avgFloat(record.SumWriteKeys, record.CommitCount)
	},
	MaxWriteKeysStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxWriteKeys
	},
	AvgWriteSizeStr: func(info columnInfo, record *StmtRecord) any {
		return avgFloat(record.SumWriteSize, record.CommitCount)
	},
	MaxWriteSizeStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxWriteSize
	},
	AvgPrewriteRegionsStr: func(info columnInfo, record *StmtRecord) any {
		return avgFloat(record.SumPrewriteRegionNum, record.CommitCount)
	},
	MaxPrewriteRegionsStr: func(info columnInfo, record *StmtRecord) any {
		return int(record.MaxPrewriteRegionNum)
	},
	AvgTxnRetryStr: func(info columnInfo, record *StmtRecord) any {
		return avgFloat(record.SumTxnRetry, record.CommitCount)
	},
	MaxTxnRetryStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxTxnRetry
	},
	SumExecRetryStr: func(info columnInfo, record *StmtRecord) any {
		return int(record.ExecRetryCount)
	},
	SumExecRetryTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.ExecRetryTime)
	},
	SumBackoffTimesStr: func(info columnInfo, record *StmtRecord) any {
		return record.SumBackoffTimes
	},
	BackoffTypesStr: func(info columnInfo, record *StmtRecord) any {
		return formatBackoffTypes(record.BackoffTypes)
	},
	AvgMemStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumMem, record.ExecCount)
	},
	MaxMemStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxMem
	},
	AvgDiskStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumDisk, record.ExecCount)
	},
	MaxDiskStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxDisk
	},
	AvgKvTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumKVTotal), record.CommitCount)
	},
	AvgPdTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumPDTotal), record.CommitCount)
	},
	AvgBackoffTotalTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumBackoffTotal), record.CommitCount)
	},
	AvgWriteSQLRespTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumWriteSQLRespTotal), record.CommitCount)
	},
	MaxResultRowsStr: func(info columnInfo, record *StmtRecord) any {
		return record.MaxResultRows
	},
	MinResultRowsStr: func(info columnInfo, record *StmtRecord) any {
		return record.MinResultRows
	},
	AvgResultRowsStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(record.SumResultRows, record.ExecCount)
	},
	PreparedStr: func(info columnInfo, record *StmtRecord) any {
		return record.Prepared
	},
	AvgAffectedRowsStr: func(info columnInfo, record *StmtRecord) any {
	...
	PlanInCacheStr: func(info columnInfo, record *StmtRecord) any {
		return record.PlanInCache
	},
	PlanCacheHitsStr: func(info columnInfo, record *StmtRecord) any {
		return record.PlanCacheHits
	},
	PlanInBindingStr: func(info columnInfo, record *StmtRecord) any {
		return record.PlanInBinding
	},
	QuerySampleTextStr: func(info columnInfo, record *StmtRecord) any {
		return record.SampleSQL
	},
	PrevSampleTextStr: func(info columnInfo, record *StmtRecord) any {
		return record.PrevSQL
	},
	PlanDigestStr: func(info columnInfo, record *StmtRecord) any {
		return record.PlanDigest
	},
	PlanStr: func(info columnInfo, record *StmtRecord) any {
	...
	BinaryPlan: func(info columnInfo, record *StmtRecord) any {
		return record.SampleBinaryPlan
	},
	Charset: func(info columnInfo, record *StmtRecord) any {
		return record.Charset
	},
	Collation: func(info columnInfo, record *StmtRecord) any {
		return record.Collation
	},
	PlanHint: func(info columnInfo, record *StmtRecord) any {
		return record.PlanHint
	},
	AvgRequestUnitRead: func(info columnInfo, record *StmtRecord) any {
		return avgSumFloat(record.SumRRU, record.ExecCount)
	},
	MaxRequestUnitRead: func(info columnInfo, record *StmtRecord) any {
		return record.MaxRRU
	},
	AvgRequestUnitWrite: func(info columnInfo, record *StmtRecord) any {
		return avgSumFloat(record.SumWRU, record.ExecCount)
	},
	MaxRequestUnitWrite: func(info columnInfo, record *StmtRecord) any {
		return record.MaxWRU
	},
	AvgQueuedRcTimeStr: func(info columnInfo, record *StmtRecord) any {
		return avgInt(int64(record.SumRUWaitDuration), record.ExecCount)
	},
	MaxQueuedRcTimeStr: func(info columnInfo, record *StmtRecord) any {
		return int64(record.MaxRUWaitDuration)
	},
	ResourceGroupName: func(info columnInfo, record *StmtRecord) any {
