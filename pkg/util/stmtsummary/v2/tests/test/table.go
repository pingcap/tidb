...
func RunStmtSummaryIndexAdvisor(t *testing.T) {
	setupStmtSummary()
...
func RunStmtSummaryIndexAdvisorNullSchema(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
	store := testkit.CreateMockStore(t)
	tk := newTestKitWithRoot(t, store)
...
func RunStmtSummaryErrorCount(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunStmtSummaryPreparedStatements(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunStmtSummarySensitiveQuery(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunStmtSummaryTableOther(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunStmtSummaryHistoryTableOther(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunPerformanceSchemaforNonPrepPlanCache(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunPlanCacheUnqualified2(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunPlanCacheUnqualified(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
...
func RunPerformanceSchemaforPlanCache(t *testing.T) {
	setupStmtSummary()
	defer closeStmtSummary()
