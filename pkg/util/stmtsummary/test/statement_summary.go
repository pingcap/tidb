...
func RunAddStatement(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
...
func RunAddStatementParallel(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
	// to disable expiration
	ssMap.beginTimeForCurInterval = now + 60
...
func RunMaxStmtCount(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
	// to disable expiration
	ssMap.beginTimeForCurInterval = now + 60
...
func RunMaxSQLLength(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
	// to disable expiration
	ssMap.beginTimeForCurInterval = now + 60
...
func RunFormatSQLClone(t *testing.T) {
...
func RunSetMaxStmtCountParallel(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
	// to disable expiration
	ssMap.beginTimeForCurInterval = now + 60
...
func RunStmtSummaryMetrics(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
...
func RunStmtSummaryMetricsAfterCapacityChange(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
...
func RunDisableStmtSummary(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
...
func RunEnableSummaryParallel(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
...
func RunFormatBackoffTypes(t *testing.T) {
...
func RunRefreshCurrentSummary(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
...
func RunSummaryHistory(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
	now := time.Now().Unix()
	err := ssMap.SetRefreshInterval(10)
	require.NoError(t, err)
...
func RunAccessPrivilege(t *testing.T) {
	ssMap := newStmtSummaryByDigestMap()
