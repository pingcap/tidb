...
func TestAddStatement(t *testing.T) {
	...
	expectedSummaryElement := stmtSummaryByDigestElement{
		...
		stmtSummaryStats: stmtSummaryStats{
			...
			sumMemArbitration: stmtExecInfo1.MemArbitration.Seconds(),
			maxMemArbitration: stmtExecInfo1.MemArbitration.Seconds(),
		},
	}
	...
	expectedSummaryElement.maxMemArbitration = stmtExecInfo2.MemArbitration.Seconds()
	expectedSummaryElement.sumMemArbitration += stmtExecInfo2.MemArbitration.Seconds()
	...
	expectedSummaryElement.sumMemArbitration += stmtExecInfo3.MemArbitration.Seconds()
...
func TestToDatum(t *testing.T) {
	...
	expectedDatum := []any{n, e, "Select", stmtExecInfo1.SchemaName, stmtExecInfo1.Digest, stmtExecInfo1.NormalizedSQL, bindingDigest, bindingSQL,
		...
		fmt.Sprintf("%s:1", boTxnLockName), stmtExecInfo1.MemMax, stmtExecInfo1.MemMax, stmtExecInfo1.MemArbitration.Seconds(), stmtExecInfo1.MemArbitration.Seconds(), stmtExecInfo1.DiskMax, stmtExecInfo1.DiskMax,
