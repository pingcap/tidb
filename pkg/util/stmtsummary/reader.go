...
var columnValueFactoryMap = map[string]columnValueFactory{
	...
	SumUnpackedBytesSentKVTotalStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesSentKVTotal
	},
	SumUnpackedBytesReceivedKVTotalStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesReceivedKVTotal
	},
	SumUnpackedBytesSentKVCrossZoneStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesSentKVCrossZone
	},
	SumUnpackedBytesReceivedKVCrossZoneStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesReceivedKVCrossZone
	},
	SumUnpackedBytesSentMPPTotalStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesSentMPPTotal
	},
	SumUnpackedBytesReceivedMPPTotalStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesReceivedMPPTotal
	},
	SumUnpackedBytesSentMPPCrossZoneStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesSentMPPCrossZone
	},
	SumUnpackedBytesReceiveMPPCrossZoneStr: func(_ *stmtSummaryReader, ssElement *stmtSummaryByDigestElement, _ *stmtSummaryByDigest) any {
		return ssElement.StmtNetworkTrafficSummary.UnpackedBytesReceivedMPPCrossZone
	},
}
