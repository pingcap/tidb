...
func RunTopRUEnableDisableAndResetInterval(t *testing.T) {
...
func RunTopRUItemIntervalLastWriteWins(t *testing.T) {
	GlobalState.ruConsumerCount.Store(0)
	ResetTopRUItemInterval()
...
func RunTopRUItemIntervalRejectsInvalid(t *testing.T) {
	GlobalState.ruConsumerCount.Store(0)
	ResetTopRUItemInterval()
