...
func RunRUItemToProto(t *testing.T) {
	item := ruItem{
		timestamp:    1000,
		totalRU:      100.5,
		execCount:    10,
...
func RunRURecordAdd(t *testing.T) {
...
func RunRURecordMerge(t *testing.T) {
...
func RunRURecordsTopN(t *testing.T) {
...
func RunUserRUCollectingTopNSQLs(t *testing.T) {
...
func RunUserRUCollectingPreTopNSQLCap(t *testing.T) {
	user := newUserRUCollecting("user1")
	extra := 5
...
func RunOthersKeySentinel(t *testing.T) {
...
func RunUserRUCollectingEmptyDigestsGoToOthersRec(t *testing.T) {
...
func RunUserRUCollectingAddOthersFoldsLegacyOthersKey(t *testing.T) {
...
func RunRUCollectingHybridTopN(t *testing.T) {
...
func RunRUCollectingPreTopNUserCap(t *testing.T) {
	collecting := newRUCollecting()
	extra := 5
...
func RunRUCollectingOthersWireLabelNoCollisionWithRuntimeUserShape(t *testing.T) {
...
func RunRUCollectingEmptyUserAndGlobalOthersRemainDistinct(t *testing.T) {
	collecting := newRUCollectingWithCaps(1, 1)
...
func RunRUCollectingMergeFromKeepsEmptyUserDistinctFromGlobalOthers(t *testing.T) {
...
func RunRUCollectingAddBatch(t *testing.T) {
	collecting := newRUCollecting()
...
func RunRUCollectingTake(t *testing.T) {
	collecting := newRUCollecting()
...
func RunRUCollectingCompactAndReportConsistency(t *testing.T) {
...
func RunCompactWithLimits(t *testing.T) {
...
func RunRUItemsSort(t *testing.T) {
	items := ruItems{
		{timestamp: 1002},
		{timestamp: 1000},
		{timestamp: 1001},
...
func RunRUItemsToProto(t *testing.T) {
	items := ruItems{
...
func RunRUCollectingSameBucketSameKeyAccumulates(t *testing.T) {
...
func RunEmptyRUCollecting(t *testing.T) {
	collecting := newRUCollecting()
	compacted := collecting.compactWithLimits(maxTopUsers, maxTopSQLsPerUser)
	var records []tipb.TopRURecord
	if compacted != nil {
