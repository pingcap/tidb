...
func RunDefaultDataSinkRegisterer(t *testing.T) {
...
func RunDefaultDataSinkRegistererTopRUTwoSinksRefCountAndReset(t *testing.T) {
	for topsqlstate.TopRUEnabled() {
		topsqlstate.DisableTopRU()
	}
	topsqlstate.DisableTopSQL()
...
func RunDefaultDataSinkRegistererTopRUDuplicateRegisterIsIdempotent(t *testing.T) {
	for topsqlstate.TopRUEnabled() {
		topsqlstate.DisableTopRU()
	}
	topsqlstate.DisableTopSQL()
...
func RunDefaultDataSinkRegistererTopRURefCountConcurrentRegisterDeregister(t *testing.T) {
	for topsqlstate.TopRUEnabled() {
		topsqlstate.DisableTopRU()
	}
	topsqlstate.DisableTopSQL()
...
func RunDefaultDataSinkRegistererTopSQLRespectsTopRUOnly(t *testing.T) {
	for topsqlstate.TopRUEnabled() {
		topsqlstate.DisableTopRU()
	}
	topsqlstate.DisableTopSQL()
...
func RunDefaultDataSinkRegistererSingleTargetTopRUBehavior(t *testing.T) {
