...
func RunDoReportSendsMetaWhenRURecordsEmpty(t *testing.T) {
...
func RunCollectAndSendBatch(t *testing.T) {
...
func RunCollectAndEvicted(t *testing.T) {
	tsr, ds := setupRemoteTopSQLReporter(t, maxSQLNum, 1)
...
func RunTopRUItemIntervalLifecycleIndependentFromFixedReportTicker(t *testing.T) {
...
func RunCollectAndTopN(t *testing.T) {
...
func RunCollectCapacity(t *testing.T) {
...
func RunCollectInternal(t *testing.T) {
...
func RunMultipleDataSinks(t *testing.T) {
...
func RunReporterWorker(t *testing.T) {
...
func RunProcessStmtStatsData(t *testing.T) {
	restoreTicker := SetReportTickerIntervalSecondsForTest(3)
	t.Cleanup(restoreTicker)
...
func RunReporterChannelsFullDropsAndMetrics(t *testing.T) {
	tsr := NewRemoteTopSQLReporter(mockPlanBinaryDecoderFunc, mockPlanBinaryCompressFunc)
	t.Cleanup(tsr.Close)
...
func RunReporterBackpressureAndDropScenario(t *testing.T) {
	origNowFunc := nowFunc
...
func RunTopRUPipelineInProcessIntegration(t *testing.T) {
	origNowFunc := nowFunc
	var currentUnix int64 = 1
	nowFunc = func() time.Time {
		return time.Unix(atomic.LoadInt64(&currentUnix), 0)
...
func RunTopRUPipelineGracefulShutdown(t *testing.T) {
	origNowFunc := nowFunc
	var currentUnix int64 = 1
	nowFunc = func() time.Time {
		return time.Unix(atomic.LoadInt64(&currentUnix), 0)
...
func RunTopRUHandoverEdgeCases(t *testing.T) {
