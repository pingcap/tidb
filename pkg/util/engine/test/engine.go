...
func RunIsTiFlashHTTPResp(t *testing.T) {
	tests := []struct {
		name  string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			require.Equal(t, tt.want, engine.ExportIsTiFlashHTTPResp(tt.store))
		})
	}
}

func RunIsTiFlashWriteHTTPResp(t *testing.T) {
	tests := []struct {
		name  string
		store *pdhttp.MetaStore
		want  bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			require.Equal(t, tt.want, engine.ExportIsTiFlashWriteHTTPResp(tt.store))
		})
	}
}
