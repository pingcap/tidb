...
func TestCopRuntimeStatsForTiFlash(t *testing.T) {
	...
	require.Equal(t, "tiflash_task:{proc max:2ns, min:1ns, avg: 1ns, p80:2ns, p95:2ns, iters:3, tasks:2, threads:2}, tiflash_scan:{dtfile:{data_scanned_rows:8192, data_skipped_rows:0, mvcc_scanned_rows:0, mvcc_skipped_rows:0, lm_filter_scanned_rows:0, lm_filter_skipped_rows:0, rs_index_check_time: 15ms, read_time: 202ms, disagg_cache_hit_size: 100, disagg_cache_miss_size: 50}, delta_rows: 0, delta_bytes: 0, mvcc_input_rows: 0, mvcc_input_bytes: 0, mvcc_output_rows: 0, lm_skip_rows: 0, segment_num: 0, create_snapshot_time: 40ms, build_bitmap_time: 0ms, build_inputstream_time: 0ms, local_min_stream_cost: 0ms, local_max_stream_cost: 0ms, remote_min_stream_cost: 0ms, remote_max_stream_cost: 0ms, local_region_num: 10, remote_region_num: 4, stale_read_num: 0, learner_read_time: 1ms, region_balance_info: none}", cop.String())
	...
	require.Equal(t, "time:1s, loops:2, threads:1, tiflash_scan:{dtfile:{data_scanned_rows:8192, data_skipped_rows:0, mvcc_scanned_rows:0, mvcc_skipped_rows:0, lm_filter_scanned_rows:0, lm_filter_skipped_rows:0, rs_index_check_time: 15ms, read_time: 200ms, disagg_cache_hit_size: 100, disagg_cache_miss_size: 50}, delta_rows: 0, delta_bytes: 0, mvcc_input_rows: 0, mvcc_input_bytes: 0, mvcc_output_rows: 0, lm_skip_rows: 0, segment_num: 0, create_snapshot_time: 40ms, build_bitmap_time: 0ms, build_inputstream_time: 0ms, local_min_stream_cost: 0ms, local_max_stream_cost: 0ms, remote_min_stream_cost: 0ms, remote_max_stream_cost: 0ms, local_region_num: 10, remote_region_num: 4, stale_read_num: 0, learner_read_time: 1ms, region_balance_info: none}", copStats.String())
	expected := "tiflash_task:{proc max:4ns, min:3ns, avg: 3ns, p80:4ns, p95:4ns, iters:7, tasks:2, threads:2}, tiflash_scan:{dtfile:{data_scanned_rows:20192, data_skipped_rows:86000, mvcc_scanned_rows:0, mvcc_skipped_rows:0, lm_filter_scanned_rows:0, lm_filter_skipped_rows:0, rs_index_check_time: 100ms, read_time: 3000ms, disagg_cache_hit_size: 20, disagg_cache_miss_size: 0}, delta_rows: 0, delta_bytes: 0, mvcc_input_rows: 0, mvcc_input_bytes: 0, mvcc_output_rows: 0, lm_skip_rows: 0, segment_num: 0, create_snapshot_time: 50ms, build_bitmap_time: 0ms, build_inputstream_time: 0ms, local_min_stream_cost: 0ms, local_max_stream_cost: 0ms, remote_min_stream_cost: 0ms, remote_max_stream_cost: 0ms, local_region_num: 6, remote_region_num: 2, stale_read_num: 0, learner_read_time: 0ms, region_balance_info: none}"
