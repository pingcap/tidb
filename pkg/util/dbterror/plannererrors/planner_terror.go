...
var (
	...
	ErrForeignKeyWithCreateAsSelect          = dbterror.ClassOptimizer.NewStd(mysql.ErrForeignKeyWithCreateAsSelect)
	...
	//sp error
	ErrBadDB                   = dbterror.ClassOptimizer.NewStd(mysql.ErrBadDB)
	ErrSpDoesNotExist          = dbterror.ClassOptimizer.NewStd(mysql.ErrSpDoesNotExist)
	ErrSpWrongNoOfArgs         = dbterror.ClassOptimizer.NewStd(mysql.ErrSpWrongNoOfArgs)
	ErrUnknownSystemVariable   = dbterror.ClassOptimizer.NewStd(mysql.ErrUnknownSystemVariable)
	ErrSpVarcondAfterCurshndlr = dbterror.ClassOptimizer.NewStd(mysql.ErrSpVarcondAfterCurshndlr)
	...
	ErrSpLabelRedefine         = dbterror.ClassOptimizer.NewStd(mysql.ErrSpLabelRedefine)
	ErrSpLabelMismatch         = dbterror.ClassOptimizer.NewStd(mysql.ErrSpLabelMismatch)
	ErrSpLilabelMismatch       = dbterror.ClassOptimizer.NewStd(mysql.ErrSpLilabelMismatch)
	ErrSpCursorAlreadyOpen     = dbterror.ClassOptimizer.NewStd(mysql.ErrSpCursorAlreadyOpen)
	ErrSpCursorNotOpen         = dbterror.ClassOptimizer.NewStd(mysql.ErrSpCursorNotOpen)
	ErrSpFetchNoData           = dbterror.ClassOptimizer.NewStd(mysql.ErrSpFetchNoData)
	ErrSpWrongNoOfFetchArgs    = dbterror.ClassOptimizer.NewStd(mysql.ErrSpWrongNoOfFetchArgs)
	ErrSpDupCond               = dbterror.ClassOptimizer.NewStd(mysql.ErrSpDupCond)
	ErrSpDupVar                = dbterror.ClassOptimizer.NewStd(mysql.ErrSpDupVar)
	ErrSpDupCurs               = dbterror.ClassOptimizer.NewStd(mysql.ErrSpDupCurs)
	ErrSpDupParam              = dbterror.ClassOptimizer.NewStd(mysql.ErrSpDupParam)
	ErrSpUndeclaredVar         = dbterror.ClassOptimizer.NewStd(mysql.ErrSpUndeclaredVar)
	ErrSpDupHandler            = dbterror.ClassOptimizer.NewStd(mysql.ErrSpDupHandler)
	ErrSpCaseNotFound          = dbterror.ClassOptimizer.NewStd(mysql.ErrSpCaseNotFound)
	ErrProcaccessDenied        = dbterror.ClassOptimizer.NewStd(mysql.ErrProcaccessDenied)
	ErrSPvarNonintegerType     = dbterror.ClassOptimizer.NewStd(mysql.ErrSPvarNonintegerType)
	ErrUnknownSystemVar        = dbterror.ClassVariable.NewStd(mysql.ErrUnknownSystemVariable)
	ErrPsNoRecursion           = dbterror.ClassOptimizer.NewStd(mysql.ErrPsNoRecursion)
	ErrSpRecursionLimit        = dbterror.ClassOptimizer.NewStd(mysql.ErrSpRecursionLimit)
