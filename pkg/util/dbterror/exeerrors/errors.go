...
var (
	...
	ErrMaterializedViewDisabled            = dbterror.ClassExecutor.NewStdErr(mysql.ErrNotSupportedYet, parser_mysql.Message("materialized view is disabled", nil))
	ErrMaterializedViewOpNotSupported      = dbterror.ClassExecutor.NewStdErr(mysql.ErrNotSupportedYet, parser_mysql.Message("%-.32s %-.32s %-.192s is not supported", nil))
	ErrMaterializedViewLogExists           = dbterror.ClassExecutor.NewStdErr(mysql.ErrNotSupportedYet, parser_mysql.Message("cannot %-.192s: materialized view log exists", nil))
	ErrMaterializedViewDependentExists     = dbterror.ClassExecutor.NewStdErr(mysql.ErrNotSupportedYet, parser_mysql.Message("cannot %-.192s: dependent materialized view exists", nil))
	ErrMaterializedViewReplaceNotSupported = dbterror.ClassExecutor.NewStdErr(mysql.ErrNotSupportedYet, parser_mysql.Message("replace into a table with materialized view log is not supported", nil))
