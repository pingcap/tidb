...
var (
	...
	// ErrTiFlashColumnarStorageNotEnabled returns when adding TiFlash replica on a keyspace whose columnar storage is not enabled.
	...
	// ErrTiFlashColumnarStorageCheckFailed returns when the columnar storage enabled status of the keyspace cannot be verified.
	...
	// ErrWarnDeprecatedZerofill is for when the deprecated zerofill attribute is used
