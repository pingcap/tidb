...
var (
	...
	// ErrDropColumnReferencedByPartialCondition is used when a column is referenced by a partial index condition.
	ErrDropColumnReferencedByPartialCondition = ClassDDL.NewStd(mysql.ErrDropColumnReferencedByPartialCondition)
