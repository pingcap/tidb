...
func RunIsFullRange(t *testing.T) {
...
func RunRangeMemUsage(t *testing.T) {
	r1 := ranger.Range{
...
func RunIntersectionList(t *testing.T) {
	ctx := coretestsdk.MockContext()
...
func RunIntersectionEmpty(t *testing.T) {
	...
	cases := []testCase{
		{expected: "<nil>", start1: []int64{1}, end1: []int64{2}, start2: []int64{3}, end2: []int64{4}, exclLow1: false, exclHigh1: false, exclLow2: false, exclHigh2: false},
		{expected: "<nil>", start1: []int64{1}, end1: []int64{2}, start2: []int64{3}, end2: []int64{4}, exclLow1: true, exclHigh1: false, exclLow2: true, exclHigh2: false},
		{expected: "<nil>", start1: []int64{1}, end1: []int64{2}, start2: []int64{3}, end2: []int64{4}, exclLow1: false, exclHigh1: true, exclLow2: false, exclHigh2: true},
		{expected: "<nil>", start1: []int64{1}, end1: []int64{2}, start2: []int64{3}, end2: []int64{4}, exclLow1: true, exclHigh1: true, exclLow2: true, exclHigh2: true},
		{expected: "<nil>", start1: []int64{1, 2}, end1: []int64{1, 3}, start2: []int64{1, 3}, end2: []int64{1, 4}, exclLow1: false, exclHigh1: false, exclLow2: true, exclHigh2: false},
		{expected: "<nil>", start1: []int64{math.MinInt64}, end1: []int64{1}, start2: []int64{2}, end2: []int64{math.MaxInt64}, exclLow1: false, exclHigh1: false, exclLow2: false, exclHigh2: false},
		{expected: "[1 3,1 3]", start1: []int64{1, 2}, end1: []int64{1, 3}, start2: []int64{1, 3}, end2: []int64{1, 4}, exclLow1: false, exclHigh1: false, exclLow2: false, exclHigh2: false},
		{expected: "<nil>", start1: []int64{1, 1, 2}, end1: []int64{1, 1, 5}, start2: []int64{1, 2}, end2: []int64{1, 3}, exclLow1: false, exclHigh1: false, exclLow2: true, exclHigh2: true},
		{expected: "<nil>", start1: []int64{100, 0}, end1: []int64{100, math.MaxInt64}, start2: []int64{math.MinInt64, math.MinInt64}, end2: []int64{100, math.MinInt64}, exclLow1: true, exclHigh1: false, exclLow2: false, exclHigh2: false},
		{expected: "<nil>", start1: []int64{100, 0}, end1: []int64{100, math.MaxInt64}, start2: []int64{math.MinInt64}, end2: []int64{100}, exclLow1: true, exclHigh1: false, exclLow2: false, exclHigh2: true},
		{expected: "<nil>", start1: []int64{5}, end1: []int64{5}, start2: []int64{5}, end2: []int64{math.MaxInt64}, exclLow1: false, exclHigh1: false, exclLow2: true, exclHigh2: false},
		{expected: "<nil>", start1: []int64{1}, end1: []int64{1}, start2: []int64{5}, end2: []int64{math.MaxInt64}, exclLow1: false, exclHigh1: false, exclLow2: true, exclHigh2: false},
		{expected: "<nil>", start1: []int64{5}, end1: []int64{5}, start2: []int64{5, 1}, end2: []int64{5, math.MaxInt64}, exclLow1: false, exclHigh1: false, exclLow2: true, exclHigh2: false},
		{expected: "<nil>", start1: []int64{1}, end1: []int64{1}, start2: []int64{5, 1}, end2: []int64{5, math.MaxInt64}, exclLow1: false, exclHigh1: false, exclLow2: true, exclHigh2: false},
	}
...
func RunIntersectionSubset(t *testing.T) {
	expectedResult := map[string]string{
		"[1,5] [2,4]":                 "[2,4]",
		"(1,5] (2,4]":                 "(2,4]",
		"[1,5) [2,4)":                 "[2,4)",
	...
	cases := []testCase{
		{low1: []int64{1}, high1: []int64{5}, low2: []int64{2}, high2: []int64{4}, coll1: 1, coll2: 1, lowEx1: false, highEx1: false, lowEx2: false, highEx2: false},
		{low1: []int64{1}, high1: []int64{5}, low2: []int64{2}, high2: []int64{4}, coll1: 1, coll2: 1, lowEx1: true, highEx1: false, lowEx2: true, highEx2: false},
		{low1: []int64{1}, high1: []int64{5}, low2: []int64{2}, high2: []int64{4}, coll1: 1, coll2: 1, lowEx1: false, highEx1: true, lowEx2: false, highEx2: true},
		{low1: []int64{1}, high1: []int64{5}, low2: []int64{2}, high2: []int64{4}, coll1: 1, coll2: 1, lowEx1: true, highEx1: true, lowEx2: true, highEx2: true},
		{low1: []int64{math.MinInt64}, high1: []int64{5}, low2: []int64{2}, high2: []int64{4}, coll1: 1, coll2: 1, lowEx1: false, highEx1: false, lowEx2: false, highEx2: false},
		{low1: []int64{1, 2}, high1: []int64{1, 5}, low2: []int64{1, 3}, high2: []int64{1, 4}, coll1: 2, coll2: 2, lowEx1: false, highEx1: false, lowEx2: true, highEx2: false},
		{low1: []int64{1, 1, math.MinInt64}, high1: []int64{1, 1, 15}, low2: []int64{1, 1}, high2: []int64{1, 1}, coll1: 3, coll2: 2, lowEx1: false, highEx1: false, lowEx2: false, highEx2: false},
	}
...
func RunIntersectionOverlap(t *testing.T) {
	ctx := coretestsdk.MockContext()
	type testCase struct {
