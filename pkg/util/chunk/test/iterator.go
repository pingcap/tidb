...
func RunIteratorOnSel(t *testing.T) {
...
func checkEqual(it chunk.Iterator, exp []int64, t *testing.T) {
...
func RunMultiIterator(t *testing.T) {
	...
	rc = Newchunk.ExportedRowContainer(fields, 1024)
...
func RunChunkIterator(t *testing.T) {
	fields := []*types.FieldType{types.NewFieldType(mysql.TypeLonglong)}
	chk := New(fields, 32, 1024)
	n := 10
	expected := make([]int64, 0, n)
