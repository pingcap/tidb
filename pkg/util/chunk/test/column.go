...
func RunColumnCopy(t *testing.T) {
...
func RunColumnCopyReconstructFixedLen(t *testing.T) {
...
func RunColumnCopyReconstructVarLen(t *testing.T) {
	col := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeVarString), 1024)
...
func RunLargeStringColumnOffset(t *testing.T) {
	numRows := 1
	col := newVarLenchunk.ExportedColumn(numRows)
...
func RunDurationSliceColumn(t *testing.T) {
...
func RunStringColumn(t *testing.T) {
...
func RunJSONColumn(t *testing.T) {
...
func RunTimeColumn(t *testing.T) {
...
func RunDurationColumn(t *testing.T) {
	chk := NewChunkWithCapacity([]*types.FieldType{types.NewFieldType(mysql.TypeDuration)}, 1024)
	col := chk.Column(0)
	for i := range 1024 {
...
func RunEnumColumn(t *testing.T) {
...
func RunNullsColumn(t *testing.T) {
	chk := NewChunkWithCapacity([]*types.FieldType{types.NewFieldType(mysql.TypeLonglong)}, 1024)
	col := chk.Column(0)
	for i := range 1024 {
		if i%2 == 0 {
...
func RunReconstructFixedLen(t *testing.T) {
	col := NewColumn(types.NewFieldType(mysql.TypeLonglong), 1024)
	results := make([]int64, 0, 1024)
	nulls := make([]bool, 0, 1024)
	sel := make([]int, 0, 1024)
...
func RunReconstructVarLen(t *testing.T) {
	col := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeVarString), 1024)
	results := make([]string, 0, 1024)
	nulls := make([]bool, 0, 1024)
	sel := make([]int, 0, 1024)
...
func RunPreAllocInt64(t *testing.T) {
	col := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeLonglong), 128)
...
func RunPreAllocFloat32(t *testing.T) {
	col := newFixedLenchunk.ExportedColumn(sizeFloat32, 128)
...
func RunPreAllocFloat64(t *testing.T) {
	col := newFixedLenchunk.ExportedColumn(sizeFloat64, 128)
...
func RunPreAllocDecimal(t *testing.T) {
	col := newFixedLenchunk.ExportedColumn(sizeMyDecimal, 128)
...
func RunPreAllocTime(t *testing.T) {
	col := newFixedLenchunk.ExportedColumn(sizeTime, 128)
...
func RunNull(t *testing.T) {
	col := newFixedLenchunk.ExportedColumn(sizeFloat64, 32)
...
func RunResizeReserve(t *testing.T) {
	cI64s := newFixedLenchunk.ExportedColumn(sizeInt64, 0)
	...
	cStrs := newVarLenchunk.ExportedColumn(0)
	for range 100 {
		n := rand.Intn(1024)
...
func RunGetRaw(t *testing.T) {
	...
	chk = NewChunkWithCapacity([]*types.FieldType{types.NewFieldType(mysql.TypeVarString)}, 1024)
	col = chk.chunk.ExportedColumn(0)
	for i := range 1024 {
...
func RunResize(t *testing.T) {
	...
	col = Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeFloat), 1024)
	for i := range 1024 {
		col.AppendFloat32(float32(i))
	}
	...
	col = Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeDouble), 1024)
	for i := range 1024 {
		col.AppendFloat64(float64(i))
	}
	...
	col = Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeNewDecimal), 1024)
	for i := range 1024 {
	...
	col = Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeDuration), 1024)
	for i := range 1024 {
	...
	col = Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeDatetime), 1024)
	for range 1024 {
...
func RunReserve(t *testing.T) {
	col := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeVarString), 0)
...
func BenchmarkDurationRow(b *testing.B) {
	...
	col1 := chk1.chunk.ExportedColumn(0)
	for i := range 1024 {
...
func BenchmarkDurationVec(b *testing.B) {
	chk := NewChunkWithCapacity([]*types.FieldType{types.NewFieldType(mysql.TypeDuration)}, 1024)
	col1 := chk.chunk.ExportedColumn(0)
	for i := range 1024 {
		col1.AppendDuration(types.Duration{Duration: time.Second * time.Duration(i)})
	}
...
func genNullCols(n int) []*chunk.Column {
	cols := make([]*chunk.Column, n)
	for i := range cols {
...
func RunVectorizedNulls(t *testing.T) {
	for range 256 {
		cols := genNullCols(4)
...
func RunResetColumn(t *testing.T) {
	col0 := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeVarString), 0)
	col1 := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeLonglong), 0)
	...
	col := Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeDatetime), 0)
...
func RunColumnResizeInt64(t *testing.T) {
	var col = Newchunk.ExportedColumn(types.NewFieldType(mysql.TypeLonglong), 2)
	col.AppendUint64(11)
	col.AppendUint64(11)
