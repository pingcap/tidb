...
func getChk(isLast3ColTheSame bool) (*chunk.Chunk, *chunk.Chunk, []bool) {
	numRows := 1024
...
func RunCopySelectedJoinRows(t *testing.T) {
...
func RunCopySelectedJoinRowsWithoutSameOuters(t *testing.T) {
...
func RunCopySelectedJoinRowsDirect(t *testing.T) {
	srcChk, dstChk, selected := getChk(false)
	numRows := srcChk.NumRows()
	for i := range numRows {
		if !selected[i] {
...
func RunCopySelectedVirtualNum(t *testing.T) {
...
func RunMergeInputIdxToOutputIdxes(t *testing.T) {
	...
	require.Equal(t, output.chunk.ExportedColumn(0), output.chunk.ExportedColumn(1))
	require.Equal(t, output.chunk.ExportedColumn(1), output.chunk.ExportedColumn(2))
	require.Equal(t, output.chunk.ExportedColumn(2), output.chunk.ExportedColumn(3))
