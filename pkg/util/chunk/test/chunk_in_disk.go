...
func stripAuxDataForChunk(chk *chunk.Chunk) {
	chk.capacity = 0
	chk.requiredRows = 0
...
func addAuxDataForChunks(chunks []*chunk.Chunk) {
...
func checkAuxDataForChunk(t *testing.T, chk1, chk2 *chunk.Chunk) {
...
func checkChunk(t *testing.T, chk1, chk2 *chunk.Chunk) {
...
func RunDataInDiskByChunks(t *testing.T) {
	testGetChunk(t)
	testFillChunk(t)
}
