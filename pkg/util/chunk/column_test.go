...
func TestReserve(t *testing.T) {
	...
	require.GreaterOrEqual(t, cap(col.data), 10)
	require.GreaterOrEqual(t, cap(col.offsets), 11)
	require.GreaterOrEqual(t, cap(col.nullBitmap), 10)
	...
	require.GreaterOrEqual(t, cap(col.data), 105)
	require.GreaterOrEqual(t, cap(col.offsets), 106)
	require.GreaterOrEqual(t, cap(col.nullBitmap), 105)
