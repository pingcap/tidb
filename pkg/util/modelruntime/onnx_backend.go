...
func (*onnxBackend) Infer(_ context.Context, artifact Artifact, inputNames, outputNames []string, inputs []float32, opts InferenceOptions) ([]float32, error) {
...
func (*onnxBackend) InferBatch(_ context.Context, artifact Artifact, inputNames, outputNames []string, inputs [][]float32, opts InferenceOptions) ([][]float32, error) {
	key := SessionKeyFromParts(artifact.ModelID, artifact.Version, inputNames, outputNames)
