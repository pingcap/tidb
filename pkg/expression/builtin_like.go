...
func (c *likeFunctionClass) getFunction(ctx BuildContext, cc CloneContext, args []Expression) (builtinFunc, error) {
...
func (b *builtinLikeSig) Clone(cc CloneContext) builtinFunc {
