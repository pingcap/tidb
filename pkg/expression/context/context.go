...
// StaticalizableExprContext provides more methods to implement the clone of a `ExprContext`
type StaticalizableExprContext interface {
	ExprContext

	GetStaticalizableEvalContext() StaticalizableEvalContext
	GetPlanCacheTracker() *contextutil.PlanCacheTracker
	GetLastPlanColumnID() int64
}

// StaticalizableEvalContext provides more methods to implement the clone of a `EvalContext`
type StaticalizableEvalContext interface {
	EvalContext
