...
func RunSessionEvalContextBasic(t *testing.T) {
	ctx := mock.NewContext()
...
func RunSessionEvalContextCurrentTime(t *testing.T) {
	ctx := mock.NewContext()
	vars := ctx.GetSessionVars()
	sc := vars.StmtCtx
	impl := sessionexpr.NewEvalContext(ctx)
...
func RunSessionEvalContextPrivilegeCheck(t *testing.T) {
	ctx := mock.NewContext()
	impl := sessionexpr.NewEvalContext(ctx)
...
func RunSessionEvalContextOptProps(t *testing.T) {
	ctx := mock.NewContext()
	impl := sessionexpr.NewEvalContext(ctx)
...
func RunSessionBuildContext(t *testing.T) {
	ctx := mock.NewContext()
