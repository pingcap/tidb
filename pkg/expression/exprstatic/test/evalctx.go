...
func RunNewStaticEvalCtx(t *testing.T) {
	// default context
...
func RunStaticEvalCtxCurrentTime(t *testing.T) {
...
func RunStaticEvalCtxWarnings(t *testing.T) {
...
func RunStaticEvalContextOptionalProps(t *testing.T) {
	ctx := NewEvalContext()
	require.True(t, ctx.GetOptionalPropSet().IsEmpty())
...
func RunUpdateStaticEvalContext(t *testing.T) {
...
func RunMakeEvalContextStatic(t *testing.T) {
...
func RunEvalCtxLoadSystemVars(t *testing.T) {
	vars := []struct {
		name   string
		val    string
		field  string
