...
func RunNewStaticExprCtx(t *testing.T) {
...
func RunStaticExprCtxApplyOptions(t *testing.T) {
	ctx := NewExprContext()
...
func RunExprCtxColumnIDAllocator(t *testing.T) {
	// default
	ctx := NewExprContext()
...
func RunMakeExprContextStatic(t *testing.T) {
...
func RunExprCtxLoadSystemVars(t *testing.T) {
	vars := []struct {
		name   string
		val    string
		field  string
