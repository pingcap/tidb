...
func checkDefaultStaticExprCtx(t *testing.T, ctx *ExprContext) {
	checkDefaultStaticEvalCtx(t, ctx.GetEvalCtx().(*EvalContext))
...
func checkOptionsStaticExprCtx(t *testing.T, ctx *ExprContext, s *exprCtxOptionsTestState) {
