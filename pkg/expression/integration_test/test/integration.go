...
func RunFTSIndexSyntax(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, 1*time.Second, mockstore.WithMockTiFlash(2))
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunVectorLong(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, 1*time.Second, mockstore.WithMockTiFlash(2))
...
func RunVectorDefaultValue(t *testing.T) {
...
func RunVectorColumnInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunVectorExplainTruncate(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunVectorConstantExplain(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("CREATE TABLE t(c VECTOR);")
...
func RunVectorIndexExplain(t *testing.T) {
	store := testkit.CreateMockStoreWithSchemaLease(t, 1*time.Second, mockstore.WithMockTiFlash(2))
...
func RunFixedVector(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunVectorOperators(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorConversion(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorAssignVariable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorControlFlow(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorStringCompare(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorAggregations(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorWindow(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorIndexSyntax(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("USE test;")
...
func RunVectorSetOperation(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorArithmatic(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorFunctions(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorMiscFunctions(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunVectorSearchExtractProj(t *testing.T) {
	{
...
func RunVectorSearchPreparedStatement(t *testing.T) {
	store, _ := testkit.CreateMockStoreAndDomainWithSchemaLease(t, 200*time.Millisecond, mockstore.WithMockTiFlash(1))
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("USE test;")
...
func RunInfoBuiltin(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunFilterExtractFromDNF(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBDecodeKeyFunc(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBEncodeKey(t *testing.T) {
...
func RunShardIndexOnTiFlash(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunExprPushdownBlacklist(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunDecodetoChunkReuse(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue16697(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSecurityEnhancedMode(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunBuiltinFuncJSONMergePatch_InColumn(t *testing.T) {
	ctx := context.Background()
	store := testkit.CreateMockStore(t)
...
func RunBuiltinFuncJSONMergePatch_InExpression(t *testing.T) {
	ctx := context.Background()
	store := testkit.CreateMockStore(t)
...
func RunPrimaryKeyRequiredSysvar(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCastJSONTimeDuration(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunCompareBuiltin(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTimeBuiltin(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSetVariables(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPreparePlanCacheOnCachedTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue16205(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBRowChecksumBuiltinAfterDropColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBRowChecksumBuiltinAfterAddColumn(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBRowChecksumBuiltin(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunIssue43527(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue51842(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t;")
...
func RunIssue44706(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue55885(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue55886(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunIssue57608(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t1;")
...
func RunDeepCopyRetType(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
