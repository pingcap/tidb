...
func TestFTSIndexSyntax(t *testing.T) {
	...
	tk.MustQuery("show create table t1").Check(testkit.Rows("t1 CREATE TABLE `t1` (\n  `title` text DEFAULT NULL,\n  `body` text DEFAULT NULL,\n  FULLTEXT INDEX `FTSIdx`(`title`,`body`) WITH PARSER NGRAM\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin"))
	tk.MustExec("alter table t1 drop index FTSIdx")
	tk.MustExec("alter table t1 add FULLTEXT INDEX FTSIdx(title, body) WITH PARSER 	MULTILINGUAL;")
	tk.MustQuery("show create table t1").Check(testkit.Rows("t1 CREATE TABLE `t1` (\n  `title` text DEFAULT NULL,\n  `body` text DEFAULT NULL,\n  FULLTEXT INDEX `FTSIdx`(`title`,`body`) WITH PARSER MULTILINGUAL\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin"))
	tk.MustExec("alter table t1 drop index FTSIdx")
