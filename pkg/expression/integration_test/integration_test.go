...
func TestTimeBuiltin(t *testing.T) {
	...
	tk.MustQuery(`select months_between(DATE('2003-01-06'),DATE('2003-05-06 12:05:55'))`).Check(testkit.Rows("-4"))
	tk.MustQuery(`select months_between(DATE('2003-02-01'),DATE('2003-05-06 12:05:55'))`).Check(testkit.Rows("-3.1775519"))
	tk.MustQuery(`select months_between(DATE('2003-05-06 12:05:55'),DATE('2003-02-01'))`).Check(testkit.Rows("3.1775519"))
