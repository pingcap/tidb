...
func TestTruncateLongString(t *testing.T) {
	...
	tk.MustQuery("explain format = 'brief' select * from t where id < 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbb' order by id limit 1").Check(testkit.Rows(
		"TopN 1.00 root  test.t.id, offset:0, count:1",
		"└─TableReader 1.00 root  data:TopN",
		"  └─TopN 1.00 cop[tikv]  test.t.id, offset:0, count:1",
		"    └─Selection 3323.33 cop[tikv]  lt(test.t.id, \"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\"...(len:140))",
