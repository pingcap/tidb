...
func TestTiDBEncodeKey(t *testing.T) {
	...
	rs := tk.MustQuery("select tidb_mvcc_info('7480000000000000775f728000000000000001');")
	...
	require.NoError(t, err)
	err = tk2.QueryToErr("select tidb_mvcc_info('7480000000000000775f728000000000000001');")
