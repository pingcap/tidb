...
func TestCompareBuiltin(t *testing.T) {
	...
	tk.MustExec(`drop table if exists t_bigint_unsigned`)
	tk.MustExec(`create table t_bigint_unsigned (a bigint unsigned, b bigint unsigned)`)
	tk.MustExec(`insert into t_bigint_unsigned values (9223372036854775807, 9223372036854775808)`)
	result = tk.MustQuery(`select /* issue:66244 */ greatest(a, b), least(a, b) from t_bigint_unsigned`)
	result.Check(testkit.Rows("9223372036854775808 9223372036854775807"))
	result = tk.MustQuery(`select greatest(b, a), least(b, a) from t_bigint_unsigned`)
	result.Check(testkit.Rows("9223372036854775808 9223372036854775807"))
	result = tk.MustQuery(`select greatest(cast(9223372036854775807 as unsigned), cast(9223372036854775808 as unsigned)), least(cast(9223372036854775807 as unsigned), cast(9223372036854775808 as unsigned))`)
	result.Check(testkit.Rows("9223372036854775808 9223372036854775807"))
	result = tk.MustQuery(`select greatest(a, cast(9223372036854775808 as unsigned)), least(a, cast(9223372036854775808 as unsigned)) from t_bigint_unsigned`)
	result.Check(testkit.Rows("9223372036854775808 9223372036854775807"))
	result = tk.MustQuery(`select greatest(b, cast(9223372036854775807 as unsigned)), least(b, cast(9223372036854775807 as unsigned)) from t_bigint_unsigned`)
	result.Check(testkit.Rows("9223372036854775808 9223372036854775807"))
