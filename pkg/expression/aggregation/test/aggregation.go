...
func RunAvgFinalMode(t *testing.T) {
	s := createAggFuncSuite()
...
func RunAggFuncDesc(t *testing.T) {
	s := createAggFuncSuite()
	col := &expression.Column{
		Index:   0,
		RetType: types.NewFieldType(mysql.TypeLonglong),
