...
func (*baseBuiltinFunc) vecEvalVectorFloat32(*chunk.Chunk, *chunk.Column) error {
...
func (*baseBuiltinFunc) evalVectorFloat32(chunk.Row) (types.VectorFloat32, bool, error) {
