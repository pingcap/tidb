...
func TestInferType(t *testing.T) {
	...
	sql := `create table t (
		...
		c_decimal_f decimal(3, 3),
		c_udecimal_f decimal(3, 3) unsigned,
		c_decimal_d decimal,
...
func (s *InferTypeSuite) createTestCase4ControlFuncs() []typeInferTestCase {
	return []typeInferTestCase{
		...
		{"ifnull(c_decimal_d, '')", mysql.TypeVarchar, charset.CharsetUTF8MB4, mysql.BinaryFlag | mysql.NotNullFlag, 11, types.UnspecifiedLength},
		{"ifnull(c_decimal, '')", mysql.TypeVarchar, charset.CharsetUTF8MB4, mysql.BinaryFlag | mysql.NotNullFlag, 8, types.UnspecifiedLength},
		{"ifnull(c_udecimal, '')", mysql.TypeVarchar, charset.CharsetUTF8MB4, mysql.BinaryFlag | mysql.NotNullFlag, 11, types.UnspecifiedLength},
		{"ifnull(c_decimal_f, '')", mysql.TypeVarchar, charset.CharsetUTF8MB4, mysql.BinaryFlag | mysql.NotNullFlag, 6, types.UnspecifiedLength},
		{"ifnull(c_udecimal_f, '')", mysql.TypeVarchar, charset.CharsetUTF8MB4, mysql.BinaryFlag | mysql.NotNullFlag, 5, types.UnspecifiedLength},
