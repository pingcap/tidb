...
func RunReadCounter(t *testing.T) {
...
func RunReadHistogramSum(t *testing.T) {
...
func RunRecordEngineCount(t *testing.T) {
...
func RunMetricsRegister(t *testing.T) {
...
func RunMetricsUnregister(t *testing.T) {
	m := metric.NewMetrics(promutil.NewDefaultFactory())
	r := prometheus.NewRegistry()
	m.RegisterTo(r)
	m.UnregisterFrom(r)
