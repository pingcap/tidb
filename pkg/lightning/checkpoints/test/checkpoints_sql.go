...
func RunNormalOperations(t *testing.T) {
...
func RunNormalOperationsWithAddIndexBySQL(t *testing.T) {
	ctx := context.Background()
	s := newCPSQLSuite(t)
	cpdb := s.cpdb
...
func RunRemoveAllCheckpoints_SQL(t *testing.T) {
	s := newCPSQLSuite(t)
...
func RunRemoveOneCheckpoint_SQL(t *testing.T) {
	s := newCPSQLSuite(t)
...
func RunIgnoreAllErrorCheckpoints_SQL(t *testing.T) {
	s := newCPSQLSuite(t)
...
func RunIgnoreOneErrorCheckpoint(t *testing.T) {
	s := newCPSQLSuite(t)
...
func RunDestroyAllErrorCheckpoints_SQL(t *testing.T) {
	s := newCPSQLSuite(t)
...
func RunDestroyOneErrorCheckpoints(t *testing.T) {
	s := newCPSQLSuite(t)
...
func RunMoveCheckpoints(t *testing.T) {
	ctx := context.Background()
	s := newCPSQLSuite(t)
