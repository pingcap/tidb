...
func RunMergeKVIter(t *testing.T) {
...
func RunOneUpstream(t *testing.T) {
	ctx := context.Background()
	memStore := objstore.NewMemStorage()
...
func RunCorruptContent(t *testing.T) {
	ctx := context.Background()
	memStore := objstore.NewMemStorage()
	filenames := []string{"/test1", "/test2"}
	data := [][][2]string{
...
func RunMergeIterSwitchMode(t *testing.T) {
	seed := time.Now().Unix()
...
func RunReadAfterCloseConnReader(t *testing.T) {
	ctx := context.Background()
...
func RunMemoryUsageWhenHotspotChange(t *testing.T) {
...
func RunLimitSizeMergeIter(t *testing.T) {
	ctx := context.Background()
...
func RunLimitSizeMergeIterDiffWeight(t *testing.T) {
	ctx := context.Background()
	refCnt := atomic.NewInt64(0)
	readerOpeners := buildOpener([][]int{
		{1, 4, 7}, {2, 5}, {3},
...
func RunMergePropBaseIter(t *testing.T) {
...
func RunEmptyBaseReader4LimitSizeMergeIter(t *testing.T) {
	fileNum := 100
	filenames := make([]string, fileNum)
	for i := range filenames {
		filenames[i] = fmt.Sprintf("/test%06d", i)
...
func RunCloseLimitSizeMergeIterHalfway(t *testing.T) {
	fileNum := 10000
	filenames := make([]string, fileNum)
	for i := range filenames {
		filenames[i] = fmt.Sprintf("/test%06d", i)
...
func RunMergeKVIterPassWrongParam(t *testing.T) {
