...
func RunGeneralProperties(t *testing.T) {
	seed := time.Now().Unix()
...
func RunOnlyOneGroup(t *testing.T) {
	ctx := context.Background()
	memStore := objstore.NewMemStorage()
	subDir := "/mock-test"
...
func RunSortedData(t *testing.T) {
	ctx := context.Background()
	memStore := objstore.NewMemStorage()
	kvNum := 100
...
func RunRangeSplitterStrictCase(t *testing.T) {
	ctx := context.Background()
	memStore := objstore.NewMemStorage()
	subDir := "/mock-test"
...
func RunExactlyKeyNum(t *testing.T) {
	ctx := context.Background()
	memStore := objstore.NewMemStorage()
	kvNum := 3
...
func RunCalRangeSize(t *testing.T) {
	var17 := 1.7
	var35 := 3.5
