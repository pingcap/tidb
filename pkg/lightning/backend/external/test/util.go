...
func RunGetReadRangeFromProps(t *testing.T) {
...
func RunGetReadRangeFromPropsEmptyJobKeys(t *testing.T) {
	ctx := context.Background()
	store := objstore.NewMemStorage()
...
func RunGetReadRangeFromPropsLimitsParallelRead(t *testing.T) {
...
func RunGetAllFileNames(t *testing.T) {
	ctx := context.Background()
	store := objstore.NewMemStorage()
	w := NewWriterBuilder().
...
func RunCleanUpFiles(t *testing.T) {
	ctx := context.Background()
	store := objstore.NewMemStorage()
	w := NewWriterBuilder().
		SetMemorySizeLimit(10*(lengthBytes*2+2)).
...
func RunGetMaxOverlapping(t *testing.T) {
	// [1, 3), [2, 4)
	points := []Endpoint{
...
func RunSortedKVMeta(t *testing.T) {
...
func RunMarshalFields(t *testing.T) {
	type Example struct {
		X string
		Y int `json:"y"`
	}
...
func RunReadWriteJSON(t *testing.T) {
	ctx := context.Background()
	store := objstore.NewMemStorage()
...
func RunExternalMetaPath(t *testing.T) {
...
func RunRemoveDuplicates(t *testing.T) {
...
func RunRemoveDuplicatesMoreThan2(t *testing.T) {
	valGetter := func(e *int) []byte {
		return []byte{byte(*e)}
	}
	cases := []struct {
...
func RunDivideMergeSortDataFilesBasic(t *testing.T) {
	testCases := []struct {
		fileCnt       int
		nodeCnt       int
		expectedSizes []int
...
func RunDivideMergeSortDataFilesSubtaskCount(t *testing.T) {
