...
func RunCompareWriter(t *testing.T) {
...
func RunCompareReaderEvenlyDistributedContent(t *testing.T) {
...
func RunReadMergeIterWithoutCheckHotspot(t *testing.T) {
...
func RunMergeBench(t *testing.T) {
	p := newProfiler(true, true)
...
func RunReadAllDataLargeFiles(t *testing.T) {
	ctx := context.Background()
	store := openTestingStorage(t)
...
func RunReadAllData(t *testing.T) {
