...
type BaseKVEncoder struct {
	...
	AutoRandomColOffset int
	AutoIncColOffset    int
...
func NewBaseKVEncoder(config *encode.EncodingConfig) (*BaseKVEncoder, error) {
	...
	return &BaseKVEncoder{
		...
		table:               config.Table,
		Columns:             cols,
		AutoRandomColOffset: autoRandomColOffset,
		AutoIncColOffset:    autoIncColOffset,
		AutoIDFn:            autoIDFn,
...
func (e *BaseKVEncoder) HandleAutoColumn(record []types.Datum) error {
	if e.AutoRandomColOffset >= 0 {
		value := record[e.AutoRandomColOffset]
		col := e.Columns[e.AutoRandomColOffset]
		meta := e.table.Meta()
		shardFmt := autoid.NewShardIDFormat(&col.FieldType, meta.AutoRandomBits, meta.AutoRandomRangeBits)
...
func (e *BaseKVEncoder) GetActualDatum(col *table.Column, rowID int64, inputDatum *types.Datum, needCast bool) (types.Datum, error) {
	...
	case col.Offset == e.AutoRandomColOffset:
		var val types.Datum
