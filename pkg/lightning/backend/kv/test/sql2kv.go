...
func (mockTable) AddRecord(ctx table.MutateContext, txn kv.Transaction, r []types.Datum, opts ...table.AddRecordOption) (recordID kv.Handle, err error) {
	return kv.IntHandle(-1), errors.New("mock error")
}

func RunEncode(t *testing.T) {
...
func RunDecodeIndex(t *testing.T) {
...
func RunEncodeRowFormatV2(t *testing.T) {
...
func RunEncodeTimestamp(t *testing.T) {
...
func RunEncodeDoubleAutoIncrement(t *testing.T) {
...
func RunEncodeMissingAutoValue(t *testing.T) {
	var rowID int64 = 70
...
func RunEncodeExpressionColumn(t *testing.T) {
...
func RunDefaultAutoRandoms(t *testing.T) {
...
func RunShardRowId(t *testing.T) {
...
func RunClassifyAndAppend(t *testing.T) {
