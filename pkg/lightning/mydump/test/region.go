...
func RunAllocateEngineIDs(t *testing.T) {
...
func RunMakeTableRegionsSplitLargeFile(t *testing.T) {
	cfg := &config.Config{
...
func RunCompressedMakeSourceFileRegion(t *testing.T) {
	meta := &MDTableMeta{
		DB:   "csv",
		Name: "large_csv_file",
	}
...
func RunSplitLargeFile(t *testing.T) {
	meta := &MDTableMeta{
		DB:   "csv",
		Name: "large_csv_file",
	}
...
func RunSplitLargeFileNoNewLineAtEOF(t *testing.T) {
	meta := &MDTableMeta{
		DB:   "csv",
		Name: "large_csv_file",
	}
...
func RunSplitLargeFileWithCustomTerminator(t *testing.T) {
	meta := &MDTableMeta{
		DB:   "csv",
...
func RunSplitLargeFileOnlyOneChunk(t *testing.T) {
	meta := &MDTableMeta{
		DB:   "csv",
		Name: "large_csv_file",
	}
...
func RunSplitLargeFileSeekInsideCRLF(t *testing.T) {
	ctx := context.Background()
	meta := &MDTableMeta{
		DB:   "csv",
	...
	file, err := os.Open(filePath) // #nosec G304 -- test-controlled path
	require.NoError(t, err)
