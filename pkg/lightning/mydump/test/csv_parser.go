...
func RunTPCHMultiBytes(t *testing.T) {
	datums := tpchDatums()
...
func RunCustomEscapeChar(t *testing.T) {
	cfg := config.CSVConfig{
		FieldsTerminatedBy: ",",
		FieldsEnclosedBy:   `"`,
		FieldsEscapedBy:    `!`,
...
func RunSyntaxErrorCSV(t *testing.T) {
...
func RunCsvWithWhiteSpaceLine(t *testing.T) {
	cfg := config.CSVConfig{
		FieldsTerminatedBy: ",",
		FieldsEnclosedBy:   `"`,
		FieldNullDefinedBy: []string{""},
...
func RunQuotedSeparator(t *testing.T) {
	cfg := config.CSVConfig{
		FieldsTerminatedBy: ",",
		FieldsEnclosedBy:   `"`,
	}
...
func RunConsecutiveFields(t *testing.T) {
...
func RunTooLargeRow(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: ",",
			FieldsEnclosedBy:   `"`,
...
func RunSpecialChars(t *testing.T) {
	cfg := config.MydumperRuntime{
...
func RunContinuationCSV(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: ",",
			FieldsEnclosedBy:   `"`,
...
func RunBackslashAsSep(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: `\`,
			FieldsEnclosedBy:   `"`,
...
func RunBackslashAsDelim(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: ",",
			FieldsEnclosedBy:   `\`,
...
func RunSyntaxErrorLog(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: "\t",
			FieldsEnclosedBy:   "'",
...
func RunTrimLastSep(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: ",",
			FieldsEnclosedBy:   `"`,
...
func RunTerminator(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: "|+|",
			LinesTerminatedBy:  "|+|\n",
...
func RunReadUntilTerminator(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: "#",
			LinesTerminatedBy:  "#\n",
...
func RunStartingBy(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: ",",
			FieldsEnclosedBy:   `"`,
...
func RunCharsetConversion(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: "，",
			LinesTerminatedBy:  "。\n",
...
func RunHeaderSchemaMatch(t *testing.T) {
	cfg := config.MydumperRuntime{
		CSV: config.CSVConfig{
			FieldsTerminatedBy: ",",
			FieldsEnclosedBy:   `"`,
