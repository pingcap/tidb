...
func RunReadChunks(t *testing.T) {
	reader := mydump.NewStringReader(`
...
func RunVariousSyntax(t *testing.T) {
	testCases := []testCase{
		{
...
func RunContinuation(t *testing.T) {
	testCases := []testCase{
		{
			input: `
...
func RunPseudoKeywords(t *testing.T) {
	reader := mydump.NewStringReader(`
		INSERT INTO t (
			c, C,
			co, CO,
...
func RunSyntaxError(t *testing.T) {
	inputs := []string{
		"('xxx)",
		`("xxx)`,
		"(`xxx)",
...
func RunMoreSyntaxError(t *testing.T) {
	inputs := []string{
		" usin0",
		"- ",
		"-,",
...
func RunMoreEmptyFiles(t *testing.T) {
	testCases := []testCase{
		{input: ""},
		{input: "--\t"},
		{input: "--\""},
