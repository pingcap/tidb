...
func (s *testMydumpLoaderSuite) touch(t *testing.T, filename ...string) {
	components := make([]string, 0, len(filename)+1)
...
func (s *testMydumpLoaderSuite) mkdir(t *testing.T, dirname string) {
	...
	err := os.Mkdir(path, 0o750) // #nosec G301 -- test directory, intentionally created with specific permissions
	require.Nil(t, err)
}
...
func RunDuplicatedDB(t *testing.T) {
	/*
		Path/
			a/
...
func RunTableNoHostDB(t *testing.T) {
	/*
		Path/
...
func RunDuplicatedTable(t *testing.T) {
	/*
		Path/
			db-schema-create.sql
			a/
...
func RunTableInfoNotFound(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunTableUnexpectedError(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
	s.touch(t, "db-schema-create.sql")
	s.touch(t, "db.tbl-schema.sql")
...
func RunMissingTableSchema(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunDataNoHostDB(t *testing.T) {
	/*
		Path/
			notdb-schema-create.sql
			db.tbl.sql
...
func RunDataNoHostTable(t *testing.T) {
	/*
		Path/
			db-schema-create.sql
			db.tbl.sql
...
func RunViewNoHostDB(t *testing.T) {
	/*
		Path/
			notdb-schema-create.sql
...
func RunViewNoHostTable(t *testing.T) {
	/*
		Path/
			db-schema-create.sql
			db.tbl-schema-view.sql
...
func RunDataWithoutSchema(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunTablesWithDots(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunRoutesPanic(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
	s.cfg.Routes = []*router.TableRule{
		{
			SchemaPattern: "test1",
...
func RunBadRouterRule(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunFileRouting(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunInputWithSpecialChars(t *testing.T) {
	/*
		Path/
...
func RunMDLoaderSetupOption(t *testing.T) {
...
func RunExternalDataRoutes(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
...
func RunSampleFileCompressRatio(t *testing.T) {
	s := newTestMydumpLoaderSuite(t)
	store, err := objstore.NewLocalStorage(s.sourceDir)
	require.NoError(t, err)
...
func RunEstimateFileSize(t *testing.T) {
...
func RunMDLoaderSkipRealSizeEstimation(t *testing.T) {
	ctx := context.Background()
...
func RunSampleParquetDataSize(t *testing.T) {
...
func RunSetupOptions(t *testing.T) {
...
func RunParallelProcess(t *testing.T) {
