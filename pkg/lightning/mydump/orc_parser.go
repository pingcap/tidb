...
func setORCDatumValue(d *types.Datum, value interface{}, t *orc.TypeDescription, logger log.Logger) error {
	return setORCDatumByReflect(d, value, t, logger)
}

func setORCDatumByReflect(d *types.Datum, value interface{}, t *orc.TypeDescription, logger log.Logger) error {
...
func setORCDatumByOrcKind(d *types.Datum, value interface{}, t *orc.TypeDescription, logger log.Logger) error {
	v := reflect.ValueOf(value)
	switch *t.Type().Kind {
