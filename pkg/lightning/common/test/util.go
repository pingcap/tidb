...
func RunUniqueTable(t *testing.T) {
...
func RunSQLWithRetry(t *testing.T) {
...
func RunInterpolateMySQLString(t *testing.T) {
...
func RunGetAutoRandomColumn(t *testing.T) {
	tests := []struct {
		ddl     string
		colName string
	}{
...
func RunBuildAddIndexSQL(t *testing.T) {
	tests := []struct {
		table     string
		current   string
		desired   string
...
func RunSkipReadRowCount(t *testing.T) {
