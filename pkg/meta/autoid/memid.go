...
func (alloc *inMemoryAllocator) alloc4Signed(n uint64, increment, offset int64) (mini, maxv int64, err error) {
...
func (alloc *inMemoryAllocator) alloc4Unsigned(n uint64, increment, offset int64) (mini int64, maxv int64, err error) {
	// Check offset rebase if necessary.
