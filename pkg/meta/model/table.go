...
// ExtraBM25ScoreName is the name of the extra BM25 score column used by TiCI FTS.
var ExtraBM25ScoreName = ast.NewCIStr("_tidb_fts_bm25_score")
...
// ExtraBM25ScoreID is the ID of the extra column that holds the TiCI FTS BM25 score.
const ExtraBM25ScoreID int64 = -2050
