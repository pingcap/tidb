...
func newColumnForForeignKeyTest(id int64, offset int) *metamodel.ColumnInfo {
...
func newIndexForForeignKeyTest(id int64, cols ...*metamodel.ColumnInfo) *metamodel.IndexInfo {
...
func TestIsIndexPrefixCoveredForForeignKey(t *testing.T) {
	c0 := newColumnForForeignKeyTest(0, 0)
	c1 := newColumnForForeignKeyTest(1, 1)
	c2 := newColumnForForeignKeyTest(2, 2)
	...
	safePartial := newIndexForForeignKeyTest(2, c0, c1)
	...
	safePartialOnFirstFKCol := newIndexForForeignKeyTest(3, c0, c1)
	...
	unsafePartialOnNonFKCol := newIndexForForeignKeyTest(4, c0, c1)
	...
	unsafePartialIsNull := newIndexForForeignKeyTest(5, c0)
	...
	unsafePartialBinaryCondition := newIndexForForeignKeyTest(6, c0)
	...
	badCondition := newIndexForForeignKeyTest(7, c0)
