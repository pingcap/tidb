...
type IndexInfo struct {
	...
	PartialConditionExprString string             `json:"partial_condition_expr_string"` // PartialConditionExprString is the string representation of the partial index condition.
}
