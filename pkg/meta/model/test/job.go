...
func RunJobStartTime(t *testing.T) {
	job := &Job{
		Version:    JobVersion1,
		ID:         123,
...
func RunBackfillMetaCodec(t *testing.T) {
	jm := &JobMeta{
		SchemaID: 1,
		TableID:  2,
...
func RunMayNeedReorg(t *testing.T) {
...
func RunInFinalState(t *testing.T) {
...
func RunSchemaState(t *testing.T) {
...
func RunActionTypeReserved(t *testing.T) {
...
func RunJobEncodeV2(t *testing.T) {
	j := &Job{
		Version: JobVersion2,
...
func RunJobVerInUse(t *testing.T) {
...
func RunJobCheckInvolvingSchemaInfo(t *testing.T) {
	cases := []struct {
		job    *Job
		errStr string
	}{
