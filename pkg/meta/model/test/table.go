...
func RunMoveColumnInfo(t *testing.T) {
...
func RunModelBasic(t *testing.T) {
	column := &ColumnInfo{
		ID:           1,
		Name:         ast.NewCIStr("c"),
		Offset:       0,
...
func RunTTLInfoClone(t *testing.T) {
	ttlInfo := &TTLInfo{
...
func RunTTLJobInterval(t *testing.T) {
	ttlInfo := &TTLInfo{}
...
func RunClearReorgIntermediateInfo(t *testing.T) {
...
func RunTTLDefaultJobInterval(t *testing.T) {
