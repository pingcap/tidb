...
func RunGetOrDecodeArgsV2(t *testing.T) {
	j := &Job{
		Version: JobVersion2,
...
func RunCreateSchemaArgs(t *testing.T) {
...
func RunDropSchemaArgs(t *testing.T) {
...
func RunModifySchemaArgs(t *testing.T) {
...
func RunCreateTableArgs(t *testing.T) {
...
func RunBatchCreateTableArgs(t *testing.T) {
...
func RunDropTableArgs(t *testing.T) {
...
func RunFinishedDropTableArgs(t *testing.T) {
	inArgs := &DropTableArgs{
		StartKey:        []byte("xxx"),
...
func RunTruncateTableArgs(t *testing.T) {
...
func RunTablePartitionArgs(t *testing.T) {
...
func RunFinishedTablePartitionArgs(t *testing.T) {
	inArgs := &TablePartitionArgs{
...
func RunExchangeTablePartitionArgs(t *testing.T) {
...
func RunAlterTablePartitionArgs(t *testing.T) {
...
func RunRenameTableArgs(t *testing.T) {
...
func RunRenameTablesArgs(t *testing.T) {
...
func RunResourceGroupArgs(t *testing.T) {
...
func RunGetAlterSequenceArgs(t *testing.T) {
...
func RunGetRebaseAutoIDArgs(t *testing.T) {
...
func RunGetModifyTableCommentArgs(t *testing.T) {
...
func RunGetAlterIndexVisibilityArgs(t *testing.T) {
...
func RunGetAddForeignKeyArgs(t *testing.T) {
...
func RunGetModifyTableAutoIDCacheArgs(t *testing.T) {
...
func RunGetShardRowIDArgs(t *testing.T) {
...
func RunGetDropForeignKeyArgs(t *testing.T) {
...
func RunGetAlterTTLInfoArgs(t *testing.T) {
	ttlEanble := true
...
func RunAddCheckConstraintArgs(t *testing.T) {
	Constraint :=
		&ConstraintInfo{
...
func RunCheckConstraintArgs(t *testing.T) {
...
func RunGetAlterTablePlacementArgs(t *testing.T) {
...
func RunGetSetTiFlashReplicaArgs(t *testing.T) {
...
func RunGetUpdateTiFlashReplicaStatusArgs(t *testing.T) {
...
func RunLockTableArgs(t *testing.T) {
...
func RunRepairTableArgs(t *testing.T) {
...
func RunRecoverArgs(t *testing.T) {
...
func RunPlacementPolicyArgs(t *testing.T) {
...
func RunMaskingPolicyArgs(t *testing.T) {
...
func RunGetSetDefaultValueArgs(t *testing.T) {
...
func RunFlashbackClusterArgs(t *testing.T) {
...
func RunDropColumnArgs(t *testing.T) {
...
func RunAddColumnArgs(t *testing.T) {
	inArgs := &TableColumnArgs{
		Col: &ColumnInfo{
			ID:   7527,
			Name: ast.NewCIStr("col_name"),
...
func RunAlterTableAttributesArgs(t *testing.T) {
...
func RunAddIndexArgs(t *testing.T) {
...
func RunDropIndexArguements(t *testing.T) {
...
func RunGetRenameIndexArgs(t *testing.T) {
	inArgs := &ModifyIndexArgs{
		IndexArgs: []*IndexArg{
...
func RunModifyColumnsArgs(t *testing.T) {
