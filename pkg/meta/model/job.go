...
const (
	...
	ActionAlterTableSoftDeleteInfo              ActionType = 81 // reserve for soft-delete feature
	ActionModifySchemaSoftDeleteAndActiveActive ActionType = 82 // reserve for soft-delete and active-active feature
)
