...
func RunMaskingPolicy(t *testing.T) {
	store, err := mockstore.NewMockStore(mockstore.WithStoreType(mockstore.EmbedUnistore))
	require.NoError(t, err)
...
func RunResourceGroup(t *testing.T) {
...
func RunAutoTableIDKey(b *testing.T) {
	var tableID int64 = 10
...
func RunAutoRandomTableIDKey(b *testing.T) {
	var tableID int64 = 10
...
func RunIterDatabases(t *testing.T) {
...
func RunSequenceKey(b *testing.T) {
	var tableID int64 = 10
...
func RunCreateMySQLDatabase(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunIsTableInfoMustLoad(t *testing.T) {
...
func RunIsTableInfoMustLoadSubStringsOrder(t *testing.T) {
	// The order matter!
...
func RunTableNameExtract(t *testing.T) {
...
func RunNameExtractFromJob(t *testing.T) {
...
func RunInfoSchemaV2SpecialAttributeCorrectnessAfterBootstrap(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunInfoSchemaV2DataFieldsCorrectnessAfterBootstrap(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunInfoSchemaMiscFieldsCorrectnessAfterBootstrap(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunIsDatabaseExist(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunBootTableVersion(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunCreateSysDatabaseByIDIfNotExists(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
	defer func() {
		require.NoError(t, store.Close())
...
func RunSetGetDXFScheduleTuneFactors(t *testing.T) {
