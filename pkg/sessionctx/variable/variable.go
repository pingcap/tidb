...
type SysVar struct {
	...
	// The first return value must be a valid value for the variable, and second return value must be
	// true if only if the variable has been changed from the default.
