...
func RunSQLSelectLimit(t *testing.T) {
...
func RunSQLModeVar(t *testing.T) {
...
func RunTiDBTraceEventSysVar(t *testing.T) {
	t.Cleanup(func() {
...
func RunTiFlashMaxBytes(t *testing.T) {
...
func RunTiFlashMemQuotaQueryPerNode(t *testing.T) {
...
func RunTiFlashQuerySpillRatio(t *testing.T) {
...
func RunTiFlashHashJoinVersion(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunCollationServer(t *testing.T) {
...
func RunTxnIsolation(t *testing.T) {
...
func RunTiDBMultiStatementMode(t *testing.T) {
...
func RunReadOnlyNoop(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunSessionGetterFuncs(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunInstanceScopedVars(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunSecureAuth(t *testing.T) {
...
func RunTiDBReplicaRead(t *testing.T) {
...
func RunSQLAutoIsNull(t *testing.T) {
...
func RunLastInsertID(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunLcTimeNamesReadOnly(t *testing.T) {
...
func RunLcMessages(t *testing.T) {
...
func RunDDLWorkers(t *testing.T) {
...
func RunDefaultCharsetAndCollation(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunIndexMergeSwitcher(t *testing.T) {
	vars := NewSessionVars(nil)
	vars.GlobalVarsAccessor = NewMockGlobalAccessor4Tests()
...
func RunNetBufferLength(t *testing.T) {
...
func RunTiDBBatchPendingTiFlashCount(t *testing.T) {
...
func RunTiDBMemQuotaQuery(t *testing.T) {
...
func RunTiDBQueryLogMaxLen(t *testing.T) {
...
func RunTiDBCommitterConcurrency(t *testing.T) {
...
func RunTiDBDDLFlashbackConcurrency(t *testing.T) {
...
func RunDefaultMemoryDebugModeValue(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunSetTIDBDistributeReorg(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunDefaultPartitionPruneMode(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunSetTIDBFastDDL(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunSetTIDBDiskQuota(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBServerMemoryLimit(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBServerMemoryLimit2(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBServerMemoryLimitSessMinSize(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBServerMemoryLimitGCTrigger(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunSetAggPushDownGlobally(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunSetDeriveTopNGlobally(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunSetJobScheduleWindow(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBIgnoreInlistPlanDigest(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBEnableResourceControl(t *testing.T) {
...
func RunTiDBResourceControlStrictMode(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBEnableRowLevelChecksum(t *testing.T) {
...
func RunTiDBAutoAnalyzeRatio(t *testing.T) {
	ctx := context.Background()
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
...
func RunTiDBTiFlashReplicaRead(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunGlobalSystemVariableInitialValue(t *testing.T) {
	vars := []struct {
		name    string
		val     string
		initVal string
...
func RunTiDBOptTxnAutoRetry(t *testing.T) {
...
func RunTiDBLowResTSOUpdateInterval(t *testing.T) {
...
func RunTiDBSchemaCacheSize(t *testing.T) {
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
	vars.GlobalVarsAccessor = mock
...
func RunTiDBCircuitBreakerPDMetadataErrorRateThresholdRatio(t *testing.T) {
...
func RunEnableWindowFunction(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunTiDBHashJoinVersion(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunTiDBAutoAnalyzeConcurrencyValidation(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunTiDBOptSelectivityFactor(t *testing.T) {
	ctx := context.Background()
	vars := NewSessionVars(nil)
	mock := NewMockGlobalAccessor4Tests()
	mock.SessionVars = vars
...
func RunSkipInitIsUsed(t *testing.T) {
