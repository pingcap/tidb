...
func RunNewSessionVars(t *testing.T) {
...
func RunValidateStmtSummary(t *testing.T) {
	v := NewSessionVars(nil)
	v.GlobalVarsAccessor = NewMockGlobalAccessor4Tests()
	v.TimeZone = time.UTC
...
func RunConcurrencyVariables(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunHelperFuncs(t *testing.T) {
...
func RunSessionStatesSystemVar(t *testing.T) {
	vars := NewSessionVars(nil)
...
func RunOnOffHelpers(t *testing.T) {
...
func RunAssertionLevel(t *testing.T) {
