...
type SessionVars struct {
	...
	*UserVars
	...
	// TiDBOptJoinReorderPushSelection enables pushing selection conditions down to
	// reordered join trees when applicable.
	TiDBOptJoinReorderPushSelection bool
...
func NewSessionVars(hctx HookContext) *SessionVars {
	vars := &SessionVars{
		...
		TiDBOptJoinReorderPushSelection: vardef.DefTiDBOptJoinReorderPushSelection,
