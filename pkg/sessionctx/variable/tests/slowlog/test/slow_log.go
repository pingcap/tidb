...
func RunSlowLogFieldAccessor(t *testing.T) {
...
func RunMatchSingleRuleSingleCondition(t *testing.T) {
	ctx := newMockCtx()
...
func RunMatchSpecialTypeConditions(t *testing.T) {
	ctx := newMockCtx()
...
func RunMatchSingleRuleMultipleConditions(t *testing.T) {
	ctx := newMockCtx()
	items := &variable.SlowQueryLogItems{
		MemMax:            200,
		Digest:            "abc",
...
func RunMatchMultipleRulesOR(t *testing.T) {
	ctx := newMockCtx()
...
func RunMatchDifferentTypesAfterParse(t *testing.T) {
	ctx := newMockCtx()
	items := &variable.SlowQueryLogItems{
		MemMax:            123,                     // int64
		DiskMax:           456,                     // int64
...
func RunMatchUintExecDetailFieldsAfterParse(t *testing.T) {
...
func RunParseSingleSlowLogField(t *testing.T) {
...
func RunParseSessionSlowLogRules(t *testing.T) {
	// normal tests
...
func RunParseGlobalSlowLogRules(t *testing.T) {
	// normal tests
