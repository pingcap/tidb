...
func RunSetSystemVariable(t *testing.T) {
...
func RunSlowLogFormat(t *testing.T) {
...
func RunSlowLogFormatIncludesTiFlashRUInRUV2Metrics(t *testing.T) {
...
func RunIsolationRead(t *testing.T) {
...
func RunTableDeltaClone(t *testing.T) {
...
func RunTransactionContextSavepoint(t *testing.T) {
...
func RunNonPreparedPlanCacheStmt(t *testing.T) {
	sessVars := variable.NewSessionVars(nil)
...
func RunHookContext(t *testing.T) {
	store := testkit.CreateMockStore(t)
	ctx := mock.NewContext()
	ctx.Store = store
...
func RunGetReuseChunk(t *testing.T) {
...
func RunUserVarConcurrently(t *testing.T) {
...
func RunRowIDShardGenerator(t *testing.T) {
...
func RunTiDBOptPartialOrderedIndexForTopNSessionAndGlobal(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTiDBOptPartialOrderedIndexForTopN(t *testing.T) {
...
func RunPerformanceSchemaSessionConnectAttrsSizeGlobalSQL(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunSetTiDBCloudStorageURI(t *testing.T) {
	vars := variable.NewSessionVars(nil)
