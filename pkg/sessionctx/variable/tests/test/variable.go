...
func RunIndexJoinBuildV2SysVarCompatibility(t *testing.T) {
...
func RunRegistrationOfNewSysVar(t *testing.T) {
...
func RunIntValidation(t *testing.T) {
...
func RunPerformanceSchemaSessionConnectAttrsSizeValidation(t *testing.T) {
...
func RunUintValidation(t *testing.T) {
...
func RunEnumValidation(t *testing.T) {
...
func RunDurationValidation(t *testing.T) {
...
func RunFloatValidation(t *testing.T) {
...
func RunBoolValidation(t *testing.T) {
...
func RunTimeValidation(t *testing.T) {
...
func RunGetNativeValType(t *testing.T) {
	sv := variable.SysVar{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: "mynewsysvar", Value: vardef.Off, Type: vardef.TypeBool}
...
func RunDeprecation(t *testing.T) {
...
func RunBuiltInCase(t *testing.T) {
...
func RunDefaultValuesAreSettable(t *testing.T) {
	vars := variable.NewSessionVars(nil)
...
func RunLimitBetweenVariable(t *testing.T) {
...
func RunSysVarNameIsLowerCase(t *testing.T) {
	for _, sv := range variable.GetSysVars() {
...
func RunSettersandGetters(t *testing.T) {
	for _, sv := range variable.GetSysVars() {
...
func RunScopeToString(t *testing.T) {
...
func RunValidateWithRelaxedValidation(t *testing.T) {
...
func RunValidateInternalSessionVariable(t *testing.T) {
	vars := variable.NewSessionVars(nil)
...
func RunInstanceConfigHasMatchingSysvar(t *testing.T) {
...
func RunInstanceScope(t *testing.T) {
...
func RunSkipSysvarCache(t *testing.T) {
...
func RunTimeValidationWithTimezone(t *testing.T) {
	sv := variable.SysVar{Scope: vardef.ScopeSession, Name: "mynewsysvar", Value: "23:59 +0000", Type: vardef.TypeTime}
	vars := variable.NewSessionVars(nil)
...
func RunOrderByDependency(t *testing.T) {
