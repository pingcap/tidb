...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal, Name: TiDBInsertSelectFastMode, Value: BoolToOnOff(DefTiDBInsertSelectFastMode), Type: TypeBool,
		SetGlobal: func(_ context.Context, s *SessionVars, val string) error {
			InsertSelectFastMode.Store(TiDBOptOn(val))
			return nil
		},
		GetGlobal: func(ctx context.Context, vars *SessionVars) (string, error) {
			return BoolToOnOff(InsertSelectFastMode.Load()), nil
		},
	},
}
