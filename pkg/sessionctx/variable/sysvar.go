...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: vardef.TiDBOptJoinReorderPushSelection, Value: BoolToOnOff(vardef.DefTiDBOptJoinReorderPushSelection), Type: vardef.TypeBool, SetSession: func(s *SessionVars, val string) error {
		s.TiDBOptJoinReorderPushSelection = TiDBOptOn(val)
		return nil
	}},
