...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBHashJoinUseImplV2, Value: BoolToOnOff(DefTiDBHashJoinUseImplV2), Type: TypeBool, SetSession: func(s *SessionVars, val string) error {
