...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: vardef.TiDBOptIndexJoinMaxProbeScanRatio, Value: strconv.FormatFloat(vardef.DefOptIndexJoinMaxProbeScanRatio, 'f', -1, 64), Type: vardef.TypeFloat, MinValue: 0, MaxValue: math.MaxUint64, SetSession: func(s *SessionVars, val string) error {
		s.IndexJoinMaxProbeScanRatio = tidbOptFloat64(val, vardef.DefOptIndexJoinMaxProbeScanRatio)
		return nil
	}},
