...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal, Name: vardef.TiDBEnableHistogramForPresplitIndexRegion, Value: BoolToOnOff(vardef.DefTiDBEnableHistogramForPresplitIndexRegion), Type: vardef.TypeBool},
