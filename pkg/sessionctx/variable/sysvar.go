...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: vardef.TiDBDDLEnableAutoSplitHotRegion, Value: BoolToOnOff(vardef.DefTiDBDDLEnableAutoSplitHotRegion), Type: vardef.TypeBool},
