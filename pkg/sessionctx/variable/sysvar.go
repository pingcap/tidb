...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBOptEnableFuzzingBinding, Value: BoolToOnOff(false), Type: TypeBool, IsHintUpdatableVerfied: true, SetSession: func(s *SessionVars, val string) error {
