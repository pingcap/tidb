...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: vardef.TiDBEnablePlanCacheGenericPlan, Value: BoolToOnOff(vardef.DefTiDBEnablePlanCacheGenericPlan), Type: vardef.TypeBool, SetSession: func(s *SessionVars, val string) error {
		s.EnablePlanCacheGenericPlan = TiDBOptOn(val)
		return nil
	}},
