...
func TestQBHintHandlerBuildState(t *testing.T) {
	...
	require.Equal(t, map[int][]*ast.TableOptimizerHint{
		1: {{HintName: pmodel.NewCIStr("use_index"), QBName: pmodel.NewCIStr("qb_1")}},
