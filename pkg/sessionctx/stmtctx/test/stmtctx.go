...
func RunCopTasksDetails(t *testing.T) {
...
func RunStatementContextPushDownFLags(t *testing.T) {
...
func RunWeakConsistencyRead(t *testing.T) {
	...
	execAndCheck := func(sql string, rows [][]any, isolationLevel kv.IsoLevel) {
		ctx := context.WithValue(context.Background(), contextKey("CheckSelectRequestHook"), func(req *kv.Request) {
...
func RunMarshalSQLWarn(t *testing.T) {
...
func RunLogicalPlanBuildStateRestore(t *testing.T) {
	sc := stmtctx.NewStmtCtx()
...
func RunQBHintHandlerBuildState(t *testing.T) {
...
func RunApproxRuntimeInfo(t *testing.T) {
...
func RunStmtHintsClone(t *testing.T) {
...
func RunNewStmtCtx(t *testing.T) {
	sc := stmtctx.NewStmtCtx()
...
func RunSetStmtCtxTimeZone(t *testing.T) {
	sc := stmtctx.NewStmtCtx()
	require.Same(t, time.UTC, sc.TimeZone())
	tz := time.FixedZone("UTC+1", 2*60*60)
	sc.SetTimeZone(tz)
...
func RunSetStmtCtxTypeFlags(t *testing.T) {
	sc := stmtctx.NewStmtCtx()
	require.Equal(t, types.DefaultStmtFlags, sc.TypeFlags())
...
func RunResetStmtCtx(t *testing.T) {
	sc := stmtctx.NewStmtCtx()
	require.Equal(t, types.DefaultStmtFlags, sc.TypeFlags())
...
func RunIssue58600(t *testing.T) {
	sc := stmtctx.NewStmtCtx()
...
func RunReservedRowIDAlloc(t *testing.T) {
...
func RunUsedStatsInfoForTableWriteToSlowLog(t *testing.T) {
