...
const (
	...
	// TiDBOptJoinReorderBlockingPenaltyRatio controls the penalty ratio for blocking operators in join reorder.
	// Range: [0,1]. 0 disables the penalty; 1 applies the full penalty.
	TiDBOptJoinReorderBlockingPenaltyRatio = "tidb_opt_join_reorder_blocking_penalty_ratio"
...
const (
	...
	DefTiDBOptJoinReorderBlockingPenaltyRatio = 1.0
	DefOptCPUFactor                           = 3.0
