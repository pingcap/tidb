...
const (
	...
	// For versions earlier than v7.6.0, the scan concurrency of DistSQL during ANALYZE is controlled by the tidb_distsql_scan_concurrency variable.
	...
	// Deprecated: This variable is deprecated, please do not use this variable.
	// Before v5.0.0, this variable was used to control the concurrency of index scan operations for both regular queries and ANALYZE statements.
	// From version v5.0.0 up to (and including) v8.0.0, this variable was used only to control the concurrency of index scan operations for ANALYZE statements.
