...
func (t *mockTxn) Prefetch(ctx context.Context, k []Key) (map[string][]byte, error) { return nil, nil }
func (t *mockTxn) GetFromPrefetchCache(ctx context.Context, k Key) ([]byte, error)  { return nil, nil }
