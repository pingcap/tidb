...
func RunPartialNext(t *testing.T) {
...
func RunPaddingHandle(t *testing.T) {
...
func RunCommonHandlesFitIntHandleRange(t *testing.T) {
...
func RunHandleMapWithPartialHandle(t *testing.T) {
	m := NewHandleMap()
...
func RunMemAwareHandleMapWithPartialHandle(t *testing.T) {
...
func RunKeyRangeDefinition(t *testing.T) {
