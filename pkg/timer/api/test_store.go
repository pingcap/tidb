...
func RunFieldOptional(t *testing.T) {
...
func RunFieldsReflect(t *testing.T) {
	var cond TimerCond
...
func RunTimerRecordCond(t *testing.T) {
	tm := &TimerRecord{
		ID: "123",
		TimerSpec: TimerSpec{
			Namespace: "n1",
...
func RunOperatorCond(t *testing.T) {
	tm := &TimerRecord{
		ID: "123",
		TimerSpec: TimerSpec{
			Namespace: "n1",
...
func RunTimerUpdate(t *testing.T) {
	...
	updateCopy := *update
	_, err := ExportedApply(&updateCopy, tm)
	require.Error(t, err)
	...
	record, err := ExportedApply(update, tm)
	...
	record, err = ExportedApply(emptyUpdate, tm)
	require.NoError(t, err)
