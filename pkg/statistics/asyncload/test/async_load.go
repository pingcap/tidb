...
func RunLoadColumnStatisticsAfterTableDrop(t *testing.T) {
...
func RunLoadStatisticsAfterColumnDrop(t *testing.T) {
	// Use real tikv to enable the sync and async load.
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	// Turn off the sync load.
...
func RunLoadIndexStatisticsAfterTableDrop(t *testing.T) {
	// Use real tikv to enable the sync and async load.
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	// Turn off the sync load.
...
func RunLoadStatisticsAfterIndexDrop(t *testing.T) {
	// Use real tikv to enable the sync and async load.
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	// Turn off the sync load.
...
func RunLoadCorruptedStatistics(t *testing.T) {
	// Use real tikv to enable the sync and async load.
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	// Turn off the sync load.
