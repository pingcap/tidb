...
func CallWithSCtx(pool *syssession.AdvancedSessionPool, f func(sctx sessionctx.Context) error, flags ...int) (err error) {
...
func GetCurrentPruneMode(pool *syssession.AdvancedSessionPool) (mode string, err error) {
