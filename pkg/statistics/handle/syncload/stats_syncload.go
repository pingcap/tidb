...
func (*statsSyncLoad) readStatsForOneItem(sctx sessionapi.Context, item model.TableItemID, w *statsWrapper, isPkIsHandle bool, fullLoad bool) (*statsWrapper, error) {
