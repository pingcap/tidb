...
func testIssues24349(t *testing.T, testKit *testkit.TestKit, store kv.Storage) {
	...
	// repeat=1 = 4). The leftover TopN entries and the remaining hist
	// buckets all overlap the same value range [1,4] and collapse into
	// a single equi-depth global bucket with mass=8.
