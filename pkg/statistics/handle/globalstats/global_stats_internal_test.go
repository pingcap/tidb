...
func testGlobalStatsAndSQLBinding(tk *testkit.TestKit, t *testing.T, dom *domain.Domain) {
	tk.MustExec("use test")
	tk.MustExec("create database test_global_stats")
	tk.MustExec("use test_global_stats")
	tk.MustExec("set @@tidb_partition_prune_mode = 'dynamic'")
	tk.MustExec("set tidb_cost_model_version=2")
	tk.MustExec("set @@session.tidb_stats_load_sync_wait = 20000")
	...
	tk.MustExec("analyze table thash all columns")
	tk.MustExec("analyze table trange all columns")
	tk.MustExec("analyze table tlist all columns")
