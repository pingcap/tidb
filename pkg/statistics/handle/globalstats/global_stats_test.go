...
partitions 12;`)
	...
	tk.MustQuery("show warnings").Check(testkit.Rows(asyncMergeWarn))
	dom.StatsHandle().MergePartitionStats2GlobalStatsByTableID(se, core.GetAnalyzeOptionDefaultForTest(), infoSchema, &types.GlobalStatsInfo{StatsVersion: 2}, tbl.Meta().ID)
