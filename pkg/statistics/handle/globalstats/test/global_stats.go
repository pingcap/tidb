...
func RunShowGlobalStatsWithAsyncMergeGlobal(t *testing.T) {
	testShowGlobalStats(t, true)
}

func RunShowGlobalStatsWithoutAsyncMergeGlobal(t *testing.T) {
...
func RunGlobalStatsPanicInIOWorker(t *testing.T) {
...
func RunGlobalStatsWithCMSketchErr(t *testing.T) {
...
func RunGlobalStatsWithHistogramAndTopNErr(t *testing.T) {
...
func RunGlobalStatsPanicInCPUWorker(t *testing.T) {
...
func RunGlobalStatsPanicSametime(t *testing.T) {
...
func RunGlobalStatsErrorSametime(t *testing.T) {
...
func RunBuildGlobalLevelStats(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGlobalStatsHealthy(t *testing.T) {
...
func RunGlobalStatsData(t *testing.T) {
...
func RunGlobalStatsData2(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	testGlobalStats2(t, tk, dom)
}

func RunGlobalStatsData2WithConcurrency(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunGlobalStatsData3(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("set @@tidb_partition_prune_mode='dynamic'")
...
func RunGlobalStatsVersion(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunDDLPartition4GlobalStats(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunGlobalStatsNDV(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("set @@tidb_partition_prune_mode = 'dynamic'")
...
func RunGlobalStatsIndexNDV(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("set @@tidb_partition_prune_mode = 'dynamic'")
...
func RunGlobalStats(t *testing.T) {
...
func RunGlobalIndexStatistics(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	h := dom.StatsHandle()
	originLease := h.Lease()
...
func RunIssues24349(t *testing.T) {
	store := testkit.CreateMockStore(t)
	testKit := testkit.NewTestKit(t, store)
	testKit.MustExec("use test")
	testKit.MustExec("set @@tidb_partition_prune_mode='dynamic'")
...
func RunIssues24349WithConcurrency(t *testing.T) {
	store := testkit.CreateMockStore(t)
	testKit := testkit.NewTestKit(t, store)
	testKit.MustExec("use test")
	testKit.MustExec("set @@tidb_partition_prune_mode='dynamic'")
...
func RunGlobalStatsAndSQLBinding(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGlobalStatsAndSQLBindingWithConcurrency(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMergeGlobalStatsForCMSketch(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunEmptyHists(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
