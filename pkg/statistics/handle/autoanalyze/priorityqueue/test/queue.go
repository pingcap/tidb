...
func RunCallAPIBeforeInitialize(t *testing.T) {
...
func RunAnalysisPriorityQueue(t *testing.T) {
...
func RunRefreshLastAnalysisDuration(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunProcessDMLChanges(t *testing.T) {
	testProcessDMLChanges(t, false)
}

func RunProcessDMLChangesPartitioned(t *testing.T) {
	testProcessDMLChanges(t, true)
}

func RunProcessDMLChangesWithRunningJobs(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunRequeueMustRetryJobs(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	tk := testkit.NewTestKit(t, store)
...
func RunProcessDMLChangesWithLockedTables(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunProcessDMLChangesWithLockedPartitionsAndDynamicPruneMode(t *testing.T) {
	ctx := context.Background()
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	tk := testkit.NewTestKit(t, store)
...
func RunProcessDMLChangesWithLockedPartitionsAndStaticPruneMode(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunPQCanBeClosedAndReInitialized(t *testing.T) {
	_, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
	pq := priorityqueue.NewAnalysisPriorityQueue(handle)
	defer pq.Close()
...
func RunPQHandlesTableDeletionGracefully(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
...
func RunConcurrentCloseAndBackgroundOperations(t *testing.T) {
...
func RunConcurrentClose(t *testing.T) {
	_, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
...
func RunConcurrentInitializeAndClose(t *testing.T) {
	_, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
...
func RunPanicAndRecoverInQueueRun(t *testing.T) {
	_, dom := testkit.CreateMockStoreAndDomain(t)
	handle := dom.StatsHandle()
