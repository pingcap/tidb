...
func RunCheckIndexesNeedAnalyze(t *testing.T) {
...
func RunCreateNonPartitionedTableAnalysisJobUsesRequestedStatsVersion(t *testing.T) {
...
func RunCalculateIndicatorsForPartitions(t *testing.T) {
	// 2024-01-01 10:00:00
...
func RunCheckNewlyAddedIndexesNeedAnalyzeForPartitionedTable(t *testing.T) {
	tblInfo := model.TableInfo{
		Indices: []*model.IndexInfo{
			{
				ID:    1,
