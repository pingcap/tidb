...
func RunGenSQLForNonPartitionedTable(t *testing.T) {
...
func RunGenSQLForNonPartitionedTableIndex(t *testing.T) {
	job := &priorityqueue.NonPartitionedTableAnalysisJob{
		SchemaName: "test_schema",
		TableName:  "test_table",
	}
...
func RunAnalyzeNonPartitionedTable(t *testing.T) {
...
func RunAnalyzeNonPartitionedIndexes(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunNonPartitionedTableValidateAndPrepare(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunValidateAndPrepareWhenOnlyHasFailedAnalysisRecords(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(metadef.CreateAnalyzeJobsTable)
	tk.MustExec("create schema example_schema")
