...
func RunGenSQLForAnalyzeStaticPartitionedTable(t *testing.T) {
...
func RunGenSQLForAnalyzeStaticPartitionedTableIndex(t *testing.T) {
	job := &priorityqueue.StaticPartitionedTableAnalysisJob{
		SchemaName:          "test_schema",
		GlobalTableName:     "test_table",
		StaticPartitionName: "p0",
...
func RunAnalyzeStaticPartitionedTable(t *testing.T) {
...
func RunAnalyzeStaticPartitionedTableIndexes(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunStaticPartitionedTableValidateAndPrepare(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
