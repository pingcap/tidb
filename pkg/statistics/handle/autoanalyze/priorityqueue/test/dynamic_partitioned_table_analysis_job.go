...
func RunAnalyzeDynamicPartitionedTable(t *testing.T) {
...
func RunAnalyzeDynamicPartitionedTableIndexes(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunValidateAndPrepareForDynamicPartitionedTable(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
...
func RunPerformanceOfValidateAndPrepare(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec(metadef.CreateAnalyzeJobsTable)
	tk.MustExec("create database example_schema")
