...
// - Alternative (checking ownership during Initialize) would add complexity for little gain
// - It is possible to analyze the same table twice in this short window, but it's harmless and rare
//
// SAFETY GUARANTEES:
