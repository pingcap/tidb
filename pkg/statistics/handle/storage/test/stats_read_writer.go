...
func RunUpdateStatsMetaVersionForGC(t *testing.T) {
...
func RunSlowStatsSaving(t *testing.T) {
...
func RunSlowStatsSavingForPartitionedTable(t *testing.T) {
	err := failpoint.Enable("github.com/pingcap/tidb/pkg/statistics/handle/storage/slowStatsSaving", "return(true)")
	require.NoError(t, err)
	defer func() {
		err = failpoint.Disable("github.com/pingcap/tidb/pkg/statistics/handle/storage/slowStatsSaving")
...
func RunFailedToHandleSlowStatsSaving(t *testing.T) {
	err := failpoint.Enable("github.com/pingcap/tidb/pkg/statistics/handle/storage/slowStatsSaving", "return(true)")
	require.NoError(t, err)
