...
func RunLFUPutGetDel(t *testing.T) {
	capacity := int64(100)
...
func RunLFUFreshMemUsage(t *testing.T) {
...
func RunLFUPutTooBig(t *testing.T) {
	lfu, err := NewLFU(1)
	require.NoError(t, err)
	mockTable := testutil.NewMockStatisticsTable(1, 1, true, false, false)
...
func RunLFUCachePutGetWithManyConcurrency(t *testing.T) {
	// to test DATA RACE
...
func RunLFUCachePutGetWithManyConcurrency2(t *testing.T) {
	// to test DATA RACE
	capacity := int64(100000000000)
	lfu, err := NewLFU(capacity)
	require.NoError(t, err)
...
func RunLFUCachePutGetWithManyConcurrencyAndSmallConcurrency(t *testing.T) {
	// to test DATA RACE
...
func RunMemoryControl(t *testing.T) {
	capacity := int64(100000000000)
	lfu, err := NewLFU(capacity)
	require.NoError(t, err)
	t1 := testutil.NewMockStatisticsTable(2, 1, true, false, false)
...
func RunMemoryControlWithUpdate(t *testing.T) {
	capacity := int64(100)
	lfu, err := NewLFU(capacity)
	require.NoError(t, err)
	for i := range 100 {
