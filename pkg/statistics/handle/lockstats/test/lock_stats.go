...
func RunGenerateSkippedTablesMessage(t *testing.T) {
	tests := []struct {
		name          string
		totalTableIDs []int64
		tables        []string
...
func RunGenerateSkippedPartitionsMessage(t *testing.T) {
	tests := []struct {
		name              string
		tableName         string
...
func RunInsertIntoStatsTableLocked(t *testing.T) {
...
func RunAddLockedTables(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	exec := mock.NewMockRestrictedSQLExecutor(ctrl)
...
func RunAddLockedPartitions(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	exec := mock.NewMockRestrictedSQLExecutor(ctrl)
...
func RunAddLockedPartitionsFailed(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	exec := mock.NewMockRestrictedSQLExecutor(ctrl)
