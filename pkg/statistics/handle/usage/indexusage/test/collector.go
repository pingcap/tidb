...
func RunUpdateIndex(t *testing.T) {
...
func RunFlushConcurrentIndexCollector(t *testing.T) {
...
func RunStmtIndexUsageCollector(t *testing.T) {
	iuc := NewCollector()
	iuc.StartWorker()
	defer iuc.Close()
