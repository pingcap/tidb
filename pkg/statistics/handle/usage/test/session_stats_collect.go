...
func RunPredicateUsage_FirstTouchCreatesRow(t *testing.T) {
...
func RunPredicateUsage_NoBumpWithinThrottle(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunPredicateUsage_BumpAfterOldStoredValue(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunDumpColStatsUsageWriter_ConcurrentMultiTables(t *testing.T) {
...
func RunDumpStatsDeltaPersistsInitTime(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func RunDumpStatsDeltaMergeKeepsEarliestInitTime(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	// Test setup:
