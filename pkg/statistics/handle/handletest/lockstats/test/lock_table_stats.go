...
func RunLockAndUnlockTableStats(t *testing.T) {
...
func RunLockAndUnlockPartitionedTableStats(t *testing.T) {
...
func RunLockTableAndUnlockTableStatsRepeatedly(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithTableT(t)
...
func RunLockAndUnlockTablesStats(t *testing.T) {
...
func RunDropTableShouldCleanUpLockInfo(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithTableT(t)
...
func RunTruncateTableShouldCleanUpLockInfo(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithTableT(t)
...
func RunUnlockPartitionedTableWouldUpdateGlobalCountCorrectly(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunDeltaInLockInfoCanBeNegative(t *testing.T) {
