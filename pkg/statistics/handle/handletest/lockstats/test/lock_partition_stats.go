...
func RunLockAndUnlockPartitionStats(t *testing.T) {
...
func RunLockAndUnlockPartitionsStats(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunLockAndUnlockPartitionStatsRepeatedly(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunSkipLockPartition(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunUnlockOnePartitionOfLockedTableWouldFail(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunUnlockTheUnlockedTableWouldGenerateWarning(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunSkipLockALotOfPartitions(t *testing.T) {
...
func RunReorganizePartitionShouldCleanUpLockInfo(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunDropPartitionShouldCleanUpLockInfo(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunTruncatePartitionShouldCleanUpLockInfo(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunExchangePartitionShouldChangeNothing(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunNewPartitionShouldBeLockedIfWholeTableLocked(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
...
func RunUnlockSomePartitionsWouldUpdateGlobalCountCorrectly(t *testing.T) {
	_, dom, tk, tbl := setupTestEnvironmentWithPartitionedTableT(t)
