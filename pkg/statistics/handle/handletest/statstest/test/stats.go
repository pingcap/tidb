...
func RunStatsCacheProcess(t *testing.T) {
...
func RunStatsCache(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	testKit.MustExec("use test")
	testKit.MustExec("create table t (c1 int, c2 int)")
...
func RunStatsCacheMemTracker(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	testKit.MustExec("use test")
...
func RunStatsStoreAndLoad(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	testKit := testkit.NewTestKit(t, store)
	testKit.MustExec("use test")
	testKit.MustExec("create table t (c1 int, c2 int)")
...
func RunInitStatsMemTraceWithLite(t *testing.T) {
	restore := config.RestoreFunc()
	defer restore()
	testInitStatsMemTraceFunc(t, true)
}

func RunInitStatsMemTraceWithoutLite(t *testing.T) {
	restore := config.RestoreFunc()
	defer restore()
	testInitStatsMemTraceFunc(t, false)
}

func RunInitStatsMemTraceWithConcurrentLite(t *testing.T) {
	restore := config.RestoreFunc()
	defer restore()
	testInitStatsMemTraceFunc(t, true)
}

func RunInitStatsMemTraceWithoutConcurrentLite(t *testing.T) {
	restore := config.RestoreFunc()
	defer restore()
	testInitStatsMemTraceFunc(t, false)
}
...
func RunInitStatsForPartitionedTable(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunInitStatsWithoutHandlingDDLEvent(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t(a int, b int, c int, primary key(a), key idx(b))")
...
func RunInitStatsVer2(t *testing.T) {
	originValue := config.GetGlobalConfig().Performance.LiteInitStats
	defer func() {
		config.GetGlobalConfig().Performance.LiteInitStats = originValue
	}()
...
func RunInitStats51358(t *testing.T) {
	originValue := config.GetGlobalConfig().Performance.LiteInitStats
	defer func() {
		config.GetGlobalConfig().Performance.LiteInitStats = originValue
	}()
...
func RunInitStatsIssue41938(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunDumpStatsDeltaInBatch(t *testing.T) {
...
func RunInitStatsForTableWithTopNButNoBuckets(t *testing.T) {
	store, dom := testkit.CreateMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t2(a int, b int, c int, primary key(a), key idx(b))")
...
func RunInitStatsMemoryFullBlocksBucketsButKeepsTopN(t *testing.T) {
	restore := config.RestoreFunc()
	defer restore()
