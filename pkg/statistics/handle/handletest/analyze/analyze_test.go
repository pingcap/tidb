...
func TestAnalyzeIncrementalEvictedIndex(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/pingcap/tidb/pkg/executor/assertEvictIndex", `return(true)`))
	tk.MustExec("analyze incremental table test.t index idx_b")
	require.Nil(t, failpoint.Disable("github.com/pingcap/tidb/pkg/executor/assertEvictIndex"))
}
