...
func RunUpgradeVersion83AndVersion84(t *testing.T) {
...
func RunUpgradeVersion66(t *testing.T) {
...
func RunUpgradeVersion74(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
...
func RunUpgradeVersion75(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
	ctx := context.Background()
...
func RunUpgradeVersionMockLatest(t *testing.T) {
	mock := true
...
func RunUpgradeVersionWithUpgradeHTTPOp(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
...
func RunUpgradeVersionWithoutUpgradeHTTPOp(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
...
func RunUpgradeVersionForPausedJob(t *testing.T) {
	store, dom := session.CreateStoreAndBootstrap(t)
	defer func() { require.NoError(t, store.Close()) }()
...
func RunUpgradeVersionForSystemPausedJob(t *testing.T) {
...
func RunUpgradeVersionForResumeJob(t *testing.T) {
	store, dom := session.CreateStoreAndBootstrap(t)
	defer func() { require.NoError(t, store.Close()) }()
...
func RunUpgradeWithPauseDDL(t *testing.T) {
...
func RunUpgradeWithCrossJoinDisabled(t *testing.T) {
	session.SupportUpgradeHTTPOpVer--
	ddl.SetWaitTimeWhenErrorOccurred(1 * time.Microsecond)
...
func RunUpgradeBDRPrimary(t *testing.T) {
	fromVersion := 244
	if kerneltype.IsNextGen() {
		fromVersion = 250
	}
...
func RunUpgradeBDRSecondary(t *testing.T) {
	fromVersion := 244
	if kerneltype.IsNextGen() {
		fromVersion = 250
	}
...
func RunUpgradeBindInfo(t *testing.T) {
	fromVersion := 251
	store, dom := session.CreateStoreAndBootstrap(t)
	defer func() { require.NoError(t, store.Close()) }()
...
func RunUpgradeWithAnalyzeColumnOptions(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
	ctx := context.Background()
...
func RunAnalyzeDistsqlConcurrencyByUpgrade750To850(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
	ctx := context.Background()
...
func RunAutoAnalyzeConcurrencyDefaultOnlyAffectsFreshBootstrap(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
	store, dom := session.CreateStoreAndBootstrap(t)
...
func RunBootstrapInNextGenInvalidSystemTable(t *testing.T) {
...
func RunUpgradeVersion256PlanCacheSkipStatsOnBinding(t *testing.T) {
	if kerneltype.IsNextGen() {
		t.Skip("Skip this case because there is no upgrade in the first release of next-gen kernel")
	}
