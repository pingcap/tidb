...
func RunAutocommit(t *testing.T) {
...
// a new transaction.
func RunTxnLazyInitialize(t *testing.T) {
...
func RunDisableTxnAutoRetry(t *testing.T) {
...
func RunAutoCommitRespectsReadOnly(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTxnRetryErrMsg(t *testing.T) {
	store := testkit.CreateMockStore(t)
	setTxnTk := testkit.NewTestKit(t, store)
	setTxnTk.MustExec("set global tidb_txn_mode=''")
	tk1 := testkit.NewTestKit(t, store)
...
func RunErrorRollback(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCommitTSOrderCheck(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t(id int)")
...
func RunMemBufferSnapshotRead(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMemBufferCleanupMemoryLeak(t *testing.T) {
...
func RunPanicOnRollbackKilledTxn(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
