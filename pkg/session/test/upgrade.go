...
func RunUpgradeToVerFunctionsCheck(t *testing.T) {
	var lastVer int64
	upgradeFns := sessionpkg.GetExportedUpgradeToVerFunctions()
	...
	require.Equal(t, sessionpkg.GetExportedCurrentBootstrapVersion(), lastVer, "last version in upgradeToVerFunctions should match currentBootstrapVersion")
}
