...
func RunIndexColumnLength(t *testing.T) {
	...
	is := dom.InfoSchema()
	tab, err2 := is.TableByName(context.Background(), ast.NewCIStr("test"), ast.NewCIStr("t"))
...
func RunTableInfoMeta(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunLastMessage(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunQueryString(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAffectedRows(t *testing.T) {
	store := testkit.CreateMockStore(t)
