...
func RunForbidSettingBothTSVariable(t *testing.T) {
...
func RunCoprocessorOOMAction(t *testing.T) {
...
func RunCorrectScopeError(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunReadDMLBatchSize(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSetEnableRateLimitAction(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMaxExecutionTime(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunReplicaRead(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunLastQueryInfo(t *testing.T) {
...
func RunMockZapCore(t *testing.T) {
...
func RunGeneralLogNonzeroTxnStartTS(t *testing.T) {
...
func RunGeneralLogBinaryText(t *testing.T) {
	oldGL := logutil.GeneralLogger
	mzc := mockZapCore{Core: zapcore.NewNopCore()}
	logutil.GeneralLogger = zap.New(&mzc)
	defer func() { logutil.GeneralLogger = oldGL }()
