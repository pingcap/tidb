...
func RunInitDDLTables(t *testing.T) {
...
func RunInitMetaTable(t *testing.T) {
...
func RunMetaTableRegion(t *testing.T) {
...
func RunRecordTTLRows(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunInformationSchemaCreateTime(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunNextgenBootstrap(t *testing.T) {
