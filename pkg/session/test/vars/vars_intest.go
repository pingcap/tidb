...
func RunRemovedSysVars(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunTiKVSystemVars(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunUpgradeSysvars(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSetInstanceSysvarBySetGlobalSysVar(t *testing.T) {
...
func RunGlobalVarAccessor(t *testing.T) {
...
func RunPrepareExecuteWithSQLHints(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	se := tk.Session()
...
func RunTiDBValidateTS(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("create table t(a int primary key)")
...
func RunTiDBAdvancerCheckPointLagLimit(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
