...
func RunRangeCursor(t *testing.T) {
	tracker := &cursorTracker{cursors: &sync.Map{}}
...
func RunCursorHandleClose(t *testing.T) {
	tracker := &cursorTracker{cursors: &sync.Map{}}
	cursor := tracker.NewCursor(State{})
	id := cursor.ID()
	cursor.Close()
...
func RunCursorTrackerConcurrentCreateDelete(t *testing.T) {
	tracker := &cursorTracker{cursors: &sync.Map{}}
