...
const (
	...
	version254 = 254
	// version255
	// Add model system tables mysql.tidb_model and mysql.tidb_model_version.
	version255 = 255
)
...
func upgradeToVer255(s sessionapi.Session, _ int64) {
	mustExecute(s, metadef.CreateTiDBModelTable)
	mustExecute(s, metadef.CreateTiDBModelVersionTable)
}
