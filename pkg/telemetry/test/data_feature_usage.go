...
func RunTxnUsageInfo(t *testing.T) {
...
func RunTemporaryTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAutoIDNoCache(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAccountLock(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMultiSchemaChange(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPlacementPolicies(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunResourceGroups(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAutoCapture(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunNonTransactionalUsage(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunGlobalKillUsageInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunPagingUsageInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunCostModelVer2UsageInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTxnSavepointUsageInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunLazyPessimisticUniqueCheck(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunFlashbackCluster(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAddIndexAccelerationAndMDL(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	usage, err := telemetry.GetFeatureUsage(tk.Session())
...
func RunIndexMergeUsage(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunTTLTelemetry(t *testing.T) {
...
func RunStoreBatchCopr(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
...
func RunFairLockingUsage(t *testing.T) {
