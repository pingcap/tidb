...
const file_indexer_proto_rawDesc = "" +
	...
	"\x05epoch\x18\x04 \x01(\x04R\x05epoch\"\xab\x01\n" +
	...
	"\n" +
	"table_info\x18\x03 \x01(\v2\x12.indexer.TableInfoR\ttableInfo\"*\n" +
	...
	"\bAddShard\x12\x18.indexer.AddShardRequest\x1a\x19.indexer.AddShardResponseB\vZ\t./indexerb\x06proto3"
...
var file_indexer_proto_goTypes = []any{
	...
	(*ShardManifestHeader)(nil),      // 2: indexer.ShardManifestHeader
	(*AddShardRequest)(nil),          // 3: indexer.AddShardRequest
	(*AddShardResponse)(nil),         // 4: indexer.AddShardResponse
	(*CreateIndexRequest)(nil),       // 5: indexer.CreateIndexRequest
	(*CreateIndexResponse)(nil),      // 6: indexer.CreateIndexResponse
	(*DropIndexRequest)(nil),         // 7: indexer.DropIndexRequest
	(*DropIndexResponse)(nil),        // 8: indexer.DropIndexResponse
	(*TableInfo)(nil),                // 9: indexer.TableInfo
	(*ColumnInfo)(nil),               // 10: indexer.ColumnInfo
	(*IndexInfo)(nil),                // 11: indexer.IndexInfo
	(*ParserInfo)(nil),               // 12: indexer.ParserInfo
	(*GetIndexProgressRequest)(nil),  // 13: indexer.GetIndexProgressRequest
	(*GetIndexProgressResponse)(nil), // 14: indexer.GetIndexProgressResponse
	nil,                              // 15: indexer.IndexInfo.OtherParamsEntry
	nil,                              // 16: indexer.ParserInfo.ParserParamsEntry
}
var file_indexer_proto_depIdxs = []int32{
	2,  // 0: indexer.AddShardRequest.shard:type_name -> indexer.ShardManifestHeader
	11, // 1: indexer.AddShardRequest.index_info:type_name -> indexer.IndexInfo
	9,  // 2: indexer.AddShardRequest.table_info:type_name -> indexer.TableInfo
	11, // 3: indexer.CreateIndexRequest.index_info:type_name -> indexer.IndexInfo
	9,  // 4: indexer.CreateIndexRequest.table_info:type_name -> indexer.TableInfo
	10, // 5: indexer.TableInfo.columns:type_name -> indexer.ColumnInfo
	0,  // 6: indexer.IndexInfo.index_type:type_name -> indexer.IndexType
	10, // 7: indexer.IndexInfo.columns:type_name -> indexer.ColumnInfo
	12, // 8: indexer.IndexInfo.parser_info:type_name -> indexer.ParserInfo
	15, // 9: indexer.IndexInfo.other_params:type_name -> indexer.IndexInfo.OtherParamsEntry
	1,  // 10: indexer.ParserInfo.parser_type:type_name -> indexer.ParserType
	16, // 11: indexer.ParserInfo.parser_params:type_name -> indexer.ParserInfo.ParserParamsEntry
	5,  // 12: indexer.IndexerService.CreateIndex:input_type -> indexer.CreateIndexRequest
	7,  // 13: indexer.IndexerService.DropIndex:input_type -> indexer.DropIndexRequest
	13, // 14: indexer.IndexerService.GetIndexProgress:input_type -> indexer.GetIndexProgressRequest
	3,  // 15: indexer.IndexerService.AddShard:input_type -> indexer.AddShardRequest
	6,  // 16: indexer.IndexerService.CreateIndex:output_type -> indexer.CreateIndexResponse
	8,  // 17: indexer.IndexerService.DropIndex:output_type -> indexer.DropIndexResponse
	14, // 18: indexer.IndexerService.GetIndexProgress:output_type -> indexer.GetIndexProgressResponse
	4,  // 19: indexer.IndexerService.AddShard:output_type -> indexer.AddShardResponse
