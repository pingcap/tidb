...
var MySQLErrName = map[uint16]*mysql.ErrMessage{
	...
	ErrAlterColumnReferencedByPartialCondition: mysql.Message("Column '%-.192s' is referenced by a partial index condition in index '%-.192s', so it cannot be altered", nil),
}
