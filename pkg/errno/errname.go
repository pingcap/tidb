...
var MySQLErrName = map[uint16]*mysql.ErrMessage{
	...
	ErrMemoryExceed:                     mysql.Message("Your query has been cancelled due to exceeding the allowed memory limit for %s. Please try narrowing your query scope or increase the %s and try again.[conn=%d]", nil),
