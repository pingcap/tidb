...
var MySQLErrName = map[uint16]*mysql.ErrMessage{
	...
	ErrGlobalIndexNotExplicitlySet: mysql.Message("Global Index is needed, since the unique index is not including all partitioning columns, but GLOBAL is not given as IndexOption", nil),
}
