...
func tableInfoResultEqual(t1, t2 []infoschemacontext.TableInfoResult) bool {
...
func (is *InfoschemaV3) SchemaSimpleTableInfos(ctx context.Context, schema pmodel.CIStr) ([]*model.TableNameInfo, error) {
...
func (is *InfoschemaV3) TableInfoByName(schema, table pmodel.CIStr) (*model.TableInfo, error) {
...
func (is *InfoschemaV3) SchemaTableInfos(ctx context.Context, schema pmodel.CIStr) ([]*model.TableInfo, error) {
...
func (is *InfoschemaV3) SchemaByName(schema pmodel.CIStr) (val *model.DBInfo, ok bool) {
...
func (is *InfoschemaV3) SchemaNameByTableID(tableID int64) (schemaName pmodel.CIStr, ok bool) {
	dbname1, ok1 := is.infoV1.SchemaNameByTableID(tableID)
	dbname2, ok2 := is.infoV2.SchemaNameByTableID(tableID)
	if ok1 != ok2 {
		panic("inconsistent infoschema 17")
	}
	if !ok1 {
...
func (is *InfoschemaV3) AllSchemaNames() []pmodel.CIStr {
	names1 := is.infoV1.AllSchemaNames()
	names2 := is.infoV2.AllSchemaNames()
	if len(names1) != len(names2) {
		panic("inconsistent infoschema 21")
	}
	slices.SortFunc(names1, func(i, j pmodel.CIStr) int {
		return strings.Compare(i.O, j.O)
	})
	slices.SortFunc(names2, func(i, j pmodel.CIStr) int {
		return strings.Compare(i.O, j.O)
	})
	for i := range names1 {
...
func (is *InfoschemaV3) SchemaExists(schema pmodel.CIStr) bool {
...
func (is *InfoschemaV3) TableExists(schema, table pmodel.CIStr) bool {
...
func (is *InfoschemaV3) PolicyByName(name pmodel.CIStr) (*model.PolicyInfo, bool) {
...
func (is *InfoschemaV3) ResourceGroupByName(name pmodel.CIStr) (*model.ResourceGroupInfo, bool) {
...
func (is *InfoschemaV3) ListTablesWithSpecialAttribute(filter infoschemacontext.SpecialAttributeFilter) []infoschemacontext.TableInfoResult {
