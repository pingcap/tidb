...
func RunPerfSchemaTables(t *testing.T) {
...
func RunTiKVProfileCPU(t *testing.T) {
	store := newMockStore(t)
	...
	copyHandler := func(filename string) http.HandlerFunc {
		return func(w http.ResponseWriter, _ *http.Request) {
			file, err := os.Open(filename) // #nosec G304 -- test-controlled path
			if err != nil {
...
func RunSessionConnectAttrs(t *testing.T) {
