...
// InitWithDBInfos ...
func (b *BuilderV3) InitWithDBInfos(
	dbInfosFull []*model.DBInfo,
	dbInfos []*model.DBInfo,
	policies []*model.PolicyInfo,
	resourceGroups []*model.ResourceGroupInfo,
	schemaVersion int64,
) (*BuilderV3, error) {
...
// ApplyDiff ...
func (b *BuilderV3) ApplyDiff(m meta.Reader, diff *model.SchemaDiff) ([]int64, error) {
