...
func RunInfoSchemaFieldValue(t *testing.T) {
	...
	tk.MustQuery("show create table information_schema.PROCESSLIST").Check(
		testkit.Rows("" +
			...
			"  `MEM_ARBITRATION` double DEFAULT NULL,\n" +
			"  `MEM_WAIT_ARBITRATE_START` varchar(32) DEFAULT NULL,\n" +
			"  `MEM_WAIT_ARBITRATE_BYTES` bigint(21) DEFAULT NULL,\n" +
...
func RunSomeTables(t *testing.T) {
	store := testkit.CreateMockStore(t)
	...
	tk.MustQuery("select * from information_schema.PROCESSLIST order by ID;").Check(
		testkit.Rows(
			...
			fmt.Sprintf("2 user-2 localhost <nil> Init DB 9223372036 %s %s abc2 0 2.1 1970-01-02 10:17:36.789 123456789123 0 07-29 03:26"+
...
func RunTableRowIDShardingInfo(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSlowQuery(t *testing.T) {
	...
	// Test for long query.
	f, err := os.OpenFile(slowLogFileName, os.O_CREATE|os.O_WRONLY, 0o600)
	require.NoError(t, err)
...
func RunTableIfHasColumn(t *testing.T) {
...
`)
	...
	// check schema
	// #nosec G202 -- test builds SQL from a trusted column identifier constant
...
func RunReloadDropDatabase(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSystemSchemaID(t *testing.T) {
...
func RunSelectHiddenColumn(t *testing.T) {
...
func RunFormatVersion(t *testing.T) {
...
func RunFormatStoreServerVersion(t *testing.T) {
...
func RunStmtSummaryTable(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunStmtSummaryTablePrivilege(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunStmtSummaryInternalQuery(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunSimpleStmtSummaryEvictedCount(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunStmtSummaryEvictedPointGet(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunStorageEnginesInStmtSummary(t *testing.T) {
...
func RunServerInfoResolveLoopBackAddr(t *testing.T) {
...
func RunInfoSchemaClientErrors(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunTiDBTrxSummary(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunAttributes(t *testing.T) {
	store := testkit.CreateMockStore(t)
...
func RunMemoryUsageAndOpsHistory(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
...
func RunAddFieldsForBinding(t *testing.T) {
...
func RunClusterInfoTime(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
