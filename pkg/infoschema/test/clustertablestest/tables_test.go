...
func TestMemoryUsageAndOpsHistory(t *testing.T) {
	...
	err = tk.QueryToErr("explain analyze format = 'brief' select * from t t1 join t t2 join t t3 on t1.a=t2.a and t1.a=t3.a order by t1.a")
	...
	require.Equal(t, row[10], "9110763964dc6a6aad6a9dc0408d52997e2828a3a062c7e66460e054e9239425")                                                 // SQL_DIGEST
	require.Equal(t, row[11], "explain analyze format = 'brief' select * from t t1 join t t2 join t t3 on t1.a=t2.a and t1.a=t3.a order by t1.a") // SQL_TEXT
}
