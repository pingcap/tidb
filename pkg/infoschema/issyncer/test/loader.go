...
func RunLoadFromTS(t *testing.T) {
...
func RunLoadFromTSForCrossKS(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
...
func RunLoaderSkipLoadingDiff(t *testing.T) {
...
func RunLoaderSkipLoadingDiffForBR(t *testing.T) {
	store, err := mockstore.NewMockStore()
	require.NoError(t, err)
