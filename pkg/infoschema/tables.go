...
var tableStatementsSummaryCols = []columnInfo{
	...
	{name: stmtsummary.MaxRequestUnitV2Str, tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Max request-unit v2 cost of these statements"},
	{name: stmtsummary.AvgRequestUnitV2Str, tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Average request-unit v2 cost of these statements"},
