...
var slowQueryCols = []columnInfo{
	...
	{name: variable.SlowLogUnpackedBytesSentKVTotal, tp: mysql.TypeLonglong, size: 20},
	{name: variable.SlowLogUnpackedBytesReceivedKVTotal, tp: mysql.TypeLonglong, size: 20},
	{name: variable.SlowLogUnpackedBytesSentKVCrossZone, tp: mysql.TypeLonglong, size: 20},
	{name: variable.SlowLogUnpackedBytesReceivedKVCrossZone, tp: mysql.TypeLonglong, size: 20},
