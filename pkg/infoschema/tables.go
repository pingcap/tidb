...
var slowQueryCols = []columnInfo{
	...
	{name: variable.SlowLogMVMergeTotalTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogMVMergeBuildLocalTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogMVMergeBuildASTTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogMVMergeOptimizeMergeSourceTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogMVMergeOptimizeFullUpdateTimeStr, tp: mysql.TypeDouble, size: 22},
	{name: variable.SlowLogMVMergeExtractFullUpdateTimeStr, tp: mysql.TypeDouble, size: 22},
