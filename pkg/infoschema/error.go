...
var (
	...
	//// ErrPlacementPolicyFormatNotExists return for placement_policy policy format not exists.
	//ErrPlacementPolicyFormatNotExists = dbterror.ClassSchema.NewStd(mysql.ErrPlacementPolicyFormatNotExists)
